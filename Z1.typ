...
// ========================================================
#let profile = "loigiai"         // "dethi": bản học sinh làm, "loigiai": bản giáo viên có đáp án
...
#tn([Hàm số $y=x^3-3x$ đạt cực đại tại điểm nào?], 
(
True([$x = -1$]), 
[$x = 1$], 
[$x = 0$], 
