...
(function() {
  ...
  window.addEventListener('load', () => {
     // Các trang thế hệ mới đã có nút thư viện riêng trong giao diện.
     // Chỉ tiêm nút vào bố cục cũ để tránh hiển thị trùng.
     if (document.getElementById('btnTemplates')) return;
