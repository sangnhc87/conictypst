...
const SYSTEM_FILES = {
  ...
  '/smg/src/core/projections.typ': null,
  '/smg/src/2d/shapes.typ': null,
  '/smg/src/2d/conics.typ': null,
  '/smg/src/2d/graphs.typ': null,
  '/smg/src/3d/pseudo3d.typ': null,
  '/smg/src/3d/phanghoa.typ': null,
  '/smg/src/3d/solids.typ': null,
  '/smg/src/3d/polyhedra.typ': null,
  '/smg/src/3d/curves.typ': null,
  '/smg/src/3d/surfaces.typ': null,
  '/smg/src/3d/geodesic.typ': null,
  '/smg/src/calculus/volumes.typ': null,
  '/smg/src/probability/tree.typ': null,
  '/smg/src/probability/bayes.typ': null,
  // unfold-package files
  '/unfold-package/conic-tangent.typ': null,
  '/unfold-package/integral-region.typ': null,
  '/unfold-package/lp-region.typ': null,
  '/unfold-package/solid-section.typ': null,
  '/unfold-package/tree.typ': null,
  '/unfold-package/unfold.typ': null,
  '/unfold-package/venn.typ': null,
};
...
async function loadSystemFiles() {
  ...
  const urls = [
    ...
    { key: '/smg/src/core/projections.typ',   url: `${base}/typst/smg/src/core/projections.typ` },
    { key: '/smg/src/2d/shapes.typ',          url: `${base}/typst/smg/src/2d/shapes.typ` },
    { key: '/smg/src/2d/conics.typ',          url: `${base}/typst/smg/src/2d/conics.typ` },
    { key: '/smg/src/2d/graphs.typ',          url: `${base}/typst/smg/src/2d/graphs.typ` },
    { key: '/smg/src/3d/pseudo3d.typ',        url: `${base}/typst/smg/src/3d/pseudo3d.typ` },
    { key: '/smg/src/3d/phanghoa.typ',        url: `${base}/typst/smg/src/3d/phanghoa.typ` },
    { key: '/smg/src/3d/solids.typ',          url: `${base}/typst/smg/src/3d/solids.typ` },
    { key: '/smg/src/3d/polyhedra.typ',       url: `${base}/typst/smg/src/3d/polyhedra.typ` },
    { key: '/smg/src/3d/curves.typ',          url: `${base}/typst/smg/src/3d/curves.typ` },
    { key: '/smg/src/3d/surfaces.typ',        url: `${base}/typst/smg/src/3d/surfaces.typ` },
    { key: '/smg/src/3d/geodesic.typ',        url: `${base}/typst/smg/src/3d/geodesic.typ` },
    { key: '/smg/src/calculus/volumes.typ',   url: `${base}/typst/smg/src/calculus/volumes.typ` },
    { key: '/smg/src/probability/tree.typ',   url: `${base}/typst/smg/src/probability/tree.typ` },
    { key: '/smg/src/probability/bayes.typ',  url: `${base}/typst/smg/src/probability/bayes.typ` },
    // unfold-package files
    { key: '/unfold-package/conic-tangent.typ', url: `${base}/typst/unfold-package/conic-tangent.typ` },
    { key: '/unfold-package/integral-region.typ', url: `${base}/typst/unfold-package/integral-region.typ` },
    { key: '/unfold-package/lp-region.typ', url: `${base}/typst/unfold-package/lp-region.typ` },
    { key: '/unfold-package/solid-section.typ', url: `${base}/typst/unfold-package/solid-section.typ` },
    { key: '/unfold-package/tree.typ', url: `${base}/typst/unfold-package/tree.typ` },
    { key: '/unfold-package/unfold.typ', url: `${base}/typst/unfold-package/unfold.typ` },
    { key: '/unfold-package/venn.typ', url: `${base}/typst/unfold-package/venn.typ` },
  ];
...
async function compileTySvg(code) {
  ...
  const hasBbt   = /#bbtv2\(|#bbbt\(|#bxd\(|#bxd-tich\(|#bbt-opt\(|#bang-gia-tri\(|#bang-phan-phoi\(|#auto-bbt\(|#o-cheo\(|#o-cheo3\(/.test(code);
  ...
  // SMG import trước (cung cấp các hàm hình học tổng hợp)
  if (hasSmg && SYSTEM_FILES['/smg/lib.typ']) imports += `#import "/smg/lib.typ": *\n`;
  // Import cetz chỉ khi code dùng trực tiếp VÀ không qua bbt.typ VÀ không qua SMG
