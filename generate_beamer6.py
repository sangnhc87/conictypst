...
files_to_process = [
    "typst/sach/DECUONG12-HK1/chuong-01/chuyen-de-tiep-tuyen-tuong-giao.typ",
]

beamer_file = "typst/beamer/beamer-12-bai-6-tiep-tuyen-tuong-giao.typ"
...
print("Done generating Beamer 6.")
