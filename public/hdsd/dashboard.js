...
const tools = [
  ...
  { title: 'AI tạo bài tương tự', desc: 'Khung prompt và chuẩn hóa ID', icon: 'cpu', color: 'violet', href: 'index.html#ids-bank', status: 'Đang dựng', keywords: 'ai tạo bài tương tự sinh câu hỏi' },
  ...
  { title: 'Beamer Converter', desc: 'Đề thi sang slide Typst Beamer', icon: 'presentation', color: 'indigo', href: 'index.html#book-overview', status: 'Đang dựng', keywords: 'beamer converter slide typst' },
  ...
  { title: 'AI Typst Assistant', desc: 'Trợ lý sửa macro, đổi cấu trúc', icon: 'bot', color: 'green', href: 'index.html#typst-params', status: 'Đang dựng', keywords: 'ai typst assistant macro' },
