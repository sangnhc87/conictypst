  ...
  const LINKS = [
    {
      ...
      items: [
        ...
        ['✨', 'AI sang-math 1.0.4', 'ai-sang-math.html'],
        ['🧠', 'AI Tạo đề THPT', 'ai-tao-de.html?tab=gen'],
    ...
    },
    {
      title: 'CeTZ & hình học',
      items: [
        ['📊', 'Đồ thị & Miền phẳng CeTZ', 'cetz-plot.html'],
        ['📈', 'Bảng biến thiên Live', 'bbt-live.html'],
        ['📐', 'Hình học Live 2D/3D', 'hh-live.html'],
        ['✏️', 'Bảng vẽ CeTZ & TikZ', 'cetz-ve.html'],
        ['📐', 'GeoGebra → CeTZ', 'cetz-geogebra.html'],
        ['🧊', 'Hình học 3D CeTZ', 'cetz-3d.html'],
      ],
    },
    {
      title: 'AI & kiểm tra',
      items: [
        ['📷', 'OCR ảnh/PDF → Typst', 'ocr-typst.html'],
        ['✨', 'AI sang-math 1.0.4', 'ai-sang-math.html'],
        ['✅', 'Kiểm lỗi Typst (Linter)', 'typst-linter.html'],
    ...
    },
    {
      ...
      items: [
        ['⚡', 'Dashboard Tổng Hợp', 'dashboard.html'],
        ['📚', 'Atlas 209 Học Liệu', 'atlas.html'],
        ['📖', 'Hướng dẫn sang-math', 'index.html'],
        ['🌿', 'Hệ sinh thái ConicTypst', 'ecosystem.html'],
        ['🎯', 'Sang Math Chấm Thi OMR', 'https://chamthi-conictypst.pages.dev/'],
