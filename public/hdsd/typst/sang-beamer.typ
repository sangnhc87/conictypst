...
#let mcq(
  ...
  let _has-id-first = type(stem) == str and args.pos().len() > 0
  let _qid = if _has-id-first { stem } else { args.named().at("id", default: none) }
  let stem = if _has-id-first { options } else { stem }
  let options = if _has-id-first { args.pos().at(0) } else { options }
...
#let tf(
  ...
  let _has-id-first = type(stem) == str and args.pos().len() > 0
  let _qid = if _has-id-first { stem } else { args.named().at("id", default: none) }
  let stem = if _has-id-first { statements } else { stem }
  let statements = if _has-id-first { args.pos().at(0) } else { statements }
...
#let short(
  ...
  let _has-id-first = type(stem) == str and args.pos().len() > 0
  let _qid = if _has-id-first { stem } else { args.named().at("id", default: none) }
  let stem = if _has-id-first { answer } else { stem }
  let answer = if _has-id-first { args.pos().at(0) } else { answer }
...
#let tl(
  ...
  let _has-id-first = type(stem) == str and args.pos().len() > 0
  let _qid = if _has-id-first { stem } else { args.named().at("id", default: none) }
  let stem = if _has-id-first { args.pos().at(0) } else { stem }
