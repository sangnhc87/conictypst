...
warp_heights = {
    ...
    'ds-12': 1204,
    'tln-10': 2210,
    'hybrid': 1051 # guessing 1051 for hybrid if not present
}
...
for k, v in t.items():
    ...
    v_new['warp']['height'] = H # Fix the height back to warped pixel height
    v_new['warp']['width'] = 1500
    new_t[k] = v_new
...
new_js = "window.TEMPLATES = " + json.dumps(new_t) + ";"
