...
```typ
#import "@preview/sang-math:1.0.0": ds, sang-setup, True

#show: sang-setup

#ds("DS01",
  [Một số mệnh đề về số phức $z$.],
  (
    True([$z = a + b i$ thì phần thực là $a$.]),
    [$z = a + b i$ thì phần ảo là $b i$.],
  ),
  ds-style: "bookmark", // "table" | "list" | "pill" | "modern" | "minimal" | "bookmark" | "folder" | "diamond" | "gradient" | "checklist"
)
```

### 6. Câu tự luận có lời giải (`tl`)
...
### 8. Chế độ hiển thị đề thi (`exam-mode`)
...
### 9. Ký hiệu toán học tắt (`math-sym`)
