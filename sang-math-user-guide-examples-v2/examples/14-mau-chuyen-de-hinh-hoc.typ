...
#{
  ...
  let c-p1    = rgb("#01579B") // Purple
  let c-p2    = rgb("#0277BD") // Violet
  let c-p3    = rgb("#0288D1") // Pink
  ...
  align(center, {
    ...
    block(
      ...
      #block(
        ...
        #linebreak()
        #text(size: 14pt, weight: "bold", fill: c-p2)[TƯ DUY HÌNH HỌC TRỰC QUAN]
        #linebreak()
        #v(0.4em)
...
// ═══════════════════════════════════════════════
#outline(
  title: [Mục Lục MẪU HÌNH HỌC KHÔNG GIAN],
  depth: 2,
  indent: 1.5em,
)
#pagebreak()
