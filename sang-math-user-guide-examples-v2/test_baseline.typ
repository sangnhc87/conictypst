...
Test text #option-label("A", style: "circle") baseline #option-label("B", style: "calligraphy") test #option-label("C", style: "vietnam-star") test #option-label("D", style: "bad-star")
