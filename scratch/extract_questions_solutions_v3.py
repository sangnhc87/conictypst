...
def extract_solution_boxes_in_range(text, start_pos, end_pos):
    ...
    while pos < end_pos:
        ...
        if raw_text:
            # Clean up the raw text slightly
            sol_parts.append({
                "type": box_type,
...
def extract_problems_with_solutions(filepath):
    ...
    # Find all question occurrences and their positions
    q_matches = []
    pos = 0
    while True:
...
output_path = "/Users/admin/conictypst/scratch/extracted_questions_solutions_v3.json"
