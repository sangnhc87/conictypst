...
extracted_path = "/Users/admin/conictypst/scratch/extracted_questions_solutions_v6.json"
...
def clean_math_delimiters(text):
    ...
    text = re.sub(r'\bsect\b', 'inter', text)
    return text

def strip_cetz_from_question(text):
    pos = 0
    while True:
...
out.append('#import "@preview/cetz:0.5.2": canvas, draw')
out.append('')
out.append('// ═══════════════════════════════════════════════')
...
out.append('#let c-navy = rgb("0D47A1")')
out.append('#let c-teal = rgb("00695C")')
out.append('#let c-violet = rgb("4A148C")')
out.append('#let c-amber = rgb("BF360C")')
out.append('#let c-green = rgb("1B5E20")')
out.append('')
...
out.append('')
out.append('// ═══════════════════════════════════════════════')
out.append('// ĐỊNH NGHĨA CÁC HỘP LỜI GIẢI MẪU')
out.append('// ═══════════════════════════════════════════════')
out.append('#let cach-box(title: "Hướng giải", color: col-blue, icon: "🔵", body) = block(')
out.append('  fill: color.lighten(94%),')
out.append('  stroke: (left: 4pt + color, rest: 0.5pt + color.lighten(70%)),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 13pt, y: 10pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: color, weight: "bold", size: 10.5pt)[#icon #title]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let note-box(title: "📌 Nhận Xét Quan Trọng", body) = block(')
out.append('  fill: rgb("FFF9C4"),')
out.append('  stroke: (left: 4pt + rgb("FBC02D"), rest: 0.5pt + rgb("FFF59D")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 13pt, y: 10pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("FBC02D").darken(20%), weight: "bold")[#title]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let cach1-box(body) = block(')
out.append('  fill: rgb("E8F8F5"),')
out.append('  stroke: (left: 4pt + rgb("117A65"), rest: 0.8pt + rgb("A2D9CE")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 11pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("117A65"), weight: "bold")[💡 Cách 1: Phân tích Sơ đồ cây / Lời giải Trực quan]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let cach2-box(body) = block(')
out.append('  fill: rgb("EBF5FB"),')
out.append('  stroke: (left: 4pt + rgb("2E86C1"), rest: 0.8pt + rgb("AED6F1")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 11pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("2E86C1"), weight: "bold")[⚡ Cách 2: Thiết lập phương trình / Giải tích / Công thức tổng quát]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let ans-box(body) = block(')
out.append('  fill: rgb("F4ECF7"),')
out.append('  stroke: (left: 4pt + rgb("8E44AD"), rest: 0.8pt + rgb("D7BDE2")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 11pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("8E44AD"), weight: "bold")[🏁 Đáp số & Mệnh đề đúng/sai]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let loigiai-box(body) = block(')
out.append('  fill: rgb("F8F9F9"),')
out.append('  stroke: (left: 4pt + rgb("7F8C8D"), rest: 0.8pt + rgb("D5DBDB")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 11pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("7F8C8D"), weight: "bold")[📝 Lời giải chi tiết]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let theory-box(body) = block(')
out.append('  fill: rgb("E3F2FD"),')
out.append('  stroke: (left: 4pt + c-navy, rest: 0.8pt + rgb("90CAF9")),')
out.append('  radius: (right: 7pt),')
out.append('  inset: (x: 16pt, y: 14pt),')
out.append('  width: 100%,')
out.append(')[#body]')
out.append('')
out.append('#let insight-box(title: "💡 Trực Giác Sư Phạm", body) = block(')
out.append('  fill: rgb("E8F5E9"),')
out.append('  stroke: (left: 4pt + c-teal, rest: 0.6pt + rgb("A5D6A7")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 12pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: c-teal, weight: "bold")[#title]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let key-box(body) = block(')
out.append('  fill: rgb("F3E5F5"),')
out.append('  stroke: (left: 4pt + c-violet, rest: 0.6pt + rgb("CE93D8")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 12pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: c-violet, weight: "bold")[🔑 Nguyên Lý Then Chốt]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let warn-box(body) = block(')
out.append('  fill: rgb("FBE9E7"),')
out.append('  stroke: (left: 4pt + c-amber, rest: 0.6pt + rgb("FFAB91")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 11pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: c-amber, weight: "bold")[⚠️ Lỗi Sai Thường Gặp]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let compare-box(title: "🔍 Phân Tích So Sánh", body) = block(')
out.append('  fill: rgb("F7F9FA"),')
out.append('  stroke: (left: 4pt + rgb("006064"), rest: 0.6pt + rgb("B2EBF2")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 12pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("006064"), weight: "bold")[#title]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let example-box(n: "", body) = block(')
out.append('  fill: rgb("F1F8E9"),')
out.append('  stroke: (left: 4pt + c-green, rest: 0.6pt + rgb("C5E1A5")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 14pt, y: 11pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: c-green, weight: "bold")[🎯 Ví dụ #n]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let activity-box(title: "🎓 Hoạt Động Lớp Học", body) = block(')
out.append('  fill: rgb("E8F8F5"),')
out.append('  stroke: (left: 4pt + rgb("117A65"), rest: 0.8pt + rgb("A2D9CE")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 13pt, y: 10pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("117A65"), weight: "bold")[#title]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let qopen(body) = block(')
out.append('  fill: rgb("F7F9FA"),')
out.append('  stroke: 0.5pt + rgb("CFD8DC"),')
out.append('  inset: (x: 12pt, y: 10pt),')
out.append('  width: 100%,')
out.append(')[#body]')
out.append('')
out.append('#let step-box(n, title, body) = block(')
out.append('  fill: rgb("EBF5FB"),')
out.append('  stroke: (left: 4pt + rgb("2E86C1"), rest: 0.5pt + rgb("AED6F1")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 13pt, y: 10pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("2E86C1"), weight: "bold")[Bước #n: #title]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let crime-gold = rgb("D4AC0D")')
out.append('#let verdict-box(body) = block(')
out.append('  fill: rgb("FFFDE7"),')
out.append('  stroke: (left: 4pt + crime-gold, rest: 0.5pt + rgb("F9E79F")),')
out.append('  radius: (right: 6pt),')
out.append('  inset: (x: 12pt, y: 10pt),')
out.append('  width: 100%,')
out.append(')[')
out.append('  #text(fill: rgb("7D6608"), weight: "bold")[⚖️ Phán Quyết]')
out.append('  #v(0.3em)')
out.append('  #body')
out.append(']')
out.append('')
out.append('#let fig-shadow = rgb(198, 210, 224, 70)')
out.append('#let iso-point(p, dx: 0.18, dy: -0.14) = (p.at(0) + dx, p.at(1) + dy)')
out.append('#let iso-points(pts, dx: 0.18, dy: -0.14) = pts.map(p => iso-point(p, dx: dx, dy: dy))')
out.append('#let fig-panel(body) = block(')
out.append('  fill: gradient.linear(rgb("FDFEFE"), rgb("ECF5F8"), angle: 90deg),')
out.append('  stroke: 0.8pt + rgb("D4E6EC"),')
out.append('  radius: 10pt,')
out.append('  inset: (x: 8pt, y: 8pt),')
out.append(')[#body]')
out.append('')
out.append('#let method-box(body) = loigiai-box(body)')
out.append('#let thm-box(title: "📐 Định Lý", body) = theory-box(body)')
out.append('#let sol-diagram(body) = align(center, body)')
out.append('')
out.append('// ═══════════════════════════════════════════════')
...
out.append('    ]')
out.append('    #v(0.6em)')
out.append('    #text(fill: white, size: 22pt, weight: "black")[Hệ Thống Chuyên Đề & Lời Giải Chi Tiết]')
out.append('    #v(0.4em)')
out.append('    #text(fill: rgb("E3F2FD"), size: 14pt)[📚 Tuyển tập các phương pháp giải quyết bài toán nâng cao, thực tế & liên môn]')
out.append('    #v(0.5em)')
out.append('    #text(fill: rgb("E3F2FD"), size: 11pt, style: "italic")[')
out.append('      "Phân tích đa dạng cách giải, ưu tiên trực quan hóa bằng Sơ đồ cây và các phương pháp bản chất"')
out.append('    ]')
out.append('  ]')
out.append(']')
out.append('')
...
for g_id, g_title in groups.items():
    ...
    for idx, (filename, title, desc) in enumerate(topics, 1):
        ...
        for p_idx, p in enumerate(probs[:2], 1):
            q_text = strip_cetz_from_question(p['q'])
            ...
            # Write detailed solutions if available
            if solutions:
                for s in solutions:
                    raw_sol = s['raw_text']
                    raw_sol = clean_math_delimiters(raw_sol)
                    out.append(raw_sol)
                    out.append("")
            else:
                out.append("*(Không có lời giải chi tiết)*")
                out.append("")
...
print(f"Generated summary typst file with solutions at {output_typst_path}")
