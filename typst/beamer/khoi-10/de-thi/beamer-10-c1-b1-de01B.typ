// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 1: MỆNH ĐỀ TOÁN HỌC (ĐỀ SỐ 2)
...
#show: lecture-theme.with(
  title: "BÀI 1: MỆNH ĐỀ TOÁN HỌC (ĐỀ SỐ 2)",
  subtitle: "ÔN TẬP CHƯƠNG 1 — MÃ ĐỀ: 103",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Trong các câu sau, câu nào là một mệnh đề?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Tìm mệnh đề phủ định của mệnh đề: "$exists x in RR, x^2 + 1 = 0$".],
    (
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Mệnh đề nào sau đây là một mệnh đề *sai*?],
    (
        [$forall n in NN, n >= 0$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Cho mệnh đề $P$: "Số tự nhiên $n$ chia hết cho 4" và mệnh đề $Q$: "Số tự nhiên $n$ chia hết cho 2". Khẳng định nào sau đây là phát biểu của mệnh đề kéo theo $P => Q$?],
    (
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Khẳng định nào sau đây là *sai* khi nói về định lý toán học dạng $P => Q$?],
    (
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Cho định lý: "Nếu một tứ giác là hình thoi thì nó có hai đường chéo vuông góc với nhau". Mệnh đề đảo của định lý này là:],
    (
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Biết mệnh đề $P$ là ĐÚNG và mệnh đề $Q$ là SAI. Mệnh đề nào sau đây là mệnh đề ĐÚNG?],
    (
        [$P => Q$],
        [$(P text(" và ") Q)$],
        True([$Q => P$]),
...
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Hai bạn Mai và Lan cùng giải một bài toán. 
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Mệnh đề nào sau đây là mệnh đề tương đương $P <=> Q$ đúng?],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Cho mệnh đề chứa biến $P(x)$: "$3x - 1 > 5$". Tìm tất cả các giá trị của $x$ trong tập ${0; 1; 2; 3; 4}$ để $P(x)$ là mệnh đề đúng.],
    (
        [${1; 2; 3; 4}$],
        [${2; 3; 4}$],
        True([${3; 4}$]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Phủ định của mệnh đề "Tất cả các học sinh lớp 10 đều thích môn Thể dục" là mệnh đề nào sau đây?],
    (
...
// TN 12 (Thực tế logic)
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Một biển báo giao thông ghi: "Nếu xe chở hàng vượt quá 10 tấn thì không được đi qua cầu". Một xe tải chở 8 tấn hàng đi qua cây cầu này. Xét về mặt logic mệnh đề, hành động của chiếc xe tải đó có vi phạm quy định của biển báo không?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Cho các phát biểu về tính đúng/sai của mệnh đề kéo theo và mệnh đề tương đương:],
  (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Xét tính đúng sai của các mệnh đề chứa biến sau đây trên các tập hợp số:],
  (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Trong một vụ án, thám tử điều tra ba nghi phạm là Hùng, Dũng, và Mạnh. Biết rằng chỉ có đúng một người là thủ phạm và thủ phạm luôn nói dối, còn người vô tội luôn nói thật. Các nghi phạm khai như sau:
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Cho tứ giác ABCD. Đặt mệnh đề $P$: "Tứ giác ABCD là hình chữ nhật" và mệnh đề $Q$: "Tứ giác ABCD có hai đường chéo bằng nhau". Xét các mệnh đề sau:],
  (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Có bao nhiêu câu trong đoạn hội thoại dưới đây là mệnh đề toán học?
...
// TLN 2
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Cho mệnh đề chứa biến $P(x)$: "$2x + 1 < 7$". Có bao nhiêu giá trị nguyên dương của $x$ thỏa mãn mệnh đề $P(x)$ là mệnh đề đúng?],
    [2],
    loigiai: [
...
// TLN 3
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Biết mệnh đề $P => Q$ là một mệnh đề SAI. 
...
// TLN 4
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Một số nguyên dương $n$ được gọi là "số hoàn hảo" nếu mệnh đề sau đúng: "Tổng tất cả các ước số thực sự của $n$ (không kể chính nó) bằng $n$". 
...
// TLN 5
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Cho mệnh đề $P(m)$: "$forall x in RR, 3x - m != 0$". Có bao nhiêu giá trị thực của tham số $m$ để mệnh đề $P(m)$ là ĐÚNG?],
    [0],
    loigiai: [
...
// TLN 6 (Tư duy)
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 103], back-to: "sec-exercise-hub",[Trong một phòng học có 4 bạn A, B, C, D tham gia giải một bài toán khó. Cuối giờ, giáo viên hỏi ai là người đã giải được bài toán. Các bạn trả lời như sau:
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 1: MỆNH ĐỀ TOÁN HỌC (ĐỀ SỐ 2)!]      #v(0.6em)
