// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 2 & 3: TẬP HỢP VÀ CÁC PHÉP TOÁN (ĐỀ SỐ 1)
...
#show: lecture-theme.with(
  title: "BÀI 2 & 3: TẬP HỢP VÀ CÁC PHÉP TOÁN (ĐỀ SỐ 1)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho tập hợp $A = {x in ZZ | -2 < x <= 1}$. Cách viết nào sau đây dưới dạng liệt kê các phần tử là đúng?],
    (
        [${-2; -1; 0; 1}$],
        True([${-1; 0; 1}$]),
        [${-2; -1; 0}$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Ký hiệu nào sau đây thể hiện tập hợp các số thực lớn hơn hoặc bằng $3$ và nhỏ hơn $7$?],
    (
        [$(3; 7)$],
        True([$[3; 7)$]),
        [$(3; 7]$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Trong các tập hợp sau, tập hợp nào là tập rỗng?],
    (
        [${x in ZZ | x^2 - 9 = 0}$],
        [${x in RR | x^2 + 2x + 1 = 0}$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hai tập hợp $A = {1; 2; 3}$ và $B = {1; 2; 3; 4; 5}$. Khẳng định nào sau đây là *sai*?],
    (
        [$A subset B$],
        [$A cup B = B$],
        [$A cap B = A$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Hình vẽ sau đây (phần không bị gạch chéo) biểu diễn tập hợp nào trên trục số?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hai tập hợp $A = {a; b; c}$ và $B = {c; d; e}$. Tìm tập hợp $A cap B$.],
    (
        [${a; b}$],
        True([${c}$]),
        [${a; b; c; d; e}$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho $A = (-infty; 5)$ và $B = [-2; +infty)$. Tìm $A cup B$.],
    (
        [$[-2; 5)$],
        [$( -infty ; -2 )$],
        [$[5 ; +infty )$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Gọi $C_RR A$ là phần bù của tập hợp $A$ trong $RR$. Nếu $A = [-1; 3)$ thì $C_RR A$ là tập hợp nào sau đây?],
    (
        [$( -infty ; -1 ) cup [ 3 ; +infty )$],
        [$( -infty ; -1 ] cup ( 3 ; +infty )$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho tập hợp $X$ có đúng $3$ phần tử. Hỏi tập $X$ có tất cả bao nhiêu tập hợp con?],
    (
        [3],
        [6],
        True([8]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Lớp 10A có 25 học sinh thích môn Toán, 20 học sinh thích môn Văn. Biết rằng lớp có 15 học sinh thích cả hai môn Toán và Văn. Hỏi có bao nhiêu học sinh chỉ thích môn Toán (mà không thích Văn)?],
    (
        True([10]),
        [5],
        [15],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hai tập hợp $A = {x; y; z}$ và $B = {x; y; z; t; w}$. Có bao nhiêu tập hợp $X$ thỏa mãn điều kiện $A subset X subset B$?],
    (
        [2],
        [3],
        True([4]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Khẳng định nào sau đây là biểu diễn đúng của phép hiệu hai tập hợp $A setminus B$?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho các tập hợp $A = (-3; 2]$ và $B = [0; +infty)$. Xét tính đúng sai của các phát biểu sau:],
  (
    [Tập hợp $A cap B = (0; 2]$.],
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hai tập hợp được xác định bởi phương trình và bất phương trình:
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một khảo sát về sở thích thể thao ở một trường THPT với 100 học sinh cho kết quả như sau:
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hai khoảng $A = (m; m+2)$ và $B = [3; 5)$. Xét các mệnh đề liên quan đến tham số $m$ để hai tập hợp có sự tương quan nhất định:],
  (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho các tập hợp $A = [-3; 6]$ và $B = (2; 10)$. Tập hợp $A cap B$ là khoảng $(a; b]$. Tính tổng $S = a + b$.],
    [8],
    loigiai: [
...
// TLN 2
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một nhà hàng tiến hành khảo sát 50 khách hàng về hai món ăn là Phở và Bún chả. Kết quả cho thấy:
...
// TLN 3
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tìm số phần tử nguyên của tập hợp $S = (-5; 3) setminus [-2; 1]$.],
    [3],
    loigiai: [
...
// TLN 4
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hai tập hợp $A = (-infty; m]$ và $B = (3; +infty)$. Tìm giá trị nguyên lớn nhất của tham số $m$ để $A cap B = emptyset$.],
    [3],
    loigiai: [
        #step([Phân tích điều kiện $A cap B = emptyset$])
...
// TLN 5
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho tập hợp $M = {x in ZZ | (2x + 3)/(x - 1) in ZZ}$. Tập hợp $M$ có bao nhiêu phần tử?],
    [4],
    loigiai: [
...
// TLN 6 (Tư duy)
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho ba tập hợp $A, B, C$. Biết rằng mỗi tập hợp đều có $10$ phần tử. Giao của bất kỳ hai tập hợp nào cũng có đúng $4$ phần tử. Giao của cả ba tập hợp có đúng $1$ phần tử. Hỏi tập hợp hợp $A cup B cup C$ có tổng cộng bao nhiêu phần tử?],
    [19],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 2 & 3: TẬP HỢP VÀ CÁC PHÉP TOÁN (ĐỀ SỐ 1)!]      #v(0.6em)
