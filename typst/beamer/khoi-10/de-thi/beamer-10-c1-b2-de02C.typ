// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 2 & 3: TẬP HỢP VÀ CÁC PHÉP TOÁN (ĐỀ SỐ 3)
...
#show: lecture-theme.with(
  title: "BÀI 2 & 3: TẬP HỢP VÀ CÁC PHÉP TOÁN (ĐỀ SỐ 3)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho tập hợp $X = {x in ZZ | -3 <= x < 2}$. Hãy viết tập hợp $X$ bằng cách liệt kê các phần tử.],
    (
        [${-2; -1; 0; 1}$],
        True([${-3; -2; -1; 0; 1}$]),
        [${-3; -2; -1; 0; 1; 2}$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Ký hiệu nào biểu diễn đúng tập hợp các số thực lớn hơn $2$ và nhỏ hơn $8$?],
    (
        [$[2; 8]$],
        [$(2; 8]$],
        True([$(2; 8)$]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Tập hợp nào sau đây là tập hợp rỗng?],
    (
        True([${x in NN | 2x - 1 = 0}$]),
        [${x in RR | x^2 - x + 1/4 = 0}$],
        [${x in ZZ | x^2 - 1 = 0}$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Khẳng định nào sau đây là SAI về quan hệ giữa các tập hợp số?],
    (
        [$NN subset ZZ$],
        [$ZZ subset QQ$],
        True([$RR subset QQ$]),
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Hình vẽ sau đây biểu diễn tập hợp nào trên trục số?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho hai tập hợp $C = {1; 3; 5; 7}$ và $D = {2; 3; 5; 6; 8}$. Phép toán $C cap D$ cho kết quả là:],
    (
        [${1; 2; 3; 5; 6; 7; 8}$],
        True([${3; 5}$]),
        [${1; 7}$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho $P = [-4; 2)$ và $Q = [0; 5]$. Kết quả của phép toán $P cup Q$ là:],
    (
        True([$[-4; 5]$]),
        [$[0; 2)$],
        [$[-4; 0)$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Phần bù của tập hợp $K = (-infty; 0)$ trong tập số thực $RR$ là:],
    (
        [$( 0 ; +infty )$],
        True([$[ 0 ; +infty )$]),
        [$( -infty ; 0 ]$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Một tập hợp $A$ có $5$ phần tử thì tập hợp $A$ có tổng cộng bao nhiêu tập hợp con?],
    (
        [5],
        [10],
        [25],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Một câu lạc bộ thể thao có 60 hội viên. Biết rằng có 45 người đăng ký bơi lội, 35 người đăng ký cầu lông và 10 người không đăng ký môn nào trong hai môn này. Số hội viên đăng ký CẢ HAI môn bơi lội và cầu lông là:],
    (
        [15],
        True([30]),
        [20],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho $A = {1; 2; 3}$. Số các tập hợp $X$ thỏa mãn $X cup A = A$ là:],
    (
        [3],
        [4],
        [6],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Hai tập hợp $A$ và $B$ được gọi là bằng nhau nếu:],
    (
        [$A subset B$],
        [$B subset A$],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho các khoảng và đoạn sau: $A = [-3; 1)$, $B = (0; 4]$. Xét tính đúng sai của các phép toán:],
  (
    [Tập hợp $A cap B = (0; 1]$.],
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Xác định tính đúng sai của các mệnh đề sau liên quan đến tập hợp $S = {n in ZZ | (2n^2 + 5n + 2)/(n + 2) in ZZ}$:],
  (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho các khoảng $X = (m; m+5)$ và $Y = (2; 8)$. Xét các mệnh đề sau:],
  (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Trong một nhóm có 50 học sinh, qua điều tra thấy:
...
// TLN 1
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho $A = {1; 2; 3; 4; 5}$ và $B = {2; 4; 6; 8}$. Gọi $C = A setminus B$ và $D = B setminus A$. Hãy tính tổng các phần tử của tập hợp $C cup D$.],
    [23],
    loigiai: [
...
// TLN 2
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho hai tập hợp $A = [m; m+2]$ và $B = [1; 5]$. Có bao nhiêu giá trị nguyên của tham số $m$ để $A subset B$?],
    [3],
    loigiai: [
        Để $A subset B$, cần:
...
// TLN 3
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Lớp 10C có 40 học sinh. Trong đó có 15 bạn học thêm tiếng Hàn, 18 bạn học thêm tiếng Nhật. Có 12 bạn không học thêm ngôn ngữ nào trong hai ngôn ngữ này. Hỏi có bao nhiêu bạn học thêm CẢ HAI ngôn ngữ Hàn và Nhật?],
    [5],
    loigiai: [
        #step([Tính toán])
...
// TLN 4
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Cho tập hợp $X = {x in RR | x^2 - 3x - 4 = 0}$ và $Y = ( -2; 3 ]$. Hỏi giao của hai tập hợp $X cap Y$ có bao nhiêu phần tử?],
    [1],
    loigiai: [
...
// TLN 5
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Một nhóm 50 sinh viên thi ba môn: Toán, Lý, Hóa. Biết rằng:
...
// TLN 6
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 103], back-to: "sec-exercise-hub",[Tìm số phần tử nguyên của tập hợp $M = (-4; 6) setminus ( -1; 3 ]$.],
    [5],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 2 & 3: TẬP HỢP VÀ CÁC PHÉP TOÁN (ĐỀ SỐ 3)!]      #v(0.6em)
