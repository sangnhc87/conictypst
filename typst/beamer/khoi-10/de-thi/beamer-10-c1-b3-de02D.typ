// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHUYÊN ĐỀ TOÁN THỰC TẾ (ĐỀ D: MÔ HÌNH HÓA VENN, KHẢO SÁT THỊ TRƯỜNG & KINH TẾ SỐ - VD, VDC)
// Lớp: Khối 10  ·  Mã đề: 106D  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHUYÊN ĐỀ TOÁN THỰC TẾ (ĐỀ D: MÔ HÌNH HÓA VENN, KHẢO SÁT THỊ TRƯỜNG & KINH TẾ SỐ - VD, VDC)",
  subtitle: "CHƯƠNG I: MỆNH ĐỀ VÀ TẬP HỢP — MÃ ĐỀ: 106D",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 106D]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một sàn thương mại điện tử khảo sát thói quen mua sắm của $100$ khách hàng thân thiết. Kết quả ghi nhận: có $65$ người từng mua hàng trên ứng dụng di động (Tập $A$) và $45$ người từng mua hàng trên trang web máy tính (Tập $B$). Biết rằng có $25$ người sử dụng cả hai kênh mua sắm này. Số khách hàng đã từng mua sắm trên ít nhất một trong hai kênh là],
    (
        True([$85$ người]),
        [$110$ người],
        [$80$ người],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Biểu đồ Venn dưới đây mô tả kết quả khảo sát $60$ sinh viên về hai ứng dụng gọi xe công nghệ $G$ (Grab) và $B$ (Be):
#venn2-box(
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Trong quản trị nhân sự của một tập đoàn công nghệ, gọi $E$ là tập hợp tất cả nhân viên biết lập trình, và $A$ là tập hợp tất cả các kỹ sư chuyên ngành Trí tuệ nhân tạo (AI). Mệnh đề nào sau đây diễn tả đúng thực tế "Tất cả các kỹ sư AI đều biết lập trình"?],
    (
        True([$A subset E$]),
        [$E subset A$],
        [$A cap E = emptyset$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một chuỗi rạp chiếu phim phát hành phiếu khảo sát khán giả. Khảo sát $50$ người xem phim cuối tuần thu được: $30$ người thích thể loại Hành động, $25$ người thích thể loại Hoạt hình, và $10$ người thích cả hai thể loại. Số người không thích thể loại nào trong hai thể loại trên là],
    (
        True([$5$ người]),
        [$15$ người],
        [$10$ người],
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Cho tập hợp $U$ là toàn bộ $200$ khách hàng tiềm năng nhận được email tiếp thị. Gọi $A$ là tập hợp các khách hàng đã mở email đọc thông tin, biết rằng $n(A) = 75$. Số lượng khách hàng thuộc tập phần bù $C_U A$ (chưa từng mở email) bằng],
    (
        True([$125$ khách hàng]),
        [$75$ khách hàng],
        [$100$ khách hàng],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một đại lý vé máy bay ghi nhận khung giá vé khuyến mãi của hai hãng hàng không trong mùa du lịch:
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Thời gian hoạt động hàng ngày của hai trung tâm thương mại lân cận là:
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một hệ thống ngân hàng phân loại rủi ro tín dụng của các khoản vay dựa trên thang điểm từ $0$ đến $100$:
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Khảo sát $40$ chuyên viên phân tích dữ liệu, ghi nhận có $28$ người thành thạo ngôn ngữ Python và $20$ người thành thạo ngôn ngữ SQL. Biết rằng mỗi chuyên viên đều thành thạo ít nhất một trong hai ngôn ngữ này. Số người thành thạo cả hai ngôn ngữ Python và SQL là],
    (
        True([$8$ người]),
        [$10$ người],
        [$12$ người],
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một phòng trưng bày sản phẩm thông minh trưng bày $n$ sản phẩm. Biết rằng số tập con gồm đúng $2$ sản phẩm mà khách hàng có thể chọn dùng thử là $6$. Số lượng sản phẩm $n$ đang trưng bày bằng],
    (
        True([$n = 4$]),
        [$n = 3$],
        [$n = 5$],
...
#lt-ds(num: 13, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một viện nghiên cứu kinh tế số khảo sát hành vi tiêu dùng của $100$ hộ gia đình về việc mua sắm trên ba nền tảng thương mại điện tử: Shopee ($S$), Lazada ($L$) và TikTok Shop ($T$).
...
#lt-ds(num: 14, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một chuyên gia tiếp thị số (Digital Marketing) cấu hình tệp khách hàng quảng cáo trên mạng xã hội theo độ tuổi (tính theo năm):
...
#lt-ds(num: 15, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một công ty nông sản xuất khẩu kiểm định chất lượng $100$ tấn sầu riêng theo hai tiêu chuẩn:
...
#lt-ds(num: 16, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một hệ thống bán lẻ phân loại khách hàng VIP theo doanh số mua hàng hàng năm $x$ (triệu đồng):
...
#lt-tln(num: 17, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một khu vui chơi giải trí bán được $500$ vé trong ngày khai trương: có $320$ khách mua vé vào Công viên nước, $260$ khách mua vé vào Khu vui chơi cảm giác mạnh.
...
#lt-tln(num: 18, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một cuộc khảo sát $100$ người tiêu dùng về việc sở hữu ba thiết bị gia đình: Robot hút bụi ($R$), Nồi chiên không dầu ($N$) và Máy rửa bát ($M$).
Kết quả cho thấy:
...
#lt-tln(num: 19, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Từ số liệu của câu hỏi trên, hãy tính số người tiêu dùng chỉ sở hữu duy nhất đúng một thiết bị thông minh trong ba thiết bị $R, N, M$.],
    [50],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Hai ca làm việc của nhà máy được bố trí theo các khoảng thời gian (giờ):
Ca $1$: $A = [7; 15]$.
...
#lt-tln(num: 21, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một nhà hàng tiệc cưới cho phép khách hàng chọn các món tráng miệng từ một danh sách gồm $5$ món khác nhau.
...
#lt-tln(num: 22, de: [Đề 1 (D) — Mã 106D], back-to: "sec-exercise-hub",[Một công ty đa quốc gia có $60$ nhân viên: có $42$ nhân viên biết Tiếng Anh và $30$ nhân viên biết Tiếng Trung.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHUYÊN ĐỀ TOÁN THỰC TẾ (ĐỀ D: MÔ HÌNH HÓA VENN, KHẢO SÁT THỊ TRƯỜNG & KINH TẾ SỐ - VD, VDC)!]      #v(0.6em)
