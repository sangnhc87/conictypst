// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHUYÊN ĐỀ TOÁN THỰC TẾ (ĐỀ F: LOGIC Y SINH, TRUY VẾT DỊCH TỄ & ĐIỀU TRA PHÁP Y - VD, VDC)
// Lớp: Khối 10  ·  Mã đề: 106F  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHUYÊN ĐỀ TOÁN THỰC TẾ (ĐỀ F: LOGIC Y SINH, TRUY VẾT DỊCH TỄ & ĐIỀU TRA PHÁP Y - VD, VDC)",
  subtitle: "CHƯƠNG I: MỆNH ĐỀ VÀ TẬP HỢP — MÃ ĐỀ: 106F",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 106F]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trong hệ thống nhóm máu ABO ở người, hồng cầu có thể mang kháng nguyên $A$ (tập $A$), kháng nguyên $B$ (tập $B$), mang cả hai kháng nguyên (nhóm máu AB) hoặc không mang kháng nguyên nào (nhóm máu O):
#blood-abo()
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trong điều tra dịch tễ học bệnh truyền nhiễm, gọi $U$ là toàn bộ cư dân của một khu vực phong tỏa. Gọi $E$ là tập hợp những người có tiếp xúc gần với ca bệnh dương tính ($F_0$). Tập hợp các cư dân an toàn không có tiếp xúc dịch tễ với ca bệnh ($F_0$) là],
    (
        True([$C_U E$]),
        [$U inter E$],
        [$E setminus U$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Một bệnh viện tiến hành lấy mẫu xét nghiệm tầm soát cho $80$ bệnh nhân có triệu chứng hô hấp:
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trong điều tra hiện trường vụ án, điều tra viên đưa ra nhận định logic: "Nếu nghi phạm $X$ có mặt tại hiện trường lúc gây án ($P$) thì nghi phạm $X$ phải có dấu vân tay trên tay nắm cửa ($Q$)". Cơ quan giám định xác nhận nghi phạm $X$ KHÔNG có dấu vân tay trên tay nắm cửa ($not Q$). Kết luận logic chắc chắn đúng là gì?],
    (
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Khoảng trị liệu an toàn (Therapeutic window) của một loại thuốc kháng sinh trong máu được xác định:
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trong giám định ADN pháp y, một mẫu tóc tại hiện trường chứa $4$ đoạn alen đặc trưng. Để đối chiếu với tệp hồ sơ lưu trữ, kỹ sư phân tích các tổ hợp gồm đúng $3$ alen từ $4$ alen trên. Số tổ hợp $3$ alen có thể tạo ra từ mẫu tóc là],
    (
        True([$4$ tổ hợp]),
        [$6$ tổ hợp],
        [$12$ tổ hợp],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Thời gian ủ bệnh của một chủng virus cúm mùa dao động trong khoảng từ $2$ đến $8$ ngày ($A = [2; 8]$). Thời gian phát tán virus ra cộng đồng mạnh nhất dao động từ $5$ đến $12$ ngày ($B = [5; 12]$). Khoảng thời gian người bệnh vừa trong giai đoạn ủ bệnh vừa có khả năng lây nhiễm mạnh ($A inter B$) là],
    (
        True([$[5; 8]$ ngày]),
        [$[2; 12]$ ngày],
        [$[2; 5]$ ngày],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Một nghiên cứu di truyền học khảo sát trên $100$ gia đình:
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Thang đo chỉ số khối cơ thể (BMI) của Tổ chức Y tế Thế giới (WHO) dành cho người châu Á:
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Mệnh đề đảo của phát biểu y khoa: "Nếu một người bị nhiễm virus SARS-CoV-2 thì người đó có kết quả xét nghiệm PCR dương tính" là:],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trong thí nghiệm phân lập vi khuẩn, một mẫu bệnh phẩm ban đầu chứa $n$ dòng vi khuẩn khác nhau. Biết rằng số cách chọn ra một cặp gồm đúng $2$ dòng vi khuẩn để thử nghiệm kháng sinh đồ là $15$ cách. Số lượng dòng vi khuẩn $n$ trong mẫu bệnh phẩm là],
    (
        True([$n = 6$]),
        [$n = 5$],
        [$n = 7$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Mức đường huyết lúc đói an toàn cho người trưởng thành là $x in [3.9; 6.4]$ ($"mmol/L"$). Nếu lượng đường huyết $x > 7.0$ ($"mmol/L"$) trong hai lần đo liên tiếp thì được chẩn đoán mắc đái tháo đường. Tập hợp các mức đường huyết nằm ngoài khoảng an toàn ($C_RR [3.9; 6.4]$) là],
    (
...
#lt-ds(num: 13, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trung tâm y tế dự phòng truy vết dịch tễ $120$ người trong một tòa nhà có ca nhiễm bệnh:
...
#lt-ds(num: 14, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Một bệnh nhân suy thận cần điều chỉnh liều dùng thuốc theo độ thanh thải Creatinine $C_r$ ($"mL/phút"$):
...
#lt-ds(num: 15, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trong một vụ án mất trộm tài liệu mật tại viện nghiên cứu, có $3$ nghi phạm $A, B, C$. Cơ quan điều tra xác định được các sự thật logic sau:
...
#lt-ds(num: 16, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Một thử nghiệm lâm sàng giai đoạn 3 đánh giá hiệu quả của thuốc mới trên $200$ bệnh nhân tăng huyết áp:
...
#lt-tln(num: 17, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Một phòng khám đa khoa tiếp nhận $350$ lượt khám bệnh trong ngày: có $210$ người có bảo hiểm y tế đúng tuyến, $180$ người có chỉ định làm xét nghiệm sinh hóa máu.
...
#lt-tln(num: 18, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Trong một đợt bùng phát dịch bệnh, cơ quan y tế điều tra lịch trình của $150$ ca nghi nhiễm qua ba địa điểm công cộng: Bến xe ($B$), Siêu thị ($S$) và Chợ dân sinh ($C$).
Số liệu tổng hợp:
...
#lt-tln(num: 19, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Từ số liệu của bài toán truy vết trên, hãy tính số ca nghi nhiễm chỉ đến duy nhất đúng một địa điểm công cộng trong ba địa điểm $B, S, C$.],
    [80],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Chỉ số xét nghiệm chức năng gan AST ($"U/L"$) của bệnh nhân được đánh giá:
...
#lt-tln(num: 21, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Để tiết kiệm sinh phẩm, phòng xét nghiệm chọn ra một nhóm gồm đúng $3$ mẫu máu từ một lô gồm $7$ mẫu bệnh phẩm khác nhau để thực hiện xét nghiệm gộp (Pool PCR).
...
#lt-tln(num: 22, de: [Đề 3 (F) — Mã 106F], back-to: "sec-exercise-hub",[Khảo sát $100$ chủng vi khuẩn phân lập từ bệnh viện:
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHUYÊN ĐỀ TOÁN THỰC TẾ (ĐỀ F: LOGIC Y SINH, TRUY VẾT DỊCH TỄ & ĐIỀU TRA PHÁP Y - VD, VDC)!]      #v(0.6em)
