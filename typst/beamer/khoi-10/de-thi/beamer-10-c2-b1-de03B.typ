// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 3: BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 2)
...
#show: lecture-theme.with(
  title: "BÀI 3: BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 2)",
  subtitle: "ÔN TẬP CHƯƠNG 2 — MÃ ĐỀ: 102",
...
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Biểu thức nào sau đây sau khi rút gọn là một bất phương trình bậc nhất hai ẩn?],
    (
        [$(x + y)^2 - (x - y)^2 <= 4$],
        [$x^3 - y^3 >= 3(x - y)$],
        True([$(x + 2)(y - 1) - x y >= 0$]),
...
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho đường thẳng bờ $d: 2x - y + 4 = 0$. Cặp điểm nào sau đây nằm CÙNG PHÍA đối với đường thẳng $d$?],
    (
        [$M(0; 0)$ và $N(1; 7)$],
        [$P(-3; 0)$ và $Q(0; 5)$],
        True([$A(1; 1)$ và $B(0; 2)$]),
...
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho điểm $M(x_0; y_0)$ nằm trên đường thẳng bờ $x - 3y + 6 = 0$. Giá trị của biểu thức $P = 2x_0 - 6y_0 + 15$ bằng:],
    (
        [$0$],
        True([$3$]),
        [$15$],
...
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Đường thẳng bờ của một bất phương trình đi qua điểm $A(1; 2)$ và có hệ số góc $k = -2$. Phương trình tổng quát của đường thẳng bờ đó là:],
    (
        [$x + 2y - 5 = 0$],
        [$2x - y = 0$],
        True([$2x + y - 4 = 0$]),
...
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Hình vẽ sau đây (phần không bị gạch chéo, kể cả bờ) biểu diễn miền nghiệm của bất phương trình nào?
#draw_bpt(
  a: 2,
  b: 1,
  c: -4,
...
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Bất phương trình $x/3 + y/(-2) <= 1$ tương đương với bất phương trình nào sau đây?],
    (
        [$2x - 3y - 6 <= 0$],
        True([$2x - 3y - 6 >= 0$]),
        [$3x - 2y - 6 <= 0$],
...
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Tìm giá trị của tham số $m$ để đường thẳng bờ $(m - 1)x + 2y - 6 = 0$ đi qua điểm $M(2; 1)$.],
    (
        [$m = 1$],
        [$m = 2$],
        True([$m = 3$]),
...
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Điểm đối xứng của $P(-1; 2)$ qua gốc tọa độ $O(0;0)$ là $P'$. Điểm $P'$ thuộc miền nghiệm của bất phương trình nào sau đây?],
    (
        [$2x + y + 1 < 0$],
        [$x - 2y - 6 > 0$],
        True([$3x - 2y - 5 >= 0$]),
...
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Trong các điểm sau, điểm nào có khoảng cách LỚN NHẤT đến đường thẳng bờ $d: x + y - 4 = 0$?],
    (
        True([$O(0; 0)$]),
        [$A(1; 2)$],
        [$B(2; -1)$],
...
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Một chiếc xe buýt du lịch chở học sinh và giáo viên. Tổng số người trên xe không vượt quá 45 người. Gọi $x$ là số học sinh và $y$ là số giáo viên ($x, y in NN$). Bất phương trình mô tả giới hạn số lượng người trên xe là:],
    (
        [$x + y >= 45$],
        [$x - y <= 45$],
        True([$x + y <= 45$]),
...
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để bất phương trình $(m^2 - 4)x + (m - 2)y + 5 >= 0$ là bất phương trình bậc nhất hai ẩn.],
    (
        [$m != 2$ và $m != -2$],
        [$m = 2$],
        True([$m != 2$]),
...
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Miền nghiệm của bất phương trình $x - y < 0$ là nửa mặt phẳng gồm tất cả các điểm:],
    (
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho đường thẳng $d: x - 2y + 4 = 0$ và ba điểm $A(0; 3), B(2; 1), C(-4; 0)$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho hình vẽ biểu diễn miền nghiệm của một bất phương trình trên mặt phẳng $O x y$ (phần không bị gạch, kể cả bờ):
#draw_bpt(
  a: 2,
  b: 1,
  c: -2,
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Một vận động viên bơi lội cần nạp tối thiểu $120$ g protein mỗi ngày từ hai nguồn thực phẩm: ức gà (mỗi $100$ g cung cấp $30$ g protein) và thịt bò nạc (mỗi $100$ g cung cấp $25$ g protein). Gọi $x, y$ lần lượt là số lạng (mỗi lạng $= 100$ g) ức gà và thịt bò mà vận động viên ăn trong ngày ($x, y >= 0$).],
  (
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho bất phương trình $(2m - 1)x + (m + 2)y - 4m <= 0$ (với $m$ là tham số). Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho bất phương trình $3x + 4y <= 25$. Có tất cả bao nhiêu cặp số nguyên dương $(x; y)$ thỏa mãn bất phương trình trên?],
    [20],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Đường thẳng bờ $d: 2x - 5y + 10 = 0$ của một bất phương trình cắt đường thẳng nằm ngang $y = 4$ tại điểm $P$. Tính khoảng cách từ điểm $P$ đến trục tung $O y$.],
    [5],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Một trạm sạc xe điện có hai loại trụ sạc: trụ sạc nhanh (công suất $60$ kW) và trụ sạc tiêu chuẩn (công suất $20$ kW). Tổng công suất cấp điện đồng thời tối đa của trạm là $300$ kW. Nếu trạm đang có 3 trụ sạc nhanh hoạt động thì có thể vận hành tối đa bao nhiêu trụ sạc tiêu chuẩn cùng lúc?],
    [6],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Có bao nhiêu giá trị nguyên của tham số $m$ để điểm $M(m; m^2)$ thuộc miền nghiệm của bất phương trình $2x - y + 3 >= 0$?],
    [5],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Trên đoạn thẳng nối hai điểm $A(-1; 1)$ và $B(5; 7)$, có tất cả bao nhiêu điểm có tọa độ nguyên $(x; y)$ thuộc miền nghiệm của bất phương trình $2x - y + 3 >= 0$?],
    [7],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho cặp số nguyên không âm $(x; y)$ thỏa mãn bất phương trình $x + 2y <= 6$. Tìm giá trị lớn nhất của biểu thức $F(x, y) = 3x + 2y$.],
    [18],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 3: BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 2)!]      #v(0.6em)
