// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 4: HỆ BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 1)
...
#show: lecture-theme.with(
  title: "BÀI 4: HỆ BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 1)",
...
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Hệ bất phương trình nào sau đây là hệ bất phương trình bậc nhất hai ẩn?],
    (
...
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cặp số $(x; y) = (1; 2)$ là một nghiệm của hệ bất phương trình nào sau đây?],
    (
        [$cases(x + y > 4, 2x - y <= 0)$],
...
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hệ bất phương trình $cases(x + y - 2 <= 0, 2x - y + 1 >= 0, x >= 0)$. Điểm nào sau đây thuộc miền nghiệm của hệ?],
    (
        [$M(2; 1)$],
        [$N(-1; 2)$],
        True([$P(0; 1)$]),
...
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Miền nghiệm của hệ bất phương trình $cases(x >= 0, y >= 0, x + y <= 4)$ trên mặt phẳng tọa độ $O x y$ là một:],
    (
        [Hình vuông.],
        [Hình chữ nhật.],
...
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Hình vẽ sau đây (phần miền tam giác không bị gạch chéo, kể cả bờ) biểu diễn miền nghiệm của hệ bất phương trình nào?
#draw_system_bpt(
  lines: (
...
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tọa độ giao điểm của hai đường thẳng bờ $d_1: x + y = 3$ và $d_2: 2x - y = 0$ là đỉnh của một miền nghiệm. Tọa độ đỉnh đó là:],
    (
        [$(2; 1)$],
        True([$(1; 2)$]),
        [$(0; 3)$],
...
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho miền nghiệm của một hệ bất phương trình là hình tam giác có 3 đỉnh là $O(0;0), A(3;0), B(0;2)$. Giá trị nhỏ nhất của biểu thức $F(x, y) = 2x + 3y$ trên miền tam giác đó bằng:],
    (
        True([$0$]),
        [$6$],
        [$9$],
...
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Biểu thức $F(x, y) = x - 2y$ đạt giá trị LỚN NHẤT trên miền tứ giác có 4 đỉnh $O(0;0), A(4;0), B(2;3), C(0;2)$ tại đỉnh nào?],
    (
        [$O(0;0)$],
        True([$A(4;0)$]),
        [$B(2;3)$],
...
// TN 9: Hệ vô nghiệm
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Hệ bất phương trình nào sau đây có miền nghiệm là TẬP RỖNG (vô nghiệm)?],
    (
        [$cases(x + y <= 2, x >= 0, y >= 0)$],
        [$cases(x - y >= 0, x + y <= 4)$],
...
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một xưởng may sản xuất áo và quần. Mỗi chiếc áo cần 2 giờ may và 1 giờ ủi. Mỗi chiếc quần cần 1 giờ may và 2 giờ ủi. Thời gian tối đa của máy may là 40 giờ/tuần, của bàn ủi là 50 giờ/tuần. Gọi $x, y$ lần lượt là số áo và quần may trong tuần ($x, y in NN$). Hệ bất phương trình mô tả các điều kiện trên là:],
    (
...
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Có tất cả bao nhiêu cặp số nguyên không âm $(x; y)$ thỏa mãn hệ bất phương trình $cases(x + y <= 2, x >= 0, y >= 0)$?],
    (
        [$3$],
        [$5$],
        True([$6$]),
...
// TN 12: Tham số m
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để cặp số $(1; 1)$ là một nghiệm của hệ bất phương trình $cases(2x - y + m >= 0, x + 3y - 5 <= 0)$?],
    (
        [$m <= -1$],
        True([$m >= -1$]),
        [$m >= 1$],
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hệ bất phương trình bậc nhất hai ẩn $cases(x - y <= 1, x + 2y <= 4, x >= 0, y >= 0)$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vẽ biểu diễn miền nghiệm của một hệ bất phương trình trên mặt phẳng tọa độ $O x y$ (phần tứ giác không bị gạch, kể cả bờ):
#draw_system_bpt(
  lines: (
    (a: 1, b: 1, c: -4, sign: "<=", name: [$x + y = 4$], stroke-color: rgb("2563eb")),
    (a: 2, b: -1, c: 2, sign: ">=", name: [$2x - y = -2$], stroke-color: rgb("059669")),
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hệ bất phương trình $cases(x + y <= 3, x >= 0, y >= 0)$ và biểu thức $F(x, y) = m x + y$ (với $m$ là tham số). Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hệ bất phương trình $cases(x + y <= 4, 2x - y <= 2, x >= 0, y >= 0)$. Tính diện tích của hình tứ giác là miền nghiệm của hệ bất phương trình trên.],
    [5],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tìm giá trị lớn nhất của biểu thức $F(x, y) = 4x + 3y$ trên miền nghiệm của hệ bất phương trình $cases(x + y <= 5, x <= 4, y <= 3, x >= 0, y >= 0)$.],
    [19],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một hộ nông dân có diện tích đất $10$ ha để trồng lúa và ngô. Trồng $1$ ha lúa cần $20$ ngày công và đem lại lợi nhuận $30$ triệu đồng. Trồng $1$ ha ngô cần $15$ ngày công và đem lại lợi nhuận $25$ triệu đồng. Tổng số ngày công tối đa của gia đình là $180$ ngày công. Tính số tiền lợi nhuận lớn nhất (đơn vị triệu đồng) mà hộ nông dân có thể thu được.],
    [280],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Có tất cả bao nhiêu cặp số nguyên dương $(x; y)$ thỏa mãn hệ bất phương trình $cases(x + y <= 6, x >= 2, y >= 1)$?],
    [10],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có miền trong (kể cả biên) là miền nghiệm của một hệ bất phương trình, với tọa độ ba đỉnh là $A(1; 1), B(4; 1), C(1; 4)$. Tìm giá trị nhỏ nhất của biểu thức $F(x, y) = 3x - 2y$ trên miền tam giác đó.],
    [-5],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tìm giá trị nguyên lớn nhất của tham số $m$ để hệ bất phương trình $cases(x + y <= 4, 2x - y <= 1, x >= m)$ có nghiệm.],
    [1],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 4: HỆ BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 1)!]      #v(0.6em)
