// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 4: HỆ BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 2)
...
#show: lecture-theme.with(
  title: "BÀI 4: HỆ BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 2)",
...
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Hệ bất phương trình nào sau đây tương đương với hệ $cases((x + 1)/2 - (y - 1)/3 >= 1, x - 2y <= 0)$?],
    (
...
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Điểm nào sau đây KHÔNG THUỘC miền nghiệm của hệ bất phương trình $cases(2x + y >= 4, x - 2y <= 2, y >= 0)$?],
    (
        [$A(3; 1)$],
        [$B(2; 1)$],
        True([$M(0; 2)$]),
...
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Miền nghiệm của hệ bất phương trình $cases(x + 2y >= 6, 2x + y >= 6, x >= 0, y >= 0)$ có đặc điểm nào sau đây?],
    (
...
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho hệ bất phương trình $cases(x + 2y >= 6, 2x + y >= 6, x >= 0, y >= 0)$. Tọa độ giao điểm của hai đường thẳng bờ $x + 2y = 6$ và $2x + y = 6$ là:],
    (
        [$(3; 3)$],
        True([$(2; 2)$]),
        [$(1; 4)$],
...
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Hình vẽ sau đây biểu diễn miền nghiệm của hệ bất phương trình nào (phần không bị gạch, kể cả các đường bờ)?
#draw_system_bpt(
  lines: (
    (a: 1, b: 2, c: -6, sign: ">=", name: [$x + 2y = 6$], stroke-color: rgb("2563eb")),
    (a: 2, b: 1, c: -6, sign: ">=", name: [$2x + y = 6$], stroke-color: rgb("059669")),
...
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Giá trị nhỏ nhất của biểu thức $F(x, y) = 3x + 2y$ trên miền nghiệm không bị chặn có các đỉnh $A(0; 6), B(2; 2), C(6; 0)$ bằng:],
    (
        [$6$],
        True([$10$]),
        [$12$],
...
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để hệ bất phương trình $cases(x + y <= 2, x + y >= m)$ có nghiệm.],
    (
        [$m > 2$],
        True([$m <= 2$]),
        [$m >= 2$],
...
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Hệ bất phương trình $cases(1 <= x <= 4, -1 <= y <= 3)$ có miền nghiệm là một hình chữ nhật. Diện tích của hình chữ nhật đó bằng:],
    (
        [$7$],
        [$10$],
        True([$12$]),
...
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Chu vi của hình chữ nhật là miền nghiệm của hệ bất phương trình $cases(0 <= x <= 5, 0 <= y <= 3)$ bằng:],
    (
        [$8$],
        [$15$],
        True([$16$]),
...
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Có tất cả bao nhiêu điểm có tọa độ nguyên $(x; y)$ thuộc miền nghiệm của hệ bất phương trình $cases(1 <= x <= 4, 2 <= y <= 5)$?],
    (
        [$12$],
        True([$16$]),
        [$20$],
...
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để điểm $M(m; 2)$ là nghiệm của hệ bất phương trình $cases(2x - y >= 0, x + 3y <= 10)$?],
    (
        [$m <= 1$],
        [$m >= 4$],
        True([$1 <= m <= 4$]),
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho hệ bất phương trình bậc nhất hai ẩn $cases(2x + y >= 4, x + 2y >= 4, x >= 0, y >= 0)$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho hình vẽ biểu diễn miền nghiệm của hệ bất phương trình $cases(0 <= x - y <= 3, y >= 0)$ trên mặt phẳng $O x y$ (phần không bị gạch, kể cả bờ):
#draw_system_bpt(
  lines: (
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Một công ty cần vận chuyển ít nhất $100$ tấn hàng và $120$ hành khách. Công ty có thể thuê hai loại xe: loại $A$ (giá thuê $4$ triệu đồng/chuyến, chở được $20$ tấn hàng và $15$ khách) và loại $B$ (giá thuê $3$ triệu đồng/chuyến, chở được $10$ tấn hàng và $30$ khách). Gọi $x, y$ lần lượt là số xe loại $A$ và $B$ cần thuê ($x, y in NN$).],
  (
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho hệ bất phương trình $cases(x + y <= 4, x - y <= 2, x >= m)$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho hệ bất phương trình $cases(x + 2y >= 6, 2x + y >= 6, x >= 0, y >= 0)$. Tìm giá trị nhỏ nhất của biểu thức $F(x, y) = 2x + 3y$ trên miền nghiệm của hệ bất phương trình trên.],
    [10],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Tính diện tích của hình bình hành là miền nghiệm của hệ bất phương trình $cases(0 <= x <= 4, x <= y <= x + 3)$ trên mặt phẳng $O x y$.],
    [12],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Một xưởng sản xuất hai loại nước giải khát: loại $A$ (cần $2$ kg đường, $1$ giờ máy chạy, lãi $40$ nghìn đồng/thùng) và loại $B$ (cần $1$ kg đường, $2$ giờ máy chạy, lãi $50$ nghìn đồng/thùng). Mỗi ngày xưởng có tối đa $100$ kg đường và $110$ giờ máy chạy. Số tiền lãi lớn nhất mỗi ngày mà xưởng có thể thu được là bao nhiêu nghìn đồng?],
    [3200],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Có tất cả bao nhiêu cặp số nguyên $(x; y)$ thỏa mãn hệ bất phương trình $cases(-2 <= x <= 2, x - 1 <= y <= x + 1)$?],
    [15],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Cho hệ bất phương trình $cases(x + y <= 6, 2x + y <= 8, x >= 0, y >= 0)$. Tìm giá trị lớn nhất của biểu thức $F(x, y) = 5x + 3y$ trên miền nghiệm của hệ.],
    [22],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 102], back-to: "sec-exercise-hub",[Tìm giá trị nguyên nhỏ nhất của tham số $m$ để hệ bất phương trình $cases(x + y >= 5, x <= 3, y <= m)$ có nghiệm.],
    [2],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 4: HỆ BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 2)!]      #v(0.6em)
