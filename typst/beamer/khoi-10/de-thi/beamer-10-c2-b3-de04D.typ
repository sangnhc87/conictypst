// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 4: QUY HOẠCH TUYẾN TÍNH & TOÁN THỰC TẾ (ĐỀ SỐ 1 - CƠ KHÍ & SẢN XUẤT)
...
#show: lecture-theme.with(
  title: "BÀI 4: QUY HOẠCH TUYẾN TÍNH & TOÁN THỰC TẾ (ĐỀ SỐ 1 - CƠ KHÍ & SẢN XUẤT)",
  subtitle: "ÔN TẬP CHƯƠNG 2 — MÃ ĐỀ: 104",
...
#lt-tn(num: 1, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một xưởng cơ khí dự định sản xuất $x$ chi tiết máy loại $A$ và $y$ chi tiết máy loại $B$. Điều kiện thực tế của hai biến số $x$ và $y$ là:],
    (
        [$x > 0, y > 0$],
        [$x in RR, y in RR$],
...
#lt-tn(num: 2, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Để may một chiếc áo sơ mi cần $1.2" m"$ vải và để may một chiếc quần âu cần $1.5" m"$ vải. Một xưởng may có sẵn $120" m"$ vải. Gọi $x, y$ lần lượt là số áo sơ mi và quần âu xưởng may. Bất phương trình mô tả ràng buộc về số lượng vải khả dụng là:],
    (
        [$1.5x + 1.2y <= 120$],
        True([$1.2x + 1.5y <= 120$]),
        [$1.2x + 1.5y >= 120$],
...
#lt-tn(num: 3, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một xưởng mộc sản xuất $x$ chiếc bàn và $y$ chiếc ghế. Để làm nguội $1$ chiếc bàn cần $4$ giờ, làm nguội $1$ chiếc ghế cần $2$ giờ. Mỗi ngày xưởng có tối đa $40$ giờ làm nguội. Bất phương trình rút gọn nào sau đây biểu diễn lượng thời gian làm nguội?],
    (
        [$x + 2y <= 20$],
        True([$2x + y <= 20$]),
        [$4x + 2y >= 40$],
...
#lt-tn(num: 4, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một cơ sở lắp ráp quạt điện sản xuất hai dòng sản phẩm: quạt cây (lãi $60$ nghìn đồng/chiếc) và quạt treo tường (lãi $45$ nghìn đồng/chiếc). Gọi $x, y$ lần lượt là số quạt cây và quạt treo tường được lắp ráp. Biểu thức tính tổng tiền lãi $F(x, y)$ (đơn vị: nghìn đồng) là:],
    (
        [$F(x, y) = 45x + 60y$],
        [$F(x, y) = 60x - 45y$],
        True([$F(x, y) = 60x + 45y$]),
...
#lt-tn(num: 5, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một xưởng bánh kẹo sản xuất hai loại hộp bánh đậu xanh: loại thường $A$ và loại cao cấp $B$. Để sản xuất 1 hộp loại $A$ cần $0.2" kg"$ đường và $0.3" kg"$ đậu xanh; 1 hộp loại $B$ cần $0.25" kg"$ đường và $0.4" kg"$ đậu xanh. Kho xưởng hiện có $50" kg"$ đường và $70" kg"$ đậu xanh. Hệ bất phương trình ràng buộc là:],
    (
...
#lt-tn(num: 6, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một xưởng in sử dụng hai dòng máy in $X$ và $Y$. Mỗi ngày máy $X$ in được $20$ ram giấy, máy $Y$ in được $30$ ram giấy. Để hoàn thành đơn hàng tối thiểu $180$ ram giấy trong ngày, hệ thức nào sau đây đúng với số máy $x$ và $y$ được vận hành?],
    (
        [$20x + 30y <= 180$],
        True([$2x + 3y >= 18$]),
        [$2x + 3y <= 18$],
...
// TN 8: Lò nung gốm sứ
#lt-tn(num: 8, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một nghệ nhân gốm nung đĩa sứ ($x$ chiếc) và bát sứ ($y$ chiếc). Thời gian tạo hình cho 1 chiếc đĩa là $15$ phút, 1 chiếc bát là $10$ phút. Tổng thời gian tạo hình trong ngày không quá $300$ phút ($5$ giờ). Bất phương trình rút gọn là:],
    (
        [$2x + 3y <= 60$],
        True([$3x + 2y <= 60$]),
        [$3x + 2y >= 60$],
...
#lt-tn(num: 9, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một phân xưởng có miền phương án sản xuất là tam giác $O A B$ kể cả biên, với các đỉnh $O(0; 0), A(5; 0), B(0; 4)$. Hàm lợi nhuận là $F(x, y) = 20x + 30y$ (triệu đồng). Giá trị lớn nhất của lợi nhuận bằng bao nhiêu?],
    (
        [$100$ triệu đồng],
        True([$120$ triệu đồng]),
        [$110$ triệu đồng],
...
#lt-tn(num: 10, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Miền nghiệm của một bài toán sản xuất linh kiện là tứ giác $O A B C$ với tọa độ các đỉnh là $O(0; 0), A(4; 0), B(3; 2), C(0; 3)$. Hàm doanh thu là $R(x, y) = 50x + 40y$ (nghìn đồng). Doanh thu lớn nhất đạt được là:],
    (
        [$200$ nghìn đồng],
        [$120$ nghìn đồng],
        True([$230$ nghìn đồng]),
...
#lt-tn(num: 11, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một xưởng gia công mỹ nghệ nhận sản xuất $x$ tượng đồng nhỏ và $y$ tượng đồng lớn thỏa mãn các ràng buộc: $x + y <= 5, x >= 2, y >= 1$ ($x, y in NN$). Xưởng có tất cả bao nhiêu phương án sản xuất kết hợp?],
    (
        [$3$],
        [$4$],
        [$5$],
...
#lt-tn(num: 12, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Để đảm bảo chỉ tiêu kĩ thuật, một nhà máy cần bổ sung ít nhất $12" kg"$ phụ gia $A$ và $8" kg"$ phụ gia $B$. Công ty có thể mua bao loại I (chứa $3" kg" A, 1" kg" B$, giá $100$ nghìn) và bao loại II (chứa $2" kg" A, 2" kg" B$, giá $120$ nghìn). Gọi $x, y$ là số bao loại I và II. Hàm chi phí cần tối thiểu hóa là:],
    (
        [$F(x, y) = 3x + 2y$],
        [$F(x, y) = 12x + 8y$],
...
#lt-tln(num: 17, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một nghệ nhân làm bình hoa ($x$ chiếc) và ấm trà ($y$ chiếc). Để làm 1 bình hoa cần $2" kg"$ đất sét và $4$ giờ nung, lãi $150$ nghìn đồng. Để làm 1 ấm trà cần $1" kg"$ đất sét và $1$ giờ nung, lãi $60$ nghìn đồng. Nghệ nhân có $30" kg"$ đất sét và $80$ giờ nung lò. Tính số tiền lãi lớn nhất (đơn vị: nghìn đồng) mà nghệ nhân có thể thu được.],
    [2250],
    loigiai: [
        #step([Lập bảng tóm tắt số liệu])
        #align(center)[
...
#lt-tln(num: 18, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một xưởng lắp ráp xe đạp địa hình ($x$ chiếc) và xe đạp đường phố ($y$ chiếc). Lắp $1$ xe địa hình cần $3$ giờ công và $2$ bộ giảm xóc, lãi $300$ nghìn đồng. Lắp $1$ xe đường phố cần $2$ giờ công và $1$ bộ giảm xóc, lãi $180$ nghìn đồng. Xưởng có $120$ giờ công và $70$ bộ giảm xóc. Để tiền lãi lớn nhất, xưởng cần lắp ráp bao nhiêu chiếc xe đạp địa hình?],
    [20],
    loigiai: [
        #step([Lập bảng tóm tắt số liệu])
        #align(center)[
...
#lt-tln(num: 19, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một xưởng làm bánh trung thu nướng ($x$ cái) và dẻo ($y$ cái). Mỗi bánh nướng cần $100" g"$ bột và $50" g"$ đường. Mỗi bánh dẻo cần $80" g"$ bột và $80" g"$ đường. Xưởng có $8" kg"$ bột ($8000" g"$) và $6" kg"$ đường ($6000" g"$). Tiền lãi mỗi chiếc bánh nướng là $15$ nghìn đồng, bánh dẻo là $12$ nghìn đồng. Tính tiền lãi lớn nhất (đơn vị: nghìn đồng) xưởng có thể thu được.],
    [1250],
    loigiai: [
        #step([Lập bảng tóm tắt số liệu])
        #align(center)[
...
#lt-tln(num: 22, de: [Đề 1 (D) — Mã 104], back-to: "sec-exercise-hub",[Một nhà máy chế tạo hai dòng robot công nghiệp: robot hàn tự động ($x$ chiếc) và robot sơn tự động ($y$ chiếc). Quy trình chế tạo trải qua ba công đoạn: Cơ khí, Điện tử và Kiểm thử.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 4: QUY HOẠCH TUYẾN TÍNH & TOÁN THỰC TẾ (ĐỀ SỐ 1 - CƠ KHÍ & SẢN XUẤT)!]      #v(0.6em)
