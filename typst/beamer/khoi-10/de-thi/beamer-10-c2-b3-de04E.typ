// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 4: QUY HOẠCH TUYẾN TÍNH & TOÁN THỰC TẾ (ĐỀ SỐ 2 - NÔNG NGHIỆP & TRANG TRẠI)
...
#show: lecture-theme.with(
  title: "BÀI 4: QUY HOẠCH TUYẾN TÍNH & TOÁN THỰC TẾ (ĐỀ SỐ 2 - NÔNG NGHIỆP & TRANG TRẠI)",
  subtitle: "ÔN TẬP CHƯƠNG 2 — MÃ ĐỀ: 105",
...
#lt-tn(num: 1, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Một nông hộ có $10" ha"$ đất để trồng cà rốt ($x" ha"$) và bắp cải ($y" ha"$). Bất phương trình nào sau đây mô tả đúng ràng buộc về tổng diện tích đất canh tác khả dụng?],
    (
        [$x + y >= 10$],
...
#lt-tn(num: 2, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Để trồng $1" ha"$ ngô cần $20$ ngày công lao động và $1" ha"$ đậu tương cần $30$ ngày công lao động. Trang trại có tối đa $180$ ngày công trong vụ mùa. Gọi $x, y$ lần lượt là diện tích (ha) trồng ngô và đậu tương. Bất phương trình rút gọn về ngày công là:],
    (
        [$3x + 2y <= 18$],
        [$2x + 3y >= 18$],
        True([$2x + 3y <= 18$]),
...
#lt-tn(num: 3, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Một trang trại trồng sầu riêng ($x$ sào) và bơ booth ($y$ sào). Mỗi sào sầu riêng cần $40" m"^3$ nước tưới mỗi đợt, mỗi sào bơ cần $25" m"^3$ nước tưới. Hồ thủy lợi chỉ có thể cấp tối đa $500" m"^3$ nước mỗi đợt. Bất phương trình mô tả lượng nước tưới là:],
    (
        [$5x + 8y <= 100$],
        True([$8x + 5y <= 100$]),
        [$8x + 5y >= 100$],
...
#lt-tn(num: 4, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Một vườn hoa Đà Lạt trồng hai loại hoa phục vụ Tết: hoa ly ($x$ sào, lãi $80$ triệu đồng/sào) và hoa cúc ($y$ sào, lãi $40$ triệu đồng/sào). Hàm mục tiêu biểu thị tổng tiền lãi $L(x, y)$ (đơn vị: triệu đồng) là:],
    (
        [$L(x, y) = 40x + 80y$],
        True([$L(x, y) = 80x + 40y$]),
        [$L(x, y) = 120(x + y)$],
...
#lt-tn(num: 5, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Để phối trộn $1" kg"$ thức ăn tổng hợp cho gà, người nuôi dùng cám bắp ($x" kg"$) và bột đậu nành ($y" kg"$). Mỗi kg cám bắp chứa $80" g"$ đạm; mỗi kg bột đậu nành chứa $400" g"$ đạm. Để đàn gà phát triển tốt, hỗn hợp phải cung cấp ít nhất $160" g"$ đạm. Bất phương trình nào sau đây đúng?],
    (
        [$x + 5y <= 2$],
        [$5x + y >= 2$],
        True([$x + 5y >= 2$]),
...
#lt-tn(num: 6, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Một nông dân cần cung cấp tối thiểu $40" kg"$ Đạm (N) cho vườn cây. Phân bón loại I chứa $10\%$ Đạm, phân bón loại II chứa $20\%$ Đạm. Gọi $x, y$ lần lượt là số kg phân loại I và II được bón. Bất phương trình nào thể hiện yêu cầu về lượng Đạm?],
    (
        [$x + 2y <= 400$],
        [$2x + y >= 400$],
        True([$x + 2y >= 400$]),
...
#lt-tn(num: 7, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Cần gặt xong ít nhất $20" ha"$ lúa trong một ngày. Hợp tác xã điều động $x$ máy gặt loại lớn (công suất $4" ha"$/ngày) và $y$ máy gặt loại nhỏ (công suất $2" ha"$/ngày). Bất phương trình ràng buộc diện tích lúa được gặt là:],
    (
        [$2x + y <= 10$],
        True([$2x + y >= 10$]),
        [$4x + 2y <= 20$],
...
#lt-tn(num: 8, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Một trại nuôi ong đặt $x$ đàn ong nội và $y$ đàn ong ngoại. Thời gian chăm sóc mỗi tuần cho $1$ đàn ong nội là $2$ giờ, $1$ đàn ong ngoại là $3$ giờ. Trại có tối đa $60$ giờ chăm sóc mỗi tuần. Bất phương trình nào sau đây đúng?],
    (
        [$3x + 2y <= 60$],
        True([$2x + 3y <= 60$]),
        [$2x + 3y >= 60$],
...
#lt-tn(num: 9, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Miền phương án trồng trọt của một hộ nông dân là tam giác $O A B$ có các đỉnh $O(0; 0), A(6; 0), B(0; 5)$. Hàm lợi nhuận từ dưa hấu ($x$ sào) và dưa lê ($y$ sào) là $F(x, y) = 15x + 20y$ (triệu đồng). Mức lợi nhuận lớn nhất đạt được là:],
    (
        [$90$ triệu đồng],
        True([$100$ triệu đồng]),
        [$95$ triệu đồng],
...
#lt-tn(num: 10, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Miền nghiệm của bài toán chăn nuôi gia cầm là tứ giác $O A B C$ với tọa độ các đỉnh $O(0; 0), A(50; 0), B(30; 40), C(0; 60)$ (đơn vị: con). Hàm lợi nhuận từ gà ($x$ con) và vịt ($y$ con) là $F(x, y) = 30x + 25y$ (nghìn đồng). Tiền lãi lớn nhất là:],
    (
        [$1.500.000$ đồng],
        True([$1.900.000$ đồng]),
        [$1.800.000$ đồng],
...
#lt-tn(num: 11, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Trang trại cần xử lý sâu bệnh cho hai khu vườn $A$ và $B$. Mỗi lít thuốc sinh học phun được $2" ha"$ vườn $A$ hoặc $3" ha"$ vườn $B$. Tổng diện tích trang trại cần phun tối thiểu là $12" ha"$. Bất phương trình nào sau đây đúng với lượng thuốc $x, y$ (lít) dùng cho hai vườn?],
    (
        [$3x + 2y <= 12$],
        True([$2x + 3y >= 12$]),
        [$2x + 3y <= 12$],
...
#lt-tn(num: 12, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Để phủ xanh đồi trọc, trạm kiểm lâm trồng hai loại cây: keo tai tượng ($x$ vạn cây, giá $20$ triệu đồng/vạn) và bạch đàn ($y$ vạn cây, giá $25$ triệu đồng/vạn). Hàm tổng chi phí mua giống $C(x, y)$ (đơn vị: triệu đồng) cần tối thiểu hóa là:],
    (
        [$C(x, y) = 25x + 20y$],
        [$C(x, y) = 45(x + y)$],
        True([$C(x, y) = 20x + 25y$]),
...
#lt-tln(num: 17, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Bác Ba có $8" ha"$ đất để trồng lúa ($x" ha"$) và khoai lang ($y" ha"$). Vốn đầu tư cho mỗi ha lúa là $20$ triệu đồng, mỗi ha khoai lang là $30$ triệu đồng. Bác Ba có tất cả $180$ triệu đồng tiền vốn. Tiền lãi mỗi ha lúa là $30$ triệu đồng, mỗi ha khoai lang là $40$ triệu đồng. Tìm số tiền lãi lớn nhất (đơn vị: triệu đồng) mà bác Ba có thể thu được.],
    [260],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Trang trại lắp hệ thống tưới nhỏ giọt cho vườn bưởi da xanh ($x" ha"$) và mít ruột đỏ ($y" ha"$). Mỗi ha bưởi cần $30$ van tưới và $400" m"$ ống dẫn. Mỗi ha mít cần $20$ van tưới và $500" m"$ ống dẫn. Kho trang trại có $120$ van tưới và $2400" m"$ ống dẫn. Tìm diện tích canh tác lớn nhất $(x + y)$ (đơn vị: ha) có thể lắp đặt được hệ thống.],
    [5],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Một trang trại nuôi hươu sao lấy nhung ($x$ con) và dê núi ($y$ con). Chuồng trại có sức chứa tối đa $40$ con. Vốn mua giống cho $1$ con hươu là $15$ triệu đồng, cho $1$ con dê là $5$ triệu đồng. Trang trại có tổng số vốn là $300$ triệu đồng. Mỗi con hươu mang lại lãi $10$ triệu đồng/năm, mỗi con dê lãi $4$ triệu đồng/năm. Tính tiền lãi lớn nhất (đơn vị: triệu đồng) mỗi năm.],
    [220],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 2 (E) — Mã 105], back-to: "sec-exercise-hub",[Một hợp tác xã nông nghiệp tuần hoàn sản xuất nấm rơm hữu cơ ($x$ nghìn bịch phôi) và nấm linh chi đỏ ($y$ nghìn bịch phôi). Quy trình sản xuất trải qua ba công đoạn: Phối trộn nguyên liệu mùn cưa, Khử trùng hấp sấy, và Phòng nuôi thu hoạch.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 4: QUY HOẠCH TUYẾN TÍNH & TOÁN THỰC TẾ (ĐỀ SỐ 2 - NÔNG NGHIỆP & TRANG TRẠI)!]      #v(0.6em)
