// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 5: GIÁ TRỊ LƯỢNG GIÁC CỦA MỘT GÓC TỪ 0° ĐẾN 180° (ĐỀ SỐ 1)
...
#show: lecture-theme.with(
  title: "BÀI 5: GIÁ TRỊ LƯỢNG GIÁC CỦA MỘT GÓC TỪ 0° ĐẾN 180° (ĐỀ SỐ 1)",
...
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Trên mặt phẳng tọa độ $O x y$, lấy nửa đường tròn đơn vị nằm phía trên trục hoành. Cho góc $alpha$ ($0^circ <= alpha <= 180^circ$) và điểm $M(x_0; y_0)$ nằm trên nửa đường tròn đơn vị sao cho $hat(x O M) = alpha$. Khẳng định nào sau đây đúng?],
    (
        [$sin alpha = x_0$],
        True([$sin alpha = y_0$]),
        [$cos alpha = y_0$],
...
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho góc $alpha$ là góc tù ($90^circ < alpha < 180^circ$). Mệnh đề nào sau đây đúng?],
    (
        [$sin alpha < 0$],
        [$cos alpha > 0$],
        True([$tan alpha < 0$]),
...
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Giá trị của $cos 120^circ$ bằng bao nhiêu?],
    (
        [$1/2$],
        True([$- 1/2$]),
        [$- sqrt(3)/2$],
...
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Giá trị của $sin 135^circ$ bằng bao nhiêu?],
    (
        True([$sqrt(2)/2$]),
        [$- sqrt(2)/2$],
        [$1/2$],
...
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Với mọi góc $alpha$ ($0^circ <= alpha <= 180^circ$), khẳng định nào sau đây SAI?],
    (
...
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Trên nửa đường tròn đơn vị, điểm $M$ ứng với góc $alpha = 150^circ$ có tọa độ là:],
    (
        [$(1/2; - sqrt(3)/2)$],
        [$(sqrt(3)/2; 1/2)$],
        True([$(- sqrt(3)/2; 1/2)$]),
...
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho góc tù $alpha$ thỏa mãn $sin alpha = 3/5$. Giá trị của $cos alpha$ bằng:],
    (
        [$4/5$],
        True([$- 4/5$]),
        [$- 16/25$],
...
// TN 8: Hệ thức cơ bản
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Đẳng thức nào sau đây đúng với mọi góc $alpha$ ($0^circ < alpha < 180^circ, alpha != 90^circ$)?],
    (
...
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Giá trị của biểu thức $P = cos 25^circ + cos 155^circ + sin 30^circ$ bằng:],
    (
        [$0$],
        True([$1/2$]),
        [$1$],
...
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tìm số đo góc $alpha$ ($0^circ <= alpha <= 180^circ$) biết $tan alpha = - sqrt(3)$.],
    (
        [$alpha = 60^circ$],
        True([$alpha = 120^circ$]),
        [$alpha = 150^circ$],
...
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho góc $alpha$ thỏa mãn $sin alpha = 5/13$ và $cos alpha = - 12/13$. Giá trị của $tan alpha$ là:],
    (
        [$5/12$],
        True([$- 5/12$]),
        [$- 12/5$],
...
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một con đường dốc có góc nghiêng $alpha = 12^circ$ so với mặt phẳng nằm ngang. Một chiếc ô tô di chuyển từ chân dốc lên đỉnh dốc một quãng đường dài $250" m"$. Độ cao của đỉnh dốc so với chân dốc gần nhất với giá trị nào sau đây?],
    (
        [$48" m"$],
        True([$52" m"$]),
        [$60" m"$],
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Trên mặt phẳng tọa độ $O x y$, nửa đường tròn đơn vị tâm $O$ bán kính $R = 1$ nằm phía trên trục hoành. Điểm $M$ nằm trên nửa đường tròn đơn vị sao cho $hat(x O M) = 150^circ$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho góc $alpha$ thỏa mãn $90^circ < alpha < 180^circ$ và $cos alpha = - 5/13$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Xét các biểu thức lượng giác sau, với $alpha$ là góc nhọn bất kì ($0^circ < alpha < 90^circ$). Xét tính đúng sai của các khẳng định sau:],
  (
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc thang dài $4" m"$ được tựa vào một bức tường thẳng đứng trên mặt sàn nằm ngang. Gọi $alpha$ là góc nghiêng giữa chiếc thang và mặt sàn ($0^circ < alpha < 90^circ$). Xét tính đúng sai của các mệnh đề sau:],
  (
...
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tính giá trị của biểu thức $P = 4 sin 30^circ + 2 sqrt(3) cos 30^circ - 3 tan 135^circ$.],
    [8],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho góc $alpha$ thỏa mãn $tan alpha = 2$. Tính giá trị của biểu thức $A = (4 sin alpha + 5 cos alpha) / (2 sin alpha - 3 cos alpha)$.],
    [13],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Tính giá trị của biểu thức $S = sin^2 15^circ + sin^2 35^circ + sin^2 55^circ + sin^2 75^circ$.],
    [2],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho góc tù $alpha$ thỏa mãn $sin alpha + cos alpha = 1/5$. Tính giá trị của biểu thức $T = 100 dot sin alpha dot cos alpha$.],
    [-48],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một người đứng ở vị trí $A$ trên mặt đất bằng phẳng, cách chân một tháp truyền hình một khoảng $80" m"$. Người đó nhìn lên đỉnh tháp dưới góc nâng $32^circ$. Biết khoảng cách từ mắt người quan sát đến mặt đất là $1.6" m"$. Tính chiều cao của ngọn tháp (làm tròn kết quả đến hàng đơn vị mét).],
    [52],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho góc nhọn $alpha$ ($0^circ < alpha < 90^circ$). Tìm giá trị nhỏ nhất của biểu thức $S = tan alpha + cot alpha$.],
    [2],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 5: GIÁ TRỊ LƯỢNG GIÁC CỦA MỘT GÓC TỪ 0° ĐẾN 180° (ĐỀ SỐ 1)!]      #v(0.6em)
