// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 6: TOÁN THỰC TẾ & ĐO ĐẠC HÌNH HỌC (ĐỀ D: TRẮC ĐỊA & CÔNG TRÌNH)
...
#show: lecture-theme.with(
  title: "BÀI 6: TOÁN THỰC TẾ & ĐO ĐẠC HÌNH HỌC (ĐỀ D: TRẮC ĐỊA & CÔNG TRÌNH)",
  subtitle: "ÔN TẬP CHƯƠNG 3 — MÃ ĐỀ: 107",
...
#lt-tn(num: 1, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một kỹ sư trắc địa đặt giác kế có chiều cao $1.5" m"$ tại điểm $A$ cách chân tòa nhà $40" m"$. Góc nâng đo được từ giác kế lên đỉnh tòa nhà là $45^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
#lt-tn(num: 2, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một người đứng ở vị trí $A$ bên bờ sông ngắm thẳng sang một cái cây $C$ ở bờ bên kia sao cho $A C$ vuông góc với bờ sông. Người đó đi dọc theo bờ sông một đoạn $A B = 50" m"$ rồi ngắm lại cây $C$ thì thấy góc $hat(A B C) = 30^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tn(num: 3, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một mái taluy chống sạt lở của đường cao tốc có chiều dài mặt dốc là $12" m"$ và tạo với phương nằm ngang một góc $30^circ$. Độ cao của đỉnh mái dốc so với chân đường bằng:],
    (
        True([$6" m"$]),
        [$6 sqrt(3)" m"$],
        [$4" m"$],
...
#lt-tn(num: 4, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Để xây dựng một cây cầu bắc qua sông nối hai mố cầu $A$ và $B$, từ điểm quan sát $C$ trên bờ, các kỹ sư đo được $C A = 80" m", C B = 120" m"$ và góc ngắm $hat(A C B) = 60^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tn(num: 5, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một chiếc thang dài $5" m"$ được dựng tựa vào tường nhà. Để đảm bảo an toàn lao động, thang cần tạo với mặt đất nằm ngang một góc $65^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tn(num: 6, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một cột ăng-ten phát sóng được giữ thăng bằng nhờ các sợi dây cáp néo nối từ đỉnh cột xuống các cọc néo dưới mặt đất cách chân cột $30" m"$. Biết sợi dây néo tạo với mặt bằng nằm ngang một góc $60^circ$. Chiều dài của mỗi sợi dây néo bằng:],
    (
        [$30 sqrt(3)" m"$],
        [$45" m"$],
        True([$60" m"$]),
...
#lt-tn(num: 7, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một khu đất xây dựng có ranh giới là tam giác $A B C$ với độ dài ba cạnh đo được lần lượt là $30" m", 40" m"$ và $50" m"$. Diện tích của khu đất này bằng:],
    (
        [$1200" m"^2$],
        True([$600" m"^2$]),
        [$800" m"^2$],
...
#lt-tn(num: 8, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Từ vị trí máy đo đạc $O$, kỹ sư ngắm tới hai cọc mốc trắc địa $P$ và $Q$. Biết khoảng cách $O P = 150" m", O Q = 200" m"$ và góc ngắm $hat(P O Q) = 120^circ$. Khoảng cách $P Q$ giữa hai cọc mốc xấp xỉ bằng:],
    (
        [$280.5" m"$],
        [$250.0" m"$],
        True([$304.1" m"$]),
...
#lt-tn(num: 9, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một đoạn đường cong trên cao tốc được thiết kế uốn theo cung tròn ngoại tiếp tam giác tạo bởi ba điểm mốc $A, B, C$. Biết khoảng cách thẳng $A B = 200" m"$ và góc đối diện $hat(A C B) = 30^circ$. Bán kính cong $R$ của đoạn đường này bằng:],
    (
        [$100" m"$],
        True([$200" m"$]),
        [$400" m"$],
...
#lt-tn(num: 10, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một khối dầm bê tông chịu lực có mặt cắt ngang là hình tam giác với cạnh đáy dài $4" m"$ và chiều cao tương ứng là $1.5" m"$. Diện tích mặt cắt ngang của khối dầm bằng:],
    (
        [$6.0" m"^2$],
        True([$3.0" m"^2$]),
        [$4.5" m"^2$],
...
#lt-tn(num: 11, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một đoạn đường đèo lên núi dài $2" km"$, độ cao của điểm cuối cao hơn điểm đầu là $120" m"$. Góc dốc của đoạn đường so với mặt phẳng ngang xấp xỉ bằng:],
    (
        True([$3.44^circ$]),
        [$4.25^circ$],
        [$6.89^circ$],
...
#lt-tn(num: 12, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một cần trục xây dựng có tay cần dài $25" m"$ đang nâng khối vật liệu. Khi tay cần hợp với phương thẳng đứng một góc $40^circ$, khoảng cách theo phương ngang từ chân trục đến vị trí khối vật liệu xấp xỉ bằng:],
    (
        [$19.15" m"$],
        True([$16.07" m"$]),
        [$21.45" m"$],
...
#lt-ds(num: 13, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Để chuẩn bị thi công tuyến hầm đường bộ xuyên núi nối hai cửa hầm $A$ và $B$, do địa hình hiểm trở không thể kéo dây đo trực tiếp, các kỹ sư đặt một trạm định vị trên đỉnh đồi $C$ có tầm quan sát bao quát cả $A$ và $B$. Thiết bị đo đạc ghi nhận khoảng cách $C A = 600" m", C B = 800" m"$ và góc ngắm $hat(A C B) = 60^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Tuyến cáp treo lên đỉnh núi gồm hai chặng: chặng 1 từ ga xuất phát $A$ đến trụ chuyển tiếp $B$ có chiều dài cáp $A B = 800" m"$ với góc nghiêng $20^circ$ so với phương ngang; chặng 2 từ trụ $B$ đến ga đỉnh $C$ có chiều dài cáp $B C = 1200" m"$ với góc nghiêng dốc hơn là $35^circ$ so với phương ngang.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 17, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một vì kèo mái ngói tam giác cân $A B C$ có nhịp đáy $A B = 10" m"$ và hai cạnh mái $C A = C B = 6" m"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 18, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Hai người quan sát đứng tại hai điểm $A$ và $B$ dọc bờ sông cách nhau $60" m"$, cùng nhìn sang một gốc cây $C$ ở bờ đối diện. Đo được $hat(C A B) = 60^circ$ và $hat(C B A) = 45^circ$. Tính khoảng cách ngắn nhất từ gốc cây $C$ đến bờ sông chứa đoạn $A B$ (làm tròn đến hàng đơn vị theo mét).],
    [38],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một tháp ăng-ten cao $45" m"$ được dựng vuông góc với sườn đồi. Người ta kéo dây néo từ đỉnh tháp xuống một mốc cố định trên mặt đồi cách chân tháp một khoảng bằng $24" m"$. Tính độ dài sợi dây néo (đơn vị: mét).],
    [51],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một nhịp cầu vòm uốn cong theo cung tròn của một đường tròn tâm $O$. Hai chân mố cầu $A$ và $B$ cách nhau một khoảng thẳng $A B = 120" m"$. Góc ở tâm chắn cung $A B$ là $hat(A O B) = 120^circ$. Tính bán kính cong $R = O A$ của nhịp cầu (làm tròn đến hàng đơn vị theo mét).],
    [69],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Để đo chiều cao một ngọn núi đá vôi thẳng đứng, người ta đo góc nâng từ trạm $A$ lên đỉnh núi được $30^circ$. Đi thẳng về phía chân núi một đoạn $100" m"$ đến trạm $B$, góc nâng đo được tăng lên thành $45^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 1 (D) — Mã 107], back-to: "sec-exercise-hub",[Một chòi quan sát cháy rừng có thân tháp $A B$ cao $32" m"$ đặt thẳng đứng trên sườn đồi. Đội kiểm lâm đặt trạm trực dã chiến tại điểm $M$ sao cho đường gióng ngang tầm mắt cắt trục thẳng đứng của tháp tại điểm $O$ nằm dưới chân tháp $B$, với $O B = 4" m"$ (chân tháp cách tầm mắt $4" m"$) và đỉnh tháp $A$ cách tầm mắt $O A = 36" m"$.
#align(center)[
    #cetz.canvas({
        import cetz.draw: *
        set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 6: TOÁN THỰC TẾ & ĐO ĐẠC HÌNH HỌC (ĐỀ D: TRẮC ĐỊA & CÔNG TRÌNH)!]      #v(0.6em)
