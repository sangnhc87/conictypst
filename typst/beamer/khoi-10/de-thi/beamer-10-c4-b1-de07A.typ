// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 7: CÁC KHÁI NIỆM MỞ ĐẦU VỀ VECTƠ (ĐỀ SỐ 1)
...
#show: lecture-theme.with(
  title: "BÀI 7: CÁC KHÁI NIỆM MỞ ĐẦU VỀ VECTƠ (ĐỀ SỐ 1)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Khẳng định nào sau đây là đúng về định nghĩa vectơ?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hai điểm phân biệt $A$ và $B$. Vectơ có điểm đầu là $A$ và điểm cuối là $B$ được ký hiệu là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Khẳng định nào sau đây là đúng về vectơ-không?],
    (
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Độ dài của vectơ $vec(A B)$ được hiểu là],
    (
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Đường thẳng đi qua điểm đầu và điểm cuối của vectơ $vec(A B)$ (với $A != B$) được gọi là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Hai vectơ khác vectơ-không được gọi là cùng phương khi và chỉ khi
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Mệnh đề nào sau đây là đúng?],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có cạnh bằng $5" cm"$. Độ dài của vectơ $vec(B C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có $A B = 6" cm"$ và $B C = 8" cm"$. Độ dài của vectơ $vec(A C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Hai vectơ $vec(a)$ và $vec(b)$ được gọi là bằng nhau, ký hiệu $vec(a) = vec(b)$, khi và chỉ khi],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$ có trung điểm là $I$. Khẳng định nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hình bình hành $A B C D$. Vectơ nào sau đây bằng vectơ $vec(A B)$?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 1 (Câu 13)
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ tâm $O$ có cạnh bằng $a$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 2 (Câu 14)
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hình bình hành $A B C D$ có tâm đối xứng $O$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một robot tự hành xuất phát từ trạm điều khiển $O(0; 0)$ trên mặt sàn phẳng. Robot di chuyển theo vectơ $vec(d)_1 = vec(O A)$ đi về hướng Đông $4" m"$ đến điểm $A$, sau đó chuyển hướng đi theo vectơ $vec(d)_2 = vec(A B)$ về hướng Bắc $3" m"$ đến trạm nhận hàng $B$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc máy bay phản lực đang bay theo phương nằm ngang từ Tây sang Đông với vận tốc riêng đối với không khí được biểu diễn bởi vectơ $vec(v)_1$ có độ lớn $600" km/h"$. Tại thời điểm đó, một luồng gió thổi cùng hướng từ Tây sang Đông với vận tốc biểu diễn bởi vectơ $vec(v)_2$ có độ lớn $50" km/h"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho $4$ điểm phân biệt $A, B, C, D$ trên một mặt phẳng, trong đó không có ba điểm nào thẳng hàng. Hỏi có bao nhiêu vectơ khác vectơ-không có điểm đầu và điểm cuối là hai trong số bốn điểm đã cho?],
    [12],
    loigiai: [
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ vuông tại $A$ có cạnh góc vuông $A B = 6" cm"$ và $A C = 8" cm"$. Gọi $M$ là trung điểm của cạnh huyền $B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hình thoi $A B C D$ có cạnh bằng $10" cm"$ và góc $hat(B A D) = 60^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ có cạnh bằng $4" cm"$. Gọi $O$ là giao điểm của hai đường chéo $A C$ và $B D$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một kiện hàng đặt trên mặt đất chịu tác dụng đồng thời của hai lực kéo $vec(F)_1$ và $vec(F)_2$ cùng đặt tại điểm $O$. Biết hai lực này có phương vuông góc với nhau và độ lớn lần lượt là $F_1 = 30" N"$, $F_2 = 40" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc cano chuyển động thẳng đều từ bờ bên này sang bờ bên kia của một con sông. Vận tốc của cano đối với dòng nước được biểu diễn bởi vectơ $vec(v)_c$ vuông góc với bờ sông và có độ lớn bằng $12" km/h"$. Vận tốc của dòng nước chảy xuôi bờ được biểu diễn bởi vectơ $vec(v)_n$ có độ lớn bằng $5" km/h"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 7: CÁC KHÁI NIỆM MỞ ĐẦU VỀ VECTƠ (ĐỀ SỐ 1)!]      #v(0.6em)
