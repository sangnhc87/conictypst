// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 8: TỔNG VÀ HIỆU CỦA HAI VECTƠ (ĐỀ SỐ 1)
...
#show: lecture-theme.with(
  title: "BÀI 8: TỔNG VÀ HIỆU CỦA HAI VECTƠ (ĐỀ SỐ 1)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 104",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Với ba điểm bất kỳ $A, B, C$, khẳng định nào sau đây luôn đúng (quy tắc ba điểm của phép cộng)?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho hình bình hành $A B C D$. Vectơ tổng $vec(A B) + vec(A D)$ bằng vectơ nào sau đây (quy tắc hình bình hành)?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Với ba điểm phân biệt $A, B, C$, vectơ hiệu $vec(A B) - vec(A C)$ bằng vectơ nào sau đây?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$ có trung điểm là $I$. Khẳng định nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$. Độ dài của vectơ tổng $vec(A B) + vec(A D)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có cạnh bằng $a$. Độ dài của vectơ $vec(A B) + vec(B C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho bốn điểm bất kỳ $A, B, C, D$. Biểu thức vectơ $vec(A B) + vec(B C) + vec(C D)$ được rút gọn thành],
    (
        True([$vec(A D)$]),
        [$vec(D A)$],
        [$vec(A C)$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Hiệu của hai vectơ $vec(a) - vec(b)$ được định nghĩa là tổng của vectơ $vec(a)$ với],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ vuông cân tại $A$ có $A B = A C = 3" cm"$. Độ dài của vectơ hiệu $vec(A B) - vec(A C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Hai lực $vec(F)_1$ và $vec(F)_2$ cùng tác dụng vào một vật có độ lớn lần lượt là $30" N"$ và $40" N"$, giá của hai lực vuông góc với nhau. Độ lớn của hợp lực $vec(F) = vec(F)_1 + vec(F)_2$ bằng],
    (
        True([$50" N"$]),
        [$70" N"$],
        [$10" N"$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho hình thoi $A B C D$ tâm $O$. Vectơ hiệu $vec(O B) - vec(O C)$ bằng vectơ nào sau đây?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Với hai vectơ tùy ý $vec(a)$ và $vec(b)$, khẳng định nào sau đây là SAI?],
    (
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ tâm $O$ có cạnh bằng $a$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có cạnh bằng $a$. Gọi $M$ là trung điểm của cạnh $B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Một robot tự hành xuất phát từ trạm điều khiển $O$, đi thẳng về phía Đông một quãng đường $40" m"$ đến vị trí $A$ (vectơ độ dịch chuyển thứ nhất là $vec(d)_1 = vec(O A)$), sau đó rẽ vuông góc đi thẳng về phía Bắc một quãng đường $30" m"$ đến vị trí trạm cảm biến $B$ (vectơ độ dịch chuyển thứ hai là $vec(d)_2 = vec(A B)$).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Một chiếc sà lan chở hàng tại điểm $O$ được hai chiếc tàu kéo cùng tác dụng hai lực kéo $vec(F)_1$ và $vec(F)_2$ theo hai hướng vuông góc nhau. Lực kéo của tàu thứ nhất có độ lớn $F_1 = 3000" N"$, lực kéo của tàu thứ hai có độ lớn $F_2 = 4000" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ có độ dài cạnh bằng $8" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có cạnh bằng $10" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có $A B = 6" cm"$ và $B C = 8" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có cạnh bằng $6" cm"$. Gọi $M$ là trung điểm của cạnh $B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Một kiện hàng đặt trên sàn phẳng chịu tác dụng đồng thời của hai lực kéo nằm ngang: lực kéo $vec(F)_1$ hướng sang phía Đông có độ lớn $60" N"$ và lực kéo $vec(F)_2$ hướng sang phía Bắc có độ lớn $80" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 104], back-to: "sec-exercise-hub",[Hai lực $vec(F)_1$ và $vec(F)_2$ cùng tác dụng vào một chất điểm tại điểm $O$, tạo với nhau một góc $60^circ$. Biết độ lớn của hai lực là $F_1 = F_2 = 50" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 8: TỔNG VÀ HIỆU CỦA HAI VECTƠ (ĐỀ SỐ 1)!]      #v(0.6em)
