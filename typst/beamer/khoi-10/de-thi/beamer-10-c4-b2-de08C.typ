// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 8: TỔNG VÀ HIỆU CỦA HAI VECTƠ (ĐỀ SỐ 3)
...
#show: lecture-theme.with(
  title: "BÀI 8: TỔNG VÀ HIỆU CỦA HAI VECTƠ (ĐỀ SỐ 3)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 106",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Điểm $M$ thỏa mãn hệ thức vectơ $vec(M A) + vec(M B) + vec(M C) = vec(0)$ thì $M$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$. Điểm $M$ thỏa mãn hệ thức nào sau đây thì $M$ là trung điểm của đoạn thẳng $A B$?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Tổng ba vectơ $vec(A B) + vec(B C) + vec(C A)$ bằng vectơ nào sau đây?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có tâm $O$. Tổng bốn vectơ $vec(O A) + vec(O B) + vec(O C) + vec(O D)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Với hai vectơ tùy ý $vec(a)$ và $vec(b)$, bất đẳng thức nào sau đây luôn đúng?],
    (
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Dấu đẳng thức trong bất đẳng thức $|vec(a) + vec(b)| = |vec(a)| + |vec(b)|$ (với $vec(a), vec(b) != vec(0)$) xảy ra khi và chỉ khi],
    (
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ vuông tại $A$ có $A B = 5" cm"$ và $A C = 12" cm"$. Độ dài của vectơ $vec(B A) + vec(A C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ có cạnh bằng $a$. Độ dài của vectơ tổng $vec(A B) + vec(B C) + vec(C D)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Ba lực đồng phẳng $vec(F)_1, vec(F)_2, vec(F)_3$ cùng tác dụng vào một chất điểm làm cho chất điểm đó đứng yên cân bằng. Khẳng định nào sau đây là đúng?],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho hình bình hành $A B C D$ tâm $O$. Khẳng định nào sau đây là SAI?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $A C$. Biểu thức nào sau đây bằng vectơ $vec(M N)$?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Hai lực $vec(F)_1$ và $vec(F)_2$ có độ lớn không đổi cùng tác dụng vào một điểm $O$. Hợp lực $vec(F) = vec(F)_1 + vec(F)_2$ đạt độ lớn nhỏ nhất khi],
    (
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có trọng tâm $G$. Gọi $M$ là trung điểm của cạnh $B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có $A B = 4" cm"$, $B C = 3" cm"$. Gọi $O$ là giao điểm của hai đường chéo $A C$ và $B D$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Một vòng khuyên kim loại nhỏ $O$ nằm cân bằng trên mặt phẳng dưới tác dụng của ba lực kéo đồng phẳng $vec(F)_1, vec(F)_2, vec(F)_3$. Hai lực $vec(F)_1$ và $vec(F)_2$ có giá vuông góc với nhau và có độ lớn lần lượt là $F_1 = 300" N"$, $F_2 = 400" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Một cần cẩu công nghiệp đang nâng thẳng đứng một kiện hàng có trọng lượng $P = 12000" N"$ chuyển động đều lên cao nhờ hai sợi dây cáp thép đối xứng cùng buộc vào móc cẩu tại điểm $O$. Hai sợi dây cáp tạo với nhau một góc $60^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có độ dài cạnh bằng $6" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ có cạnh bằng $10" cm"$. Gọi $O$ là giao điểm của hai đường chéo $A C$ và $B D$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có $A B = 12" cm"$ và $B C = 5" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có độ dài cạnh bằng $8" cm"$. Gọi $M$ và $N$ lần lượt là trung điểm của hai cạnh $A B$ và $A C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Một chiếc cano chạy trên hồ nước phẳng lặng chịu tác dụng đồng thời của lực đẩy từ động cơ $vec(F)_1$ hướng về phía Đông có độ lớn $1500" N"$ và lực cản của dòng nước chảy $vec(F)_2$ hướng về phía Nam có độ lớn $2000" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 106], back-to: "sec-exercise-hub",[Hai chiếc tàu kéo cùng kéo một sà lan tại điểm $O$ bằng hai sợi dây cáp thép tạo với nhau một góc $60^circ$. Lực kéo của tàu thứ nhất là $F_1 = 5000" N"$, lực kéo của tàu thứ hai là $F_2 = 8000" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 8: TỔNG VÀ HIỆU CỦA HAI VECTƠ (ĐỀ SỐ 3)!]      #v(0.6em)
