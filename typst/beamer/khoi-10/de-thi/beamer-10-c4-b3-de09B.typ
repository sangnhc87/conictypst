// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 9: TÍCH CỦA MỘT VECTƠ VỚI MỘT SỐ (ĐỀ SỐ 2)
...
#show: lecture-theme.with(
  title: "BÀI 9: TÍCH CỦA MỘT VECTƠ VỚI MỘT SỐ (ĐỀ SỐ 2)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 108",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Gọi $M$ là trung điểm của cạnh $B C$. Phân tích vectơ trung tuyến $vec(A M)$ theo hai vectơ cạnh $vec(A B)$ và $vec(A C)$ ta được
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có trọng tâm là $G$. Biểu diễn vectơ $vec(A G)$ theo hai vectơ $vec(A B)$ và $vec(A C)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho hình thang $A B C D$ có hai đáy là $A B$ và $C D$ thỏa mãn $A B = 2 C D$. Đẳng thức vectơ nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$. Điểm $N$ nằm trên tia đối của tia $B A$ sao cho $B N = A B$. Đẳng thức vectơ nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Lấy điểm $K$ trên cạnh $A C$ sao cho $A K = 2/3 A C$. Phân tích vectơ $vec(B K)$ theo hai vectơ $vec(B A)$ và $vec(B C)$ ta được
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho hai vectơ không cùng phương $vec(a)$ và $vec(b)$. Nếu $m vec(a) + n vec(b) = vec(0)$ thì kết luận nào sau đây luôn đúng?],
    (
        True([$m = 0$ và $n = 0$]),
        [$m = n != 0$],
        [$m = - n$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho lục giác đều $A B C D E F$ tâm $O$. Đặt vectơ $vec(u) = vec(O A)$. Phân tích vectơ $vec(A D)$ theo $vec(u)$ ta được
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho hình bình hành $A B C D$. Gọi $M$ là trung điểm của cạnh $B C$. Phân tích vectơ $vec(A M)$ theo hai vectơ $vec(A B)$ và $vec(A D)$ ta được
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ vuông tại $A$ có $A B = 3" cm"$ và $A C = 4" cm"$. Gọi $I$ là trung điểm của cạnh huyền $B C$. Độ dài của vectơ $4 vec(A I)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Điểm $G$ là trọng tâm của tứ giác $A B C D$ khi và chỉ khi thỏa mãn đẳng thức vectơ nào sau đây?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Gọi $I$ là điểm thỏa mãn đẳng thức $2 vec(I A) + 3 vec(I B) = vec(0)$. Khẳng định nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Với điểm $M$ tùy ý, biểu thức vectơ $vec(v) = vec(M A) + vec(M B) - 2 vec(M C)$],
    (
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho hình thang vuông $A B C D$ vuông tại $A$ và $D$, có hai đáy $A B parallel C D$ thỏa mãn $A B = 2 C D$. Gọi $I$ là giao điểm của hai đường chéo $A C$ và $B D$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho lục giác đều $A B C D E F$ có tâm $O$. Đặt hai vectơ cơ sở là $vec(u) = vec(A B)$ và $vec(v) = vec(A F)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Trong giai đoạn bay bằng hành trình, cánh của một chiếc máy bay phản lực thương mại tạo ra lực nâng khí động học $vec(L)$ hướng thẳng đứng lên trên để triệt tiêu trọng lực $vec(P)$ của máy bay ($L = P = 200000" N"$). Đồng thời, máy bay chịu lực cản của không khí $vec(D)$ hướng ngược chiều bay với độ lớn $D = 20000" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Một cẩu tháp tại công trường xây dựng nâng một khối bê tông đúc sẵn có khối lượng $m = 3000" kg"$ (trọng lượng $P = 30000" N"$) bằng hai sợi dây cáp thép $O A$ và $O B$ đối xứng qua phương thẳng đứng, mỗi sợi dây hợp với phương thẳng đứng một góc $30^circ$. Khối bê tông được giữ đứng yên thăng bằng ở trạng thái tĩnh.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Gọi $M$ là điểm nằm trên cạnh $B C$ sao cho $B M = 2 M C$. Biểu diễn vectơ $vec(A M)$ theo hai vectơ cạnh dưới dạng $vec(A M) = x vec(A B) + y vec(A C)$ với $x, y in bb(R)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho hình bình hành $A B C D$. Gọi $G$ là trọng tâm của tam giác $A B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ vuông tại $A$ có $A B = 6" cm"$ và $A C = 8" cm"$. Gọi $G$ là trọng tâm của tam giác $A B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có $A B = 8" cm"$ và $B C = 6" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Trên tuyến đường cao tốc nối hai đô thị $A$ và $B$ có chiều dài $A B = 120" km"$, ban quản lý giao thông thông minh quy hoạch một trạm sạc xe điện siêu nhanh tại điểm $S$ nằm giữa hai đô thị. Để cân bằng lưới điện và tối ưu cự ly phục vụ theo mật độ phương tiện, vị trí trạm sạc $S$ được xác định thỏa mãn hệ thức vectơ: $vec(S A) + 3 vec(S B) = vec(0)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 108], back-to: "sec-exercise-hub",[Tại một điểm nút liên kết giàn giáo chịu tải trong xây dựng, ba thanh thép liên kết truyền lực đồng quy tại điểm $O$. Thanh thứ nhất truyền lực $vec(F)_1$ theo phương thẳng đứng hướng xuống dưới với độ lớn $F_1 = 2000" N"$. Thanh chống thứ hai truyền phản lực $vec(F)_3 = - 2 vec(F)_1$ theo phương thẳng đứng hướng lên trên.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 9: TÍCH CỦA MỘT VECTƠ VỚI MỘT SỐ (ĐỀ SỐ 2)!]      #v(0.6em)
