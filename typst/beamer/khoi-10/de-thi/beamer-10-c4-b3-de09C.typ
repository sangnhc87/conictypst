// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 9: TÍCH CỦA MỘT VECTƠ VỚI MỘT SỐ (ĐỀ SỐ 3)
...
#show: lecture-theme.with(
  title: "BÀI 9: TÍCH CỦA MỘT VECTƠ VỚI MỘT SỐ (ĐỀ SỐ 3)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 109",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Điều kiện cần và đủ để ba điểm phân biệt $A, B, C$ thẳng hàng là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho ba điểm phân biệt $A, B, C$ thẳng hàng thỏa mãn đẳng thức vectơ $vec(C A) = 2 vec(C B)$. Khẳng định nào sau đây là đúng về vị trí tương đối giữa các điểm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$. Điểm $I$ thỏa mãn hệ thức vectơ $vec(I A) + 2 vec(I B) = vec(0)$. Khẳng định nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Điểm $M$ thỏa mãn đẳng thức vectơ $vec(M A) + vec(M B) + vec(M C) = vec(0)$ khi và chỉ khi
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho hai vectơ không cùng phương $vec(a)$ và $vec(b)$. Tìm giá trị của số thực $m$ để hai vectơ $vec(u) = 2 vec(a) + 3 vec(b)$ và $vec(v) = m vec(a) - 6 vec(b)$ cùng phương với nhau.],
    (
        True([$m = - 4$]),
        [$m = 4$],
        [$m = - 9$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có tâm $O$. Với điểm $M$ tùy ý trong mặt phẳng, đẳng thức vectơ nào sau đây luôn đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$. Tập hợp các điểm $M$ thỏa mãn đẳng thức $|vec(M A) + vec(M B)| = |vec(M A) - vec(M B)|$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$ có độ dài bằng $6" cm"$. Gọi $I$ là điểm thỏa mãn $2 vec(I A) + vec(I B) = vec(0)$. Tập hợp các điểm $M$ thỏa mãn đẳng thức $|2 vec(M A) + vec(M B)| = 6$ là],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có cạnh bằng $a$ và trọng tâm là $G$. Tập hợp các điểm $M$ thỏa mãn đẳng thức $|vec(M A) + vec(M B) + vec(M C)| = 3 a$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho hai điểm phân biệt $A, B$. Có bao nhiêu điểm $M$ thỏa mãn đẳng thức vectơ $vec(M A) + 3 vec(M B) = vec(0)$?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Gọi $M, N$ lần lượt là các điểm thỏa mãn $vec(A M) = 1/3 vec(A B)$ và $vec(A N) = 1/3 vec(A C)$. Khẳng định nào sau đây là đúng về hai đường thẳng $M N$ và $B C$?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho ba vectơ tùy ý $vec(a), vec(b), vec(c)$ thỏa mãn $2 vec(a) - 3 vec(b) + vec(c) = vec(0)$. Khẳng định nào sau đây là đúng?],
    (
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Lấy điểm $M$ trên cạnh $A B$ sao cho $A M = 1/3 A B$, lấy điểm $N$ trên cạnh $A C$ sao cho $A N = 1/2 A C$. Lấy điểm $K$ trên cạnh $B C$ sao cho $B K = x B C$ ($x in bb(R)$).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có trọng tâm là $G$. Xét tập hợp các điểm $M$ trong mặt phẳng thỏa mãn đẳng thức vectơ: $|vec(M A) + vec(M B) + vec(M C)| = |vec(M A) + 2 vec(M B) - 3 vec(M C)|$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Ba trạm thu phát sóng radar kiểm soát không lưu ven biển đặt tại ba vị trí $A, B, C$ nằm thẳng hàng theo thứ tự đó dọc bờ biển phẳng. Khoảng cách đo được giữa các trạm là $A B = 30" km"$ và $B C = 60" km"$. Một máy bay trực thăng cứu hộ tại vị trí $M$ thu nhận đồng thời tín hiệu điều hướng từ cả ba trạm.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác $A B C$. Lấy điểm $M$ trên cạnh $B C$ sao cho $vec(M B) = - 2 vec(M C)$, lấy điểm $N$ trên cạnh $A C$ sao cho $vec(N A) = - 3 vec(N C)$. Đường thẳng $M N$ cắt đường thẳng $A B$ kéo dài tại điểm $P$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có độ dài ba cạnh lần lượt là $a = B C = 7" cm"$, $b = C A = 8" cm"$, $c = A B = 6" cm"$. Gọi $I$ là tâm đường tròn nội tiếp của tam giác $A B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho đoạn thẳng $A B$ có độ dài bằng $10" cm"$. Gọi $I$ là điểm thỏa mãn hệ thức vectơ $vec(I A) + 4 vec(I B) = vec(0)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có độ dài cạnh bằng $6" cm"$ và có trọng tâm là $G$. Gọi $M$ là một điểm di động trong mặt phẳng thỏa mãn đẳng thức $|vec(M A) + vec(M B) + vec(M C)| = 18" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 109], back-to: "sec-exercise-hub",[Ba trạm thu phát cáp quang ngầm xuyên biển $A, B, C$ nằm thẳng hàng theo thứ tự đó trên hải trình. Khoảng cách giữa trạm $A$ và trạm $B$ là $40" km"$, khoảng cách giữa trạm $B$ và trạm $C$ là $60" km"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 9: TÍCH CỦA MỘT VECTƠ VỚI MỘT SỐ (ĐỀ SỐ 3)!]      #v(0.6em)
