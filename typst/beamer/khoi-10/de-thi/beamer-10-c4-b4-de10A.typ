// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 1)
// Lớp: Khối 10  ·  Mã đề: 110  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 1)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 110",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 110]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho vectơ $vec(u) = 2 vec(i) - 5 vec(j)$ (với $vec(i), vec(j)$ lần lượt là hai vectơ đơn vị trên hai trục $O x$ và $O y$). Tọa độ của vectơ $vec(u)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 3)$ và $B(4; -1)$. Tọa độ của vectơ $vec(A B)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(a) = (3; -2)$ và $vec(b) = (-1; 4)$. Tọa độ của vectơ tổng $vec(u) = vec(a) + vec(b)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho vectơ $vec(a) = (-2; 3)$. Tọa độ của vectơ $-4 vec(a)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(2; -3)$ và $B(6; 1)$. Tọa độ trung điểm $I$ của đoạn thẳng $A B$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(1; 2), B(-2; 4), C(4; 0)$. Tọa độ trọng tâm $G$ của tam giác $A B C$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, độ dài của vectơ $vec(u) = (6; -8)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, khoảng cách giữa hai điểm $M(1; 2)$ và $N(4; 6)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho điểm $A(-3; 5)$. Tọa độ của vectơ vị trí $vec(O A)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (2; -1)$ và $vec(v) = (1; 3)$. Tọa độ của vectơ $vec(w) = 3 vec(u) - 2 vec(v)$ là],
    (
        True([$vec(w) = (4; -9)$]),
        [$vec(w) = (8; -3)$],
        [$vec(w) = (4; 3)$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho điểm $M(2; -4)$. Điểm $M'$ đối xứng với $M$ qua gốc tọa độ $O$ có tọa độ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, vectơ nào sau đây cùng hướng với vectơ đơn vị $vec(i)$ của trục hoành $O x$?],
    (
        True([$vec(u) = (3; 0)$]),
        [$vec(v) = (-3; 0)$],
        [$vec(w) = (0; 3)$],
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho ba điểm $A(-1; 2), B(3; 5)$ và $C(5; -1)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho ba điểm $A(1; 1), B(4; 2)$ và $C(2; 5)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Một robot giao hàng tự hành trong nhà kho thông minh hoạt động trên mặt sàn được mô hình hóa bằng hệ trục tọa độ $O x y$ (đơn vị mỗi trục là mét). Robot xuất phát từ trạm sạc gốc $O(0; 0)$ với vận tốc ban đầu bằng $0$.
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 3)$ và $B(-5; 11)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(a) = (2; -3)$ và $vec(b) = (-1; 5)$. Biết vectơ $vec(u) = 2 vec(a) + 3 vec(b)$ có tọa độ là $(x_0; y_0)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(2; 3), B(-1; 0)$ và trọng tâm $G(1; 2)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho ba điểm $A(1; 2), B(3; 1), C(5; 4)$. Điểm $D(x_D; y_D)$ thỏa mãn tứ giác $A B C D$ là một hình bình hành.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 110], back-to: "sec-exercise-hub",[Trên bản đồ quy hoạch hàng hải (hệ trục $O x y$, đơn vị: hải lý), trạm radar bờ biển đặt tại $A(3; 4)$, một trạm thuỷ văn trên đảo tại $B(15; 9)$. Do ảnh hưởng của địa tầng đáy biển, tuyến cáp ngầm nối $A$ và $B$ phải đi qua một trạm nối trung gian $M$ nằm trên đoạn thẳng $A B$ sao cho thỏa mãn hệ thức vectơ $vec(A M) = 1/4 vec(A B)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 1)!]      #v(0.6em)
