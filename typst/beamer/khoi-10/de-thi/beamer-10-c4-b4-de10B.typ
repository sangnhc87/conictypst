// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 2)
// Lớp: Khối 10  ·  Mã đề: 111  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 2)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 111",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 111]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, điều kiện cần và đủ để hai vectơ $vec(u) = (x_1; y_1)$ và $vec(v) = (x_2; y_2)$ ($vec(v) != vec(0)$) cùng phương là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (2; 3)$ và $vec(v) = (4; m)$. Tìm giá trị của tham số $m$ để hai vectơ $vec(u)$ và $vec(v)$ cùng phương với nhau.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho ba điểm $A(1; 1), B(2; 3)$ và $C(3; 5)$. Khẳng định nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ không cùng phương $vec(a) = (1; 2)$ và $vec(b) = (3; 4)$. Phân tích vectơ $vec(c) = (7; 10)$ theo hai vectơ $vec(a), vec(b)$ ta được
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; -2)$ và $B(3; 2)$. Tọa độ giao điểm $M$ của đường thẳng $A B$ với trục hoành $O x$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hình bình hành $A B C D$ có $A(1; 0), B(0; 2), C(-2; 1)$. Tọa độ tâm $O'$ của hình bình hành là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (-3; 6)$ và $vec(v) = (1; -2)$. Mối quan hệ giữa hai vectơ $vec(u)$ và $vec(v)$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(3; 5), B(1; 2)$ và $C(5; 2)$. Vectơ đường trung tuyến $vec(A M)$ xuất phát từ đỉnh $A$ có phương
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(-2; 4)$ và $B(1; 1)$. Điểm $P$ thuộc đoạn thẳng $A B$ sao cho $vec(A P) = 2 vec(P B)$. Tọa độ của điểm $P$ là],
    (
        True([$P(0; 2)$]),
        [$P(-1; 3)$],
        [$P(0; 3)$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho bốn điểm $A(1; 2), B(3; 6), C(7; 4), D(5; 0)$. Tứ giác $A B C D$ là hình gì?],
    (
        True([Hình bình hành]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, góc giữa vectơ đơn vị $vec(i)$ của trục hoành và vectơ đơn vị $vec(j)$ của trục tung bằng bao nhiêu?],
    (
        True([$90^circ$]),
        [$0^circ$],
        [$180^circ$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, vectơ đối của vectơ $vec(u) = (-5; 7)$ là],
    (
        True([$-vec(u) = (5; -7)$]),
        [$-vec(u) = (-5; -7)$],
        [$-vec(u) = (5; 7)$],
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho ba điểm $A(1; 3), B(2; 5)$ và $C(4; 9)$. Điểm $D$ có tọa độ $D(m; 1)$ với $m in bb(R)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(a) = (2; 1)$ và $vec(b) = (-1; 3)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trên màn hình giám sát radar kiểm soát không lưu (hệ tọa độ $O x y$, đơn vị khoảng cách: kilômét), tại cùng thời điểm $t = 0$:
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho ba điểm $A(1; 2), B(3; 5)$ và $C(x; 11)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (m - 1; 4)$ và $vec(v) = (3; 2)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(-1; 1), B(3; 2), C(1; 5)$. Điểm $D(x_D; y_D)$ thỏa mãn tứ giác $A B C D$ là hình bình hành.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(2; 4)$ và $B(8; 10)$. Điểm $M$ thuộc đoạn thẳng $A B$ sao cho $A M = 2 M B$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Một thiết bị bay không người lái (Drone) tuần tra giám sát an toàn giao thông bay thẳng đều từ điểm chốt kiểm soát $A(10; 15)$ đến điểm chốt $B(70; 95)$ (hệ tọa độ $O x y$, đơn vị: mét) trong thời gian $10$ giây.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 111], back-to: "sec-exercise-hub",[Trong một kho hàng thông minh (mặt sàn được gắn hệ trục tọa độ $O x y$, đơn vị: mét), ba kệ hàng nằm thẳng hàng tại các vị trí $K_1(4; 6), K_2(10; 12)$ và $K_3(16; 18)$. Người ta đặt một trạm tiếp pin tự động tại điểm $I$ là trung điểm của đoạn nối hai kệ hàng ngoài cùng $K_1$ và $K_3$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 2)!]      #v(0.6em)
