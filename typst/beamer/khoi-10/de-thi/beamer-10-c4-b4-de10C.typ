// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 3)
// Lớp: Khối 10  ·  Mã đề: 112  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 3)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 112",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 112]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho điểm $M(3; -5)$. Tọa độ của điểm $M'$ đối xứng với điểm $M$ qua trục hoành $O x$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho điểm $N(-2; 7)$. Tọa độ của điểm $N'$ đối xứng với điểm $N$ qua trục tung $O y$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 3)$ và $B(5; -1)$. Điểm $M$ thỏa mãn hệ thức vectơ $vec(M A) + 3 vec(M B) = vec(0)$. Tọa độ của điểm $M$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(1; 4), B(-2; 2)$ và $C(4; 0)$. Điểm $M$ thuộc trục hoành $O x$ sao cho độ dài của vectơ tổng $vec(v) = vec(M A) + vec(M B) + vec(M C)$ đạt giá trị nhỏ nhất. Tọa độ của điểm $M$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(2; 1)$ và $B(4; 3), C(6; -1)$. Điểm $D$ nằm trên trục tung $O y$ sao cho hai vectơ $vec(A D)$ và $vec(B C)$ cùng phương với nhau. Tọa độ của điểm $D$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(2; 3)$ và $B(6; 7)$. Tọa độ của điểm $A'$ đối xứng với $A$ qua điểm $B$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có ba đỉnh $A(0; 0), B(6; 0)$ và $C(0; 8)$. Tọa độ tâm đường tròn ngoại tiếp của tam giác $A B C$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (2; -1)$ và $vec(v) = (x; 3)$. Độ dài của vectơ tổng $vec(u) + vec(v)$ đạt giá trị nhỏ nhất khi $x$ bằng],
    (
        True([$x = -2$]),
        [$x = 2$],
        [$x = 0$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(1; 1), B(5; 1)$ và $C(1; 4)$. Bán kính đường tròn ngoại tiếp của tam giác $A B C$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hình chữ nhật $A B C D$ có ba đỉnh $A(0; 0), B(a; 0), D(0; b)$ với $a, b > 0$. Tọa độ đỉnh $C$ là],
    (
        True([$C(a; b)$]),
        [$C(b; a)$],
        [$C(a; -b)$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có trọng tâm là $G$. Với điểm $M$ tùy ý trong mặt phẳng, vectơ $vec(v) = 2 vec(M A) + 2 vec(M B) + 2 vec(M C)$ luôn bằng],
    (
        True([$6 vec(M G)$]),
        [$3 vec(M G)$],
        [$2 vec(M G)$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, khoảng cách từ điểm $M(x_0; y_0)$ đến trục hoành $O x$ được tính bằng công thức],
    (
        True([$|y_0|$]),
        [$|x_0|$],
        [$x_0$],
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho ba điểm $A(1; 2), B(-2; 5)$ và $C(4; 1)$. Điểm $I$ trong mặt phẳng thỏa mãn hệ thức vectơ: $2 vec(I A) + 3 vec(I B) - vec(I C) = vec(0)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 4)$ và $B(5; 2)$. Điểm $M(x; 0)$ di động trên trục hoành $O x$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 2)$ và $B(7; 5)$. Điểm $M$ thỏa mãn hệ thức vectơ $vec(M A) + 2 vec(M B) = vec(0)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(2; 3), B(4; 7)$ và $C(6; -1)$. Điểm $M(x; 0)$ thuộc trục hoành $O x$ sao cho biểu thức độ dài $|vec(M A) + vec(M B) + vec(M C)|$ đạt giá trị nhỏ nhất.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho điểm $A(3; 4)$. Điểm $A'$ đối xứng với điểm $A$ qua điểm $I(5; 2)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có ba đỉnh là $A(0; 0), B(6; 0)$ và $C(0; 8)$. Gọi $I$ là tâm đường tròn ngoại tiếp của tam giác $A B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 112], back-to: "sec-exercise-hub",[Trong bài toán đặt trạm bơm tưới tiêu bờ kênh $O x$ cho hai trang trại $A(2; 3)$ và $B(8; 5)$ (đơn vị: kilômét), vị trí đặt trạm bơm $M(x; 0)$ trên bờ kênh sao cho tổng chiều dài đường ống dẫn nước $M A + M B$ đạt giá trị nhỏ nhất.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 10: VECTƠ TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 3)!]      #v(0.6em)
