// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 11: TÍCH VÔ HƯỚNG CỦA HAI VECTƠ (ĐỀ SỐ 1 - NÂNG CAO)
// Lớp: Khối 10  ·  Mã đề: 113  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 11: TÍCH VÔ HƯỚNG CỦA HAI VECTƠ (ĐỀ SỐ 1 - NÂNG CAO)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 113",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 113]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ vuông tại $A$ có $A B = c$ và $A C = b$. Gọi $M$ là trung điểm của cạnh huyền $B C$. Giá trị của tích vô hướng $vec(A M) dot vec(B C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có hai đường trung tuyến $B M$ và $C N$ vuông góc với nhau ($B M perp C N$). Mối quan hệ giữa ba cạnh $a = B C, b = A C, c = A B$ của tam giác là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ có cạnh bằng $a$. Trên cạnh $B C$ lấy điểm $M$ sao cho $B M = 1/3 B C$, trên cạnh $C D$ lấy điểm $N$ sao cho $D N = 1/2 C D$. Tích vô hướng $vec(A M) dot vec(A N)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho hai vectơ $vec(a)$ và $vec(b)$ thỏa mãn $|vec(a)| = 2, |vec(b)| = 3$ và $|vec(a) + 2 vec(b)| = 2 sqrt(7)$. Số đo của góc giữa hai vectơ $vec(a)$ và $vec(b)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có $A B = 4$ và $A D = 3$. Điểm $M$ nằm trên cạnh $C D$ sao cho đường thẳng $A M$ vuông góc với đường chéo $B D$ ($A M perp B D$). Độ dài đoạn thẳng $D M$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có độ dài ba cạnh lần lượt là $a, b, c$ và trọng tâm $G$. Biểu thức tổng bình phương khoảng cách $G A^2 + G B^2 + G C^2$ luôn bằng],
    (
        True([$(a^2 + b^2 + c^2) / 3$]),
        [$(a^2 + b^2 + c^2) / 4$],
        [$(a^2 + b^2 + c^2) / 2$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho hai vectơ $vec(u)$ và $vec(v)$ thỏa mãn $|vec(u)| = 1, |vec(v)| = 2$ và góc $(vec(u), vec(v)) = 120^circ$. Giá trị của tham số thực $k$ để vectơ $vec(x) = vec(u) + k vec(v)$ vuông góc với vectơ $vec(y) = vec(u) - vec(v)$ là],
    (
        True([$k = 2/5$]),
        [$k = 1/2$],
        [$k = -2/5$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có cạnh bằng $a$. Hai điểm $M, N$ thỏa mãn $vec(A M) = 1/3 vec(A B)$ và $vec(A N) = 1/3 vec(A C)$. Tích vô hướng $vec(C M) dot vec(B N)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có $A B = 3, A C = 6$ và $hat(B A C) = 60^circ$. Gọi $A D$ là đường phân giác trong của góc $A$. Độ dài của đoạn thẳng $A D$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Một kiện hàng có khối lượng $m = 10" kg"$ bị kéo trượt đều lên một mặt dốc nghiêng dài $s = 10" m"$, dốc hợp với mặt phẳng ngang một góc $alpha = 30^circ$. Hệ số ma sát trượt giữa kiện hàng và dốc là $mu = 0.1$. Lấy gia tốc trọng trường $g = 10" m/s"^2$. Công của lực ma sát trượt tác dụng lên kiện hàng trong suốt chiều dài dốc bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tứ giác lồi $A B C D$. Điều kiện cần và đủ để hai đường chéo $A C$ và $B D$ vuông góc với nhau là],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ vuông tại $A$. Gọi $H$ là chân đường cao hạ từ $A$ xuống $B C$. Đẳng thức vectơ nào sau đây là đúng?],
    (
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có độ dài hai cạnh $A B = 6, A C = 8$. Hai đường trung tuyến $B M$ và $C N$ vuông góc với nhau tại trọng tâm $G$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho hình thoi $A B C D$ có cạnh bằng $a$ và góc $hat(B A D) = 60^circ$. Lấy điểm $M$ trên cạnh $B C$ sao cho $B M = 2/3 B C$ và điểm $N$ trên cạnh $C D$ sao cho $D N = 1/2 C D$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Một khối hàng công nghiệp có khối lượng $m = 20" kg"$ được máy tời kéo trượt thẳng đều lên đỉnh một con dốc nghiêng có góc dốc $alpha = 30^circ$ so với phương ngang. Chiều dài mặt dốc là $s = 12" m"$. Lực kéo của dây cáp $vec(F)$ có phương song song với mặt dốc hướng lên. Hệ số ma sát trượt giữa khối hàng và mặt dốc là $mu = 0.2$. Lấy gia tốc trọng trường $g = 9.8" m/s"^2$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Một trụ giàn khoan dầu khí ngoài khơi được giữ thăng bằng trên mặt biển nhờ ba sợi dây cáp neo $vec(T)_1, vec(T)_2, vec(T)_3$ gắn vào đáy biển đối xứng tỏa tròn, cùng xuất phát từ tâm trụ $O$. Lực căng của ba dây cáp có độ lớn bằng nhau $T_1 = T_2 = T_3 = 60" kN"$. Góc giữa hai dây cáp bất kỳ đều bằng $120^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có độ dài ba cạnh $A B = 4, A C = 6$ và $B C = 2 sqrt(7)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho hình chữ nhật $A B C D$ có $A B = 6$ và $A D = 4$. Lấy điểm $M$ trên cạnh $C D$ sao cho $A M perp B D$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho hai vectơ $vec(a)$ và $vec(b)$ có độ dài lần lượt là $|vec(a)| = 3, |vec(b)| = 4$ và độ dài vectơ tổng $|vec(a) + vec(b)| = sqrt(37)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có $A B = 3, A C = 6$ và góc $hat(A) = 60^circ$. Gọi $A D$ là đường phân giác trong của góc $A$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Một xe tải chở vật liệu có lực kéo động cơ không đổi $F = 6000" N"$ cùng hướng chuyển động, leo thẳng đều lên một đoạn đường dốc có góc nghiêng $alpha = 15^circ$ so với phương ngang. Khi xe leo được một đoạn dốc dài $s = 200" m"$, công cơ học mà động cơ xe tải đã thực hiện bằng bao nhiêu kilôjun ($"kJ"$)?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 113], back-to: "sec-exercise-hub",[Một tàu lai dắt hỗ trợ đưa sà lan vào âu tàu với lực kéo cáp $F = 40" kN"$ nghiêng một góc $alpha = 60^circ$ so với hướng di chuyển thẳng của sà lan. Tốc độ di chuyển ổn định của sà lan là $v = 3" m/s"$. Công suất kéo cơ học tức thời mà tàu lai dắt truyền cho sà lan bằng bao nhiêu kilôoát ($"kW"$)?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 11: TÍCH VÔ HƯỚNG CỦA HAI VECTƠ (ĐỀ SỐ 1 - NÂNG CAO)!]      #v(0.6em)
