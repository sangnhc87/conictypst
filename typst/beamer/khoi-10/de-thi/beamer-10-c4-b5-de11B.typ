// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 11: TÍCH VÔ HƯỚNG CỦA HAI VECTƠ (ĐỀ SỐ 2 - NÂNG CAO)
// Lớp: Khối 10  ·  Mã đề: 114  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 11: TÍCH VÔ HƯỚNG CỦA HAI VECTƠ (ĐỀ SỐ 2 - NÂNG CAO)",
  subtitle: "ÔN TẬP CHƯƠNG 4 — MÃ ĐỀ: 114",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 114]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có ba đỉnh $A(2; 3), B(4; 1)$ và $C(-2; -1)$. Tọa độ trực tâm $H(x; y)$ của tam giác $A B C$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 4)$ và $B(-2; 1)$. Điểm $D$ nằm trên trục hoành $O x$ sao cho tam giác $A B D$ vuông tại đỉnh $B$ ($vec(B A) perp vec(B D)$). Hoành độ của điểm $D$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (m - 1; 2)$ và $vec(v) = (3; m + 2)$. Tìm tất cả các giá trị của tham số $m$ để góc giữa hai vectơ là góc tù ($hat((vec(u), vec(v))) > 90^circ$).],
    (
        True([$m < - 1/5$ và $m != -4$]),
        [$m < - 1/5$],
        [$m > - 1/5$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có ba đỉnh $A(1; 2), B(3; 0)$ và $C(0; 4)$. Côsin của góc $hat(B A C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(1; 2), B(4; 3)$ và $C(2; 5)$. Côsin của góc $hat(B A C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong cơ học, chất điểm chuyển động thẳng từ vị trí $A(2; 1)$ đến vị trí $B(8; 5)$ (đơn vị tọa độ là mét) dưới tác dụng của một lực không đổi $vec(F) = (12; -5)$ (đơn vị Niutơn). Công cơ học do lực $vec(F)$ thực hiện bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(3; 1)$ và $B(-1; 4)$. Tìm tọa độ điểm $M$ nằm trên trục tung $O y$ sao cho tam giác $M A B$ vuông tại $M$ và có tung độ dương nhỏ hơn $2$.],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hình bình hành $A B C D$ có $A(-2; 3), B(2; 1)$ và $C(4; 5)$. Tích vô hướng của hai vectơ đường chéo $vec(A C) dot vec(B D)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (2; 1)$ và $vec(v) = (-1; 3)$. Gọi $vec(w) = 3 vec(u) - 2 vec(v)$. Tích vô hướng $vec(u) dot vec(w)$ bằng],
    (
        True([$13$]),
        [$15$],
        [$10$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có ba đỉnh $A(1; 1), B(5; 1)$ và $C(1; 4)$. Tọa độ tâm đường tròn ngoại tiếp $I(x; y)$ của tam giác $A B C$ là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có $A(1; 1), B(5; 1)$ và $C(1; 4)$. Tích vô hướng giữa vectơ trung tuyến $vec(A M)$ và vectơ cạnh huyền $vec(B C)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(a) = (3; 4)$ và $vec(b) = (-4; 3)$. Khẳng định nào sau đây là SAI?],
    (
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có ba đỉnh $A(2; 4), B(-1; 1)$ và $C(5; 1)$. Gọi $H$ là trực tâm của tam giác $A B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 2)$ và $B(5; 2)$. Xét tập hợp tất cả các điểm $M(x; y)$ thỏa mãn hệ thức vectơ $vec(M A) dot vec(M B) = 0$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong dây chuyền sản xuất tự động, cánh tay robot di chuyển đầu hàn từ điểm $A(10; 20)$ đến điểm $B(40; 60)$ (đơn vị: milimét) theo một đường thẳng. Lực kẹp giữ chi tiết trong quá trình di chuyển là $vec(F) = (15; -10)$ (đơn vị: Niutơn).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(a) = (2; 1)$ và $vec(b) = (1; 2)$. Tìm giá trị thực của tham số $m$ để vectơ $vec(u) = vec(a) + m vec(b)$ vuông góc với vectơ $vec(v) = vec(a) - vec(b)$.],
    [1],
    loigiai: [
...
// TLN 2 (Câu 18)
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có ba đỉnh $A(2; 3), B(4; 1)$ và $C(-2; -1)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai điểm $A(1; 2)$ và $B(3; 4)$. Điểm $M(x; 0)$ thuộc trục hoành $O x$ sao cho tổng bình phương khoảng cách $M A^2 + M B^2$ đạt giá trị nhỏ nhất.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho hai vectơ $vec(u) = (2; 1)$ và $vec(v) = (3; -1)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Trong một kho hàng thông minh, robot vận chuyển nâng một kiện hàng di chuyển thẳng từ vị trí $A(10; 10)$ đến vị trí $B(50; 40)$ (hệ tọa độ gắn trên sàn kho, đơn vị: centimét). Lực kéo do động cơ tác dụng lên khung xe là $vec(F) = (20; 15)$ (đơn vị: Niutơn).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 114], back-to: "sec-exercise-hub",[Một cột tháp phát sóng truyền hình có chân tháp đặt tại gốc tọa độ $O(0; 0)$, đỉnh tháp là điểm $S(0; 30)$ (đơn vị: mét) trên trục tung thẳng đứng. Hai dây cáp neo được cố định xuống mặt đất tại hai điểm $A(-45; 0)$ và $B(x; 0)$ ($x > 0$) trên trục hoành. Hai sợi cáp $S A$ và $S B$ vuông góc với nhau tại đỉnh tháp ($S A perp S B$).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 11: TÍCH VÔ HƯỚNG CỦA HAI VECTƠ (ĐỀ SỐ 2 - NÂNG CAO)!]      #v(0.6em)
