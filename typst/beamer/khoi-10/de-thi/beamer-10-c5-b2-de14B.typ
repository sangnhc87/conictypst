// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 14: CÁC SỐ ĐẶC TRƯNG ĐO ĐỘ PHÂN TÁN (ĐỀ B: VẬN DỤNG & THỰC TIỄN)
// Lớp: Khối 10  ·  Mã đề: 126  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 14: CÁC SỐ ĐẶC TRƯNG ĐO ĐỘ PHÂN TÁN (ĐỀ B: VẬN DỤNG & THỰC TIỄN)",
  subtitle: "CHƯƠNG V: CÁC SỐ ĐẶC TRƯNG ĐO ĐỘ PHÂN TÁN — MÃ ĐỀ: 126",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 126]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Một chuyên gia tài chính theo dõi tỉ suất sinh lời hàng năm của hai mã cổ phiếu $X$ và $Y$ trong $5$ năm gần đây. Cả hai cổ phiếu đều có tỉ suất sinh lời trung bình là $12%$/năm. Độ lệch chuẩn tỉ suất sinh lời của cổ phiếu $X$ là $s_X = 2.5%$ và của cổ phiếu $Y$ là $s_Y = 6.2%$. Kết luận nào sau đây là chuẩn xác nhất trong phân tích đầu tư?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Sản lượng tôm xuất khẩu (tấn/ngày) của một hợp tác xã thủy sản trong $8$ ngày thu hoạch liên tiếp là:
#align(center)[
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Thời gian sạc pin từ $20%$ lên $80%$ (tính bằng phút) của một dòng xe máy điện thông minh được đo trên $9$ xe thử nghiệm:
#align(center)[
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Một xưởng may thống kê số áo hoàn thành mỗi ngày của một thợ may giỏi trong $5$ ngày làm việc: $18; 20; 20; 22; 25$. Phương sai mẫu $s^2$ của số áo hoàn thành bằng],
    (
        True([$5.6$]),
        [$6.0$],
        [$2.37$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Biểu đồ hộp CeTZ dưới đây so sánh thời gian phục vụ một khách hàng (tính bằng giây) tại hai quầy thu ngân $A$ và $B$ của một siêu thị:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Cho mẫu số liệu điểm kiểm tra có tứ phân vị thứ nhất $Q_1 = 16$ và khoảng tứ phân vị $Delta_Q = 6$. Ngưỡng rào dưới $T_1$ để xác định các giá trị bất thường nhỏ hơn ngưỡng này là],
    (
        True([$T_1 = 7$]),
        [$T_1 = 10$],
        [$T_1 = 9$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Đo đường kính (milimét) của các chi tiết máy gia công cơ khí chính xác được phân bố trong bảng tần số sau:
#align(center)[
  #table(
    columns: 6,
    align: center,
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Nếu tất cả các giá trị của một mẫu số liệu đều được nhân với một hằng số $k = 3$, phương sai của mẫu số liệu mới sẽ],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Khảo sát số lượng tin nhắn rác mà $8$ thuê bao di động nhận được trong tuần:
#align(center)[
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Trong sản xuất công nghiệp, một dây chuyền đóng gói sữa hộp tự động có khối lượng ghi trên bao bì là $180" g"$. Khối lượng thực tế đóng gói có độ lệch chuẩn $s = 0.5" g"$. Sau khi bảo dưỡng và hiệu chỉnh cảm biến, độ lệch chuẩn giảm xuống còn $s' = 0.2" g"$. Điều này chứng tỏ],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Cho mẫu số liệu $5$ số: $10; quad 10; quad 10; quad 10; quad 10$. Phương sai $s^2$ của mẫu số liệu này bằng],
    (
        True([$0$]),
        [$10$],
        [$5$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Cho mẫu số liệu về thời gian phản xạ (mili-giây) của một game thủ chuyên nghiệp: $150; 155; 160; 165; 170$. Độ lệch chuẩn $s$ của mẫu số liệu này bằng],
    (
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Một nhà đầu tư cá nhân phân tích lịch sử tăng trưởng lợi nhuận (%) trong $6$ tháng gần nhất của hai quỹ đầu tư tài chính:
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Kỹ sư chất lượng đo nồng độ vi hạt bụi (đơn vị: hạt/$"m"^3$) trong phòng sạch chế tạo chip bán dẫn trong $10$ ca sản xuất liên tiếp:
#align(center)[
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Một mẫu số liệu nhiệt độ đo bằng độ Celsius ($""^circ"C"$) có khoảng biến thiên $R_C = 15^circ"C"$, khoảng tứ phân vị $Delta_Q(C) = 6^circ"C"$, và độ lệch chuẩn $s_C = 4^circ"C"$. Người ta chuyển đổi toàn bộ mẫu sang thang nhiệt độ Fahrenheit ($""^circ"F"$) theo công thức liên hệ: $F_i = 1.8 C_i + 32$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Cho một mẫu số liệu gồm $n$ phần tử ($n >= 4$) có số trung bình là $overline(x)$ và phương sai là $s^2 > 0$. Ta lập một mẫu số liệu mới bằng cách bổ sung thêm một phần tử mới có giá trị đúng bằng $overline(x)$ (mẫu mới có $n + 1$ phần tử).
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Thời gian xếp hàng chờ thanh toán (tính bằng phút) của $7$ khách hàng tại một quầy tiện ích là:
#align(center)[
...
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Lượng điện năng tiêu thụ (kWh) trong một tháng của $8$ hộ gia đình trong một khu chung cư là:
#align(center)[
...
// TLN 3 (Phương sai)
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Cho mẫu số liệu khảo sát số giờ tự học trong ngày của $5$ học sinh: $1; quad 2; quad 3; quad 4; quad 5$.
...
// TLN 4 (Độ lệch chuẩn)
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Cho mẫu số liệu điểm kiểm tra gồm $5$ giá trị: $5; quad 7; quad 8; quad 9; quad 11$.
...
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Một mẫu số liệu thống kê mức chi tiêu có tứ phân vị thứ nhất $Q_1 = 35$ triệu đồng và tứ phân vị thứ ba $Q_3 = 45$ triệu đồng.
...
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 126], back-to: "sec-exercise-hub",[Cho mẫu số liệu $x_1, x_2, dots, x_n$ có độ lệch chuẩn $s_x = 4$.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 14: CÁC SỐ ĐẶC TRƯNG ĐO ĐỘ PHÂN TÁN (ĐỀ B: VẬN DỤNG & THỰC TIỄN)!]      #v(0.6em)
