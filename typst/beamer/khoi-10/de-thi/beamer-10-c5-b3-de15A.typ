// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ A: CƠ BẢN - VẬN DỤNG)
// Lớp: Khối 10  ·  Mã đề: 128  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ A: CƠ BẢN - VẬN DỤNG)",
  subtitle: "CHƯƠNG V: CÁC SỐ ĐẶC TRƯNG ĐO XU THẾ TRUNG TÂM VÀ ĐO ĐỘ PHÂN TÁN — MÃ ĐỀ: 128",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 128]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Sử dụng máy tính cầm tay tìm giá trị của $sqrt(8) = 2.82842712 dots$. Làm tròn số $sqrt(8)$ với độ chính xác $d = 0.005$ ta được kết quả là],
    (
        True([$2.83$]),
        [$2.82$],
        [$2.828$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Đo chiều dài của một sân bóng đá tiêu chuẩn thu được kết quả $a = 105 text(" m") plus.minus 0.2 text(" m")$. Đánh giá sai số tương đối $delta_a$ của phép đo này bằng],
    (
        True([$delta_a <= 0.19%$]),
        [$delta_a <= 0.02%$],
        [$delta_a <= 1.9%$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Điểm kiểm tra giữa kỳ môn Tiếng Anh của $8$ học sinh lần lượt là:
#align(center)[
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Thời gian tự học ở nhà mỗi ngày (tính bằng phút) của $10$ học sinh ghi nhận như sau:
#align(center)[
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Khảo sát cỡ giày thể thao của $25$ học sinh nam lớp 10 thu được bảng tần số sau:
#align(center)[
  #table(
    columns: 6,
    align: center,
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Nhiệt độ đo được lúc $12$ giờ trưa trong $7$ ngày liên tiếp tại một trạm quan trắc là:
#align(center)[
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Biểu đồ hộp (Box plot) CeTZ dưới đây biểu diễn kết quả điểm thi đánh giá năng lực của một nhóm thí sinh:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Theo quy tắc hàng rào Tukey, một giá trị $x$ trong mẫu số liệu được coi là giá trị bất thường (outlier) nếu],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Một mẫu số liệu thống kê thời gian chờ xe buýt có phương sai $s^2 = 25 text(" phút")^2$. Độ lệch chuẩn $s$ của mẫu số liệu bằng],
    (
        True([$5$ phút]),
        [$25$ phút],
        [$12.5$ phút],
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Hai xạ thủ bắn súng $A$ và $B$ mỗi người thực hiện $10$ phát bắn. Kết quả ghi nhận cả hai cùng có số điểm trung bình là $overline(x) = 9.2$ điểm, nhưng độ lệch chuẩn điểm số của xạ thủ $A$ là $s_A = 0.4$ điểm và xạ thủ $B$ là $s_B = 1.1$ điểm. Khẳng định nào sau đây là đúng?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Nếu tất cả các giá trị của một mẫu số liệu đều được cộng thêm một số thực $c = 10$, khẳng định nào sau đây là sai?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Cho mẫu số liệu gồm $4$ giá trị: $2; quad 4; quad 6; quad 8$. Phương sai $s^2$ của mẫu số liệu bằng],
    (
        True([$5$]),
        [$4$],
        [$2.24$],
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Kỹ sư trắc địa đo chiều dài $a$ và chiều rộng $b$ của một khu đất hình chữ nhật thu được kết quả:
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Thống kê điểm bài thi đánh giá năng lực Toán của hai lớp 10A và 10B (mỗi lớp có $10$ học sinh đại diện) như sau:
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Khối lượng (gam) của $10$ gói kẹo đóng tự động ghi nhận trong một mẻ sản xuất:
#align(center)[
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Cho mẫu số liệu $x_1, x_2, dots, x_n$ có số trung bình $overline(x) = 20$, trung vị $M_e = 18$, độ lệch chuẩn $s_x = 4$ và khoảng biến thiên $R_x = 12$. Ta lập mẫu số liệu mới bằng phép biến đổi $y_i = 3 x_i + 5$.
Xét tính đúng sai của các nhận định sau:],
  (
...
// TLN 1 (Số trung bình)
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Cho mẫu số liệu điểm kiểm tra thường xuyên của một nhóm học sinh:
#align(center)[
...
// TLN 2 (Trung vị)
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Thời gian gọi điện thoại tư vấn (phút) của một nhân viên trong $7$ cuộc gọi liên tiếp là:
#align(center)[
...
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Sản lượng cam thu hoạch (tạ/ngày) trong $6$ ngày của một nông trường là:
#align(center)[
...
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Số lượng sách đọc được trong năm của $8$ thành viên một câu lạc bộ là:
#align(center)[
...
// TLN 5 (Phương sai)
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Cho mẫu số liệu gồm $4$ giá trị: $1; quad 3; quad 5; quad 7$.
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 128], back-to: "sec-exercise-hub",[Một mẫu số liệu thống kê thu nhập có tứ phân vị thứ nhất $Q_1 = 15$ triệu đồng và tứ phân vị thứ ba $Q_3 = 25$ triệu đồng.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ A: CƠ BẢN - VẬN DỤNG)!]      #v(0.6em)
