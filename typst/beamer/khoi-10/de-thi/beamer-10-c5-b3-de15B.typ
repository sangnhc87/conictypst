// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ B: VẬN DỤNG & THỰC TIỄN)
// Lớp: Khối 10  ·  Mã đề: 129  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ B: VẬN DỤNG & THỰC TIỄN)",
  subtitle: "CHƯƠNG V: CÁC SỐ ĐẶC TRƯNG ĐO XU THẾ TRUNG TÂM VÀ ĐO ĐỘ PHÂN TÁN — MÃ ĐỀ: 129",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 129]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Gia công một trục thép kỹ thuật có đường kính đo được là $d = 20.0 text(" cm") plus.minus 0.1 text(" cm")$. Sai số tương đối $delta_d$ của phép đo đường kính này thỏa mãn],
    (
        True([$delta_d <= 0.5%$]),
        [$delta_d <= 0.05%$],
        [$delta_d <= 5.0%$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Làm tròn số $pi approx 3.14159265 dots$ với độ chính xác $d = 0.001$ ta được kết quả là],
    (
        True([$3.142$]),
        [$3.141$],
        [$3.14$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Một sinh viên đại học hoàn thành $3$ học phần trong học kỳ với số tín chỉ và điểm số tương ứng:
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Thời gian làm thủ tục nhận phòng (tính bằng phút) của $9$ đoàn khách tại một khu nghỉ dưỡng là:
#align(center)[
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Biểu đồ hộp CeTZ dưới đây so sánh năng suất thu hoạch lúa (tạ/ha) của hai cánh đồng thử nghiệm giống mới ($X$) và giống truyền thống ($Y$):
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Khảo sát mẫu số liệu tiêu thụ điện có $Q_1 = 120$ kWh và $Q_3 = 180$ kWh. Ngưỡng dưới $T_1$ để nhận diện các chỉ số điện thấp bất thường theo quy tắc hàng rào là],
    (
        True([$T_1 = 30$ kWh]),
        [$T_1 = 60$ kWh],
        [$T_1 = 40$ kWh],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Số lượng cuộc gọi tiếp nhận mỗi giờ tại một trung tâm cứu hộ trong $5$ giờ cao điểm: $10; quad 12; quad 14; quad 16; quad 18$. Phương sai $s^2$ của mẫu số liệu bằng],
    (
        True([$8.0$]),
        [$2.83$],
        [$10.0$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Số lít xăng tiêu thụ trên $100 text(" km")$ của $7$ dòng xe ô tô tiết kiệm nhiên liệu:
#align(center)[
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Khi chuyển đổi tiền tệ từ USD sang VNĐ với tỷ giá $1 text(" USD") = 25000 text(" VNĐ")$, toàn bộ mức lương của nhân viên một công ty đa quốc gia được nhân với hệ số $25000$. Độ lệch chuẩn của mẫu số liệu lương mới sẽ],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Hai kỹ sư cơ khí kiểm tra độ chính xác của hai robot lắp ráp trục $A$ và $B$. Sau $100$ lần lắp ráp, cả hai robot đều đạt độ lệch tâm trung bình là $0.02 text(" mm")$, nhưng độ lệch chuẩn của Robot $A$ là $s_A = 0.003 text(" mm")$ và Robot $B$ là $s_B = 0.008 text(" mm")$. Nhận xét nào sau đây là đúng?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Thời gian sạc đầy pin (giờ) của một dòng tai nghe không dây ở $8$ lần thử nghiệm:
#align(center)[
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Cho mẫu số liệu có bảng phân bố tần số:
#align(center)[
  #table(
    columns: 5,
    align: center,
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Kỹ sư đo bán kính đáy $r$ và chiều cao $h$ của một bồn chứa dầu nhiên liệu hình trụ:
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Hai công ty giao hàng $A$ và $B$ cùng vận chuyển hàng trên cùng một tuyến đường nội đô. Thống kê thời gian giao hàng (phút) của $10$ đơn hàng mỗi công ty như sau:
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Nhiệt độ ($""^circ"C"$) trong kho lạnh bảo quản vắc xin y tế được ghi nhận tự động vào lúc $6$ giờ sáng trong $10$ ngày liên tiếp:
#align(center)[
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Cho mẫu số liệu $x_1, x_2, dots, x_n$ ($n >= 3$) có số trung bình $overline(x)$ và độ lệch chuẩn $s > 0$. Người ta chuẩn hóa từng số liệu thành chỉ số $z_i = (x_i - overline(x)) / s$.
...
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Một học sinh có điểm kiểm tra thường xuyên là $8.0$ (hệ số $1$), điểm kiểm tra giữa kỳ là $7.0$ (hệ số $2$) và điểm kiểm tra cuối kỳ là $9.0$ (hệ số $3$).
...
// TLN 2 (Trung vị)
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Tốc độ truyền dữ liệu internet (Mbps) tại $8$ thời điểm trong ngày ghi nhận là:
#align(center)[
...
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Thời gian chờ đèn đỏ (giây) tại một ngã tư trong $6$ chu kỳ liên tiếp là:
#align(center)[
...
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Điểm thi môn Ngữ văn của $10$ học sinh đạt giải cấp trường là:
#align(center)[
...
// TLN 5 (Phương sai)
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Cho mẫu số liệu điểm đánh giá chất lượng gồm $5$ số: $2; quad 4; quad 6; quad 8; quad 10$.
...
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 129], back-to: "sec-exercise-hub",[Mẫu số liệu thời lượng sử dụng màn hình điện thoại (giờ/ngày) có $Q_1 = 3.5$ giờ và $Q_3 = 6.5$ giờ.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ B: VẬN DỤNG & THỰC TIỄN)!]      #v(0.6em)
