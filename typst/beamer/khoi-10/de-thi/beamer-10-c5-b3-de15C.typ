// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ C: NÂNG CAO - VD, VDC)
// Lớp: Khối 10  ·  Mã đề: 130  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ C: NÂNG CAO - VD, VDC)",
  subtitle: "CHƯƠNG V: CÁC SỐ ĐẶC TRƯNG ĐO XU THẾ TRUNG TÂM VÀ ĐO ĐỘ PHÂN TÁN — MÃ ĐỀ: 130",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 130]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Cho mẫu số liệu gồm $5$ giá trị: $2; quad 4; quad 6; quad 8; quad x$. Biết rằng số trung bình của mẫu số liệu này bằng $6.0$. Phương sai $s^2$ của mẫu số liệu bằng],
    (
        True([$8.0$]),
        [$4.0$],
        [$2.83$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Một nhà nghiên cứu thống kê một mẫu số liệu gồm $n = 10$ quan sát. Sử dụng máy tính cầm tay thu được $sum_(i=1)^(10) x_i = 80$ và $sum_(i=1)^(10) x_i^2 = 720$. Phương sai $s^2$ của mẫu số liệu trên bằng],
    (
        True([$8$]),
        [$64$],
        [$72$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Cho $5$ vị trí dân cư trên trục đường thẳng $O x$ có tọa độ lần lượt là $x_1 = 1, x_2 = 3, x_3 = 5, x_4 = 7, x_5 = 9$. Người ta cần xây dựng một trạm y tế tại vị trí $c$ sao cho tổng khoảng cách di chuyển từ các điểm dân cư đến trạm $f(c) = sum_(i=1)^5 |x_i - c|$ đạt giá trị nhỏ nhất. Tọa độ tối ưu của trạm y tế là],
    (
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Hệ số biến thiên $C V = s / overline(x) dot 100%$ được dùng để so sánh độ rủi ro tương đối giữa hai danh mục đầu tư:
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Biểu đồ hộp CeTZ dưới đây mô tả sự phân bố thời gian xử lý yêu cầu (giây) của một hệ thống máy chủ cơ sở dữ liệu:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Một doanh nghiệp áp dụng chính sách điều chỉnh lương cho nhân viên theo công thức $y_i = 1.1 x_i + 500$ (nghìn đồng), trong đó $x_i$ là mức lương cũ. Nếu mẫu số liệu lương cũ có phương sai $s_x^2 = 100$, thì phương sai của mẫu số liệu lương mới $s_y^2$ bằng],
    (
        True([$121$]),
        [$110$],
        [$600$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Đo cạnh $a$ của một khối lập phương thu được kết quả $a = 10 text(" cm") plus.minus 0.05 text(" cm")$. Đánh giá sai số tương đối $delta_V$ của phép tính thể tích $V = a^3$ bằng],
    (
        True([$delta_V <= 1.5%$]),
        [$delta_V <= 0.5%$],
        [$delta_V <= 0.15%$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Một mẫu số liệu gồm $n$ quan sát có khoảng tứ phân vị bằng $0$ ($Delta_Q = 0$). Điều này chứng tỏ],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Cho mẫu số liệu gồm $4$ số: $3; quad 5; quad 7; quad x$ với $x > 7$. Biết khoảng biến thiên của mẫu số liệu bằng $R = 10$. Giá trị của $x$ bằng],
    (
        True([$13$]),
        [$10$],
        [$17$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Trong kiểm soát chất lượng quy trình công nghiệp Six Sigma, với mẫu dữ liệu tuân theo phân bố chuẩn có số trung bình $overline(x)$ và độ lệch chuẩn $s$, khoảng giá trị $(overline(x) - 2s; overline(x) + 2s)$ sẽ chứa xấp xỉ bao nhiêu phần trăm dữ liệu?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Khảo sát điểm thi của $10$ học sinh: $4; 5; 6; 6; 6; 7; 8; 8; 8; 9$. Nhận xét nào sau đây là đúng về mốt của mẫu số liệu?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Một mẫu số liệu có độ lệch chuẩn $s = 5$. Nếu ta nhân tất cả các giá trị của mẫu số liệu với $-2$ thì phương sai của mẫu số liệu mới bằng],
    (
        True([$100$]),
        [$-50$],
        [$50$],
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Trên tuyến đường thẳng quốc lộ, ba nhà máy $A, B, C$ đặt tại các mốc km tương ứng: $x_A = 10, x_B = 20, x_C = 60$. Một trung tâm kho vận cần chọn vị trí $x$ trên quốc lộ để xây dựng.
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Hai nhóm công nhân sản xuất linh kiện điện tử:
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Cho mẫu số liệu điểm kiểm tra của $9$ học sinh ban đầu:
#align(center)[
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Cho mẫu số liệu $1; quad 3; quad 5; quad 7; quad m$ với $m$ là số thực thay đổi.
...
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Một mẫu số liệu gồm $n = 6$ quan sát có tổng các giá trị $sum_(i=1)^6 x_i = 36$ và tổng các bình phương $sum_(i=1)^6 x_i^2 = 276$.
...
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Khảo sát thời gian di chuyển (phút) đến cơ quan của $10$ nhân viên:
#align(center)[
...
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Cho mẫu số liệu gồm $4$ số: $2; quad 5; quad 8; quad x$.
...
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Một mẫu số liệu thống kê doanh số bán hàng có số trung bình $overline(x) = 80$ triệu đồng và độ lệch chuẩn $s = 6$ triệu đồng.
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Một mẫu số liệu đo đạc có tứ phân vị thứ nhất $Q_1 = 40$ và tứ phân vị thứ ba $Q_3 = 60$.
...
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 130], back-to: "sec-exercise-hub",[Cho mẫu số liệu $x_1, x_2, dots, x_n$ có phương sai $s_x^2 = 16$.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI TẬP CUỐI CHƯƠNG V: ÔN TẬP TỔNG HỢP CHƯƠNG V (ĐỀ C: NÂNG CAO - VD, VDC)!]      #v(0.6em)
