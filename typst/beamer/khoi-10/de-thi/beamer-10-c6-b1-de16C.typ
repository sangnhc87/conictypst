// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 15: HÀM SỐ VÀ ĐỒ THỊ (ĐỀ SỐ 16C - NÂNG CAO & VDC)
// Lớp: Khối 10  ·  Mã đề: 139  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 15: HÀM SỐ VÀ ĐỒ THỊ (ĐỀ SỐ 16C - NÂNG CAO & VDC)",
  subtitle: "CHƯƠNG VI: HÀM SỐ, ĐỒ THỊ VÀ ỨNG DỤNG — MÃ ĐỀ: 139",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 139]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Tập xác định của hàm số $y = sqrt(x + 1) + sqrt(4 - x) / (x - 2)$ là],
    (
        True([$[-1; 4] setminus {2}$]),
        [$[-1; 4]$],
        [$(-1; 4) setminus {2}$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Tập xác định của hàm số $y = sqrt((x - 1)^2 (x + 3))$ là],
    (
        True([$[-3; +infinity)$]),
        [$( -infinity; -3]$],
        [$(-3; +infinity)$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Cho hàm số phân nhánh:
$ f(x) = cases(
  x^2 - 1 &text("khi") x >= 0,
  2x - 3 &text("khi") x < 0
) $
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Cho hàm số $f(x) = 2x^2 - 4x + 5$. Số nghiệm thực của phương trình $f(x) = f(3)$ là],
    (
        True([$2$]),
        [$1$],
        [$0$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Đồ thị của hàm số $y = a x^2 + b x$ đi qua hai điểm $A(1; 2)$ và $B(-2; 10)$. Giá trị của tổng $a + b$ bằng],
    (
        True([$2$]),
        [$4$],
        [$-2$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Hàm số nào sau đây là HÀM SỐ CHẴN trên tập xác định của nó?],
    (
        True([$y = x^4 - 2x^2 + 3$]),
        [$y = x^3 - 3x$],
        [$y = 2x + 1$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Hàm số nào sau đây là HÀM SỐ LẺ trên tập xác định của nó?],
    (
        True([$y = x^3 - 4x$]),
        [$y = x^2 + 2$],
        [$y = |x|$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Tập giá trị $T$ của hàm số phân thức $y = (x - 2) / (x + 1)$ là],
    (
        True([$RR setminus {1}$]),
        [$RR setminus {-1}$],
        [$RR setminus {2}$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để hàm số $y = (m^2 - 4)x + 2m - 1$ là hàm hằng trên toàn trục số thực $RR$.],
    (
        True([$m = plus.minus 2$]),
        [$m = 2$],
        [$m = -2$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Cho đồ thị hàm số $y = f(x)$ xác định trên đoạn $[-3; 3]$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Số lượng vi khuẩn trong một môi trường nuôi cấy sau $t text(" (giờ)")$ được ước tính bởi hàm số:
$ N(t) = 500 + 200 t^2 $
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Đồ thị của hàm số $y = 2x - 6$ tạo với hai trục tọa độ một tam giác vuông có diện tích bằng],
    (
        True([$9$]),
        [$18$],
        [$6$],
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Cho hàm số $y = f(x) = x^4 - 4x^2 + 3$ xác định trên toàn trục số thực $RR$.
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Cho hàm số $y = f(x) = sqrt(x - m) + 1 / sqrt(2m + 8 - x)$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Một xưởng cơ khí nhận hợp đồng gia công các thùng chứa dạng hình hộp chữ nhật không nắp có đáy là hình vuông cạnh $x text(" (m)")$ ($x > 0$) và chiều cao $h text(" (m)")$.
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Cho hàm số $f(x) = (m - 1)x^3 + 3x$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Tìm số giá trị nguyên của tham số $m in [-10; 10]$ để hàm số $y = sqrt(x - 3m + 6)$ xác định với mọi $x in [3; +infinity)$.],
    [14],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Cho hàm số:
$ f(x) = cases(
...
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, đồ thị của hàm số bậc nhất $y = a x + b$ đi qua điểm $M(2; 7)$ và song song với đường thẳng $y = 3x - 1$.
...
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Tìm giá trị nhỏ nhất của hàm số $f(x) = x + 4 / x$ trên khoảng $(0; +infinity)$.],
    [4],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Một quả bóng được ném thẳng đứng lên cao từ mặt đất. Độ cao $h(t) text(" (m)")$ của quả bóng so với mặt đất sau $t text(" (giây)")$ được xác định bởi hàm số:
$ h(t) = 20t - 5t^2 $
...
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 139], back-to: "sec-exercise-hub",[Tính số giao điểm của parabol $y = x^2 - 3x + 2$ và đường thẳng $y = x - 2$ trên mặt phẳng tọa độ $O x y$.],
    [1],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 15: HÀM SỐ VÀ ĐỒ THỊ (ĐỀ SỐ 16C - NÂNG CAO & VDC)!]      #v(0.6em)
