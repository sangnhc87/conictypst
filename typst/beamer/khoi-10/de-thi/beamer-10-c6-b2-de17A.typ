// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 16: HÀM SỐ BẬC HAI (ĐỀ SỐ 17A - CƠ BẢN ĐẾN VẬN DỤNG)
// Lớp: Khối 10  ·  Mã đề: 140  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 16: HÀM SỐ BẬC HAI (ĐỀ SỐ 17A - CƠ BẢN ĐẾN VẬN DỤNG)",
  subtitle: "CHƯƠNG VI: HÀM SỐ, ĐỒ THỊ VÀ ỨNG DỤNG — MÃ ĐỀ: 140",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 140]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Tọa độ đỉnh $I$ của parabol $y = x^2 - 4x + 3$ là],
    (
        True([$I(2; -1)$]),
        [$I(-2; 15)$],
        [$I(4; 3)$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Trục đối xứng của parabol $y = -2x^2 + 8x - 5$ là đường thẳng có phương trình],
    (
        True([$x = 2$]),
        [$x = -2$],
        [$x = 4$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Khẳng định nào sau đây là ĐÚNG về bề lõm của đồ thị hàm số $y = -3x^2 + 2x - 1$?],
    (
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Giao điểm của parabol $y = x^2 - 5x + 4$ với trục hoành $O x$ là],
    (
        True([$A(1; 0)$ và $B(4; 0)$]),
        [$A(-1; 0)$ và $B(-4; 0)$],
        [$A(0; 4)$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Giao điểm của parabol $y = 2x^2 - 3x + 7$ với trục tung $O y$ là điểm có tọa độ],
    (
        True([$M(0; 7)$]),
        [$N(7; 0)$],
        [$P(0; -3)$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Hàm số bậc hai $y = x^2 - 6x + 8$ NGHỊCH BIẾN trên khoảng nào sau đây?],
    (
        True([$(-infinity; 3)$]),
        [$(3; +infinity)$],
        [$(-infinity; 6)$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Hàm số bậc hai $y = -x^2 + 4x + 1$ ĐỒNG BIẾN trên khoảng nào sau đây?],
    (
        True([$(-infinity; 2)$]),
        [$(2; +infinity)$],
        [$(-infinity; 4)$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Giá trị nhỏ nhất của hàm số $y = x^2 - 2x + 5$ trên toàn trục số thực $RR$ bằng],
    (
        True([$4$]),
        [$5$],
        [$1$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Giá trị lớn nhất của hàm số $y = -x^2 + 6x - 2$ trên toàn trục số thực $RR$ bằng],
    (
        True([$7$]),
        [$3$],
        [$-2$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Cho parabol $(P): y = a x^2 + b x + c$ đi qua gốc tọa độ $O(0; 0)$ và có đỉnh là $I(1; -2)$. Phương trình của parabol là],
    (
        True([$y = 2x^2 - 4x$]),
        [$y = x^2 - 2x$],
        [$y = -2x^2 + 4x$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Bác Nam sử dụng $40 text(" m")$ lưới thép để rào một mảnh vườn hình chữ nhật tựa vào một bức tường gạch có sẵn (chỉ cần rào ba cạnh còn lại).
#align(center)[
#cetz.canvas({
  import cetz.draw: *
  // Tường gạch
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Cho parabol $y = a x^2 + b x + c$ có đồ thị nằm hoàn toàn phía trên trục hoành $O x$ và có bề lõm quay lên trên. Mệnh đề nào sau đây là ĐÚNG?],
    (
        True([$a > 0$ và $Delta < 0$]),
        [$a > 0$ và $Delta > 0$],
        [$a < 0$ và $Delta < 0$],
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Cho parabol $(P): y = -x^2 + 2x + 3$ có đồ thị trên mặt phẳng tọa độ $O x y$ như sau:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Cho parabol $(P): y = a x^2 + b x + c$ ($a != 0$) đi qua điểm $A(0; -1)$, điểm $B(1; -2)$ và có trục đối xứng là đường thẳng $x = 2$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Một quả pháo hoa tầm thấp được bắn thẳng lên không trung từ giàn phóng cao $10 text(" m")$ so với mặt đất.
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Cho hàm số bậc hai $f(x) = x^2 - 4x + 1$ xác định trên đoạn $[0; 3]$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Tìm hoành độ đỉnh $x_I$ của parabol $y = 3x^2 - 12x + 7$.],
    [2],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Tìm giá trị nhỏ nhất của hàm số bậc hai $y = 2x^2 - 8x + 11$ trên toàn trục số thực $RR$.],
    [3],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Tìm giá trị của tham số $m$ để đỉnh của parabol $y = x^2 - 2x + m$ nằm trên đường thẳng $d: y = 2x + 1$.],
    [4],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Một mảnh đất hình chữ nhật có chu vi bằng $60 text(" m")$.
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Đồ thị của hàm số $y = x^2 - 4x + 3$ cắt trục hoành $O x$ tại bao nhiêu điểm phân biệt?],
    [2],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 140], back-to: "sec-exercise-hub",[Một vận động viên đánh một quả bóng chày bay lên. Độ cao $y text(" (m)")$ của quả bóng so với mặt đất phụ thuộc vào khoảng cách ngang $x text(" (m)")$ theo công thức:
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 16: HÀM SỐ BẬC HAI (ĐỀ SỐ 17A - CƠ BẢN ĐẾN VẬN DỤNG)!]      #v(0.6em)
