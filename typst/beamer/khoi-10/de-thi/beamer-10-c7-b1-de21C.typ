// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 19: PHƯƠNG TRÌNH ĐƯỜNG THẲNG (ĐỀ SỐ 21C - NÂNG CAO & VDC)
// Lớp: Khối 10  ·  Mã đề: 157  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 19: PHƯƠNG TRÌNH ĐƯỜNG THẲNG (ĐỀ SỐ 21C - NÂNG CAO & VDC)",
  subtitle: "CHƯƠNG VII: PHƯƠNG PHÁP TỌA ĐỘ TRONG MẶT PHẲNG — MÃ ĐỀ: 157",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 157]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Trong mặt phẳng $O x y$, đường thẳng đi qua điểm $M(2; -1)$ và tạo với hai trục tọa độ một tam giác cân có phương trình là],
    (
        True([$x + y - 1 = 0$]),
        [$x + y + 1 = 0$],
        [$2x + y - 3 = 0$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có các đường thẳng chứa hai cạnh $A B$ và $A C$ lần lượt là $2x - y + 1 = 0$ và $x + 2y - 7 = 0$. Tọa độ của đỉnh $A$ là],
    (
        True([$A(1; 3)$]),
        [$A(2; 5)$],
        [$A(-1; -1)$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Điểm $M$ thuộc đường thẳng $d: x - y + 1 = 0$ sao cho khoảng cách từ gốc tọa độ $O$ đến $M$ đạt giá trị nhỏ nhất có tọa độ là],
    (
        True([$M(- 1 / 2; 1 / 2)$]),
        [$M(0; 1)$],
        [$M(-1; 0)$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có đỉnh $A(1; 2)$ và cạnh $B C$ nằm trên đường thẳng $d: x - 2y + 8 = 0$. Phương trình đường cao $A H$ kẻ từ đỉnh $A$ là],
    (
        True([$2x + y - 4 = 0$]),
        [$2x + y + 4 = 0$],
        [$x - 2y + 3 = 0$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Tọa độ hình chiếu vuông góc $H$ của điểm $P(4; 1)$ lên đường thẳng $Delta: x - y + 1 = 0$ là],
    (
        True([$H(2; 3)$]),
        [$H(1; 2)$],
        [$H(3; 4)$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Tọa độ điểm $A'$ đối xứng với điểm $A(1; 5)$ qua đường phân giác của góc phần tư thứ nhất $d: x - y = 0$ là],
    (
        True([$A'(5; 1)$]),
        [$A'(-1; -5)$],
        [$A'(-5; -1)$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Cho hai điểm $A(1; 2)$ và $B(3; 4)$. Điểm $M(x_0; 0)$ nằm trên trục hoành $O x$ sao cho tổng khoảng cách $M A + M B$ đạt giá trị nhỏ nhất. Giá trị của hoành độ $x_0$ là],
    (
        True([$x_0 = 5 / 3$]),
        [$x_0 = 2$],
        [$x_0 = 7 / 3$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Tìm giá trị của tham số $m$ để ba đường thẳng sau cùng đi qua một điểm:
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Đường thẳng $d$ đi qua điểm $M(1; 4)$ cắt các tia $O x, O y$ lần lượt tại $A(a; 0)$ và $B(0; b)$ ($a, b > 0$) sao cho diện tích tam giác $O A B$ đạt giá trị nhỏ nhất. Phương trình của đường thẳng $d$ là],
    (
        True([$4x + y - 8 = 0$]),
        [$x + 4y - 17 = 0$],
        [$2x + y - 6 = 0$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ có đỉnh $A(1; 1)$ và phương trình cạnh $B C$ là $x + 2y - 8 = 0$. Phương trình của cạnh $A D$ là],
    (
        True([$x + 2y - 3 = 0$]),
        [$x + 2y + 3 = 0$],
        [$2x - y - 1 = 0$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Một doanh nghiệp có ngân sách $120 text(" triệu đồng")$ để mua nguyên liệu $X$ (giá $10 text(" triệu đồng/tấn")$) và nguyên liệu $Y$ (giá $15 text(" triệu đồng/tấn")$).
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Một máy bay hạ cánh theo đường thẳng từ độ cao $3000 text(" m")$ xuống đường băng.
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho điểm $A(1; 4)$ và đường thẳng $d: x - y + 1 = 0$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Một đường thẳng $Delta$ đi qua điểm $M(2; 1)$ cắt hai tia $O x, O y$ lần lượt tại $A(a; 0)$ và $B(0; b)$ với $a > 0, b > 0$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Tại một sân bay quốc tế, hai đường băng cất cánh thẳng được thiết kế trên bản đồ tọa độ $O x y$ (đơn vị: kilômét):
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Hai khu công nghiệp $A(1; 3)$ và $B(5; 5)$ nằm cùng phía đối với một dòng kênh thẳng được mô hình hóa bằng trục hoành $O x$.
...
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Cho ba đường thẳng $d_1: 2x - y + 1 = 0$, $d_2: x + y - 4 = 0$ và $d_3: 3x - 2y + m = 0$ cùng đi qua một điểm. Tìm giá trị của tham số $m$.],
    [3],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Trong bài toán hạ cánh máy bay với hệ số góc $k = -0.2$, khi máy bay đang ở độ cao $1000 text(" m")$, khoảng cách theo phương ngang từ máy bay đến điểm tiếp đất bằng bao nhiêu mét?],
    [5000],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Trong bài toán đường ngân sách tiêu dùng $2x + 3y - 24 = 0$, nếu doanh nghiệp dùng toàn bộ ngân sách để chỉ mua nguyên liệu $X$ ($y = 0$) thì số tấn nguyên liệu $X$ mua được bằng bao nhiêu?],
    [12],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Tìm diện tích nhỏ nhất của tam giác tạo bởi hai tia $O x, O y$ và một đường thẳng đi qua điểm $M(2; 1)$.],
    [4],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Tìm hoành độ của điểm $A'$ đối xứng với điểm $A(3; 5)$ qua trục tung $O y$.],
    [-3],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 157], back-to: "sec-exercise-hub",[Trong mặt phẳng $O x y$, cho tam giác $A B C$ có đỉnh $A(1; 4)$ và trực tâm $H(2; 1)$.
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 19: PHƯƠNG TRÌNH ĐƯỜNG THẲNG (ĐỀ SỐ 21C - NÂNG CAO & VDC)!]      #v(0.6em)
