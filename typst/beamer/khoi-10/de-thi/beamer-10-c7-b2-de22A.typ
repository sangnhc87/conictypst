// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 20: VỊ TRÍ TƯƠNG ĐỐI GIỮA HAI ĐƯỜNG THẲNG. GÓC VÀ KHOẢNG CÁCH (ĐỀ SỐ 22A - CƠ BẢN ĐẾN VẬN DỤNG)
// Lớp: Khối 10  ·  Mã đề: 158  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 20: VỊ TRÍ TƯƠNG ĐỐI GIỮA HAI ĐƯỜNG THẲNG. GÓC VÀ KHOẢNG CÁCH (ĐỀ SỐ 22A - CƠ BẢN ĐẾN VẬN DỤNG)",
  subtitle: "CHƯƠNG VII: PHƯƠNG PHÁP TỌA ĐỘ TRONG MẶT PHẲNG — MÃ ĐỀ: 158",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 158]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Vị trí tương đối của hai đường thẳng $d_1: 2x - 3y + 5 = 0$ và $d_2: 4x - 6y + 10 = 0$ là],
    (
        True([Trùng nhau]),
        [Song song với nhau],
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Vị trí tương đối của hai đường thẳng $Delta_1: x - 2y + 3 = 0$ và $Delta_2: 2x - 4y + 7 = 0$ là],
    (
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Hai đường thẳng $d_1: 3x - y + 2 = 0$ và $d_2: x + 3y - 5 = 0$ có vị trí tương đối là],
    (
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Khoảng cách từ điểm $M(1; 2)$ đến đường thẳng $Delta: 3x + 4y + 4 = 0$ bằng],
    (
        True([$3$]),
        [$15$],
        [$5$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Khoảng cách từ gốc tọa độ $O(0; 0)$ đến đường thẳng $d: 5x - 12y + 26 = 0$ bằng],
    (
        True([$2$]),
        [$26$],
        [$13$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Cosin của góc giữa hai đường thẳng $d_1: x + 2y - 1 = 0$ và $d_2: 2x - y + 3 = 0$ bằng],
    (
        True([$0$]),
        [$1$],
        [$1 / 2$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Góc tạo bởi hai đường thẳng $d_1: x - sqrt(3) y + 2 = 0$ và $d_2: sqrt(3) x - y - 1 = 0$ bằng],
    (
        True([$30^circ$]),
        [$60^circ$],
        [$45^circ$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Khoảng cách giữa hai đường thẳng song song $d_1: 3x - 4y + 1 = 0$ và $d_2: 3x - 4y - 9 = 0$ bằng],
    (
        True([$2$]),
        [$10$],
        [$8$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để hai đường thẳng $d_1: (m - 1)x + 2y - 3 = 0$ và $d_2: 2x + y + 1 = 0$ song song với nhau.],
    (
        True([$m = 5$]),
        [$m = 3$],
        [$m = -3$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Trong mặt phẳng $O x y$, cho tam giác $A B C$ có $A(1; 1)$ và đường thẳng chứa cạnh $B C$ có phương trình $3x - 4y + 11 = 0$. Độ dài đường cao $A H$ kẻ từ đỉnh $A$ bằng],
    (
        True([$2$]),
        [$10$],
        [$2.5$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Một trạm phát sóng viễn thông đặt tại điểm $A(2; 3)$. Một tuyến đường quốc lộ thẳng được mô tả bởi đường thẳng $d: 4x + 3y + 8 = 0$ (đơn vị tọa độ là km).
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Một con tàu hàng hải di chuyển trên biển theo đường thẳng $d: x - 2y + 10 = 0$.
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Cho hai đường thẳng $d_1: 3x - 4y + 5 = 0$ và $d_2: 4x + 3y - 10 = 0$ cùng điểm $A(1; 2)$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho tam giác $A B C$ có tọa độ ba đỉnh là $A(3; 5)$, $B(-1; 1)$ và $C(3; -2)$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Một đường dây truyền tải điện cao thế chạy thẳng được quy hoạch theo đường thẳng $Delta: 5x - 12y + 60 = 0$ (mỗi đơn vị trên hệ trục tọa độ tương ứng với $10 text(" m")$).
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Cho họ đường thẳng $d_m: (m + 1)x + (m - 1)y - 2m = 0$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Tính khoảng cách từ điểm $A(2; -3)$ đến đường thẳng $d: 3x - 4y + 2 = 0$.],
    [4],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Tính khoảng cách giữa hai đường thẳng song song $d_1: 5x - 12y + 7 = 0$ và $d_2: 5x - 12y - 19 = 0$.],
    [2],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Trong bài toán tam giác $A B C$ có độ dài đáy $B C = 5$ và chiều cao $A H = 5.6$, diện tích tam giác $A B C$ bằng bao nhiêu?],
    [14],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Trong bài toán trạm phát sóng viễn thông $A(2; 3)$ và quốc lộ $4x + 3y + 8 = 0$, khoảng cách ngắn nhất từ trạm đến quốc lộ bằng bao nhiêu kilômét?],
    [5],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Tìm giá trị của tham số $m$ để hai đường thẳng $d_1: 2x - y + 1 = 0$ và $d_2: x + m y + 2 = 0$ vuông góc với nhau.],
    [2],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 158], back-to: "sec-exercise-hub",[Trong bài toán con tàu hải quân di chuyển theo đường thẳng $x - 2y + 10 = 0$, khoảng cách ngắn nhất từ ngọn hải đăng tại gốc tọa độ $O(0; 0)$ đến tàu có bình phương bằng bao nhiêu?],
    [20],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 20: VỊ TRÍ TƯƠNG ĐỐI GIỮA HAI ĐƯỜNG THẲNG. GÓC VÀ KHOẢNG CÁCH (ĐỀ SỐ 22A - CƠ BẢN ĐẾN VẬN DỤNG)!]      #v(0.6em)
