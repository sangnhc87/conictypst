// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 20: VỊ TRÍ TƯƠNG ĐỐI GIỮA HAI ĐƯỜNG THẲNG. GÓC VÀ KHOẢNG CÁCH (ĐỀ SỐ 22C - NÂNG CAO & VDC)
// Lớp: Khối 10  ·  Mã đề: 160  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 20: VỊ TRÍ TƯƠNG ĐỐI GIỮA HAI ĐƯỜNG THẲNG. GÓC VÀ KHOẢNG CÁCH (ĐỀ SỐ 22C - NÂNG CAO & VDC)",
  subtitle: "CHƯƠNG VII: PHƯƠNG PHÁP TỌA ĐỘ TRONG MẶT PHẲNG — MÃ ĐỀ: 160",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 160]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Cosin của góc giữa hai đường thẳng $d_1: 2x - y + 3 = 0$ và $d_2: x + 3y - 1 = 0$ bằng],
    (
        True([$sqrt(2) / 10$]),
        [$sqrt(2) / 5$],
        [$1 / 2$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có ba cạnh lần lượt nằm trên các đường thẳng $d_1: 3x - 4y + 1 = 0$, $d_2: 4x + 3y - 5 = 0$ và $d_3: x + 2y - 3 = 0$. Tam giác $A B C$ là],
    (
        True([Tam giác vuông]),
        [Tam giác đều],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Tìm giá trị của tham số $m$ để khoảng cách từ điểm $M(2; 1)$ đến đường thẳng $d: 3x + 4y + m = 0$ bằng khoảng cách từ điểm $N(0; 3)$ đến đường thẳng đó (với $M$ và $N$ nằm về hai phía khác nhau so với đường thẳng $d$).],
    (
        True([$m = -11$]),
        [$m = 11$],
        [$m = -10$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Cho hai đường thẳng song song $d_1: 5x - 12y + 1 = 0$ và $d_2: 5x - 12y - 25 = 0$. Đường thẳng song song và cách đều $d_1, d_2$ có phương trình là],
    (
        True([$5x - 12y - 12 = 0$]),
        [$5x - 12y + 12 = 0$],
        [$5x - 12y - 13 = 0$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Điểm $P(0; y_0)$ nằm trên trục tung $O y$ cách đều hai đường thẳng $d_1: 3x - 4y + 1 = 0$ và $d_2: 4x + 3y - 2 = 0$. Giá trị âm của tung độ $y_0$ là],
    (
        True([$y_0 = -1$]),
        [$y_0 = - 3 / 7$],
        [$y_0 = -2$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Cho tam giác đều $A B C$ có độ dài cạnh bằng $6$. Khoảng cách từ trọng tâm $G$ của tam giác đến một cạnh bất kỳ bằng],
    (
        True([$sqrt(3)$]),
        [$2 sqrt(3)$],
        [$3 sqrt(3)$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Tập hợp các điểm $M(x; y)$ cách đường thẳng $d: 3x - 4y + 2 = 0$ một khoảng bằng $2$ là hai đường thẳng có phương trình là],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Một hình vuông có hai cạnh nằm trên hai đường thẳng song song $d_1: 4x - 3y + 3 = 0$ và $d_2: 4x - 3y - 17 = 0$. Diện tích của hình vuông đó bằng],
    (
        True([$16$]),
        [$20$],
        [$25$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Điểm $M(x_0; 0)$ nằm trên trục hoành $O x$ cách đường thẳng $Delta: 3x + 4y - 6 = 0$ một khoảng bằng $3$. Giá trị dương của hoành độ $x_0$ bằng],
    (
        True([$x_0 = 7$]),
        [$x_0 = 5$],
        [$x_0 = 3$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Cho tam giác $A B C$ có diện tích bằng $15$, cạnh đáy $B C$ có độ dài bằng $6$ và nằm trên đường thẳng $d: 3x - 4y + 5 = 0$. Chiều cao $A H$ kẻ từ đỉnh $A$ của tam giác bằng],
    (
        True([$5$]),
        [$2.5$],
        [$10$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Một công trình đập thủy điện có thân đập chính chạy thẳng trên đường thẳng $Delta: 6x + 8y - 25 = 0$ (đơn vị: kilômét).
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Quỹ đạo bay trong không gian $O x y$ của hai vệ tinh viễn thông được mô hình bởi hai đường thẳng $d_1: x - 2y + 4 = 0$ và $d_2: 2x + y - 8 = 0$.
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Cho hình vuông $A B C D$ có hai cạnh $A B$ và $C D$ lần lượt nằm trên hai đường thẳng $d_1: 3x - 4y + 6 = 0$ và $d_2: 3x - 4y - 14 = 0$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Trong mặt phẳng $O x y$, cho hai đường thẳng cắt nhau $d_1: 2x - y + 1 = 0$ và $d_2: x + 2y - 3 = 0$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Một trạm radar cảnh giới bờ biển đặt tại mỏm đá có tọa độ $R(1; 3)$.
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Trong mặt phẳng $O x y$, cho ba điểm $A(0; 3)$, $B(4; 0)$ và $C(m; 2)$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Cho hình vuông có hai cạnh nằm trên hai đường thẳng song song $4x - 3y + 6 = 0$ và $4x - 3y - 14 = 0$. Diện tích của hình vuông đó bằng bao nhiêu?],
    [16],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Trong bài toán đập thủy điện $6x + 8y - 25 = 0$ và khu nhà điều hành $A(2; 4)$, khoảng cách từ nhà điều hành đến thân đập bằng bao nhiêu mét (biết $1$ đơn vị tọa độ ứng với $1000 text(" m")$)?],
    [1900],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Tìm giá trị của tham số $m$ để khoảng cách từ điểm $M(2; 1)$ đến đường thẳng $d: 3x + 4y + m = 0$ bằng khoảng cách từ điểm $N(0; 3)$ đến đường thẳng đó (biết $M$ và $N$ nằm về hai phía khác nhau so với $d$).],
    [-11],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Trong bài toán trạm radar $R(1; 3)$, khoảng cách từ trạm radar đến tuyến tuần tra số hai $3x - 4y - 1 = 0$ bằng bao nhiêu hải lý?],
    [2],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Một tam giác có diện tích bằng $15$ và cạnh đáy bằng $6$. Chiều cao tương ứng với cạnh đáy đó bằng bao nhiêu?],
    [5],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 160], back-to: "sec-exercise-hub",[Tìm hoành độ dương của điểm $M(x_0; 0)$ nằm trên trục hoành $O x$ sao cho khoảng cách từ $M$ đến đường thẳng $3x + 4y - 6 = 0$ bằng $3$.],
    [7],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 20: VỊ TRÍ TƯƠNG ĐỐI GIỮA HAI ĐƯỜNG THẲNG. GÓC VÀ KHOẢNG CÁCH (ĐỀ SỐ 22C - NÂNG CAO & VDC)!]      #v(0.6em)
