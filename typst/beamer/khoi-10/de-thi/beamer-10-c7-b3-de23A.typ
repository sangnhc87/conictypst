// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 21: ĐƯỜNG TRÒN TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 23A - CƠ BẢN ĐẾN VẬN DỤNG)
// Lớp: Khối 10  ·  Mã đề: 161  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 21: ĐƯỜNG TRÒN TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 23A - CƠ BẢN ĐẾN VẬN DỤNG)",
  subtitle: "CHƯƠNG VII: PHƯƠNG PHÁP TỌA ĐỘ TRONG MẶT PHẲNG — MÃ ĐỀ: 161",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 161]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Tọa độ tâm $I$ và bán kính $R$ của đường tròn $(C): (x - 2)^2 + (y + 3)^2 = 25$ là],
    (
        True([$I(2; -3)$ và $R = 5$]),
        [$I(-2; 3)$ và $R = 5$],
        [$I(2; -3)$ và $R = 25$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Phương trình của đường tròn có tâm $I(-1; 2)$ và bán kính $R = 3$ là],
    (
        True([$(x + 1)^2 + (y - 2)^2 = 9$]),
        [$(x - 1)^2 + (y + 2)^2 = 9$],
        [$(x + 1)^2 + (y - 2)^2 = 3$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Tọa độ tâm $I$ và bán kính $R$ của đường tròn $(C): x^2 + y^2 - 4x + 6y - 12 = 0$ là],
    (
        True([$I(2; -3)$ và $R = 5$]),
        [$I(-2; 3)$ và $R = 5$],
        [$I(2; -3)$ và $R = 25$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để phương trình $x^2 + y^2 - 2x + 4y + m = 0$ là phương trình của một đường tròn.],
    (
        True([$m < 5$]),
        [$m <= 5$],
        [$m > 5$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Phương trình đường tròn có đường kính $A B$ với $A(1; 3)$ và $B(5; -1)$ là],
    (
        True([$(x - 3)^2 + (y - 1)^2 = 8$]),
        [$(x - 3)^2 + (y - 1)^2 = 32$],
        [$(x + 3)^2 + (y + 1)^2 = 8$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Phương trình tiếp tuyến của đường tròn $(C): (x - 1)^2 + (y - 2)^2 = 25$ tại điểm $M(4; 6) in (C)$ là],
    (
        True([$3x + 4y - 36 = 0$]),
        [$3x + 4y + 36 = 0$],
        [$4x + 3y - 34 = 0$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Vị trí tương đối của điểm $M(3; 4)$ đối với đường tròn $(C): x^2 + y^2 = 25$ là],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Vị trí tương đối giữa đường thẳng $d: 3x - 4y + 4 = 0$ và đường tròn $(C): (x - 1)^2 + (y + 2)^2 = 16$ là],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Phương trình đường tròn có tâm là gốc tọa độ $O(0; 0)$ và tiếp xúc với đường thẳng $Delta: 3x + 4y - 10 = 0$ là],
    (
        True([$x^2 + y^2 = 4$]),
        [$x^2 + y^2 = 2$],
        [$x^2 + y^2 = 16$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Trong mặt phẳng $O x y$, tam giác $A B C$ vuông tại $A$ có hai đỉnh $B(1; 2)$ và $C(5; 6)$. Tọa độ tâm đường tròn ngoại tiếp tam giác $A B C$ là],
    (
        True([$I(3; 4)$]),
        [$I(2; 3)$],
        [$I(4; 5)$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Một tháp phát sóng truyền hình đặt tại gốc tọa độ $O(0; 0)$ có bán kính phủ sóng hiệu quả là $R = 50 text(" km")$.
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Một hệ thống tưới nước tự động xoay tròn (Center Pivot) có tâm vòi phun đặt tại vị trí $I(2; 3)$ và bán kính tưới đạt $R = 10 text(" m")$.
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Trong mặt phẳng tọa độ $O x y$, cho đường tròn $(C): x^2 + y^2 - 2x - 4y - 20 = 0$ và điểm $M(4; 6)$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Trong mặt phẳng $O x y$, cho tam giác $O A B$ có ba đỉnh là $O(0; 0)$, $A(6; 0)$ và $B(0; 8)$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Một trận động đất xảy ra với tâm chấn tại vị trí có tọa độ $I(5; 12)$ (đơn vị trên bản đồ là kilômét).
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Cho phương trình $(C_m): x^2 + y^2 - 4m x + 2(m + 1)y + 5m^2 - 1 = 0$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Cho đường tròn $(C): x^2 + y^2 - 6x + 8y - 11 = 0$. Bán kính $R$ của đường tròn bằng bao nhiêu?],
    [6],
    loigiai: [
        #step([Xác định hệ số])
        $a = 3, b = -4, c = -11$.
...
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Trong bài toán tâm chấn động đất tại $I(5; 12)$, khoảng cách từ tâm chấn đến trạm quan sát tại gốc tọa độ $O(0; 0)$ bằng bao nhiêu kilômét?],
    [13],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Trong tam giác vuông $O A B$ có hai cạnh góc vuông $O A = 6$ và $O B = 8$, bán kính của đường tròn ngoại tiếp tam giác bằng bao nhiêu?],
    [5],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Tìm giá trị nguyên nhỏ nhất của tham số $m$ để phương trình $x^2 + y^2 - 2x + 4y + m = 0$ không phải là phương trình đường tròn.],
    [5],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Tiếp tuyến của đường tròn $x^2 + y^2 = 25$ tại điểm $M(3; 4)$ có phương trình tổng quát dạng $3x + 4y + c = 0$. Tìm giá trị của hệ số tự do $c$.],
    [-25],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 161], back-to: "sec-exercise-hub",[Một vòi phun xoay tròn tưới cỏ có bán kính phun xa nhất là $R = 8 text(" m")$. Diện tích lớn nhất của bãi cỏ được tưới nước bằng bao nhiêu $pi text(" m"^2)$?],
    [64],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 21: ĐƯỜNG TRÒN TRONG MẶT PHẲNG TỌA ĐỘ (ĐỀ SỐ 23A - CƠ BẢN ĐẾN VẬN DỤNG)!]      #v(0.6em)
