// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 23: QUY TẮC ĐẾM (ĐỀ SỐ 26B - VẬN DỤNG CAO & THỰC TIỄN)
// Lớp: Khối 10  ·  Mã đề: 174  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 23: QUY TẮC ĐẾM (ĐỀ SỐ 26B - VẬN DỤNG CAO & THỰC TIỄN)",
  subtitle: "CHƯƠNG VIII: ĐẠI SỐ TỔ HỢP — MÃ ĐỀ: 174",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 174]],
...
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Từ các chữ số thuộc tập hợp $S = {0, 1, 2, 3, 4, 5, 6, 7}$, có thể lập được bao nhiêu số tự nhiên gồm $5$ chữ số đôi một khác nhau và chia hết cho $25$?],
    (
        True([$320$]),
        [$400$],
        [$280$],
...
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Trên một giá sách có $5$ cuốn sách Toán khác nhau, $4$ cuốn sách Vật lí khác nhau và $3$ cuốn sách Hóa học khác nhau được xếp thành một hàng ngang. Có bao nhiêu cách xếp sao cho các cuốn sách cùng một môn luôn luôn đứng cạnh nhau?],
    (
        True([$103680$]),
        [$17280$],
        [$51840$],
...
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Một mạng lưới giao thông kết nối bốn đô thị $A, B, C, D$. Giữa $A$ và $B$ có $3$ tuyến đường bộ và $2$ tuyến đường sắt. Giữa $B$ và $C$ có $4$ tuyến đường bộ. Giữa $A$ và $C$ có $2$ tuyến đường hàng không trực tiếp. Từ $C$ đến $D$ có $3$ tuyến đường cao tốc. Hỏi có bao nhiêu hành trình khác nhau để đi từ đô thị $A$ đến đô thị $D$?],
    (
        True([$66$]),
        [$60$],
        [$72$],
...
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên đối xứng (đọc xuôi hay đọc ngược đều như nhau) gồm $7$ chữ số sao cho chữ số chính giữa là một chữ số lẻ, đồng thời tổng tất cả các chữ số của số đó là một số chẵn?],
    (
        True([$0$]),
        [$4500$],
        [$5000$],
...
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Có bao nhiêu cách xếp $6$ học sinh nam và $3$ học sinh nữ thành một hàng dọc sao cho không có hai học sinh nữ nào đứng cạnh nhau?],
    (
        True([$151200$]),
        [$50400$],
        [$302400$],
...
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Một chú robot tí hon di chuyển trên các cạnh của một lưới lập phương kích thước $3 times 3 times 3$ từ góc $O(0, 0, 0)$ đến góc đối diện $A(3, 3, 3)$. Mỗi bước đi của robot có độ dài $1$ đơn vị theo chiều dương của một trong ba trục tọa độ $O x, O y, O z$. Có bao nhiêu con đường đi ngắn nhất từ $O$ đến $A$?],
    (
        True([$1680$]),
        [$504$],
        [$756$],
...
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Từ các chữ số thuộc tập $S = {0, 1, 2, 3, 4, 5, 6, 7}$, có thể lập được bao nhiêu số tự nhiên gồm $4$ chữ số đôi một khác nhau và chia hết cho $9$?],
    (
        True([$96$]),
        [$120$],
        [$84$],
...
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Xếp ngẫu nhiên $6$ chữ số $1, 2, 3, 4, 5, 6$ thành một hàng ngang. Có bao nhiêu cách xếp sao cho hai chữ số $1$ và $2$ luôn đứng cách nhau ít nhất $2$ chữ số khác?],
    (
        True([$288$]),
        [$432$],
        [$240$],
...
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Một hệ thống mã vạch sử dụng chuỗi gồm $5$ chữ số $d_1 d_2 d_3 d_4 d_5$ (mỗi chữ số lấy từ tập ${0, 1, ..., 9}$). Mã số được coi là hợp lệ nếu thỏa mãn điều kiện kiểm tra: $(3 d_1 + d_2 + 3 d_3 + d_4 + d_5)$ chia hết cho $10$. Biết rằng $4$ chữ số đầu $d_1, d_2, d_3, d_4$ được chọn tùy ý. Hỏi có bao nhiêu chuỗi mã số hợp lệ?],
    (
        True([$10000$]),
        [$100000$],
        [$9000$],
...
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Trên một bàn cờ ô vuông kích thước $8 times 8$, có tất cả bao nhiêu hình chữ nhật (kể cả hình vuông) được tạo thành bởi các đường kẻ của bàn cờ?],
    (
        True([$1296$]),
        [$204$],
        [$576$],
...
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Cho ba đường thẳng song song phân biệt $d_1, d_2, d_3$. Trên $d_1$ lấy $4$ điểm phân biệt, trên $d_2$ lấy $5$ điểm phân biệt và trên $d_3$ lấy $6$ điểm phân biệt. Có tất cả bao nhiêu tam giác có $3$ đỉnh là các điểm trong số $15$ điểm đã cho?],
    (
        True([$421$]),
        [$455$],
        [$34$],
...
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Một câu lạc bộ có $10$ nam và $8$ nữ. Ban chủ nhiệm cần chọn một đội tuyển gồm $5$ học sinh sao cho có ít nhất $2$ nam, ít nhất $2$ nữ và trong đội tuyển không đồng thời có mặt cả bạn nam $A$ và bạn nữ $B$. Số cách chọn là],
    (
        True([$5439$]),
        [$5880$],
        [$441$],
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Mạng lưới vận tải hàng hóa kết nối bốn kho bãi $A, B, C, D$ được thiết kế như sơ đồ:
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Cho tập hợp $S = {0, 1, 2, 3, 4, 5, 6, 7}$. Lập các số tự nhiên có $5$ chữ số đôi một khác nhau chia hết cho $25$ từ tập $S$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Xét bàn cờ ô vuông kích thước $8 times 8$ gồm $64$ ô vuông đơn vị kích thước $1 times 1$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Cho tập hợp các chữ số $S = {0, 1, 2, 3, 4, 5, 6, 7}$. Lập các số tự nhiên có $4$ chữ số đôi một khác nhau chia hết cho $9$ từ tập $S$.
Xét tính đúng sai của các nhận định sau:],
  (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Từ các chữ số thuộc tập $S = {0, 1, 2, 3, 4, 5, 6, 7}$, có thể lập được bao nhiêu số tự nhiên gồm $5$ chữ số đôi một khác nhau và chia hết cho $25$?],
    [320],
    loigiai: [
        #step([Tính tổng])
        Tận cùng 50: $120$ số.
...
// TLN 2
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Có bao nhiêu cách xếp $5$ cuốn sách Toán khác nhau, $4$ cuốn sách Vật lí khác nhau và $3$ cuốn sách Hóa học khác nhau thành một hàng ngang sao cho các cuốn sách cùng một môn luôn đứng cạnh nhau?],
    [103680],
    loigiai: [
        #step([Buộc khối])
...
// TLN 3
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Có bao nhiêu con đường ngắn nhất đi từ điểm $O(0, 0, 0)$ đến điểm $A(3, 3, 3)$ trên các cạnh của lưới lập phương đơn vị?],
    [1680],
    loigiai: [
        #step([Hoán vị lặp 3D])
...
// TLN 4
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Từ các chữ số thuộc tập $S = {0, 1, 2, 3, 4, 5, 6, 7}$, có thể lập được bao nhiêu số tự nhiên gồm $4$ chữ số đôi một khác nhau và chia hết cho $9$?],
    [96],
    loigiai: [
...
// TLN 5
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Trên bàn cờ ô vuông kích thước $8 times 8$, có tất cả bao nhiêu hình vuông được tạo thành bởi các đường kẻ của bàn cờ?],
    [204],
    loigiai: [
...
// TLN 6
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 174], back-to: "sec-exercise-hub",[Xếp ngẫu nhiên $6$ chữ số $1, 2, 3, 4, 5, 6$ thành hàng ngang. Có bao nhiêu cách xếp sao cho hai chữ số $1$ và $2$ đứng cách nhau ít nhất $2$ chữ số khác?],
    [288],
    loigiai: [
        #step([Phần bù])
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 23: QUY TẮC ĐẾM (ĐỀ SỐ 26B - VẬN DỤNG CAO & THỰC TIỄN)!]      #v(0.6em)
