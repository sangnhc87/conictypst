// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 23: QUY TẮC ĐẾM (ĐỀ SỐ 26C - NÂNG CAO & VDC)
// Lớp: Khối 10  ·  Mã đề: 175  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 23: QUY TẮC ĐẾM (ĐỀ SỐ 26C - NÂNG CAO & VDC)",
  subtitle: "CHƯƠNG VIII: ĐẠI SỐ TỔ HỢP — MÃ ĐỀ: 175",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 175]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Từ các chữ số $0, 1, 2, 3, 4, 5, 6$, có thể lập được bao nhiêu số tự nhiên gồm $4$ chữ số đôi một khác nhau và chia hết cho $5$?],
    (
        True([$220$]),
        [$240$],
        [$180$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $4$ chữ số đôi một khác nhau mà luôn có mặt hai chữ số $1$ và $2$ đứng cạnh nhau?],
    (
        True([$308$]),
        [$336$],
        [$252$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $5$ chữ số đôi một khác nhau lấy từ tập ${1, 2, 3, 4, 5, 6}$ sao cho hai chữ số $1$ và $6$ không đứng cạnh nhau?],
    (
        True([$528$]),
        [$720$],
        [$192$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Cho tập hợp $S = {0, 1, 2, 3, 4, 5}$. Có bao nhiêu số tự nhiên gồm $4$ chữ số đôi một khác nhau lấy từ $S$ và số đó chia hết cho $4$?],
    (
        True([$72$]),
        [$96$],
        [$60$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $4$ chữ số mà tổng các chữ số của nó là một số chẵn lập từ tập các chữ số ${1, 2, 3, 4, 5}$ (cho phép các chữ số lặp lại)?],
    (
        True([$312$]),
        [$313$],
        [$625$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $3$ chữ số đôi một khác nhau sao cho tích các chữ số của nó là một số chẵn, được lập từ tập ${1, 2, 3, 4, 5, 6, 7}$?],
    (
        True([$186$]),
        [$210$],
        [$24$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Một nhóm gồm $5$ học sinh nam và $5$ học sinh nữ xếp thành một hàng dọc để vào lớp. Có bao nhiêu cách xếp hàng sao cho các bạn nam và nữ đứng xen kẽ nhau từng người một?],
    (
        True([$28800$]),
        [$14400$],
        [$3628800$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu cách xếp $4$ viên bi đỏ khác nhau và $4$ viên bi xanh khác nhau thành một hàng ngang sao cho không có hai viên bi đỏ nào đứng cạnh nhau?],
    (
        True([$2880$]),
        [$576$],
        [$1440$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Cho một đa giác lồi có $10$ đỉnh. Có bao nhiêu tam giác có $3$ đỉnh là các đỉnh của đa giác nhưng không có cạnh nào là cạnh của đa giác đã cho?],
    (
        True([$50$]),
        [$60$],
        [$70$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $5$ chữ số đôi một khác nhau mà chữ số đứng sau luôn lớn hơn chữ số đứng trước ($a < b < c < d < e$)?],
    (
        True([$126$]),
        [$252$],
        [$120$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Trên một bàn cờ vua kích thước $8 times 8$ ô vuông, có bao nhiêu cách chọn ra $2$ ô vuông khác màu (gồm $1$ ô đen và $1$ ô trắng) sao cho hai ô này không cùng hàng và không cùng cột?],
    (
        True([$768$]),
        [$1024$],
        [$512$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên chẵn gồm $4$ chữ số đôi một khác nhau nhỏ hơn $3000$, được lập từ các chữ số thuộc tập ${0, 1, 2, 3, 4, 5}$?],
    (
        True([$60$]),
        [$72$],
        [$48$],
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Cho tập hợp các chữ số $X = {0, 1, 2, 3, 4, 5, 6}$. Lập các số tự nhiên có $4$ chữ số đôi một khác nhau $overline(a b c d)$ từ tập $X$.
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Trên giá sách có $4$ cuốn sách Toán khác nhau và $3$ cuốn sách Ngữ văn khác nhau xếp thành một hàng ngang.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Cho đa giác đều có $10$ đỉnh nội tiếp trong một đường tròn.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Một cơ quan có $12$ cán bộ gồm $7$ nam và $5$ nữ. Cần lập một đoàn công tác gồm đúng $4$ người.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Từ các chữ số $0, 1, 2, 3, 4, 5, 6$, có thể lập được bao nhiêu số tự nhiên chẵn gồm $4$ chữ số đôi một khác nhau?],
    [420],
    loigiai: [
...
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên chẵn gồm $4$ chữ số đôi một khác nhau nhỏ hơn $3000$, được lập từ các chữ số thuộc tập ${0, 1, 2, 3, 4, 5}$?],
    [60],
    loigiai: [
        #step([TH1: a = 1])
...
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Có bao nhiêu cách xếp $5$ học sinh nam và $5$ học sinh nữ thành một hàng dọc sao cho các bạn nam và nữ đứng xen kẽ nhau?],
    [28800],
    loigiai: [
...
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Trên bàn cờ vua $8 times 8$, có bao nhiêu cách chọn ra $2$ ô vuông khác màu sao cho chúng không cùng hàng và không cùng cột?],
    [768],
    loigiai: [
        #step([Chọn ô trắng])
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Từ các chữ số $0, 1, 2, 3, 4, 5$, có thể lập được bao nhiêu số tự nhiên gồm $4$ chữ số đôi một khác nhau và chia hết cho $4$?],
    [72],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 175], back-to: "sec-exercise-hub",[Cho đa giác đều có $10$ đỉnh. Có bao nhiêu tam giác có $3$ đỉnh là các đỉnh của đa giác nhưng không có cạnh nào là cạnh của đa giác đã cho?],
    [50],
    loigiai: [
        #step([Dùng phần bù])
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 23: QUY TẮC ĐẾM (ĐỀ SỐ 26C - NÂNG CAO & VDC)!]      #v(0.6em)
