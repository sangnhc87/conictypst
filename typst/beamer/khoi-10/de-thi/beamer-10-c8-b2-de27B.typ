// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 24: HOÁN VỊ, CHỈNH HỢP VÀ TỔ HỢP (ĐỀ SỐ 27B - VẬN DỤNG CAO & THỰC TIỄN)
// Lớp: Khối 10  ·  Mã đề: 177  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 24: HOÁN VỊ, CHỈNH HỢP VÀ TỔ HỢP (ĐỀ SỐ 27B - VẬN DỤNG CAO & THỰC TIỄN)",
  subtitle: "CHƯƠNG VIII: ĐẠI SỐ TỔ HỢP — MÃ ĐỀ: 177",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 177]],
...
#lt-tn(num: 1, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $5$ chữ số đôi một khác nhau $overline(a b c d e)$ thỏa mãn điều kiện các chữ số giảm dần từ trái sang phải: $a > b > c > d > e$?],
    (
        True([$252$]),
        [$126$],
        [$3024$],
...
#lt-tn(num: 2, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có $6$ viên ngọc có màu sắc khác nhau được xâu thành một chiếc vòng đeo tay tròn khép kín. Biết rằng hai chiếc vòng tay được xem là như nhau nếu có thể lật ngược mặt vòng tay mà các viên ngọc trùng khớp nhau. Số kiểu vòng tay khác nhau có thể tạo ra là],
    (
        True([$60$]),
        [$120$],
        [$720$],
...
#lt-tn(num: 3, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Cho một đa giác đều có $12$ đỉnh. Có bao nhiêu tam giác có $3$ đỉnh là các đỉnh của đa giác mà không có bất kỳ cạnh nào là cạnh của đa giác đều đó?],
    (
        True([$112$]),
        [$96$],
        [$120$],
...
#lt-tn(num: 4, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Một câu lạc bộ cờ vua có $8$ kỳ thủ tham gia thi đấu vòng loại. Ban tổ chức cần ghép ngẫu nhiên $8$ kỳ thủ thành $4$ cặp thi đấu đồng thời (không phân biệt số thứ tự bàn cờ). Số cách chia cặp thi đấu là],
    (
        True([$105$]),
        [$2520$],
        [$420$],
...
#lt-tn(num: 5, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Một robot di chuyển trên lưới ô vuông từ điểm gốc $O(0, 0)$ đến đích $B(4, 4)$ bằng các bước sang phải ($+x$) hoặc lên trên ($+y$). Biết rằng đoạn đường nối từ điểm $M(2, 2)$ đến điểm $N(2, 3)$ đang bảo trì nên robot không được đi qua. Có bao nhiêu lộ trình hợp lệ?],
    (
        True([$52$]),
        [$70$],
        [$18$],
...
#lt-tn(num: 6, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có bao nhiêu bộ số nguyên dương $(x_1, x_2, x_3, x_4)$ thỏa mãn phương trình: $x_1 + x_2 + x_3 + x_4 = 12$?],
    (
        True([$165$]),
        [$220$],
        [$455$],
...
#lt-tn(num: 7, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Từ tập hợp các chữ số $S = {0, 1, 2, 3, 4, 5, 6}$, có thể lập được bao nhiêu số tự nhiên chẵn gồm $5$ chữ số đôi một khác nhau sao cho chữ số $0$ không đứng ở vị trí tận cùng?],
    (
        True([$540$]),
        [$720$],
        [$360$],
...
#lt-tn(num: 8, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Cho đa giác đều có $16$ đỉnh nội tiếp trong đường tròn. Có bao nhiêu tam giác vuông cân có $3$ đỉnh là các đỉnh của đa giác đều đó?],
    (
        True([$16$]),
        [$32$],
        [$64$],
...
#lt-tn(num: 9, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có bao nhiêu cách hoán vị các chữ cái của từ "OLYMPIAD" sao cho không có hai nguyên âm nào đứng cạnh nhau? (Biết trong từ có 3 nguyên âm là O, I, A).],
    (
        True([$14400$]),
        [$7200$],
        [$28800$],
...
#lt-tn(num: 10, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Tìm nghiệm nguyên dương $n$ của phương trình: $C_(n + 1)^(n - 1) + 2 A_n^2 = 55$.],
    (
        True([$n = 5$]),
        [$n = 4$],
        [$n = 6$],
...
#lt-tn(num: 11, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Cho đa giác đều gồm $12$ đỉnh nội tiếp trong đường tròn. Có bao nhiêu hình chữ nhật có $4$ đỉnh là các đỉnh của đa giác đều đó?],
    (
        True([$15$]),
        [$30$],
        [$45$],
...
#lt-tn(num: 12, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có $9$ chuyên viên được phân công vào $3$ dự án khác nhau $A, B, C$ sao cho dự án $A$ có $4$ người, dự án $B$ có $3$ người và dự án $C$ có $2$ người. Số cách phân công là],
    (
        True([$1260$]),
        [$2520$],
        [$630$],
...
#lt-ds(num: 13, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Cho đa giác đều $H$ gồm $12$ đỉnh nội tiếp đường tròn tâm $O$.
...
#lt-ds(num: 14, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Xét phương trình $C_(n + 1)^(n - 1) + 2 A_n^2 = 55$ với $n in NN, n >= 2$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Một robot di chuyển trên lưới từ $O(0, 0)$ đến $B(4, 4)$ chỉ bằng các bước sang phải hoặc lên trên $1$ đơn vị. Đoạn đường nối $M(2, 2)$ và $N(2, 3)$ bị hỏng không đi qua được.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 16, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Xét phương trình $x_1 + x_2 + x_3 + x_4 = 12$.
Xét tính đúng sai của các nhận định sau:],
  (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $5$ chữ số đôi một khác nhau thỏa mãn các chữ số giảm dần từ trái sang phải: $a > b > c > d > e$?],
    [252],
    loigiai: [
        #step([Tổ hợp C_10^5])
        $ C_10^5 = 252 text(" số") $
...
// TLN 2
#lt-tln(num: 18, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có $6$ viên ngọc màu khác nhau xâu thành một chiếc vòng tay tròn khép kín. Có bao nhiêu kiểu vòng tay khác nhau nếu việc lật ngược vòng tay được xem là như nhau?],
    [60],
    loigiai: [
...
// TLN 3
#lt-tln(num: 19, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Cho đa giác đều có $12$ đỉnh. Có bao nhiêu tam giác có $3$ đỉnh là các đỉnh của đa giác mà không có cạnh nào là cạnh của đa giác?],
    [112],
    loigiai: [
        #step([Phần bù])
...
// TLN 4
#lt-tln(num: 20, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Có bao nhiêu bộ số nguyên dương $(x_1, x_2, x_3, x_4)$ thỏa mãn $x_1 + x_2 + x_3 + x_4 = 12$?],
    [165],
    loigiai: [
        #step([Stars and Bars])
...
// TLN 5
#lt-tln(num: 21, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Tìm nghiệm nguyên dương $n$ của phương trình: $C_(n + 1)^(n - 1) + 2 A_n^2 = 55$.],
    [5],
    loigiai: [
...
// TLN 6
#lt-tln(num: 22, de: [Đề 2 (B) — Mã 177], back-to: "sec-exercise-hub",[Cho đa giác đều có $12$ đỉnh. Có bao nhiêu hình chữ nhật có $4$ đỉnh là đỉnh của đa giác đều đó?],
    [15],
    loigiai: [
        #step([Cặp đường kính])
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 24: HOÁN VỊ, CHỈNH HỢP VÀ TỔ HỢP (ĐỀ SỐ 27B - VẬN DỤNG CAO & THỰC TIỄN)!]      #v(0.6em)
