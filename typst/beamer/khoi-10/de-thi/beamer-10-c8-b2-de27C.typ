// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 24: HOÁN VỊ, CHỈNH HỢP VÀ TỔ HỢP (ĐỀ SỐ 27C - NÂNG CAO & VDC)
// Lớp: Khối 10  ·  Mã đề: 178  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 24: HOÁN VỊ, CHỈNH HỢP VÀ TỔ HỢP (ĐỀ SỐ 27C - NÂNG CAO & VDC)",
  subtitle: "CHƯƠNG VIII: ĐẠI SỐ TỔ HỢP — MÃ ĐỀ: 178",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 178]],
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Từ các chữ số thuộc tập $X = {0, 1, 2, 3, 4, 5, 6}$, có thể lập được bao nhiêu số tự nhiên chẵn gồm $5$ chữ số đôi một khác nhau sao cho chữ số hàng nghìn luôn luôn là chữ số $1$?],
    (
        True([$204$]),
        [$240$],
        [$180$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Cho đa giác đều có $20$ đỉnh nội tiếp trong một đường tròn tâm $O$. Có bao nhiêu tam giác vuông không cân có $3$ đỉnh là các đỉnh của đa giác đều đã cho?],
    (
        True([$160$]),
        [$180$],
        [$20$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Có bao nhiêu cách xếp $6$ bạn học sinh gồm $3$ nam và $3$ nữ ngồi quanh một bàn tròn có $6$ chiếc ghế sao cho các bạn nam và nữ ngồi xen kẽ nhau?],
    (
        True([$12$]),
        [$36$],
        [$72$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Một nhóm gồm $9$ bạn học sinh (trong đó có hai bạn An và Bình). Có bao nhiêu cách xếp $9$ bạn này thành một hàng ngang sao cho giữa An và Bình có đúng $2$ bạn học sinh khác?],
    (
        True([$60480$]),
        [$30240$],
        [$120960$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $6$ chữ số đôi một khác nhau lấy từ tập ${1, 2, 3, 4, 5, 6, 7}$ sao cho các chữ số chẵn luôn đứng cạnh nhau?],
    (
        True([$1296$]),
        [$720$],
        [$576$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $4$ chữ số đôi một khác nhau $overline(a b c d)$ sao cho $a < b$ và $c > d$?],
    (
        True([$1008$]),
        [$1260$],
        [$840$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Trong mặt phẳng cho $10$ đường thẳng phân biệt và $6$ đường tròn phân biệt sao cho không có hai đường thẳng nào song song, không có ba đường thẳng nào đồng quy, không có hai đường tròn nào tiếp xúc nhau và đường thẳng không tiếp xúc đường tròn. Số giao điểm tối đa của hệ đường này bằng],
    (
        True([$195$]),
        [$250$],
        [$180$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Tìm số nguyên dương $n$ thỏa mãn phương trình $C_(n + 1)^2 + 2 C_(n + 2)^2 + 2 C_(n + 3)^2 + C_(n + 4)^2 = 149$.],
    (
        True([$n = 5$]),
        [$n = 6$],
        [$n = 4$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Trên một giá sách có $10$ cuốn sách khác nhau xếp thành một hàng ngang. Hỏi có bao nhiêu cách chọn ra $3$ cuốn sách sao cho không có hai cuốn sách nào đứng cạnh nhau trên giá?],
    (
        True([$56$]),
        [$120$],
        [$84$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Từ các chữ số thuộc tập $A = {0, 1, 2, 3, 4, 5, 6, 7}$, có thể lập được bao nhiêu số tự nhiên chẵn gồm $5$ chữ số đôi một khác nhau sao cho chữ số đầu tiên luôn luôn là một chữ số lẻ?],
    (
        True([$1920$]),
        [$2400$],
        [$1440$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Có bao nhiêu cách chia $12$ chiếc bút chì giống hệt nhau cho $3$ bạn học sinh An, Bình, Chi sao cho mỗi bạn đều nhận được ít nhất một chiếc bút?],
    (
        True([$55$]),
        [$66$],
        [$78$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Có bao nhiêu số tự nhiên gồm $6$ chữ số đôi một khác nhau, trong đó luôn có mặt ba chữ số $0, 1, 2$ và chữ số $1$ luôn đứng giữa hai chữ số $0$ và $2$ (không nhất thiết phải đứng cạnh nhau)?],
    (
        True([$6300$]),
        [$7200$],
        [$5400$],
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Cho đa giác đều $H$ gồm $20$ đỉnh nội tiếp trong đường tròn tâm $O$.
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Trên một giá sách có $10$ cuốn sách khác nhau xếp thành một hàng ngang.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Trong mặt phẳng cho $10$ đường thẳng phân biệt và $6$ đường tròn phân biệt (thỏa mãn không song song, không đồng quy, không tiếp xúc).
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Có $12$ chiếc bút bi giống nhau chia cho $3$ bạn học sinh An, Bình, Chi.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Cho đa giác đều có $20$ đỉnh nội tiếp trong đường tròn. Có bao nhiêu tam giác vuông không cân có $3$ đỉnh là các đỉnh của đa giác đều đã cho?],
    [160],
    loigiai: [
        #step([Lấy hiệu số])
...
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Có bao nhiêu cách xếp $3$ bạn nam và $3$ bạn nữ ngồi quanh một bàn tròn có $6$ chiếc ghế sao cho các bạn nam và nữ ngồi xen kẽ nhau?],
    [12],
    loigiai: [
...
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Một nhóm gồm $9$ bạn học sinh (trong đó có An và Bình) xếp thành hàng ngang. Có bao nhiêu cách xếp sao cho giữa An và Bình có đúng $2$ bạn học sinh khác?],
    [60480],
    loigiai: [
        #step([Quy tắc nhân])
...
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Trong mặt phẳng cho $10$ đường thẳng và $6$ đường tròn phân biệt (không song song, không đồng quy, không tiếp xúc). Số giao điểm tối đa của hệ đường này bằng bao nhiêu?],
    [195],
    loigiai: [
...
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Tìm số nguyên dương $n$ thỏa mãn phương trình $C_(n + 1)^2 + 2 C_(n + 2)^2 + 2 C_(n + 3)^2 + C_(n + 4)^2 = 149$.],
    [5],
    loigiai: [
...
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 178], back-to: "sec-exercise-hub",[Trên một giá sách có $10$ cuốn sách khác nhau xếp thành hàng ngang. Có bao nhiêu cách chọn ra $3$ cuốn sách sao cho không có hai cuốn sách nào đứng cạnh nhau trên giá?],
    [56],
    loigiai: [
        #step([Công thức])
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 24: HOÁN VỊ, CHỈNH HỢP VÀ TỔ HỢP (ĐỀ SỐ 27C - NÂNG CAO & VDC)!]      #v(0.6em)
