// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 25: NHỊ THỨC NEWTON (ĐỀ SỐ 28C - NÂNG CAO & PHÂN HÓA VDC)
// Lớp: Khối 10  ·  Mã đề: 181  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 25: NHỊ THỨC NEWTON (ĐỀ SỐ 28C - NÂNG CAO & PHÂN HÓA VDC)",
  subtitle: "CHƯƠNG VIII: ĐẠI SỐ TỔ HỢP — MÃ ĐỀ: 181",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 181]],
...
#lt-tn(num: 1, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tìm hệ số của số hạng chứa $x^4$ trong khai triển của đa thức $P(x) = (1 + x + x^2)^4$.],
    (
        True([$19$]),
        [$16$],
        [$24$],
...
#lt-tn(num: 2, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Giá trị của tổng $S = 1 cdot C_5^1 + 2 cdot C_5^2 + 3 cdot C_5^3 + 4 cdot C_5^4 + 5 cdot C_5^5$ bằng],
    (
        True([$80$]),
        [$160$],
        [$32$],
...
#lt-tn(num: 3, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Khai triển $(1 / 3 + 2 / 3 x)^5 = a_0 + a_1 x + a_2 x^2 + a_3 x^3 + a_4 x^4 + a_5 x^5$. Giá trị lớn nhất trong các hệ số $a_k$ ($k in {0, 1, ..., 5}$) bằng],
    (
        True([$80 / 243$]),
        [$40 / 243$],
        [$32 / 243$],
...
#lt-tn(num: 4, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Trong khai triển của biểu thức $(x^2 + 1 / x)^5$ với $x != 0$, số hạng chứa $x$ (bậc nhất) có hệ số bằng],
    (
        True([$10$]),
        [$5$],
        [$1$],
...
#lt-tn(num: 5, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Trong khai triển $(x + 2 / x)^5$ với $x != 0$, tỉ số giữa hệ số của số hạng chứa $x^3$ và hệ số của số hạng chứa $x$ bằng],
    (
        True([$1 / 4$]),
        [$4$],
        [$1 / 2$],
...
#lt-tn(num: 6, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Theo quy luật di truyền Mendel, khi lai hai cá thể dị hợp tử mang gen quy định màu hoa $A a times A a$, xác suất để một cây con có hoa đỏ (mang kiểu hình trội) là $p = 3 / 4$, hoa trắng là $q = 1 / 4$. Xét một lứa gồm $4$ cây con độc lập. Xác suất để trong lứa đó có đúng $3$ cây hoa đỏ và $1$ cây hoa trắng bằng],
    (
        True([$27 / 64$]),
        [$81 / 256$],
        [$27 / 128$],
...
#lt-tn(num: 7, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Giá trị của tổng bình phương các hệ số trong khai triển nhị thức bậc 4: $S = (C_4^0)^2 + (C_4^1)^2 + (C_4^2)^2 + (C_4^3)^2 + (C_4^4)^2$ bằng],
    (
        True([$70$]),
        [$256$],
        [$64$],
...
#lt-tn(num: 8, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tổng các giá trị tuyệt đối của tất cả các hệ số trong khai triển đa thức $P(x) = (x^2 - 2)^4$ bằng],
    (
        True([$81$]),
        [$41$],
        [$1$],
...
#lt-tn(num: 9, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tìm hệ số của số hạng chứa $x^2 y^3$ trong khai triển của biểu thức $(2x - 3y)^5$.],
    (
        True([$-1080$]),
        [$1080$],
        [$-720$],
...
#lt-tn(num: 10, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Một quả cầu kim loại có bán kính ban đầu $R_0 = 10 text(" cm")$. Do nhiệt độ tăng, bán kính quả cầu giãn nở thêm $Delta R = 0.02 text(" cm")$. Sử dụng khai triển $(1 + alpha)^3 approx 1 + 3 alpha$ (hoặc bậc 4 cho bài toán lớp 10), diện tích mặt ngoài hoặc thể tích...
...
#lt-tn(num: 11, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Trong khai triển của nhị thức $(root(3, 3) + 1)^5$, số hạng vô tỉ có giá trị lớn nhất là],
    (
        True([$15 root(3, 3)$]),
        [$10 root(3, 9)$],
        [$3 root(3, 9)$],
...
#lt-tn(num: 12, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Giá trị của biểu thức $T = C_5^0 - C_5^1 + C_5^2 - C_5^3 + C_5^4 - C_5^5$ bằng],
    (
        True([$0$]),
        [$1$],
        [$32$],
...
#lt-ds(num: 13, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Một xạ thủ bắn $5$ viên đạn độc lập vào bia. Xác suất bắn trúng bia ở mỗi lần bắn là $p = 0.6$, xác suất bắn trượt là $q = 0.4$.
...
#lt-ds(num: 14, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Cho đa thức $P(x) = (1 + x + x^2)^4 = a_8 x^8 + a_7 x^7 + ... + a_1 x + a_0$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Xét khai triển nhị thức Newton bậc 5: $(1 + x)^5 = C_5^0 + C_5^1 x + C_5^2 x^2 + C_5^3 x^3 + C_5^4 x^4 + C_5^5 x^5$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 16, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Cho biểu thức $Q(x) = (x + 2 / x)^5$ với $x != 0$.
Xét tính đúng sai của các nhận định sau:],
  (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tìm hệ số của số hạng chứa $x^4$ trong khai triển của đa thức $P(x) = (1 + x + x^2)^4$.],
    [19],
    loigiai: [
...
// TLN 2
#lt-tln(num: 18, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tính giá trị của tổng $S = 1 cdot C_5^1 + 2 cdot C_5^2 + 3 cdot C_5^3 + 4 cdot C_5^4 + 5 cdot C_5^5$.],
    [80],
    loigiai: [
...
// TLN 3
#lt-tln(num: 19, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Trong khai triển của biểu thức $(x^2 + 1 / x)^5$ với $x != 0$, tìm hệ số của số hạng chứa $x$.],
    [10],
    loigiai: [
        #step([Số mũ 10 - 3k = 1])
        $k = 3 => C_5^3 = 10$.
...
// TLN 4
#lt-tln(num: 20, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tính tổng bình phương các hệ số của khai triển nhị thức bậc 4: $S = (C_4^0)^2 + (C_4^1)^2 + (C_4^2)^2 + (C_4^3)^2 + (C_4^4)^2$.],
    [70],
    loigiai: [
        #step([Vandermonde])
        $ 1 + 16 + 36 + 16 + 1 = 70 $
...
// TLN 5
#lt-tln(num: 21, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tìm hệ số của số hạng chứa $x^2 y^3$ trong khai triển của biểu thức $(2x - 3y)^5$.],
    [-1080],
    loigiai: [
        #step([Khai triển kép])
...
// TLN 6
#lt-tln(num: 22, de: [Đề 3 (C) — Mã 181], back-to: "sec-exercise-hub",[Tính tổng các giá trị tuyệt đối của tất cả các hệ số trong khai triển đa thức $(x^2 - 2)^4$.],
    [81],
    loigiai: [
        #step([Tổng tuyệt đối])
        $ (1 + 2)^4 = 3^4 = 81 $
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 25: NHỊ THỨC NEWTON (ĐỀ SỐ 28C - NÂNG CAO & PHÂN HÓA VDC)!]      #v(0.6em)
