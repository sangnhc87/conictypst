// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: BÀI 26: BIẾN CỐ VÀ ĐỊNH NGHĨA CỔ ĐIỂN CỦA XÁC SUẤT (ĐỀ SỐ 30A)
// Lớp: Khối 10  ·  Mã đề: 188  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "BÀI 26: BIẾN CỐ VÀ ĐỊNH NGHĨA CỔ ĐIỂN CỦA XÁC SUẤT (ĐỀ SỐ 30A)",
  subtitle: "CHƯƠNG IX: TÍNH XÁC SUẤT THEO ĐỊNH NGHĨA CỔ ĐIỂN — MÃ ĐỀ: 188",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 188]],
...
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Gieo đồng thời hai con xúc xắc cân đối và đồng chất. Xác suất để tổng số chấm xuất hiện trên mặt trên của hai con xúc xắc bằng $8$ là],
    (
        True([$5 / 36$]),
        [$1 / 6$],
        [$1 / 9$],
...
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một hộp chứa $5$ viên bi màu đỏ, $4$ viên bi màu xanh và $3$ viên bi màu vàng (các viên bi có kích thước và khối lượng như nhau). Lấy ngẫu nhiên đồng thời $3$ viên bi từ hộp. Xác suất để trong $3$ viên bi lấy ra có đủ cả ba màu là],
    (
        True([$3 / 11$]),
        [$6 / 11$],
        [$3 / 22$],
...
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Từ tập hợp các chữ số $S = {1, 2, 3, 4, 5, 6, 7}$, người ta lập ngẫu nhiên một số tự nhiên gồm $4$ chữ số đôi một khác nhau. Xác suất để số được lập là một số chia hết cho $5$ bằng],
    (
        True([$1 / 7$]),
        [$1 / 5$],
        [$2 / 7$],
...
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một nhóm gồm $6$ bạn học sinh (trong đó có hai bạn An và Bình) được xếp ngẫu nhiên thành một hàng ngang. Xác suất để An và Bình đứng cạnh nhau bằng],
    (
        True([$1 / 3$]),
        [$1 / 6$],
        [$1 / 2$],
...
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một kiện hàng gồm $10$ linh kiện điện tử, trong đó có $7$ linh kiện tốt và $3$ linh kiện bị khuyết tật. Kỹ thuật viên kiểm tra chất lượng chọn ngẫu nhiên đồng thời $3$ linh kiện. Xác suất để có ít nhất một linh kiện bị khuyết tật trong $3$ linh kiện được lấy ra là],
    (
        True([$17 / 24$]),
        [$7 / 24$],
        [$3 / 10$],
...
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Gieo một đồng xu cân đối và đồng chất $4$ lần liên tiếp. Xác suất để số lần xuất hiện mặt sấp nhiều hơn số lần xuất hiện mặt ngửa là],
    (
        True([$5 / 16$]),
        [$1 / 2$],
        [$3 / 8$],
...
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Chọn ngẫu nhiên $3$ đỉnh từ $12$ đỉnh của một đa giác đều nội tiếp đường tròn. Xác suất để $3$ đỉnh được chọn tạo thành một tam giác vuông bằng],
    (
        True([$3 / 11$]),
        [$6 / 11$],
        [$1 / 4$],
...
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một câu lạc bộ có $18$ bạn nam và $12$ bạn nữ. Ban chủ nhiệm chọn ngẫu nhiên đồng thời $2$ bạn để làm MC cho buổi lễ. Xác suất để hai bạn được chọn có cùng giới tính (cùng là nam hoặc cùng là nữ) bằng],
    (
        True([$73 / 145$]),
        [$72 / 145$],
        [$1 / 2$],
...
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một hộp có $30$ tấm thẻ được đánh số thứ tự từ $1$ đến $30$. Rút ngẫu nhiên một tấm thẻ từ hộp. Xác suất để số ghi trên tấm thẻ rút được chia hết cho $3$ hoặc chia hết cho $5$ bằng],
    (
        True([$7 / 15$]),
        [$1 / 2$],
        [$8 / 15$],
...
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Từ tập hợp các chữ số $X = {1, 2, 3, 4, 5, 6}$, chọn ngẫu nhiên một số tự nhiên gồm $3$ chữ số đôi một khác nhau. Xác suất để tổng các chữ số của số được chọn là một số chẵn bằng],
    (
        True([$1 / 2$]),
        [$2 / 5$],
        [$3 / 5$],
...
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Hai xạ thủ cùng độc lập bắn mỗi người một viên đạn vào một tấm bia. Biết xác suất bắn trúng bia của xạ thủ thứ nhất là $0.8$ và của xạ thủ thứ hai là $0.7$. Xác suất để có đúng một xạ thủ bắn trúng bia bằng],
    (
        True([$0.38$]),
        [$0.56$],
        [$0.24$],
...
// TN 12 (Sinh cùng quý)
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Chọn ngẫu nhiên $4$ người độc lập. Giả sử khả năng sinh vào $4$ quý trong năm của mỗi người là như nhau (xác suất mỗi quý là $1 / 4$). Xác suất để có ít nhất hai người sinh cùng một quý trong năm bằng],
    (
        True([$29 / 32$]),
        [$3 / 32$],
        [$1 / 4$],
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Gieo đồng thời hai con xúc xắc cân đối và đồng chất.
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một hộp chứa $5$ viên bi đỏ, $4$ viên bi xanh và $3$ viên bi vàng. Lấy ngẫu nhiên đồng thời $3$ viên bi từ hộp.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Cho đa giác đều gồm $12$ đỉnh nội tiếp trong đường tròn. Chọn ngẫu nhiên $3$ đỉnh từ $12$ đỉnh của đa giác để tạo thành một tam giác.
Xét tính đúng sai của các nhận định sau:],
  (
    True([Số phần tử của không gian mẫu bằng $220$.]),
...
// DS 4 (Tập hợp thẻ số)
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một hộp chứa $20$ tấm thẻ cùng loại được đánh số từ $1$ đến $20$. Rút ngẫu nhiên đồng thời $2$ tấm thẻ.
Xét tính đúng sai của các nhận định sau:],
  (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Gieo hai con xúc xắc cân đối đồng chất. Tính xác suất để tổng số chấm xuất hiện bằng $8$ (kết quả viết dưới dạng phân số tối giản $a / b$).],
    [5/36],
    loigiai: [
        #step([Tính xác suất])
        $ P = 5 / 36 $
...
// TLN 2
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một hộp có $5$ bi đỏ, $4$ bi xanh, $3$ bi vàng. Lấy ngẫu nhiên $3$ bi. Tính xác suất để có đủ $3$ màu (dưới dạng phân số tối giản).],
    [3/11],
    loigiai: [
        #step([Tính xác suất])
        $ 60 / 220 = 3 / 11 $
...
// TLN 3
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Xếp ngẫu nhiên $6$ bạn học sinh (trong đó có An và Bình) thành hàng ngang. Tính xác suất để An và Bình đứng cạnh nhau (dưới dạng phân số tối giản).],
    [1/3],
    loigiai: [
        #step([Tính xác suất])
        $ 240 / 720 = 1 / 3 $
...
// TLN 4
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Một kiện hàng có $7$ linh kiện tốt và $3$ linh kiện hỏng. Lấy ngẫu nhiên $3$ linh kiện. Tính xác suất lấy được ít nhất một linh kiện hỏng (dưới dạng phân số tối giản).],
    [17/24],
    loigiai: [
        #step([Biến cố đối])
        $ 1 - 35 / 120 = 17 / 24 $
...
// TLN 5
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Gieo một đồng xu cân đối $4$ lần liên tiếp. Tính xác suất để số lần xuất hiện mặt sấp nhiều hơn mặt ngửa (dưới dạng phân số tối giản).],
    [5/16],
    loigiai: [
        #step([Tính xác suất])
        $ 5 / 16 $
...
// TLN 6
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 188], back-to: "sec-exercise-hub",[Chọn ngẫu nhiên $3$ đỉnh từ $12$ đỉnh của đa giác đều. Tính xác suất để $3$ đỉnh tạo thành tam giác vuông (dưới dạng phân số tối giản).],
    [3/11],
    loigiai: [
        #step([Tính xác suất])
        $ 60 / 220 = 3 / 11 $
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH BÀI 26: BIẾN CỐ VÀ ĐỊNH NGHĨA CỔ ĐIỂN CỦA XÁC SUẤT (ĐỀ SỐ 30A)!]      #v(0.6em)
