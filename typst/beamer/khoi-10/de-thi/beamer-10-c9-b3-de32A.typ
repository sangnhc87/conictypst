// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: ÔN TẬP CUỐI CHƯƠNG IX: TÍNH XÁC SUẤT CỔ ĐIỂN (ĐỀ SỐ 32A)
// Lớp: Khối 10  ·  Mã đề: 194  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "ÔN TẬP CUỐI CHƯƠNG IX: TÍNH XÁC SUẤT CỔ ĐIỂN (ĐỀ SỐ 32A)",
  subtitle: "CHƯƠNG IX: TÍNH XÁC SUẤT THEO ĐỊNH NGHĨA CỔ ĐIỂN — MÃ ĐỀ: 194",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 194]],
...
#lt-tn(num: 1, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Gieo đồng thời hai con xúc xắc cân đối và đồng chất. Xác suất để tổng số chấm xuất hiện trên mặt trên của hai con xúc xắc lớn hơn hoặc bằng $10$ bằng],
    (
        True([$1 / 6$]),
        [$5 / 36$],
        [$7 / 36$],
...
#lt-tn(num: 2, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Một hộp chứa $6$ viên bi màu đỏ và $4$ viên bi màu xanh (các viên bi có kích thước và khối lượng như nhau). Lấy ngẫu nhiên đồng thời $3$ viên bi từ hộp. Xác suất để trong $3$ viên bi lấy ra có ít nhất hai viên bi màu đỏ bằng],
    (
        True([$2 / 3$]),
        [$1 / 2$],
        [$3 / 5$],
...
#lt-tn(num: 3, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Từ tập hợp các chữ số $S = {1, 2, 3, 4, 5, 6}$, lập ngẫu nhiên một số tự nhiên gồm $3$ chữ số đôi một khác nhau. Xác suất để số được lập là một số chia hết cho $3$ bằng],
    (
        True([$2 / 5$]),
        [$1 / 3$],
        [$1 / 2$],
...
#lt-tn(num: 4, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Xếp ngẫu nhiên $5$ bạn học sinh An, Bình, Cường, Dũng, Hoa thành một hàng ngang gồm $5$ vị trí. Xác suất để hai bạn An và Bình đứng cách nhau đúng một bạn học sinh khác bằng],
    (
        True([$3 / 10$]),
        [$2 / 5$],
        [$1 / 5$],
...
#lt-tn(num: 5, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Một hộp có $50$ tấm thẻ cùng loại được đánh số thứ tự từ $1$ đến $50$. Rút ngẫu nhiên một tấm thẻ. Xác suất để số ghi trên tấm thẻ rút được chia hết cho cả $2$ và $5$ bằng],
    (
        True([$1 / 10$]),
        [$7 / 50$],
        [$1 / 5$],
...
#lt-tn(num: 6, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Cho đa giác đều có $10$ đỉnh nội tiếp trong đường tròn. Chọn ngẫu nhiên $3$ đỉnh từ $10$ đỉnh của đa giác. Xác suất để $3$ đỉnh được chọn tạo thành một tam giác vuông bằng],
    (
        True([$1 / 3$]),
        [$2 / 3$],
        [$1 / 4$],
...
#lt-tn(num: 7, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Hai xạ thủ cùng độc lập bắn mỗi người một phát đạn vào một tấm bia. Biết xác suất bắn trúng bia của xạ thủ thứ nhất là $0.8$ và của xạ thủ thứ hai là $0.7$. Xác suất để có ít nhất một xạ thủ bắn trúng bia bằng],
    (
        True([$0.94$]),
        [$0.56$],
        [$0.86$],
...
#lt-tn(num: 8, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Một nhóm học sinh xuất sắc gồm $6$ bạn nam và $5$ bạn nữ. Thầy giáo chọn ngẫu nhiên $4$ bạn để tham gia cuộc thi học sinh giỏi cấp trường. Xác suất để trong $4$ bạn được chọn có cả bạn nam và bạn nữ bằng],
    (
        True([$31 / 33$]),
        [$2 / 33$],
        [$30 / 33$],
...
#lt-tn(num: 9, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Gieo một đồng xu cân đối và đồng chất $5$ lần liên tiếp. Xác suất để số lần xuất hiện mặt sấp là một số chẵn (tính cả $0$ lần) bằng],
    (
        True([$1 / 2$]),
        [$5 / 16$],
        [$7 / 16$],
...
#lt-tn(num: 10, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Một hộp có $20$ tấm thẻ được đánh số từ $1$ đến $20$. Rút ngẫu nhiên đồng thời $2$ tấm thẻ. Xác suất để tổng các số ghi trên hai thẻ rút được là một số chẵn bằng],
    (
        True([$9 / 19$]),
        [$10 / 19$],
        [$1 / 2$],
...
#lt-tn(num: 11, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Chọn ngẫu nhiên $2$ người độc lập. Giả sử khả năng sinh vào $12$ tháng trong năm của mỗi người là như nhau. Xác suất để hai người đó sinh vào cùng một tháng trong năm bằng],
    (
        True([$1 / 12$]),
        [$1 / 144$],
        [$11 / 12$],
...
#lt-tn(num: 12, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Gieo đồng thời hai con xúc xắc cân đối và đồng chất. Xác suất để tổng số chấm xuất hiện trên hai con xúc xắc chia hết cho $5$ bằng],
    (
        True([$7 / 36$]),
        [$1 / 6$],
        [$5 / 36$],
...
#lt-ds(num: 13, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Một hộp chứa $6$ viên bi màu đỏ và $4$ viên bi màu xanh. Lấy ngẫu nhiên đồng thời $3$ viên bi từ hộp.
...
#lt-ds(num: 14, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Xét hai xạ thủ độc lập bắn vào bia với xác suất trúng lần lượt là $p_1 = 0.8$ và $p_2 = 0.7$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#lt-ds(num: 15, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Cho đa giác đều có $10$ đỉnh nội tiếp trong đường tròn. Chọn ngẫu nhiên $3$ đỉnh của đa giác để tạo thành một tam giác.
Xét tính đúng sai của các nhận định sau:],
  (
    True([Số phần tử của không gian mẫu bằng $120$.]),
...
#lt-ds(num: 16, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Một hộp chứa $20$ tấm thẻ được đánh số từ $1$ đến $20$. Rút ngẫu nhiên đồng thời $2$ tấm thẻ.
Xét tính đúng sai của các nhận định sau:],
  (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Gieo hai con xúc xắc cân đối. Tính xác suất để tổng số chấm xuất hiện lớn hơn hoặc bằng $10$ (dưới dạng phân số tối giản).],
    [1/6],
    loigiai: [
        #step([Tính xác suất])
        $ 6 / 36 = 1 / 6 $
...
// TLN 2
#lt-tln(num: 18, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Lấy ngẫu nhiên $3$ viên bi từ hộp có $6$ đỏ và $4$ xanh. Tính xác suất lấy được ít nhất $2$ viên bi đỏ (dưới dạng phân số tối giản).],
    [2/3],
    loigiai: [
        #step([Tính xác suất])
        $ 80 / 120 = 2 / 3 $
...
// TLN 3
#lt-tln(num: 19, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Từ tập ${1, 2, ..., 6}$, lập số có $3$ chữ số khác nhau. Tính xác suất để số đó chia hết cho $3$ (dưới dạng phân số tối giản).],
    [2/5],
    loigiai: [
        #step([Tính xác suất])
        $ 48 / 120 = 2 / 5 $
...
// TLN 4
#lt-tln(num: 20, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Xếp $5$ bạn học sinh (trong đó có An và Bình) thành hàng ngang. Tính xác suất để An và Bình đứng cách nhau đúng một bạn (dưới dạng phân số tối giản).],
    [3/10],
    loigiai: [
        #step([Tính xác suất])
        $ 36 / 120 = 3 / 10 $
...
// TLN 5
#lt-tln(num: 21, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Hai xạ thủ độc lập có xác suất trúng là $0.8$ và $0.7$. Tính xác suất có ít nhất một người bắn trúng bia.],
    [0.94],
    loigiai: [
        #step([Biến cố đối])
        $ 1 - (0.2)(0.3) = 0.94 $
...
// TLN 6
#lt-tln(num: 22, de: [Đề 1 (A) — Mã 194], back-to: "sec-exercise-hub",[Từ $10$ đỉnh của đa giác đều, có bao nhiêu tam giác vuông được tạo thành?],
    [40],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH ÔN TẬP CUỐI CHƯƠNG IX: TÍNH XÁC SUẤT CỔ ĐIỂN (ĐỀ SỐ 32A)!]      #v(0.6em)
