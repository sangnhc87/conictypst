// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 1. LƯỢNG GIÁC (ĐỀ SỐ 06)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 1. LƯỢNG GIÁC (ĐỀ SỐ 06)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Khi nghiên cứu về âm thanh, một nốt nhạc cơ bản có phương trình sóng âm dạng $p(t) = P_0 sin(2pi f t)$. Giá trị cực đại của áp suất $P_0$ thể hiện đặc trưng nào của âm thanh?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một vòng quay Mặt Trời (Ferris wheel) có cabin xuất phát từ vị trí thấp nhất. Hàm số $h(t) = 20 - 18 cos(pi/10 t)$ mô phỏng độ cao của cabin theo thời gian $t$ (phút). Bán kính của vòng quay là bao nhiêu?],
    (
        [$20$ m],
        True([$18$ m]),
        [$2$ m],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Điện áp của một mạng điện xoay chiều gia đình ở Việt Nam có tần số $f = 50$ Hz. Chu kì biến thiên của điện áp này là],
    (
        [$50$ s],
        [$20$ s],
        True([$0.02$ s]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Góc ngẩng của một vệ tinh viễn thông so với một trạm mặt đất thay đổi và tuân theo một hàm số tuần hoàn. Khoảng thời gian giữa hai lần liên tiếp vệ tinh đạt góc ngẩng lớn nhất chính là],
    (
        [Biên độ của hàm số.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Để tối ưu hóa năng lượng mặt trời, một tấm pin được thiết kế quay tự động theo góc tới của tia sáng $alpha(t) = pi/4 sin((pi t)/12)$, với $t$ là giờ trong ngày. Góc lệch lớn nhất của tấm pin so với phương ngang là],
    (
        [$pi/2$ rad],
        [$pi/3$ rad],
        True([$pi/4$ rad]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc cầu treo bị rung lắc nhẹ do gió với biên độ $A$. Nếu dùng hàm số lượng giác $y = A sin(omega t)$ để mô phỏng li độ của cầu, khi cầu ở trạng thái tĩnh (không rung), giá trị của $y$ là],
    (
        True([$0$]),
        [$A$],
        [$-A$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Số lượng sản phẩm bán ra của một công ty may mặc đồ mùa đông được mô hình hóa bởi $S(t) = 5000 + 3000 cos((pi)/6 (t - 1))$, $t$ là các tháng trong năm ($t=1,2,...,12$). Tháng nào công ty bán được nhiều sản phẩm nhất?],
    (
        True([Tháng $1$]),
        [Tháng $6$],
        [Tháng $7$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một piston trong động cơ đốt trong di chuyển dọc theo xi lanh với li độ $x = 4 cos(60pi t)$ (cm). Quãng đường di chuyển của piston từ vị trí cực tiểu đến cực đại là],
    (
        [$4$ cm],
        True([$8$ cm]),
        [$12$ cm],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Trong ngành cơ điện tử, để phân tích dao động của một cánh tay robot, kỹ sư giải phương trình $cos(x - pi/4) = sqrt(2)/2$. Tập nghiệm của phương trình này là],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Sức tải của một cây cầu vượt biến thiên theo hàm số $F(t) = 150 + 50 cos((pi t)/4)$, $t$ là thời gian. Phương trình $F(t) = 100$ có ý nghĩa thực tế nào sau đây?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Vị trí của một đầu van bánh xe đạp có phương trình $y = 35 + 35 cos(4pi t)$ (cm). Tâm của bánh xe cách mặt đất một khoảng bao nhiêu?],
    (
        [$70$ cm],
        True([$35$ cm]),
        [$0$ cm],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Mực nước $h$ tại một con kênh thay đổi theo phương trình $h = 2 sin(x)$. Nếu thay đổi pha ban đầu của dao động, đại lượng nào sau đây thay đổi?],
    (
        [Độ sâu lớn nhất.],
        [Độ sâu nhỏ nhất.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 1
#lt-tln(num: 17, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 2
#lt-tln(num: 18, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 3
#lt-tln(num: 19, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 1. LƯỢNG GIÁC (ĐỀ SỐ 06)!]      #v(0.6em)
