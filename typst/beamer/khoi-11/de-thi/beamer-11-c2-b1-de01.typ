// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 01)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 01)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ biết $u_n = (2n - 1) / (n + 1)$. Ba số hạng đầu tiên của dãy số lần lượt là],
    (
        [$1/2; 1; 5/4$.],
        [$1; 3/2; 5/3$.],
        True([$1/2; 1; 5/4$.]),
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ được xác định bởi: $cases(u_1 = 3, u_n = u_(n-1) + 2 quad (n >= 2))$. Số hạng thứ $4$ của dãy số là],
    (
        [$7$.],
        [$8$.],
        True([$9$.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Trong các dãy số sau đây, dãy số nào là cấp số cộng?],
    (
        True([$1; 4; 7; 10; 13$.]),
        [$1; 2; 4; 8; 16$.],
        [$1; -1; 1; -1; 1$.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số cộng $(u_n)$ có số hạng đầu $u_1 = -2$ và công sai $d = 3$. Tìm số hạng tổng quát $u_n$ của cấp số cộng đó.],
    (
        [$u_n = -2 + 3^n$.],
        [$u_n = 3n - 2$.],
        True([$u_n = 3n - 5$.]),
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Một cấp số cộng có $u_3 = 10$ và $u_8 = 30$. Công sai $d$ của cấp số cộng này bằng],
    (
        [$2$.],
        [$3$.],
        True([$4$.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Tổng của $10$ số hạng đầu tiên của cấp số cộng có $u_1 = 5$ và $d = 2$ bằng bao nhiêu?],
    (
        [$130$.],
        True([$140$.]),
        [$150$.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Trong các dãy số cho bởi công thức tổng quát sau đây, dãy số nào là cấp số nhân?],
    (
        [$u_n = 2n + 3$.],
        True([$u_n = 5 dot 2^n$.]),
        [$u_n = n^2 + 1$.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số nhân $(u_n)$ có số hạng đầu $u_1 = 3$ và công bội $q = -2$. Số hạng thứ $5$ của cấp số nhân đó là],
    (
        [$-48$.],
        True([$48$.]),
        [$-96$.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Tổng $S = 1 + 2 + 4 + 8 + ... + 512$ bằng bao nhiêu?],
    (
        [$511$.],
        [$1024$.],
        True([$1023$.]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Để rèn luyện sức khỏe, anh A bắt đầu tập chạy. Tuần đầu tiên anh chạy được $5$ km. Mỗi tuần sau đó, do thể lực tăng nên quãng đường anh chạy được tăng thêm $2$ km so với tuần trước. Hỏi ở tuần thứ $10$, anh A chạy được quãng đường bao nhiêu km?],
    (
        [$21$ km.],
        True([$23$ km.]),
        [$25$ km.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng cao su được thả từ độ cao $10$ m. Mỗi lần chạm đất, nó nảy lên một độ cao bằng $3/4$ độ cao trước đó. Độ cao của quả bóng sau lần nảy thứ $3$ (làm tròn đến hai chữ số thập phân) là bao nhiêu mét?],
    (
        [$3.16$ m.],
        [$5.63$ m.],
        True([$4.22$ m.]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Bốn số tạo thành một cấp số cộng. Tổng của chúng bằng $20$ và tổng bình phương của chúng bằng $120$. Công sai của cấp số cộng này (biết cấp số cộng là dãy số tăng) bằng bao nhiêu?],
    (
        [$1$.],
        True([$2$.]),
        [$3$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ với $u_n = (3n - 1) / (2n + 1)$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số cộng $(u_n)$ có $u_1 = -5$ và $u_6 = 10$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số nhân $(v_n)$ có $v_1 = 2$ và công bội $q = 3$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Một tòa nhà hình tháp có 30 tầng. Số lượng bóng đèn cần dùng ở tầng 1 là $15$ bóng, tầng 2 là $18$ bóng, tầng 3 là $21$ bóng, và cứ tiếp tục tăng theo cấp số cộng cho đến tầng 30. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số cộng $(u_n)$ có $u_1 + u_5 = 14$ và $u_2 + u_7 = 20$. Tìm số hạng thứ 10 của cấp số cộng đó.],
    [21],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cấp số nhân $(u_n)$ có $u_1 = 3$, công bội $q = 2$. Biết tổng $n$ số hạng đầu tiên $S_n = 765$. Tìm $n$.],
    [8],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Ba số $x, y, z$ theo thứ tự lập thành một cấp số cộng và tổng của chúng bằng $15$. Nếu thêm lần lượt $1, 4, 19$ vào $x, y, z$ thì được ba số mới lập thành cấp số nhân. Tìm số lớn nhất trong ba số $x, y, z$. (Biết $x < y < z$).],
    [8],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Một nhà hát có $20$ hàng ghế. Hàng ghế đầu tiên có $15$ ghế. Các hàng sau, mỗi hàng có số ghế nhiều hơn hàng liền trước $2$ ghế. Hỏi nhà hát có tổng sức chứa bao nhiêu khách ngồi?],
    [680],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cấp số nhân $(v_n)$ có số hạng thứ hai $v_2 = -6$ và số hạng thứ năm $v_5 = 48$. Tính tổng $8$ số hạng đầu tiên của cấp số nhân này.],
    [-255],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 01)!]      #v(0.6em)
