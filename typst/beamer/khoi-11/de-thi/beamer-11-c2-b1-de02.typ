// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 02)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 02)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ xác định bởi $u_n = (a n + 2) / (n + 1)$, với $a$ là tham số thực. Để dãy số $(u_n)$ là một dãy số tăng, điều kiện của $a$ là],
    (
        [$a < 2$.],
        True([$a > 2$.]),
        [$a < 1$.],
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Ba số thực $x, y, z$ (khác $0$) theo thứ tự lập thành một cấp số cộng. Mệnh đề nào sau đây là hệ quả của giả thiết trên?],
    (
        [$x^2 + z^2 = 2y^2$.],
        [$x z = y^2$.],
        [$1/x + 1/z = 2/y$.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho một cấp số nhân có các số hạng đều dương. Biết rằng tổng của hai số hạng đầu bằng $3$ và tổng của số hạng thứ ba và số hạng thứ tư bằng $12$. Công bội $q$ của cấp số nhân đó là],
    (
        [$q = 4$.],
        True([$q = 2$.]),
        [$q = 3$.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ xác định bởi $u_1 = 2$ và $u_(n+1) = u_n + 3n - 1$ với mọi $n >= 1$. Biểu thức nào sau đây biểu diễn chính xác số hạng tổng quát $u_n$?],
    (
        [$u_n = 3n^2 - 2n + 1$.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Gọi $S_n$ là tổng của $n$ số hạng đầu tiên của một cấp số cộng. Biết $S_n = 3n^2 - 2n$ với mọi $n >= 1$. Công sai $d$ của cấp số cộng đó là],
    (
        [$d = 3$.],
        [$d = 4$.],
        [$d = 5$.],
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một doanh nghiệp dự định mua một cỗ máy. Do hao mòn, giá trị của cỗ máy giảm $10\%$ mỗi năm so với năm liền trước. Gọi $V_n$ là giá trị cỗ máy sau $n$ năm. Dãy số $(V_n)$ lập thành],
    (
        [$u_n = V_0 - 0.1n$.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Tổng $S = x + x^2 + x^3 + ... + x^100$ ($x != 1$) bằng],
    (
        [$(x^(101) - 1) / (x - 1)$.],
        True([$x (x^100 - 1) / (x - 1)$.]),
        [$(x^100 - 1) / (x - 1)$.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Độ dài ba cạnh của một tam giác vuông lập thành một cấp số cộng. Tỉ số các cạnh của tam giác vuông đó là],
    (
        [$1 : 2 : 3$.],
        True([$3 : 4 : 5$.]),
        [$5 : 12 : 13$.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Nếu ba số thực $a, b, c$ lập thành cấp số nhân thì biểu thức nào sau đây chắc chắn đúng?],
    (
        True([$a c = b^2$.]),
        [$a c = 2b$.],
        [$a + c = 2b$.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một khu rừng có trữ lượng gỗ hiện tại là $100 000" m"^3$. Mỗi năm, khối lượng gỗ trong rừng tăng thêm $5\%$ nhờ cây sinh trưởng. Hàm số nào dưới đây biểu diễn trữ lượng gỗ $V(n)$ sau $n$ năm?],
    (
        [$V(n) = 100 000 + 5000 n$.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số $x, 5, 2y$ lập thành cấp số cộng và ba số $x, 4, 2y$ lập thành cấp số nhân. Giá trị của $|x - 2y|$ bằng bao nhiêu? (Giả sử các số hạng đều khác $0$).],
    (
        [$2$.],
        [$4$.],
        True([$6$.]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Người ta thiết kế một bậc thang gồm $15$ bậc. Bậc thấp nhất rộng $1.2$ mét, và cứ lên mỗi bậc thì chiều rộng lại giảm đi một khoảng cách $d$ mét. Biết bậc cao nhất rộng $0.5$ mét. Giá trị của $d$ là],
    (
        [$0.02$.],
        True([$0.05$.]),
        [$0.04$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ thỏa mãn $u_1 = 1$ và $u_n = 2u_(n-1) + 1$ với mọi $n >= 2$. Đặt $v_n = u_n + 1$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho phương trình $x^3 - 3x^2 - 9x + m = 0$ có ba nghiệm phân biệt lập thành cấp số cộng. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một dự án trồng rừng dự định năm thứ nhất trồng được $500$ hecta, và mỗi năm sau sẽ trồng được diện tích nhiều hơn năm trước là $10\%$. Gọi $S_n$ là tổng diện tích rừng đã trồng được sau $n$ năm. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ với $u_n = (-1)^n (2n + 1)$. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số cộng $(u_n)$ thỏa mãn $u_2 - u_3 + u_5 = 10$ và $u_4 + u_6 = 26$. Tính số hạng $u_10$.],
    [28],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Bốn số tạo thành một cấp số nhân. Biết tổng của số hạng thứ nhất và thứ ba bằng $20$, tổng của số hạng thứ hai và thứ tư bằng $40$. Tìm tổng $S$ của cả bốn số hạng đó.],
    [60],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một công ty khai thác quặng, mỗi năm sản lượng khai thác bị giảm đi $10\%$ so với năm trước do cạn kiệt tài nguyên. Năm đầu tiên công ty khai thác được $1000$ tấn. Giả sử quá trình khai thác diễn ra vô hạn, tổng khối lượng quặng công ty có thể khai thác được là bao nhiêu tấn?],
    [10000],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một tờ giấy có độ dày $0.1$ mm. Khi gập đôi tờ giấy, độ dày tăng lên gấp đôi. Hỏi nếu gập đôi tờ giấy liên tiếp $12$ lần thì độ dày của nó đạt bao nhiêu mm?],
    [409.6],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Trong một trò chơi, người chơi bắt đầu với số tiền thưởng là $10 000$ đồng. Nếu thắng vòng $1$, họ được cộng thêm một số tiền thưởng. Bắt đầu từ vòng $2$, nếu thắng, số tiền thưởng được cộng thêm sẽ gấp ba lần số tiền thưởng cộng thêm ở vòng ngay trước đó. Sau khi thắng $4$ vòng liên tiếp, tổng số tiền thưởng người đó có là $210 000$ đồng. Hỏi số tiền thưởng cộng thêm ở vòng $1$ là bao nhiêu đồng?],
    [5000],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Biết tam giác vuông $A B C$ có số đo ba góc (tính bằng độ) lập thành một cấp số cộng. Trong đó có một góc nhỏ nhất. Số đo của góc nhỏ nhất bằng bao nhiêu độ?],
    [30],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 02)!]      #v(0.6em)
