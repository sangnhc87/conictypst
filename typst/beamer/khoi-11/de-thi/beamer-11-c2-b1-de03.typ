// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 03)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 03)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ thỏa mãn $u_n = 2^n - n$. Khẳng định nào sau đây là đúng về dãy số này?],
    (
        [$u_n$ là dãy số giảm.],
        [$u_n$ bị chặn trên.],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Biết rằng ba số $x, y, z$ (khác $0$) lập thành một cấp số nhân với công bội $q != 1$. Ba số $x, 2y, 3z$ lập thành một cấp số cộng. Giá trị của $q$ là],
    (
        [$q = 1/2$.],
        [$q = 2$.],
        True([$q = 1/3$.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Ký hiệu $S_n$ là tổng của $n$ số hạng đầu tiên của một cấp số cộng. Nếu $S_6 = 3 S_3$, tỉ số giữa công sai $d$ và số hạng đầu $u_1$ (giả sử $u_1 != 0$) bằng bao nhiêu?],
    (
        True([$1/2$.]),
        [$1$.],
        [$2$.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số nhân $(u_n)$ có các số hạng đều âm. Biết $u_2 = -2$ và $u_4 = -18$. Số hạng tổng quát của cấp số nhân này là],
    (
        [$u_n = -2/3 dot 3^n$.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một cấp số cộng $(u_n)$ có tổng $n$ số hạng đầu tiên được cho bởi công thức $S_n = 5n^2 + 3n$. Số hạng tổng quát $u_n$ của cấp số cộng đó là],
    (
        [$u_n = 10n - 2$.],
        [$u_n = 5n + 3$.],
        [$u_n = 10n + 3$.],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Trong một nhà hát, hàng ghế đầu tiên có $a$ ghế. Mỗi hàng ghế tiếp theo có nhiều hơn hàng liền trước $d$ ghế ($d > 0$). Nếu tổng số ghế của $10$ hàng đầu tiên bằng tổng số ghế của $15$ hàng đầu tiên thì],
    (
        [$a = -7d$.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số $a, b, c$ lập thành cấp số cộng. Mệnh đề nào sau đây đúng?],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Gọi $S$ là tổng vô hạn của cấp số nhân $1, -1/2, 1/4, -1/8, ...$. Giá trị của $S$ là],
    (
        [$2$.],
        [$1/2$.],
        True([$2/3$.]),
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng rơi từ độ cao $h$. Sau mỗi lần chạm đất, quả bóng nảy lên độ cao bằng $p$ lần độ cao trước đó ($0 < p < 1$). Tổng quãng đường quả bóng di chuyển (lên và xuống) cho đến khi dừng hẳn là],
    (
        [$h (1+p) / (1-p)$.],
        True([$h (1+p) / (1-p)$.]),
        [$h / (1-p)$.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Biết rằng phương trình $x^3 - p x^2 + q x - r = 0$ có ba nghiệm lập thành cấp số nhân. Mối liên hệ bắt buộc giữa $p, q, r$ là],
    (
        [$p^3 = r q^3$.],
        [$r^2 = p^3 q$.],
        True([$q^3 = r p^3$.]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một người gửi $A$ đồng vào ngân hàng với lãi suất $r$ mỗi kỳ theo hình thức lãi kép. Tổng số tiền người đó nhận được sau $n$ kỳ hạn lập thành dãy số $(T_n)$. Dãy $(T_n)$ có tính chất gì?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hai cấp số cộng $(u_n)$ và $(v_n)$. Dãy số $(w_n)$ được định nghĩa bởi $w_n = 2u_n - 3v_n + 5$. Khẳng định nào sau đây là đúng?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ xác định bởi $u_1 = 3$ và $u_n = 1 / (2 - u_(n-1))$ với mọi $n >= 2$. Các phát biểu sau đúng hay sai?], (
        True([$u_2 = -1$.]),
        True([$u_3 = 1/3$.]),
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một cấp số cộng $(u_n)$ và một cấp số nhân $(v_n)$ có cùng số hạng thứ nhất $u_1 = v_1 = 2$, cùng số hạng thứ hai $u_2 = v_2 = a$ ($a > 2$). Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Tổng $S = 1 + 2x + 3x^2 + 4x^3 + ... + n x^(n-1)$ (với $x != 1$) được xây dựng bằng cách kết hợp cấp số cộng và cấp số nhân (gọi là chuỗi cấp số nhân - cộng). Xét quá trình tính $S$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số lập thành cấp số cộng có tổng bằng $21$. Nếu thêm $2, 3, 9$ lần lượt vào ba số đó, ta được ba số mới lập thành cấp số nhân. Gọi ba số ban đầu là $a, b, c$. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số $x, y, z$ thỏa mãn đồng thời: $x+y+z=14$, ba số này theo thứ tự lập thành một cấp số nhân, và ba số $x, y+1, z$ theo thứ tự lập thành một cấp số cộng. Tìm giá trị của $x$ biết $x > z$.],
    [8],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Tính tổng $S = 1 dot 2 + 2 dot 3 + 3 dot 4 + ... + 20 dot 21$.],
    [3080],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ được xác định bởi $u_1 = 1$ và $u_n = 2 u_(n-1) + 3$ với $n >= 2$. Số hạng $u_10$ bằng bao nhiêu?],
    [2045],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một nhà nông muốn xây dựng một hàng rào quanh một mảnh đất hình tam giác vuông. Biết độ dài ba cạnh của tam giác vuông lập thành một cấp số cộng và chu vi của tam giác bằng $120$ mét. Diện tích của mảnh đất này bằng bao nhiêu mét vuông?],
    [600],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Người ta xếp các viên bi thành hình tháp: hàng trên cùng có $1$ viên, hàng thứ hai có $3$ viên, hàng thứ ba có $6$ viên, hàng thứ tư có $10$ viên, và tổng quát hàng thứ $n$ có $n(n+1)/2$ viên. Tổng số viên bi cần thiết để xếp được một tháp có $15$ hàng bằng bao nhiêu?],
    [680],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một người vay ngân hàng $1$ tỷ đồng với lãi suất $1\%$/tháng. Mỗi tháng, người đó trả một khoản tiền cố định $X$ (đồng). Biết rằng sau đúng $12$ tháng, người đó trả hết hoàn toàn nợ (số dư bằng $0$). Giá trị của $X$ (làm tròn đến hàng đơn vị) là bao nhiêu?],
    [88848789],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 03)!]      #v(0.6em)
