// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 04)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 04)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Biết dãy số $(u_n)$ được cho bởi $u_n = 3^n / n!$. Mệnh đề nào dưới đây mô tả đúng nhất tính chất của dãy số này?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số phân biệt $a, b, c$ lập thành cấp số cộng. Mệnh đề nào sau đây biểu diễn mối liên hệ đúng của chúng?],
    (
        [$a^2 + c^2 = 2b^2$.],
        True([$(a - b) / (b - c) = 1$.]),
        [$(a - c)^2 = 4 b^2$.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Trong một cấp số nhân $(v_n)$ có $v_1 != 0$ và công bội $q != 0$, $q != 1$. Tổng bình phương của $n$ số hạng đầu tiên được tính bằng công thức nào?],
    (
        [$v_1^2 (1 - q^(2n)) / (1 - q)^2$.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Gọi $S_n$ là tổng của $n$ số hạng đầu của một cấp số cộng $(u_n)$ có công sai $d != 0$. Mệnh đề nào sau đây là hằng số (không phụ thuộc vào $n$)?],
    (
        [$S_n / n$.],
        True([$(S_n) / n - (n d) / 2$.]),
        [$S_n - n^2 d$.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số nhân $(u_n)$ với $u_1 > 0$ và công bội $q > 1$. Mệnh đề nào sau đây đúng về dãy số $v_n = ln(u_n)$?],
    (
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Khai triển của một đa thức $P(x) = a_0 + a_1 x + a_2 x^2 + ... + a_n x^n$. Biết rằng các hệ số $a_0, a_1, a_2, ...$ theo thứ tự lập thành một cấp số cộng với công sai $d$. Giá trị của biểu thức $P(1) - P(-1)$ phụ thuộc chủ yếu vào],
    (
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Trong một phòng hòa nhạc, các dãy ghế được bố trí theo hình vòng cung. Dãy đầu tiên có $20$ ghế, dãy thứ hai có $23$ ghế, dãy thứ ba có $26$ ghế... Hỏi để bố trí được ít nhất $1000$ chỗ ngồi thì phòng hòa nhạc cần thiết kế tối thiểu bao nhiêu dãy ghế?],
    (
        [$20$ dãy.],
        True([$21$ dãy.]),
        [$22$ dãy.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Ba số phân biệt $x, y, z$ lập thành cấp số nhân. Mệnh đề nào sau đây có thể đúng?],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số cộng $(u_n)$ có $u_1 > 0$ và công sai $d < 0$. Gọi $S_n$ là tổng $n$ số hạng đầu tiên. Khẳng định nào sau đây là chính xác nhất về giá trị của $S_n$?],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Hai số hạng đầu của một cấp số nhân là $x$ và $x+1$ (với $x != 0$). Số hạng thứ ba bằng $x+3$. Tìm giá trị của $x$.],
    (
        [$x = 1/2$.],
        True([$x = 1$.]),
        [$x = 2$.],
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Nếu tổng $n$ số hạng đầu tiên của một dãy số là $S_n = 2^(n+1) - 2$. Dãy số đó là],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số thực phân biệt $a, b, c$ khác $0$. Biết rằng $a, b, c$ lập thành một cấp số cộng và $a, c, b$ lập thành một cấp số nhân. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Tổng $S = sum_(k=1)^n 1/(sqrt(k) + sqrt(k+1))$ có thể tính được bằng cách rút gọn (phương pháp liên hợp). Xét quá trình tính $S$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ xác định bởi $u_n = 5^n / (n^2 + 1)$. Xét tỉ số $T_n = u_(n+1) / u_n$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Một bệnh nhân được tiêm $20$ mg một loại thuốc. Biết rằng sau mỗi giờ, cơ thể sẽ phân giải (đào thải) $25\%$ lượng thuốc còn lại trong máu. Khẳng định nào sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Cho một cấp số cộng có số hạng đầu $u_1 = a$ và công sai $d = 2$. Biết rằng ba số hạng $u_1, u_3, u_9$ theo thứ tự đó lập thành một cấp số nhân. Tìm giá trị của $a$.],
    [2],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Có bao nhiêu số nguyên $n$ thuộc khoảng $(1; 100)$ sao cho dãy số $(u_n)$ với $u_n = n^2 - 19n + 5$ là một dãy số tăng bắt đầu từ chỉ số $n$ đó? (Tức là $u_(n+1) > u_n$ với mọi $n$ lớn hơn hoặc bằng giá trị nguyên tối thiểu). Tìm giá trị nguyên $n$ tối thiểu đó.],
    [10],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Trong không gian, một vật di chuyển theo các đoạn thẳng liên tiếp. Đoạn đầu tiên dài $100$ cm. Mỗi đoạn tiếp theo có chiều dài bằng $4/5$ chiều dài đoạn liền trước nó. Tính tổng giới hạn quãng đường vật có thể di chuyển được (tính bằng cm) nếu nó cứ tiếp tục di chuyển theo quy luật đó vô hạn lần.],
    [500],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Gọi $a, b, c$ là ba góc của một tam giác. Biết rằng $sin a, sin b, sin c$ lập thành một cấp số cộng và $a, b, c$ cũng lập thành một cấp số cộng. Tìm số đo góc lớn nhất của tam giác (tính bằng độ).],
    [60],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Trong một thí nghiệm, một nhóm vi khuẩn ban đầu có $1000$ cá thể. Biết rằng cứ sau $2$ giờ, số lượng vi khuẩn tăng gấp $3$ lần. Để quần thể đạt mức tối thiểu $81 000$ cá thể thì phải mất ít nhất bao nhiêu giờ?],
    [8],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 1 (de04) — Mã 101], back-to: "sec-exercise-hub",[Tồn tại bao nhiêu tứ giác lồi có chu vi bằng $12$ và độ dài bốn cạnh lập thành một cấp số cộng với công sai $d = 2$?],
    [0],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 04)!]      #v(0.6em)
