// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 05)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 05)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Biết rằng $(u_n)$ là một dãy số tăng gồm các số thực dương. Khẳng định nào sau đây là đúng đối với dãy số $v_n = 1 / u_n$?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số cộng $(u_n)$. Biết rằng tổng của $m$ số hạng đầu tiên bằng $n$ và tổng của $n$ số hạng đầu tiên bằng $m$ (với $m != n$). Tổng của $m+n$ số hạng đầu tiên của cấp số cộng đó bằng bao nhiêu?],
    (
        [$m + n$.],
        [$m - n$.],
        [$-(m - n)$.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Tìm tất cả các giá trị của tham số $m$ để phương trình $x^4 - 2(m+1)x^2 + 2m + 1 = 0$ có $4$ nghiệm phân biệt lập thành cấp số cộng.],
    (
        [$m = 4$.],
        True([$m = 4$ hoặc $m = -4/9$.]),
        [$m = 4$ hoặc $m = 4/9$.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Biết rằng chu vi của một tam giác vuông lập thành cấp số nhân với công bội $q$. Khẳng định nào sau đây mô tả đúng nhất về $q$?],
    (
        [$q = (1 + sqrt(5))/2$.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Xét cấp số nhân vô hạn $(u_n)$ có công bội $q$ thỏa mãn $|q| < 1$. Gọi $S$ là tổng của cấp số nhân đó và $S_2$ là tổng các số hạng ở vị trí chẵn. Mối liên hệ nào sau đây là đúng?],
    (
        [$S_2 = S / (1+q)$.],
        [$S_2 = S q / (1-q)$.],
        True([$S_2 = (S q) / (1+q)$.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Người ta sử dụng phương pháp chia đôi một đoạn thẳng. Bắt đầu với đoạn thẳng $A B$ có độ dài $L$. Bước 1, lấy trung điểm $M_1$. Bước 2, lấy trung điểm $M_2$ của $M_1 B$. Bước $n$, lấy trung điểm $M_n$ của $M_(n-1) B$. Tổng độ dài các đoạn $A M_1 + M_1 M_2 + M_2 M_3 + ... + M_(n-1) M_n$ khi $n -> +oo$ bằng],
    (
        [$L/2$.],
        True([$L$.]),
        [$2L$.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Nếu ba số dương $x, y, z$ lập thành cấp số nhân thì biểu thức $P = ln x - 2 ln y + ln z$ có giá trị bằng bao nhiêu?],
    (
        [$1$.],
        [$ln(x y z)$.],
        True([$0$.]),
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho $x_1, x_2$ là các nghiệm của phương trình $x^2 - 3x + a = 0$ và $x_3, x_4$ là các nghiệm của phương trình $x^2 - 12x + b = 0$. Biết rằng $x_1, x_2, x_3, x_4$ theo thứ tự lập thành cấp số nhân tăng ngặt. Giá trị của $a + b$ là],
    (
        [$32$.],
        True([$34$.]),
        [$36$.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một công ty quyết định thưởng cuối năm cho nhân viên theo quy tắc: Năm đầu tiên thưởng $5$ triệu đồng, những năm sau mỗi năm tăng thêm $1$ triệu đồng so với năm liền trước. Hỏi sau $n$ năm, tổng số tiền thưởng mà một nhân viên nhận được vượt quá $100$ triệu đồng thì $n$ tối thiểu bằng bao nhiêu?],
    (
        [$10$.],
        True([$11$.]),
        [$12$.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ xác định bởi $u_n = sin(n pi/2)$. Khẳng định nào sau đây là sai?],
    (
        [Dãy số $(u_n)$ bị chặn.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một đa giác lồi có các góc trong (tính bằng độ) lập thành một cấp số cộng với công sai $d = 5^o$. Biết góc nhỏ nhất của đa giác đó là $120^o$. Hỏi đa giác đó có bao nhiêu cạnh?],
    (
        True([$9$ cạnh.]),
        [$16$ cạnh.],
        [$9$ cạnh hoặc $16$ cạnh.],
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Trong một giải cờ vua vòng tròn một lượt (mỗi kỳ thủ đấu với mọi kỳ thủ khác đúng một ván), người ta nhận thấy điểm số của các kỳ thủ khi xếp từ cao xuống thấp lập thành một cấp số cộng. Trận thắng được $1$ điểm, hòa được $0.5$ điểm, thua $0$ điểm. Biết có $n$ kỳ thủ và kỳ thủ xếp chót được $0$ điểm. Hỏi số kỳ thủ $n$ có thể nhận giá trị nào?],
    (
        [$n = 3$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Xét dãy số $(u_n)$ được định nghĩa bởi $u_1 = 2$ và $u_(n+1) = (u_n) / (u_n + 1)$ với mọi $n >= 1$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số $a, b, c$ lập thành cấp số nhân. Các phát biểu sau đúng hay sai (giả sử các biểu thức đều xác định)?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho cấp số cộng $(u_n)$ và gọi $S_n$ là tổng $n$ số hạng đầu tiên của nó. Biết $S_m = S_n$ với $m != n$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát mô hình lợi nhuận của một chuỗi cửa hàng. Lợi nhuận hàng tháng lập thành cấp số cộng. Tháng 1 lãi $10$ triệu. Tháng 6 lãi $35$ triệu. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho ba số lập thành cấp số nhân. Nếu lấy số thứ hai cộng thêm $2$ thì ba số mới lập thành cấp số cộng. Nếu lấy số thứ ba (của cấp số cộng mới) cộng thêm $9$ thì ba số lại lập thành cấp số nhân. Tìm số bé nhất trong ba số ban đầu, biết rằng các số đều dương.],
    [4],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Gọi $x, y$ là hai nghiệm phân biệt của phương trình $t^2 - p t + q = 0$. Giả sử $1, x, y$ lập thành một cấp số cộng và $1, y, x$ lập thành một cấp số nhân. Tính giá trị biểu thức $8(p + q)$.],
    [-3],
    loigiai: [
        Theo giả thiết:
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Trong một cuộc thi, phần thưởng được phát cho $10$ thứ hạng theo một cấp số cộng (từ hạng thấp đến hạng cao). Tổng quỹ giải thưởng là $3250$ đô la. Giải nhất (hạng cao nhất) cao hơn giải chót (hạng thấp nhất) $450$ đô la. Hỏi người đạt giải nhất sẽ nhận được bao nhiêu đô la?],
    [550],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Mật độ vi khuẩn trong một đĩa nuôi cấy tăng theo quy luật cấp số nhân theo từng giờ. Ban đầu có $A$ vi khuẩn. Sau $5$ giờ, số lượng vi khuẩn đo được là $32 A$. Hỏi sau tổng cộng $7$ giờ, số lượng vi khuẩn sẽ gấp bao nhiêu lần số lượng ban đầu $A$?],
    [128],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Hai người cùng làm việc trong $30$ ngày. Người A nhận lương một lần vào cuối kỳ là $100$ triệu đồng. Người B nhận lương theo ngày: ngày đầu $10 000$ đồng, và mỗi ngày tiếp theo nhận thêm $5 000$ đồng so với ngày trước đó. Sự chênh lệch thu nhập (triệu đồng) giữa người A và người B là bao nhiêu? (Làm tròn đến hàng đơn vị)],
    [98],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 05)!]      #v(0.6em)
