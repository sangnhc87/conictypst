// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 06)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 06)",
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Để đào một cái giếng sâu $15$ mét, một đội thợ đưa ra báo giá như sau: Mét đầu tiên giá $100 000$ đồng; kể từ mét thứ hai, giá của mỗi mét tăng thêm $20 000$ đồng so với mét liền trước đó. Chi phí để đào hết chiếc giếng đó bằng bao nhiêu?],
    (
        [$300 000$ đồng.],
        [$2 400 000$ đồng.],
        [$2 700 000$ đồng.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng bàn được thả rơi từ độ cao $h_0$ mét xuống một mặt sàn phẳng. Sau mỗi lần va chạm với sàn, quả bóng nảy ngược lên độ cao bằng $70\%$ độ cao của lần rơi trước đó. Tìm biểu thức tính độ cao $h_n$ mà bóng đạt được sau lần chạm đất thứ $n$.],
    (
        [$h_n = h_0 dot (0.7)^n$.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Biết rằng sự tăng trưởng dân số của một quốc gia được tính theo công thức lãi kép liên tục $P(t) = P_0 dot e^(r t)$, trong đó $P_0$ là dân số ban đầu, $r$ là tỉ lệ tăng dân số hàng năm, $t$ là số năm. Nếu xét theo từng năm, dân số $P_n$ sau $n$ năm lập thành một dãy số. Hãy cho biết tính chất của dãy số này.],
    (
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một người bắt đầu đi làm với mức lương khởi điểm là $15$ triệu đồng/tháng. Cứ sau mỗi năm (tức là $12$ tháng), mức lương của người đó lại được tăng thêm $8\%$ so với mức lương của năm trước đó. Tổng số tiền lương người đó nhận được sau $5$ năm làm việc (làm tròn đến triệu đồng) là bao nhiêu?],
    (
        [$900$ triệu đồng.],
        [$987$ triệu đồng.],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một bức tường được trang trí bằng các viên gạch xếp thành nhiều hàng. Hàng trên cùng có $10$ viên gạch, mỗi hàng bên dưới xếp nhiều hơn hàng liền trên nó $4$ viên gạch. Biết bức tường có tổng cộng $25$ hàng gạch. Hỏi người ta cần dùng tất cả bao nhiêu viên gạch để hoàn thành bức tường?],
    (
        [$1200$ viên.],
        True([$1450$ viên.]),
        [$1500$ viên.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một chất phóng xạ có chu kỳ bán rã là $8$ ngày. Biết lượng chất phóng xạ ban đầu là $100$ gam. Cứ sau mỗi chu kỳ $8$ ngày, lượng chất này giảm đi một nửa. Lượng chất phóng xạ còn lại sau $40$ ngày bằng bao nhiêu gam?],
    (
        [$12.5$ g.],
        [$6.25$ g.],
        True([$3.125$ g.]),
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Để tích lũy tiền mua xe, một người gửi đều đặn vào ngân hàng vào đầu mỗi tháng số tiền $3$ triệu đồng với lãi suất $0.6\%$/tháng. Công thức tính tổng số tiền $A_n$ người đó nhận được ngay sau khi gửi tiền tháng thứ $n$ (ngay đầu tháng $n$) là công thức nào dưới đây?],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một bánh xe có răng cưa chuyển động. Vòng ngoài cùng có $60$ răng, vòng thứ hai có $54$ răng, vòng thứ ba có $48$ răng... các vòng răng cưa giảm dần theo cấp số cộng cho đến vòng cuối cùng có $6$ răng. Tổng số răng cưa của bánh xe đó là],
    (
        [$300$.],
        True([$330$.]),
        [$360$.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Trong một thí nghiệm vật lý, người ta thả một con lắc dao động. Biên độ của dao động sau mỗi chu kỳ giảm $5\%$ so với chu kỳ trước đó. Biết biên độ dao động ban đầu là $10$ cm. Sau $10$ chu kỳ, biên độ của con lắc xấp xỉ bằng bao nhiêu cm?],
    (
        [$5.0$ cm.],
        [$6.3$ cm.],
        True([$6.0$ cm.]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một quần thể vi khuẩn ban đầu có $500$ cá thể, cứ sau $30$ phút số lượng vi khuẩn lại nhân đôi. Số lượng vi khuẩn sau $4$ giờ bằng bao nhiêu cá thể?],
    (
        [$8000$ cá thể.],
        [$16 000$ cá thể.],
        True([$128 000$ cá thể.]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc kim khâu dài $5$ cm được treo thẳng đứng. Cứ sau mỗi phút, chiều dài của kim tăng lên $2\%$ do hiện tượng giãn nở nhiệt đều. Chiều dài của kim sau $1$ giờ xấp xỉ bằng bao nhiêu cm?],
    (
        [$11.0$ cm.],
        True([$16.4$ cm.]),
        [$22.3$ cm.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát quá trình tăng trưởng của một loại tảo biển. Ban đầu có diện tích phủ bề mặt nước là $100 "m"^2$. Mỗi tuần, diện tích tảo tăng thêm $20\%$ so với tuần trước đó. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một dự án lắp đặt pin năng lượng mặt trời. Hàng đầu tiên lắp đặt $12$ tấm pin. Kể từ hàng thứ hai, mỗi hàng lắp đặt nhiều hơn hàng liền trước nó $3$ tấm pin. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng bàn được thả rơi từ độ cao $15$ m. Mỗi lần chạm đất, bóng nảy lên độ cao bằng $2/3$ độ cao của lần rơi trước đó. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một người vay ngân hàng số tiền $200$ triệu đồng theo hình thức trả góp hàng tháng. Lãi suất vay là $0.8\%$/tháng. Mỗi tháng người này trả đều đặn số tiền $X$ đồng. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một bể nước dung tích $2000$ lít. Mỗi ngày bể bị bay hơi $5\%$ lượng nước hiện có, đồng thời người ta bơm thêm vào bể một lượng cố định $50$ lít nước vào cuối ngày. Hỏi sau thời gian rất lâu, lượng nước trong bể sẽ ổn định ở mức bao nhiêu lít?],
    [1000],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một chuỗi cửa hàng trà sữa ngày đầu tiên bán được $500$ ly. Kể từ ngày thứ hai, mỗi ngày doanh số bán được tăng thêm $5\%$ so với ngày liền trước đó. Tính tổng số ly trà sữa chuỗi cửa hàng bán được sau $10$ ngày đầu tiên (làm tròn đến hàng đơn vị ly).],
    [6289],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một loài vi khuẩn sinh sản bằng cách phân đôi. Ban đầu có $100$ tế bào vi khuẩn. Cứ sau mỗi giờ, mỗi tế bào vi khuẩn phân chia thành hai tế bào mới. Hỏi sau đúng $12$ giờ, số lượng vi khuẩn tăng thêm bao nhiêu tế bào so với ban đầu?],
    [409500],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Để chuẩn bị cho kỳ thi, một học sinh lên kế hoạch làm bài tập tự luyện trong $30$ ngày. Ngày đầu tiên học sinh làm $5$ bài tập. Mỗi ngày tiếp theo, số bài tập làm được tăng thêm $2$ bài so với ngày trước đó. Hỏi tổng số bài tập học sinh đó đã làm trong cả quá trình $30$ ngày là bao nhiêu bài?],
    [1020],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 06)!]      #v(0.6em)
