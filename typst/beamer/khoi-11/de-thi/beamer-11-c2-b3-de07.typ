// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 07)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 07)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một cơ sở nuôi trồng thủy sản nhận thấy lượng sinh khối cá trong ao tăng trưởng sau mỗi tháng. Ở tháng đầu tiên, lượng sinh khối thu được là $5$ tấn. Từ tháng thứ hai trở đi, do cải tiến quy trình chăm sóc, sinh khối thu được tăng thêm $1.5$ tấn so với tháng liền trước đó. Lượng sinh khối cá thu hoạch được ở tháng thứ $12$ là bao nhiêu tấn?],
    (
        [$19.5$ tấn.],
        [$20.0$ tấn.],
        True([$21.5$ tấn.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một quả lắc lò xo dao động trên một mặt phẳng nằm ngang. Do ma sát, sau mỗi chu kỳ dao động, biên độ của con lắc giảm đi $10\%$ so với biên độ của chu kỳ trước đó. Biết biên độ dao động ở chu kỳ thứ nhất là $8$ cm. Biên độ dao động của con lắc ở chu kỳ thứ $6$ là bao nhiêu cm?],
    (
        [$4.0$ cm.],
        True([$4.72$ cm.]),
        [$5.12$ cm.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Dân số của một thành phố hiện nay là $2$ triệu người. Tốc độ tăng trưởng dân số bình quân của thành phố là $1.2\%$/năm. Dự báo dân số của thành phố đó sau $10$ năm nữa (làm tròn đến nghìn người) là bao nhiêu?],
    (
        [$2 240 000$ người.],
        [$2 250 000$ người.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một công ty công nghệ có số lượng nhân sự tăng trưởng liên tục. Năm đầu tiên thành lập công ty có $30$ nhân viên. Kể từ năm thứ hai, số lượng nhân sự tăng thêm $15$ người mỗi năm. Tổng số năm công ty hoạt động để quy mô nhân sự đạt mốc $180$ người là bao nhiêu năm?],
    (
        [$9$ năm.],
        [$10$ năm.],
        True([$11$ năm.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Khi thả một quả bóng từ độ cao $12$ m xuống đất, mỗi lần chạm đất nó lại nảy lên một độ cao bằng $3/5$ độ cao trước đó. Tổng quãng đường quả bóng di chuyển (lên và xuống) kể từ lúc thả cho đến khi nó dừng hẳn bằng bao nhiêu mét?],
    (
        [$24$ m.],
        True([$48$ m.]),
        [$30$ m.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một người gửi tiết kiệm ngân hàng số tiền $100$ triệu đồng vào tài khoản với kỳ hạn 1 năm, lãi suất $6.5\%$/năm theo hình thức lãi kép. Tổng số tiền lãi người đó nhận được sau $3$ năm gửi (làm tròn đến hàng nghìn đồng) là bao nhiêu?],
    (
        [$19 500 000$ đồng.],
        [$20 780 000$ đồng.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một tháp gạch đồ chơi gồm nhiều tầng xếp chồng lên nhau. Tầng dưới cùng có $50$ viên gạch, cứ lên một tầng thì số viên gạch lại giảm đi $2$ viên so với tầng ngay bên dưới. Biết tầng trên cùng có $2$ viên gạch. Hỏi chiếc tháp đó có tất cả bao nhiêu viên gạch?],
    (
        [$600$ viên.],
        True([$650$ viên.]),
        [$700$ viên.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Giá trị ban đầu của một thiết bị máy móc là $500$ triệu đồng. Do hao mòn tự nhiên, mỗi năm giá trị của thiết bị này giảm $12\%$ so với năm trước đó. Sau ít nhất bao nhiêu năm thì giá trị của thiết bị giảm xuống dưới $200$ triệu đồng?],
    (
        [$6$ năm.],
        [$7$ năm.],
        True([$8$ năm.]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Để chuẩn bị tiền cưới, anh Nam lập kế hoạch tiết kiệm gửi tiền đều đặn vào ngân hàng. Đầu mỗi tháng anh gửi $5$ triệu đồng với lãi suất tích lũy $0.5\%$/tháng theo hình thức lãi kép. Tổng số tiền anh tích lũy được ngay sau khi gửi tiền tháng thứ $12$ là bao nhiêu triệu đồng?],
    (
        [$60.5$ triệu.],
        True([$62.0$ triệu.]),
        [$63.5$ triệu.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc ô tô đang chuyển động với vận tốc $20$ m/s thì người lái xe phát hiện chướng ngại vật và hãm phanh. Kể từ giây tiếp theo, vận tốc của xe giảm đi $10\%$ mỗi giây so với giây liền trước đó. Vận tốc của xe sau $5$ giây kể từ lúc bắt đầu hãm phanh xấp xỉ bằng bao nhiêu?],
    (
        [$10.5$ m/s.],
        True([$11.8$ m/s.]),
        [$12.5$ m/s.],
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một bệnh nhân cần dùng thuốc kháng sinh liều cao. Ban đầu bệnh nhân được tiêm $100$ mg thuốc. Sau mỗi giờ, lượng thuốc trong máu bệnh nhân bị cơ thể đào thải hết $20\%$ lượng thuốc hiện có. Đồng thời sau mỗi giờ bệnh nhân lại được tiêm thêm $10$ mg thuốc nữa. Mô hình lượng thuốc $M_n$ trong máu bệnh nhân sau $n$ giờ là dãy số nào dưới đây?],
    (
        [$M_n = 0.8 M_(n-1)$.],
        [$M_n = M_(n-1) + 10$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Phương pháp định tuổi bằng Cacbon-14 là một kỹ thuật dùng để xác định tuổi của các cổ vật hữu cơ. Lượng Cacbon-14 còn lại sau mỗi chu kỳ $5730$ năm giảm đi một nửa. Gọi $N_0$ là lượng Cacbon-14 ban đầu của cổ vật. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một khán đài nhà thi đấu được thiết kế hình vòng cung gồm $20$ hàng ghế. Hàng đầu tiên có $30$ ghế. Từ hàng thứ hai trở đi, mỗi hàng có số ghế nhiều hơn hàng liền trước nó $4$ ghế. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một người có kế hoạch gửi tiền tiết kiệm hàng năm để tích lũy quỹ hưu trí. Đầu mỗi năm người đó gửi đều đặn vào ngân hàng số tiền $20$ triệu đồng với lãi suất ổn định $6\%$/năm theo hình thức lãi kép. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát tốc độ lây lan của một loại virus trong một khu vực dân cư. Ban đầu có $50$ người bị nhiễm bệnh. Cứ sau mỗi ngày, số người bị nhiễm tăng thêm $15\%$ so với ngày hôm trước. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc bể chứa $1500$ lít nước. Do bị rò rỉ nên mỗi ngày bể bị thất thoát mất $10\%$ lượng nước hiện có. Đồng thời vào cuối mỗi ngày người ta bơm thêm vào bể $100$ lít nước. Hỏi sau thời gian rất dài, lượng nước trong bể sẽ ổn định ở mức bao nhiêu lít?],
    [1000],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một cầu thang sắt ngoài trời được thiết kế gồm $20$ bậc. Chiều rộng của bậc dưới cùng là $1.5$ mét, và cứ lên mỗi bậc thì chiều rộng lại giảm đi một lượng không đổi $d$ mét. Biết bậc trên cùng rộng $0.74$ mét. Tìm giá trị công sai $d$ của cấp số cộng đó (tính bằng xăng-ti-mét).],
    [4],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một tín hiệu sóng vô tuyến truyền qua một loạt các trạm phát sóng liên tiếp. Biết rằng qua mỗi trạm, do nhiễu nên cường độ tín hiệu bị giảm đi $8\%$ so với cường độ khi đi vào trạm đó. Hỏi sau khi đi qua tối thiểu bao nhiêu trạm phát sóng thì cường độ tín hiệu còn lại nhỏ hơn một nửa cường độ tín hiệu ban đầu?],
    [9],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc lò xo dài $20$ cm khi treo quả cân $100$ g. Cứ treo thêm mỗi quả cân $50$ g thì lò xo lại giãn dài thêm $3$ cm. Nếu treo tổng cộng một vật nặng $450$ g thì chiều dài của lò xo lúc đó bằng bao nhiêu cm? (Giả sử lò xo luôn trong giới hạn đàn hồi).],
    [41],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một khoản vay trị giá $500$ triệu đồng được hoàn trả bằng các kỳ khoản hàng năm cố định trong $10$ năm với lãi suất cố định $8\%$/năm. Khoản tiền kỳ khoản hàng năm mà người đi vay phải trả vào cuối mỗi năm (làm tròn đến triệu đồng) bằng bao nhiêu?],
    [75],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 07)!]      #v(0.6em)
