// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 08)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 08)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một trang trại chăn nuôi gia súc có số lượng bò tăng trưởng hàng năm. Năm đầu tiên có $120$ con bò. Kể từ năm thứ hai, số lượng bò tăng thêm $10\%$ so với năm liền trước đó. Số lượng bò của trang trại sau $5$ năm hoạt động (làm tròn đến hàng đơn vị con) là bao nhiêu?],
    (
        [$176$ con.],
        [$180$ con.],
        True([$193$ con.]),
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Khi uống một liều thuốc kháng sinh $250$ mg, lượng thuốc đào thải qua thận theo thời gian. Biết cứ sau mỗi giờ, lượng thuốc trong cơ thể bị đào thải hết $12\%$ so với lượng thuốc hiện có ở giờ trước đó. Lượng thuốc còn lại trong cơ thể sau $4$ giờ uống xấp xỉ bằng bao nhiêu?],
          (
        [$140$ mg.],
        [$145$ mg.],
        True([$150$ mg.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một nhà máy xi măng dự kiến năm đầu tiên sản xuất được $2$ triệu tấn xi măng. Kể từ năm thứ hai, sản lượng tăng thêm $5\%$ so với năm trước đó. Tổng sản lượng xi măng nhà máy sản xuất được trong $6$ năm hoạt động đầu tiên (làm tròn đến hàng phần mười triệu tấn) là bao nhiêu?],
    (
        [$12.5$ triệu tấn.],
        [$13.0$ triệu tấn.],
        True([$13.6$ triệu tấn.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một tòa nhà cao tầng có thiết kế độ cao của các tầng giảm dần từ dưới lên trên. Tầng 1 cao $4.5$ m, và từ tầng 2 trở đi, độ cao của mỗi tầng giảm đi một lượng không đổi $0.15$ m so với tầng ngay bên dưới. Biết tòa nhà có $12$ tầng. Chiều cao tổng cộng của tòa nhà đó bằng bao nhiêu mét?],
    (
        [$41.5$ m.],
        [$42.0$ m.],
        True([$44.1$ m.]),
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Dân số của một quốc gia hiện tại là $98$ triệu người. Mỗi năm, dân số tăng trưởng đều đặn $0.9\%$/năm theo hình thức lãi kép. Dãy số dân số hàng năm có dạng biểu diễn tổng quát nào dưới đây?],
    (
        [$P_n = 98 dot (0.009)^n$.],
        [$P_n = 98 + 0.882n$.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một đống gỗ tròn được xếp thành đống hình tam giác. Hàng dưới cùng có $25$ khúc gỗ, hàng phía trên tiếp theo có ít hơn hàng dưới $1$ khúc gỗ, và cứ thế tiếp tục cho đến hàng trên cùng chỉ có $1$ khúc gỗ. Tổng số khúc gỗ trong đống gỗ đó bằng bao nhiêu?],
    (
        [$300$ khúc.],
        True([$325$ khúc.]),
        [$350$ khúc.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc máy giặt mới mua có giá trị $12$ triệu đồng. Mỗi năm giá trị chiếc máy giặt giảm đi $15\%$ so với giá trị của năm trước đó. Giá trị chiếc máy giặt sau $6$ năm sử dụng (làm tròn đến hàng nghìn đồng) là bao nhiêu?],
    (
        [$4 200 000$ đồng.],
        [$4 350 000$ đồng.],
        True([$4 526 000$ đồng.]),
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Khi một quả bóng rơi tự do từ độ cao $16$ m xuống đất, mỗi lần chạm đất nó lại nảy lên một độ cao bằng $1/2$ độ cao trước đó. Tổng quãng đường quả bóng di chuyển (lên và xuống) kể từ lúc thả cho đến khi nó dừng hẳn bằng bao nhiêu mét?],
    (
        [$32$ m.],
        True([$48$ m.]),
        [$64$ m.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Để lập quỹ mua máy tính mới, một học sinh tiết kiệm bỏ heo đất hàng tháng. Tháng thứ nhất bỏ vào $100 000$ đồng, mỗi tháng sau đó số tiền bỏ heo tăng thêm $20 000$ đồng so với tháng liền trước đó. Tổng số tiền học sinh đó tiết kiệm được sau $12$ tháng (1 năm) bằng bao nhiêu?],
    (
        [$1 800 000$ đồng.],
        [$2 100 000$ đồng.],
        True([$2 520 000$ đồng.]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một viên bi lăn trên một tấm thảm trải phẳng dưới tác dụng của lực cản. Vận tốc ban đầu của bi là $5$ m/s. Kể từ giây thứ hai, vận tốc của bi giảm đi $20\%$ mỗi giây so với vận tốc ở giây trước đó. Tổng quãng đường bi lăn được (làm tròn đến hai chữ số thập phân) trước khi dừng lại là bao nhiêu mét?],
    (
        [$20.00$ m.],
        True([$25.00$ m.]),
        [$30.00$ m.],
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một hồ chứa nước dung tích $5000 "m"^3$. Mỗi ngày hồ bị rò rỉ thất thoát mất $2\%$ lượng nước hiện có trong hồ. Đồng thời mỗi ngày người ta bổ sung thêm một lượng cố định $80 "m"^3$ nước vào hồ. Mô hình lượng nước $W_n$ trong hồ sau $n$ ngày là dãy số nào dưới đây?],
    (
        [$W_n = 0.98 W_(n-1)$.],
        [$W_n = W_(n-1) + 80$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một người vay ngân hàng số tiền $100$ triệu đồng trả góp với lãi suất cố định $1\%$/tháng. Mỗi tháng người đó hoàn trả đều đặn số tiền $X$ triệu đồng bắt đầu từ tháng thứ nhất. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một rạp chiếu phim thiết kế khán đài gồm $15$ hàng ghế. Hàng ghế thứ nhất có $20$ ghế. Từ hàng thứ hai trở đi, mỗi hàng có số ghế nhiều hơn hàng liền trước nó $2$ ghế. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát lượng chất phóng xạ Iốt-131 dùng trong y tế. Chu kỳ bán rã của Iốt-131 là $8$ ngày. Biết lượng chất phóng xạ ban đầu là $160$ mg. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát lượng sinh khối vi khuẩn trong môi trường nuôi cấy nhân tạo có giới hạn dinh dưỡng. Số lượng tế bào vi khuẩn sau mỗi giờ được mô hình hóa bởi dãy số sinh khối tăng trưởng. Ban đầu có $1000$ tế bào, lượng tế bào tăng trưởng $10\%$ mỗi giờ. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một hồ nước dung tích $3000 "m"^3$ bị ô nhiễm. Mỗi ngày hồ nước bị thau rửa cuốn đi mất $15\%$ lượng chất ô nhiễm hiện có, đồng thời nguồn thải đổ vào hồ thêm một lượng cố định $30$ kg chất ô nhiễm mới vào cuối ngày. Hỏi sau thời gian rất dài, lượng chất ô nhiễm trong hồ sẽ ổn định ở mức bao nhiêu kg?],
    [200],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc khán đài ngoài trời gồm $30$ hàng ghế xếp theo dạng hình thang. Hàng đầu tiên có $15$ ghế. Các hàng sau có số ghế tăng dần theo cấp số cộng. Biết tổng số ghế của cả khán đài là $1320$ ghế. Hỏi hàng ghế cuối cùng (hàng thứ 30) có bao nhiêu ghế?],
    [73],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một tia sáng laser truyền qua một loạt các thấu kính lọc cường độ sáng. Biết qua mỗi thấu kính, cường độ sáng giảm đi $10\%$ so với cường độ trước khi truyền qua thấu kính đó. Hỏi tia sáng phải truyền qua tối thiểu bao nhiêu thấu kính để cường độ sáng còn lại nhỏ hơn $30\%$ cường độ sáng ban đầu?],
    [12],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc lò xo dài $15$ cm khi treo quả cân $50$ g. Cứ treo thêm mỗi quả cân $50$ g thì lò xo lại giãn dài thêm $2$ cm. Nếu treo một vật nặng tổng cộng $400$ g thì chiều dài của lò xo khi đó bằng bao nhiêu cm? (Giả sử lò xo luôn trong giới hạn đàn hồi).],
    [29],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một khoản vay mua ô tô trị giá $400$ triệu đồng được trả góp hàng tháng cố định trong $3$ năm (tương đương $36$ tháng) với lãi suất cố định $0.8\%$/tháng. Khoản tiền hoàn trả cố định hàng tháng mà người đi vay phải trả là bao nhiêu triệu đồng? (Làm tròn đến hàng phần mười).],
    [12.8],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 08)!]      #v(0.6em)
