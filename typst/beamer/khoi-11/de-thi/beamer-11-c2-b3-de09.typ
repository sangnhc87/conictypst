// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 09)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 09)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một trang trại trồng rừng nhận thấy thể tích gỗ tăng trưởng theo thời gian. Năm đầu tiên trữ lượng gỗ của rừng là $1000 "m"^3$. Từ năm thứ hai trở đi, do công tác bón phân và chăm sóc tốt, trữ lượng gỗ tăng thêm $150 "m"^3$ mỗi năm so với năm liền trước đó. Trữ lượng gỗ thu được ở năm thứ $8$ là bao nhiêu?],
    (
        [$1950 "m"^3$.],
        [$2000 "m"^3$.],
        True([$2050 "m"^3$.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một con lắc dao động tắt dần. Sau mỗi chu kỳ dao động, biên độ của con lắc giảm đi $8\%$ so với biên độ của chu kỳ trước đó. Biết biên độ ban đầu là $12$ cm. Sau $8$ chu kỳ dao động, biên độ của con lắc xấp xỉ bằng bao nhiêu cm?],
    (
        [$5.0$ cm.],
        [$5.5$ cm.],
        True([$6.16$ cm.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Dân số của một nước hiện tại là $95$ triệu người. Tỷ lệ tăng dân số hàng năm được duy trì ổn định ở mức $1.0\%$/năm. Dự báo dân số nước này sau $15$ năm nữa (làm tròn đến hàng nghìn người) là bao nhiêu?],
    (
        [$109 000 000$ người.],
        [$109 500 000$ người.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một doanh nghiệp khởi nghiệp dịch vụ logistics năm đầu tiên sở hữu $15$ xe tải. Kể từ năm thứ hai, doanh nghiệp mua thêm $6$ xe tải mỗi năm. Số năm hoạt động tối thiểu để quy mô đội xe tải đạt trên $80$ xe là bao nhiêu năm?],
    (
        [$10$ năm.],
        [$11$ năm.],
        True([$12$ năm.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Khi thả một quả bóng từ độ cao $20$ m xuống đất, mỗi lần chạm đất nó lại nảy lên một độ cao bằng $3/4$ độ cao trước đó. Tổng quãng đường quả bóng di chuyển (lên và xuống) kể từ lúc thả cho đến khi nó dừng hẳn bằng bao nhiêu mét?],
    (
        [$80$ m.],
        True([$140$ m.]),
        [$100$ m.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một tháp gạch đồ chơi dạng hình thang xếp bằng các viên gạch chồng lên nhau. Hàng trên cùng có $5$ viên gạch, mỗi hàng bên dưới có nhiều hơn hàng liền ngay trên nó $3$ viên gạch. Biết tổng số viên gạch trong tháp là $370$ viên. Hỏi tháp gạch đó có bao nhiêu hàng gạch?],
    (
        [$14$ hàng.],
        True([$15$ hàng.]),
        [$16$ hàng.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc điện thoại thông minh mới mua có giá trị $18$ triệu đồng. Mỗi năm giá trị chiếc điện thoại giảm đi $20\%$ so với giá trị của năm trước đó. Giá trị chiếc điện thoại còn lại sau $4$ năm sử dụng (làm tròn đến hàng nghìn đồng) là bao nhiêu?],
    (
        [$6 800 000$ đồng.],
        [$7 200 000$ đồng.],
        True([$7 373 000$ đồng.]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Anh Minh tiết kiệm tiền mua máy ảnh bằng cách gửi đều đặn vào đầu mỗi tháng số tiền $2$ triệu đồng với lãi suất tích lũy $0.4\%$/tháng theo hình thức lãi kép. Tổng số tiền anh Minh tích lũy được ngay sau khi gửi tiền tháng thứ $10$ là bao nhiêu triệu đồng?],
    (
        [$20.15$ triệu.],
        True([$20.44$ triệu.]),
        [$20.80$ triệu.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc thuyền máy tắt động cơ và trôi chậm dần trên mặt nước tĩnh lặng. Giây thứ nhất thuyền đi được $8$ mét. Kể từ giây thứ hai, quãng đường thuyền đi được trong mỗi giây giảm đi $25\%$ so với giây trước đó. Tổng quãng đường thuyền trôi được kể từ khi tắt máy cho đến khi dừng hẳn là bao nhiêu mét?],
    (
        [$24$ m.],
        True([$32$ m.]),
        [$28$ m.],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một hồ nuôi cá có dung tích $1000 "m"^3$ bị nhiễm phèn nhẹ. Mỗi ngày hồ nước bị bốc hơi tự nhiên cuốn đi mất $4\%$ lượng chất phèn hiện có, đồng thời nguồn nước ngầm bổ sung thêm lượng chất phèn cố định là $2$ kg vào cuối mỗi ngày. Mô hình lượng chất phèn $P_n$ trong hồ sau $n$ ngày là dãy số nào dưới đây?],
    (
        [$P_n = 0.96 P_(n-1)$.],
        [$P_n = P_(n-1) + 2$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một khách hàng vay ngân hàng số tiền $300$ triệu đồng trả góp với lãi suất cố định $0.7\%$/tháng. Mỗi tháng người đó hoàn trả đều đặn số tiền $X$ triệu đồng bắt đầu từ tháng thứ nhất. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một hội trường lớn thiết kế các hàng ghế xếp hình cung tròn đồng tâm. Hàng thứ nhất có $40$ ghế. Kể từ hàng thứ hai trở đi, mỗi hàng có số ghế nhiều hơn hàng liền trước nó $5$ ghế. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát chất thải nhựa phân hủy sinh học trong lòng đất. Cứ sau mỗi chu kỳ $10$ năm, khối lượng chất thải giảm đi một nửa so với khối lượng chất thải ở chu kỳ trước đó. Biết khối lượng ban đầu là $80$ kg. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát quá trình tăng trưởng của một loại nấm men trong phòng thí nghiệm. Lượng nấm men sinh trưởng sau mỗi giờ được mô hình hóa bởi dãy số tăng trưởng. Ban đầu có $200$ tế bào, lượng tế bào tăng trưởng $12\%$ mỗi giờ. Các phát biểu sau đúng hay sai?], (
...
// TL 2
#lt-tln(num: 18, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một bức tường trang trí hình thang đứng được xây dựng bằng cách xếp các viên gạch chồng lên nhau. Hàng dưới cùng có $45$ viên gạch. Cứ lên mỗi hàng tiếp theo thì số viên gạch giảm đi một lượng không đổi $d$ viên. Biết hàng trên cùng có $10$ viên gạch và tổng số hàng gạch của bức tường là $8$ hàng. Tìm giá trị công sai $d$ của cấp số cộng đó.],
    [5],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một tín hiệu truyền hình cáp đi qua một chuỗi các bộ khuếch đại tín hiệu nối tiếp. Biết qua mỗi bộ khuếch đại, do nhiễu đường truyền nên cường độ tín hiệu bị giảm đi $5\%$ so với cường độ trước đó. Hỏi tín hiệu phải đi qua tối thiểu bao nhiêu bộ khuếch đại để cường độ tín hiệu còn lại nhỏ hơn $40\%$ cường độ ban đầu?],
    [18],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một viên bi lăn xuống một cái máng nghiêng dài. Giây thứ nhất viên bi đi được $4$ cm. Mỗi giây tiếp theo quãng đường bi đi được tăng thêm $5$ cm so với giây trước đó. Tính tổng quãng đường bi lăn được sau $10$ giây đầu tiên (tính bằng xăng-ti-mét).],
    [265],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de09) — Mã 101], back-to: "sec-exercise-hub",[Một người mua xe trả góp trị giá $300$ triệu đồng. Hàng tháng người này trả một số tiền cố định là $X$ triệu đồng vào cuối mỗi tháng trong vòng $2$ năm (tương ứng $24$ tháng). Biết lãi suất cho vay là $0.9\%$/tháng cố định. Số tiền $X$ người đó phải trả hàng tháng (làm tròn đến hàng phần mười triệu đồng) bằng bao nhiêu?],
    [14.0],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 09)!]      #v(0.6em)
