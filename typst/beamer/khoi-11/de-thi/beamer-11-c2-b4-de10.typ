// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 10)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 10)",
  subtitle: "ÔN TẬP CHƯƠNG 3 — MÃ ĐỀ: 101",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một người gửi tiết kiệm ngân hàng số tiền $20$ triệu đồng với lãi suất $0.5\%$/tháng theo hình thức lãi kép. Tổng số tiền người đó nhận được (cả gốc lẫn lãi) sau $2$ năm gửi (làm tròn đến hàng nghìn đồng) là bao nhiêu?],
    (
        [$22 400 000$ đồng.],
        [$22 500 000$ đồng.],
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một quy trình lọc nước tuần hoàn qua các màng lọc. Biết qua mỗi màng lọc, lượng tạp chất hữu cơ giảm đi $15\%$ so với trước khi qua màng lọc đó. Hỏi sau khi qua $6$ màng lọc liên tiếp thì lượng tạp chất còn lại trong nước chiếm bao nhiêu phần trăm so với ban đầu?],
    (
        [$32.4\%$],
        True([$37.71\%$]),
        [$45.0\%$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một cây tre non mới trồng trong năm đầu tiên chiều cao tăng thêm $1.2$ mét. Kể từ năm thứ hai, lượng tăng trưởng chiều cao hàng năm của cây chỉ bằng $90\%$ so với năm trước đó. Chiều cao tăng thêm tối đa của cây tre này sau thời gian vô hạn (làm tròn đến hàng đơn vị mét) là bao nhiêu?],
    (
        [$10$ m.],
        True([$12$ m.]),
        [$14$ m.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một đống gạch xây dựng được xếp dạng hình thang đứng. Hàng gạch trên cùng có $10$ viên, mỗi hàng bên dưới có nhiều hơn hàng liền ngay trên nó $2$ viên. Biết tổng số gạch xếp được đống gạch đó là $420$ viên. Hỏi đống gạch đó có bao nhiêu hàng gạch?],
    (
        [$18$ hàng.],
        True([$20$ hàng.]),
        [$22$ hàng.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một vận động viên điền kinh lên kế hoạch tập luyện chạy bộ. Ngày thứ nhất anh ta chạy quãng đường $2$ km. Kể từ ngày thứ hai, mỗi ngày quãng đường chạy được tăng thêm $0.5$ km so với ngày trước đó. Hỏi ngày thứ bao nhiêu thì vận động viên đó chạy quãng đường dài $10$ km?],
    (
        [$15$ ngày.],
        [$16$ ngày.],
        True([$17$ ngày.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một chất phóng xạ có chu kỳ bán rã là $5$ ngày. Biết khối lượng chất phóng xạ ban đầu là $64$ gam. Sau $25$ ngày thì khối lượng chất phóng xạ còn lại bằng bao nhiêu gam?],
    (
        [$4.0$ g.],
        True([$2.0$ g.]),
        [$1.0$ g.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Khi thả một quả bóng từ độ cao $10$ m xuống đất, mỗi lần chạm đất nó lại nảy lên một độ cao bằng $60\%$ độ cao trước đó. Tổng quãng đường quả bóng di chuyển (lên và xuống) kể từ lúc thả cho đến khi nó dừng hẳn bằng bao nhiêu mét?],
    (
        [$30$ m.],
        True([$40$ m.]),
        [$35$ m.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Dân số của một tỉnh hiện nay là $1.2$ triệu người. Mỗi năm dân số của tỉnh tăng trưởng ổn định ở mức $1.5\%$/năm theo hình thức lãi kép. Dân số của tỉnh đó sau $8$ năm nữa (làm tròn đến hàng nghìn người) là bao nhiêu?],
    (
        [$1 340 000$ người.],
        [$1 350 000$ người.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Để mua xe điện tự cân bằng, một học sinh gửi đều đặn vào đầu mỗi tháng số tiền $1$ triệu đồng vào quỹ tiết kiệm với lãi suất cố định $0.5\%$/tháng theo hình thức lãi kép. Tổng số tiền học sinh tích lũy được ngay sau khi gửi tiền tháng thứ $24$ là bao nhiêu triệu đồng?],
    (
        [$24.5$ triệu.],
        True([$25.56$ triệu.]),
        [$26.12$ triệu.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Khi một tia sáng truyền qua một chuỗi các tấm thủy tinh mỏng ghép liên tiếp, cường độ sáng giảm đi $10\%$ qua mỗi tấm kính so với trước khi đi vào tấm kính đó. Hỏi sau khi truyền qua $6$ tấm thủy tinh liên tiếp thì cường độ sáng còn lại chiếm bao nhiêu phần trăm cường độ sáng ban đầu?],
    (
        [$45\%$],
        True([$53.14\%$]),
        [$60\%$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một bệnh nhân uống liều kháng sinh ban đầu là $200$ mg. Cứ sau mỗi giờ lượng thuốc trong cơ thể lại bị cơ thể đào thải mất $20\%$ lượng thuốc hiện có. Lượng thuốc kháng sinh còn lại trong cơ thể bệnh nhân sau $6$ giờ uống xấp xỉ bằng bao nhiêu?],
    (
        [$45$ mg.],
        True([$52.4$ mg.]),
        [$60$ mg.],
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một người đi vay ngân hàng số tiền $120$ triệu đồng để trang trải chi phí học tập theo hình thức trả góp hàng tháng. Lãi suất vay là $0.8\%$/tháng. Mỗi tháng người này trả đều đặn số tiền $X$ triệu đồng. Dãy số dư nợ còn lại của người này sau mỗi tháng tuân theo hệ thức truy hồi nào dưới đây?],
    (
        [$D_n = 1.08 D_(n-1) - X$.],
        [$D_n = D_(n-1) + X$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát quá trình tăng trưởng dân số của một đô thị vệ tinh lớn. Ban đầu dân số là $100 000$ người. Tốc độ tăng trưởng dân số bình quân của đô thị là $2\%$/năm. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một khán phòng nhà hát thiết kế khán đài gồm $25$ hàng ghế xếp theo hình cung tròn. Hàng đầu tiên có $20$ ghế. Từ hàng thứ hai trở đi, mỗi hàng có số ghế nhiều hơn hàng liền ngay trước nó $3$ ghế. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một người có kế hoạch tích lũy tiền cho con đi học đại học. Đầu mỗi năm người đó gửi đều đặn vào ngân hàng số tiền $50$ triệu đồng với lãi suất tích lũy $5\%$/năm theo hình thức lãi kép. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát quá trình lây nhiễm của một loại dịch bệnh trong một cộng đồng dân cư nhỏ. Ban đầu có $10$ người nhiễm bệnh. Cứ sau mỗi ngày, số người nhiễm bệnh tăng thêm $20\%$ so với ngày hôm trước. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc bể chứa $2000$ lít nước. Do bốc hơi tự nhiên nên mỗi ngày bể bị thất thoát mất $5\%$ lượng nước hiện có trong bể. Đồng thời vào cuối mỗi ngày người ta bổ sung thêm vào bể $40$ lít nước. Hỏi sau thời gian rất dài, lượng nước trong bể sẽ ổn định ở mức bao nhiêu lít?],
    [800],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một cầu thang sắt ngoài trời được thiết kế gồm $15$ bậc. Chiều rộng của bậc dưới cùng là $1.2$ mét, và cứ lên mỗi bậc thì chiều rộng lại giảm đi một lượng không đổi $d$ mét. Biết bậc trên cùng rộng $0.64$ mét. Tìm giá trị công sai $d$ của cấp số cộng đó (tính bằng xăng-ti-mét).],
    [4],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một tín hiệu sóng vô tuyến truyền qua một loạt các trạm phát sóng liên tiếp. Biết rằng qua mỗi trạm, cường độ tín hiệu bị giảm đi $6\%$ so với cường độ khi đi vào trạm đó. Hỏi sau khi đi qua tối thiểu bao nhiêu trạm phát sóng thì cường độ tín hiệu còn lại nhỏ hơn $30\%$ cường độ tín hiệu ban đầu?],
    [20],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một viên bi lăn xuống một cái máng nghiêng dài. Giây thứ nhất viên bi đi được $3$ m. Mỗi giây tiếp theo quãng đường bi đi được tăng thêm $2$ m so với giây trước đó. Tính tổng quãng đường bi lăn được sau $8$ giây đầu tiên (tính bằng mét).],
    [80],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 1 (de10) — Mã 101], back-to: "sec-exercise-hub",[Một khoản tiền thanh toán trị giá $10$ triệu đồng nhận được hàng năm vào cuối mỗi năm liên tiếp trong $5$ năm. Biết lãi suất chiết khấu cố định là $7\%$/năm. Tính giá trị hiện tại (Present Value) của dòng tiền thanh toán đó (làm tròn đến hàng đơn vị triệu đồng).],
    [41],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 10)!]      #v(0.6em)
