// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 11)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 11)",
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Một hiện tượng thủy triều đỏ nở hoa do mật độ tảo biển bùng phát. Ban đầu mật độ tảo là $500$ tế bào/ml. Kể từ ngày thứ hai, cứ sau mỗi ngày mật độ tảo biển tăng trưởng $20\%$ so với ngày hôm trước, đồng thời dòng hải lưu cuốn đi một lượng cố định là $100$ tế bào/ml tảo biển vào cuối ngày. Dãy số mô hình mật độ tảo $A_n$ sau $n$ ngày tuân theo hệ thức truy hồi nào dưới đây?],
    (
        [$A_n = 1.2 A_(n-1) + 100$.],
        [$A_n = A_(n-1) - 100$.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Hao hụt hiệu suất của một hệ thống tấm pin mặt trời lắp đặt trên mái nhà xưởng do hiện tượng bám bụi và lão hóa vật liệu. Năm đầu tiên hệ thống đạt công suất phát điện $2000$ kWh/ngày. Kể từ năm thứ hai, công suất phát điện giảm đi $3\%$ mỗi năm so với công suất của năm liền trước đó. Tổng công suất điện phát được của hệ thống pin này trong $5$ năm hoạt động đầu tiên (làm tròn đến hàng đơn vị kWh) là bao nhiêu?],
    (
        [$8400$ kWh.],
        [$9000$ kWh.],
        True([$9067$ kWh.]),
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Một thiết bị khí cầu đo đạc tầng khí quyển rơi tự do từ độ cao $1000$ m xuống mặt đất. Sau lần chạm đất thứ nhất, quả bóng chứa thiết bị nảy ngược lên độ cao bằng $15\%$ độ cao của lần rơi trước đó. Tìm công thức tổng quát tính độ cao $h_n$ mà bóng đạt được sau lần chạm đất thứ $n$.],
    (
        [$h_n = 1000 dot (0.15)^n$.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Một bức tường cách âm của trạm phát điện biến áp gồm nhiều lớp vật liệu đặc biệt ghép song song. Cường độ âm thanh của sóng âm đi qua bức tường bị giảm đi $25\%$ qua mỗi lớp vật liệu so với cường độ trước khi đi vào lớp vật liệu đó. Hỏi sau khi đi qua $4$ lớp vật liệu liên tiếp thì cường độ âm thanh còn lại chiếm bao nhiêu phần trăm so với ban đầu?],
    (
        [$25.0\%$],
        True([$31.64\%$]),
        [$42.2\%$],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Một dự án trồng rừng phòng hộ đầu nguồn ngập mặn ven biển sử dụng phương pháp gieo trồng xen kẽ các hàng cây đước. Hàng đầu tiên sát biển gieo trồng $100$ cây đước. Do lực sóng vỗ mạnh ở mép ngoài, các hàng cây tiếp theo dịch chuyển vào sâu trong đất liền được gieo trồng nhiều cây đước hơn để tăng mật độ chắn sóng, mỗi hàng sau có nhiều hơn hàng liền trước nó $5$ cây đước. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Mô hình lây lan thông tin truyền thông trên mạng xã hội về thông điệp bảo vệ môi trường toàn cầu GreenEarth. Ban đầu có $100$ người chia sẻ thông điệp này. Kể từ ngày tiếp theo, mỗi ngày số người chia sẻ mới tăng thêm $30\%$ so với ngày hôm trước. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát hiệu suất hấp thụ ánh sáng mặt trời của một tấm kính năng lượng mặt trời công nghệ Nano thế hệ mới. Biết cứ sau mỗi lớp màng phủ Nano chống phản xạ (dày $0.1$ micromet), cường độ phản xạ ánh sáng của kính bị giảm đi $18\%$ so với cường độ trước đó. Các phát biểu sau đúng hay sai?], (
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Tần số dao động tự do của một thiết bị giảm chấn cơ học sử dụng lớp lò xo triệt tiêu xung điện lực. Tần số dao động sau mỗi lớp giảm chấn giảm đi $20\%$ so với lớp giảm chấn trước đó. Hỏi sau khi truyền qua tối thiểu bao nhiêu lớp giảm chấn thì tần số dao động còn lại nhỏ hơn $10\%$ tần số dao động ban đầu?],
    [11],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 11)!]      #v(0.6em)
