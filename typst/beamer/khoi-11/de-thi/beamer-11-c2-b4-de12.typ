// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 12)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 12)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một cầu dây văng được thiết kế với các dây cáp đối xứng qua trụ tháp chính. Chiều dài dây cáp ngắn nhất sát tháp là $15$ mét. Kể từ dây cáp tiếp theo tính từ trong ra ngoài, chiều dài mỗi dây cáp tăng thêm $4.5$ mét so với dây liền trước đó. Chiều dài của dây cáp thứ $10$ là bao nhiêu?],
    (
        [$51.0$ mét.],
        [$55.0$ mét.],
        True([$55.5$ mét.]),
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một đoàn tàu điện ngầm đô thị đang di chuyển với vận tốc $24$ m/s thì bắt đầu giảm tốc độ để đi vào nhà ga. Kể từ giây tiếp theo, vận tốc của tàu giảm đi $15\%$ mỗi giây so với vận tốc ở giây liền trước đó. Vận tốc của tàu sau $4$ giây hãm phanh giảm tốc xấp xỉ bằng bao nhiêu?],
    (
        [$10.5$ m/s.],
        True([$12.53$ m/s.]),
        [$14.20$ m/s.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Để phát triển giao thông xanh, một thành phố khuyến khích người dân sử dụng ô tô điện. Số lượng ô tô điện đăng ký mới tại thành phố ở năm thứ nhất là $5000$ chiếc. Kể từ năm thứ hai, số lượng ô tô điện đăng ký mới tăng thêm $30\%$ mỗi năm so với năm trước đó. Số lượng ô tô điện đăng ký mới tại thành phố ở năm thứ $6$ là bao nhiêu?],
    (
        [$15 200$ chiếc.],
        [$16 400$ chiếc.],
        True([$18 564$ chiếc.]),
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một cầu vượt dành cho người đi bộ qua đường cao tốc đô thị được thiết kế gồm $35$ bậc thang lên xuống. Bậc thang dưới cùng rộng $1.8$ mét. Từ bậc thứ hai trở đi, chiều rộng mỗi bậc co rút hẹp lại một lượng không đổi $0.03$ mét so với bậc liền kề phía dưới. Chiều rộng của bậc trên cùng (bậc thứ 35) của cầu vượt bằng bao nhiêu mét?],
    (
        [$0.74$ m.],
        [$0.76$ m.],
        True([$0.78$ m.]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Quang thông phát sáng của hệ thống đèn đường LED đô thị bị suy giảm dần theo thời gian sử dụng. Năm đầu tiên sử dụng, quang thông đèn đạt $10 000$ lumen. Kể từ năm thứ hai, độ suy giảm quang thông mất đi $6\%$ mỗi năm so với năm trước đó. Quang thông của đèn đường LED còn lại sau $5$ năm sử dụng xấp xỉ bằng bao nhiêu lumen?],
    (
        [$7000$ lumen.],
        True([$7339$ lumen.]),
        [$7800$ lumen.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một khán phòng nhà hát bậc thang hiện đại được thiết kế có dạng hình vòng cung rẻ quạt mở rộng dần ra phía sau. Hàng ghế đầu tiên sát sân khấu có $24$ ghế. Từ hàng thứ hai trở đi, mỗi hàng kế tiếp được bố trí nhiều hơn hàng liền ngay trước nó $4$ ghế. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát hiện tượng hao mòn lún mặt đường nhựa nhựa của một tuyến đại lộ đô thị dưới tác dụng của tải trọng xe cộ. Biết cứ sau mỗi chu kỳ $1$ năm, độ mòn phẳng mặt đường tích lũy thêm một lượng là $1.5$ mm so với năm trước đó. Khảo sát ban đầu lúc bàn giao thông xe độ mòn bằng $0$. Các phát biểu sau đúng hay sai?], (
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một công ty vận tải hành khách công cộng đầu tư mua một đội xe buýt điện mới trị giá $10$ tỷ đồng. Mỗi năm giá trị sử dụng còn lại của đội xe giảm đi $12\%$ so với năm liền trước đó. Hỏi sau $6$ năm sử dụng giá trị còn lại của đội xe buýt điện điện bằng bao nhiêu tỷ đồng? (Làm tròn đến hàng phần mười).],
    [4.6],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Để mở rộng bãi đỗ xe thông minh nhiều tầng tại trung tâm thành phố, một chủ đầu tư lên kế hoạch thi công. Hàng đầu tiên xây dựng được $50$ vị trí đỗ xe. Cứ sau mỗi hàng tiếp theo xây dựng được thêm số vị trí đỗ xe tăng thêm $10\%$ so với hàng trước đó để tận dụng diện tích sàn mở rộng phía ngoài của tháp đỗ xe hình phễu. Hỏi sau khi xây dựng hoàn thành $8$ hàng đỗ xe, tổng số vị trí đỗ xe của bãi xe thông minh đó bằng bao nhiêu vị trí? (Làm tròn đến hàng đơn vị)],
    [572],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 12)!]      #v(0.6em)
