// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 13)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 13)",
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de13) — Mã 101], back-to: "sec-exercise-hub",[Một bộ lọc thư rác (spam filter) của hệ thống email hoạt động dựa trên học máy được cập nhật cơ sở dữ liệu chặn định kỳ hằng ngày. Ngày đầu tiên bộ lọc chặn được $50$ email spam. Do lượng spam gia tăng và thuật toán thông minh hơn, từ ngày thứ hai trở đi số lượng thư rác bị chặn tăng thêm $12$ thư mỗi ngày. Tổng số thư rác bị chặn sau $30$ ngày hoạt động là bao nhiêu?],
    (
        [$6000$ thư.],
        [$6500$ thư.],
        True([$6720$ thư.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de13) — Mã 101], back-to: "sec-exercise-hub",[Một mã độc (ransomware) lây lan trong mạng máy tính nội bộ của một cơ quan. Ban đầu có $3$ máy chủ bị nhiễm mã độc. Kể từ giờ tiếp theo, mỗi máy tính bị nhiễm lại lây lan mã độc sang thêm $2$ máy tính mới khác chưa bị nhiễm trong mạng. Số lượng máy tính bị nhiễm mã độc sau đúng $6$ giờ (làm tròn đến hàng đơn vị máy) là bao nhiêu?],
    (
        [$192$ máy.],
        True([$2187$ máy.]),
        [$729$ máy.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de13) — Mã 101], back-to: "sec-exercise-hub",[Một cấu trúc cây thư mục phân cấp dữ liệu lớn lưu trữ thông tin. Thư mục gốc chứa $2$ thư mục con. Mỗi thư mục con cấp dưới lại chứa đúng $3$ thư mục con cấp tiếp theo. Hỏi cấu trúc cây thư mục có tổng cộng bao nhiêu thư mục con từ cấp 1 đến cấp $5$?],
    (
        [$240$ thư mục.],
        [$242$ thư mục.],
        True([$242$ thư mục.]),
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de13) — Mã 101], back-to: "sec-exercise-hub",[Một ứng dụng cung cấp phần mềm dưới dạng dịch vụ (SaaS) được phát triển trên đám mây. Tháng thứ nhất doanh thu định kỳ hằng tháng (MRR) của phần mềm đạt $2000$ USD. Kể từ tháng thứ hai, do chất lượng sản phẩm tốt tốt, MRR tăng trưởng $10\%$ mỗi tháng so với tháng trước đó. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de13) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát chu kỳ nâng cấp và vá lỗi hệ điều hành của một nhóm thiết bị IoT thông minh trong đô thị. Biết cứ sau mỗi chu kỳ nâng cấp $2$ năm, lượng năng lượng tiêu thụ tiêu chuẩn của thiết bị giảm đi $5\%$ so với chu kỳ trước đó. Đo năng lượng tiêu thụ ban đầu lúc bắt đầu vận hành thiết bị là $50$ W. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de13) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát bộ điều phối phân chia lưu lượng truy cập (Load Balancer) gửi request đến cụm máy chủ dịch vụ đám mây. Ban đầu lúc 8 giờ sáng, lưu lượng là $150$ request/giây. Cứ sau mỗi giờ tiếp theo trong buổi sáng, lưu lượng request tăng thêm $12\%$ so với giờ trước đó. Các phát biểu sau đúng hay sai?], (
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de13) — Mã 101], back-to: "sec-exercise-hub",[Độ trễ mạng (latency) tích lũy của dữ liệu truyền từ máy khách qua một chuỗi các trạm định tuyến (hop) nối tiếp để đến máy chủ. Biết độ trễ tín hiệu bị tăng thêm $12\%$ sau mỗi hop truyền tải so với độ trễ ở hop liền trước đó. Biết độ trễ ở hop thứ nhất là $10$ miligiây (ms). Hỏi sau khi truyền đi qua tối đa bao nhiêu hop thì độ trễ tích lũy còn nhỏ hơn hoặc bằng $30$ ms?],
    [10],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 13)!]      #v(0.6em)
