// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 14)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 14)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de14) — Mã 101], back-to: "sec-exercise-hub",[Khi một người được tiêm vắc-xin phòng bệnh, lượng kháng thể bảo vệ trong máu bắt đầu tăng nhanh. Ngày đầu tiên sinh ra $200$ đơn vị kháng thể. Kể từ ngày thứ hai trở đi, số lượng kháng thể sinh ra mỗi ngày tăng thêm $30$ đơn vị so với ngày liền trước đó. Số lượng kháng thể sinh ra trong ngày thứ $12$ là bao nhiêu?],
    (
        [$500$ đơn vị.],
        [$510$ đơn vị.],
        True([$530$ đơn vị.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de14) — Mã 101], back-to: "sec-exercise-hub",[Vào mùa mưa triều cường dâng cao, muỗi truyền bệnh sốt xuất huyết đẻ trứng phát triển mật độ cá thể. Ban đầu mật độ loăng quăng đo được là $40 "cá thể/m"^2$. Kể từ tuần tiếp theo, số lượng cá thể sinh sôi tăng gấp rưỡi (tương đương tăng $50\%$) so với tuần trước đó, đồng thời cơ quan y tế phun hóa chất tiêu diệt bớt lượng cố định là $12 "cá thể/m"^2$ vào cuối mỗi tuần. Mô hình mật độ loăng quăng $M_n$ sau $n$ tuần tuân theo hệ thức truy hồi nào?],
    (
        [$M_n = 1.5 M_(n-1) + 12$.],
        [$M_n = M_(n-1) - 12$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de14) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát quá trình lan truyền của một bệnh dịch cúm mùa trong một trường học nội trú học sinh. Ban đầu có $5$ học sinh nhiễm bệnh. Cứ sau mỗi ngày, số học sinh bị lây nhiễm tăng thêm $25\%$ so với ngày hôm trước. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de14) — Mã 101], back-to: "sec-exercise-hub",[Một bệnh viện đầu tư xây dựng trung tâm phục hồi chức năng vận động. Hàng đầu tiên lắp đặt $12$ thiết bị tập phục hồi. Từ hàng thứ hai trở đi, để phân làn tập và mở rộng lối đi thông thoáng chống va chạm, mỗi hàng sau lắp đặt ít hơn hàng liền trước nó $2$ thiết bị. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de14) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát mật độ phát triển của vi khuẩn kháng thuốc (superbug) trên đĩa thạch thí nghiệm petri. Ban đầu có $200$ tế bào vi khuẩn. Cứ sau mỗi giờ nuôi cấy, do cơ chế kháng thuốc sinh sản nhanh, lượng vi khuẩn tăng thêm $30\%$ so với giờ trước đó. Các phát biểu sau đúng hay sai?], (
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de14) — Mã 101], back-to: "sec-exercise-hub",[Mức độ suy giảm thính lực của các công nhân làm việc lâu năm trong nhà máy dệt công nghiệp tiếng ồn lớn. Biết cứ sau mỗi chu kỳ làm việc $5$ năm, độ nhạy thính lực trung bình giảm đi $6\%$ so với độ nhạy thính lực ở chu kỳ trước đó. Hỏi sau tối thiểu bao nhiêu chu kỳ làm việc thì độ nhạy thính lực giảm xuống còn dưới $60\%$ so với mức ban đầu lúc mới vào làm?],
    [9],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de14) — Mã 101], back-to: "sec-exercise-hub",[Một dự án tầm soát ung thư sớm quy mô cộng đồng được triển khai miễn phí cho người dân. Tổng chi phí duy trì dự án hằng năm dự kiến là $500$ triệu đồng vào cuối mỗi năm liên tiếp trong $5$ năm. Biết lãi suất chiết khấu dòng tiền là $6\%$/năm cố định. Tính giá trị hiện tại (Present Value) của tổng chi phí chi trả cho dự án tầm soát này (làm tròn đến hàng đơn vị triệu đồng).],
    [2106],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 14)!]      #v(0.6em)
