// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 15)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 15)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de15) — Mã 101], back-to: "sec-exercise-hub",[Một con lắc lò xo dao động tắt dần chậm do lực cản môi trường. Biên độ dao động của chu kỳ đầu tiên là $8.0$ cm. Kể từ chu kỳ thứ hai trở đi, biên độ dao động giảm đi $10\%$ sau mỗi chu kỳ so với chu kỳ liền trước đó. Biên độ dao động của con lắc ở chu kỳ thứ $6$ bằng bao nhiêu xăng-ti-mét?],
    (
        [$4.0$ cm.],
        [$4.3$ cm.],
        True([$4.72$ cm.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de15) — Mã 101], back-to: "sec-exercise-hub",[Trong một máy gia tốc hạt ly tâm cơ học, hạt mang điện được gia tốc chuyển động tăng tốc liên tục. Chu kỳ thứ nhất tốc độ hạt đạt $1000$ m/s. Kể từ chu kỳ thứ hai trở đi, tốc độ hạt tăng gấp rưỡi (tương đương tăng $50\%$) so với chu kỳ liền trước đó. Tốc độ hạt đạt được ở chu kỳ thứ $6$ bằng bao nhiêu m/s?],
    (
        [$5000$ m/s.],
        [$6500$ m/s.],
        True([$7593.75$ m/s.]),
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de15) — Mã 101], back-to: "sec-exercise-hub",[Một đường dây tải điện xoay chiều truyền tải năng lượng đi xa đô thị thị. Điện áp ở đầu nguồn cấp điện là $220$ kV. Cứ truyền tải đi xa thêm mỗi km đường dây, do hao tổn trở kháng, điện áp bị sụt giảm đi $1.5\%$ so với điện áp ở km liền trước đó. Hỏi điện áp truyền đến trạm biến áp cuối cách nguồn $15$ km bằng bao nhiêu kV?],
    (
        [$170.5$ kV.],
        True([$175.3$ kV.]),
        [$180.2$ kV.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de15) — Mã 101], back-to: "sec-exercise-hub",[Một hệ thống lò xo giảm xóc chịu tải cơ học được lắp xếp chồng lên nhau thành một cột giảm xóc đồng trục đứng. Chiều dài lò xo trên cùng là $30$ cm. Từ lò xo thứ hai trở xuống dưới, để tăng cứng chịu tải trọng lớn của móng, mỗi lò xo sau được nén ngắn hơn lò xo liền ngay trên nó là $1.5$ cm. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de15) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát hiện tượng giãn nở nhiệt cơ học của các thanh kim loại ghép nối tiếp nhau dọc hành lang kết cấu nhà xưởng. Ở nhiệt độ phòng $25 degree "C"$, thanh thứ nhất dài $2.0$ mét. Cứ thanh tiếp theo dài hơn thanh liền trước nó là $0.3$ mét. Khi nhiệt độ môi trường tăng lên thêm $1 degree "C"$, mỗi thanh bị giãn nở dài ra thêm một lượng không đổi là $0.15$ mm. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de15) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát quá trình phản xạ khuếch tán ánh sáng qua hệ nhiều tấm gương thủy tinh xếp song song chồng khít. Tia sáng truyền thẳng chiếu qua hệ gương. Biết sau mỗi lần phản xạ gương, cường độ bức xạ còn truyền qua giảm đi $12\%$ so với cường độ trước đó. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de15) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát quá trình phân rã phóng xạ tự nhiên của một mẫu chất phóng xạ Urani đồng vị. Biết cứ sau mỗi chu kỳ bán rã $100$ năm, khối lượng chất phóng xạ còn lại giảm đi một nửa ($50\%$) so với ban đầu. Ban đầu khối lượng mẫu chất phóng xạ là $800$ gam. Các phát biểu sau đúng hay sai?], (
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 3. DÃY SỐ - CẤP SỐ CỘNG - CẤP SỐ NHÂN (ĐỀ SỐ 15)!]      #v(0.6em)
