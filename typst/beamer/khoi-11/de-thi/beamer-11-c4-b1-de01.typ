// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 01)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 01)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho ba điểm $A$, $B$, $C$ không thẳng hàng và một điểm $S$ nằm ngoài mặt phẳng $(A B C)$. Có bao nhiêu mặt phẳng phân biệt được tạo thành từ $4$ điểm đã cho?],
    (
        [$3$ mặt phẳng.],
        True([$4$ mặt phẳng.]),
        [$5$ mặt phẳng.],
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Trong không gian, cho hai đường thẳng chéo nhau $a$ và $b$. Mệnh đề nào sau đây là đúng?],
    (
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành tâm $O$. Gọi $M$, $N$ lần lượt là trung điểm của các cạnh $S A$ và $S D$. Đường thẳng $M N$ song song với đường thẳng nào sau đây?],
    (
        [$S B$.],
        [$B C$.],
        True([$A D$.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Mái nhà của một nhà xưởng công nghiệp được cấu tạo từ các kèo thép hình tam giác $S B C$. Trên các kèo này, người ta gác các thanh xà gồ dọc song song với nhau để lợp tôn. Nếu đường thẳng chứa xà gồ thứ nhất là $d_1$ và đường thẳng chứa xà gồ thứ hai là $d_2$, khi đó mối quan hệ giữa $d_1$ và $d_2$ trong thiết kế kết cấu là gì?],
    (
        [Chéo nhau.],
        [Cắt nhau.],
        True([Song song.]),
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình thang $A B C D$ trong không gian có $A B parallel C D$. Gọi $I, J$ lần lượt là trung điểm của $A D$ và $B C$. Giao tuyến của hai mặt phẳng $(S A B)$ và $(S C D)$ (với $S$ không nằm trên mặt phẳng hình thang) là đường thẳng nào sau đây?],
    (
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho đường thẳng $a$ song song với mặt phẳng $(alpha)$. Nếu mặt phẳng $(beta)$ chứa đường thẳng $a$ và cắt $(alpha)$ theo giao tuyến $b$ thì mối quan hệ giữa $a$ và $b$ là gì?],
    (
        [Cắt nhau.],
        [Chéo nhau.],
        True([Song song.]),
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình thang với các cạnh đáy là $A B$ và $C D$. Gọi $d$ là giao tuyến của hai mặt phẳng $(S A B)$ and $(S C D)$. Khẳng định nào sau đây đúng?],
    (
        [$d$ song song với $S A$.],
        [$d$ song song với $S D$.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Trong không gian, cho hai đường thẳng chéo nhau $a$ và $b$. Có bao nhiêu mặt phẳng chứa đường thẳng $a$ và song song với đường thẳng $b$?],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện $A B C D$. Gọi $M$, $N$, $P$, $Q$ lần lượt là trung điểm của các cạnh $A B$, $B C$, $C D$, $D A$. Tứ giác $M N P Q$ là hình gì?],
    (
        [Hình thang.],
        [Hình chữ nhật.],
        True([Hình bình hành.]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Mô hình hóa kết cấu của một cầu vượt cạn đô thị phẳng. Mặt cầu phẳng nằm trên hệ dầm gồm các xà dọc $X_1, X_2$ song song với nhau. Trụ đỡ cầu được đóng đứng vuông góc với mặt đất phẳng. Các dầm xà dọc $X_1, X_2$ song song với mặt đất phẳng. Nếu một đường thẳng $d$ trên mặt đất song song với hệ xà dọc thì khẳng định nào dưới đây đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành tâm $O$. Giao tuyến của hai mặt phẳng $(S A D)$ và $(S B C)$ là đường thẳng đi qua $S$ và song song với đường thẳng nào sau đây?],
    (
        [$A B$.],
        True([$A D$.]),
        [$A C$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M, N$ lần lượt là trung điểm của các cạnh $S A, S B$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện đều $S.A B C$ cạnh $a$. Một mặt phẳng $(alpha)$ song song với hai cạnh $A B$ và $S C$ cắt các cạnh $S A, S B, B C, A C$ lần lượt tại các điểm $M, N, P, Q$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Một giàn thép chịu lực có kết cấu hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành phẳng tâm $O$. Trên các cạnh $S A, S B, S C$, người ta lắp các khớp định vị $I, J, K$ sao cho $(S I) / (S A) = (S J) / (S B) = (2)/(3)$ và $(S K) / (S C) = (1)/(2)$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M, N, P, Q$ lần lượt là trung điểm của các cạnh $S A, S B, S C, S D$. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện $A B C D$. Lấy các điểm $M, N$ lần lượt trên các cạnh $A B$ và $A C$ sao cho $(A M) / (A B) = (1)/(3)$ và $(A N) / (A C) = (2)/(3)$. Gọi $d$ là giao tuyến của hai mặt phẳng $(D M N)$ và $(B C D)$. Hỏi đường thẳng $d$ cắt đường thẳng $B C$ tại điểm $K$. Tính tỉ số $(K B) / (K C)$.],
    [4],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện đều $A B C D$ cạnh $a = 12$ cm. Một mặt phẳng $(alpha)$ song song với cả $A B$ và $C D$ cắt các cạnh của tứ diện tạo thành thiết diện là một hình chữ nhật. Tính chu vi của hình chữ nhật thiết diện đó (tính bằng xăng-ti-mét).],
    [24],
    fig: canvas(length: 1.3cm, {
      import draw: *
      let A = (-1.5, 0.5)
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình thang ($A B parallel C D$ và $A B = 2 C D$). Gọi $M$ là trung điểm của cạnh $S A$. Mặt phẳng $(M C D)$ cắt cạnh $S B$ tại điểm $N$. Tính tỉ số diện tích tam giác $S M N$ và diện tích tam giác $S A B$. (Viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$)],
    [5],
    fig: canvas(length: 1.3cm, {
      import draw: *
      let A = (-2.0, 0.8)
...
// TL 6
#lt-tln(num: 22, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M, N$ lần lượt là trung điểm của $S B$ và $S D$. Mặt phẳng $(A M N)$ cắt $S C$ tại điểm $P$. Biết tỉ số $(S P) / (S C) = a/b$ (phân số tối giản). Nhập đáp án là $a+b$.],
    [4],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 01)!]      #v(0.6em)
