// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 02)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 02)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho đường thẳng $d$ song song với mặt phẳng $(alpha)$. Khẳng định nào sau đây đúng?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hai đường thẳng phân biệt $a, b$ và mặt phẳng $(alpha)$. Biết $a parallel (alpha)$ và $b subset (alpha)$. Mệnh đề nào sau đây đúng?],
    (
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành tâm $O$. Đường thẳng $M N$ song song với mặt phẳng $(S A D)$ khi $M, N$ lần lượt là trung điểm của các cạnh nào dưới đây?],
    (
        [$S B$ và $A B$.],
        [$S B$ và $A D$.],
        True([$S C$ và $C D$.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một cấu kiện của giàn giáo xây dựng gồm bốn thanh sắt tạo thành một hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Các thanh giằng ngang $M N, N P, P Q, Q M$ nối trung điểm của các cạnh bên $S A, S B, S C, S D$. Khẳng định nào sau đây là sai?],
    (
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Để lắp ráp hệ thống rèm cửa thông minh phẳng song song với bức tường đứng $(alpha)$, người thợ cần lắp một thanh ray định hướng $d$ nằm ngang. Để đảm bảo tính thẩm mỹ và kỹ thuật, thanh ray $d$ phải có vị trí thế nào đối với bức tường $(alpha)$?],
    (
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Trong không gian, cho hai đường thẳng chéo nhau $a, b$. Có bao nhiêu mặt phẳng chứa đường thẳng $a$ và song song với đường thẳng $b$?],
    (
        [Vô số.],
        [Không có.],
        True([Duy nhất $1$.]),
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hai đường thẳng chéo nhau $a$ và $b$. Khẳng định nào sau đây là sai khi nói về các đường thẳng song song với $b$?],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho đường thẳng $a$ song song với mặt phẳng $(alpha)$ và đường thẳng $b$ nằm trong mặt phẳng $(alpha)$. Mệnh đề nào sau đây đúng?],
    (
        [$a$ và $b$ chéo nhau.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành tâm $O$. Gọi $M$ là trung điểm của $S D$. Giao tuyến của hai mặt phẳng $(S A B)$ và $(M C D)$ là đường thẳng như thế nào?],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Trong mô hình kiến trúc của một tòa nhà phẳng đứng. Để tạo tính liên kết chịu lực giữa cột thẳng đứng $a$ và thanh dầm chéo $b$, người thợ cần đặt một tấm liên kết dầm chéo song song với cả hai thanh $a$ và $b$. Điều kiện cần và đủ để dựng được tấm liên kết chéo này là gì?],
    (
        [$a$ và $b$ cắt nhau.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình thang ($A D parallel B C$). Gọi $M$ là trung điểm của $S B$. Mặt phẳng $(A D M)$ cắt hình chóp theo thiết diện là hình gì?],
    (
        [Hình bình hành.],
        [Hình chữ nhật.],
        True([Hình thang.]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho đường thẳng $a$ song song với mặt phẳng $(alpha)$. Mệnh đề nào sau đây đúng?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành tâm $O$. Gọi $M$ là trung điểm của cạnh $S A$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M$ là trung điểm của cạnh $S A$. Mặt phẳng $(alpha)$ đi qua $M$ và song song với mặt phẳng $(S B C)$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hai đường thẳng chéo nhau $a$ và $b$. Đường thẳng $c$ cắt cả hai đường thẳng $a$ và $b$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một khung giàn mái thép có kết cấu dạng hình chóp cụt tứ giác $A B C D . A' B' C' D'$ với hai đáy $A B C D$ và $A' B' C' D'$ song song với nhau. Một thanh giằng chéo ổn định liên kết $M N$ nối trung điểm $M$ của cạnh $A B$ và trung điểm $N$ của cạnh $C' D'$. Các phát biểu sau đúng hay sai?], (
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M$ là trung điểm của cạnh $S C$. Mặt phẳng $(alpha)$ đi qua $A M$ và song song với đường thẳng $B D$ cắt các cạnh $S B, S D$ lần lượt tại $P, Q$. Biết diện tích tam giác $S P Q$ bằng $16$ $"cm"^2$. Tính diện tích tam giác $S B D$ (tính bằng xăng-ti-mét vuông).],
    [36],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $C D$. Một mặt phẳng $(alpha)$ song song với mặt phẳng $(S A D)$ cắt các cạnh $B C, S C, S B$ lần lượt tại $I, J, K$. Biết $M N = 12$ cm. Tính độ dài đoạn thẳng thiết diện $I K$ (tính bằng xăng-ti-mét).],
    [6],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện $A B C D$. Gọi $G_1, G_2, G_3$ lần lượt là trọng tâm của các tam giác $A B C$, $A C D$, $A B D$. Tính tỉ số diện tích tam giác $G_1 G_2 G_3$ và diện tích tam giác $B C D$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [10],
    fig: canvas(length: 1.3cm, {
      import draw: *
...
// TL 6
#lt-tln(num: 22, de: [Đề 2 (de02) — Mã 101], back-to: "sec-exercise-hub",[Một giàn giáo chịu lực đứng dạng hình chóp $S.A B C D$ đáy là hình bình hành có chu vi bằng $36$ m. Người ta lắp các thanh thép ngang chống trượt ổn định kết cấu $M N, N P, P Q, Q M$ kết nối lần lượt trung điểm các cạnh bên $S A, S B, S C, S D$. Tính chu vi của khung thép ngang $M N P Q$ đó (tính bằng mét).],
    [18],
    fig: canvas(length: 1.3cm, {
      import draw: *
      let A = (-1.0, 0.8)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 02)!]      #v(0.6em)
