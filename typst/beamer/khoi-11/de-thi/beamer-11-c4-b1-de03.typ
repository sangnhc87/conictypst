// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 03)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 03)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hai mặt phẳng song song $(alpha)$ và $(beta)$. Nếu mặt phẳng $(gamma)$ cắt $(alpha)$ theo giao tuyến $a$ thì giao tuyến $b$ của $(gamma)$ và $(beta)$ có mối quan hệ thế nào với $a$?],
    (
        [Cắt nhau.],
        [Chéo nhau.],
        True([Song song.]),
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Trong không gian, cho hai mặt phẳng phân biệt $(alpha)$ và $(beta)$ cùng song song với mặt phẳng $(gamma)$. Mệnh đề nào sau đây đúng?],
    (
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Phép chiếu song song không bảo toàn tính chất nào sau đây của hình phẳng?],
    (
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của $A B$ và $A C$. Mặt phẳng $(A' M N)$ song song với đường thẳng nào sau đây?],
    (
        [$A A'$.],
        True([$B' C'$.]),
        [$B B'$.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Trong thiết kế mái nhà khung thép phẳng song song, mặt phẳng mái chứa hệ xà gồ $(alpha)$ song song với mặt sàn ngang $(beta)$. Nếu dầm chịu lực chính của mái là đường thẳng $d$ song song với mặt sàn $(beta)$ thì khẳng định nào dưới đây đúng?],
    (
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Mặt phẳng $(B A' D')$ song song với mặt phẳng nào sau đây?],
    (
        [$(A B' D)$.],
        True([$(C D' B')$.]),
        [$(A' C' D)$.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Nếu hai mặt phẳng song song $(alpha)$ và $(beta)$ lần lượt chứa hai đường thẳng song song $a$ và $b$ thì mọi mặt phẳng $(gamma)$ cắt cả $a$ và $b$ sẽ cắt $(alpha)$ và $(beta)$ theo hai giao tuyến có mối quan hệ gì?],
    (
        [Cắt nhau.],
        True([Song song.]),
        [Chéo nhau.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hai mặt phẳng song song $(alpha)$ và $(beta)$. Điểm $A$ thuộc $(alpha)$ và điểm $B$ thuộc $(beta)$. Qua $A$ vẽ đường thẳng $a$ song song với $b$ qua $B$. Khẳng định nào sau đây đúng?],
    (
        [$a$ và $b$ chéo nhau.],
        [$a$ và $b$ cắt nhau.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $I, J, K$ lần lượt là trung điểm của các cạnh $A B, B C, C A$. Mặt phẳng $(I J K)$ song song với mặt phẳng nào sau đây?],
    (
        [$(A' B' C')$.],
        True([$(A B C)$ và $(A' B' C')$.]),
        [$(A B C)$.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Trong phép chiếu song song lên mặt phẳng chiếu $(P)$ theo phương chiếu $l$. Một hình tròn $(C)$ nằm trên mặt phẳng không song song với phương chiếu $l$ và không song song với mặt phẳng chiếu $(P)$. Hình chiếu của hình tròn $(C)$ là hình gì?],
    (
        [Hình tròn.],
        True([Hình elip.]),
        [Đoạn thẳng.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Thiết diện cắt bởi mặt phẳng song song với mặt phẳng $(A B C D)$ là hình gì?],
    (
        [Hình tam giác.],
        [Hình thang.],
        True([Hình bình hành.]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một bức tranh phẳng được treo đứng trên tường đứng $(alpha)$. Một bóng đèn chiếu sáng từ xa tạo ánh sáng song song chiếu vào bức tranh và in bóng lên mặt sàn phẳng ngang $(beta)$. Biết tường $(alpha)$ vuông góc với sàn $(beta)$. Bóng của bức tranh trên mặt sàn là hình gì?],
    (
        [Hình chữ nhật.],
        True([Đoạn thẳng.]),
        [Hình elip.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hai mặt phẳng song song $(alpha)$ và $(beta)$. Đường thẳng $a$ nằm trong $(alpha)$, đường thẳng $b$ nằm trong $(beta)$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $C D$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N, P$ lần lượt là trung điểm của các cạnh bên $A A', B B', C C'$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của $A' B'$ và $B' C'$. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ đứng tam giác $A B C . A' B' C'$. Một mặt phẳng $(alpha)$ song song với mặt phẳng đáy $(A B C)$ cắt các cạnh bên $A A', B B', C C'$ lần lượt tại $A_1, B_1, C_1$. Biết $A A_1 = 3$ cm và $A_1 A' = 6$ cm. Tính tỉ số diện tích mặt bên $A B B_1 A_1$ và diện tích mặt bên $A_1 B_1 B' A'$ (viết kết quả dưới dạng số thập phân).],
    [0.5],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hai mặt phẳng song song $(alpha)$ và $(beta)$ có khoảng cách bằng $d = 8$ cm. Một hình lập phương $A B C D . A' B' C' D'$ có đáy $A B C D$ nằm trên $(alpha)$ và đáy $A' B' C' D'$ nằm trên $(beta)$. Tính diện tích toàn phần của hình lập phương đó (tính bằng xăng-ti-mét vuông).],
    [384],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ đứng tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $A C$. Tính tỉ số diện tích tam giác $A M N$ và diện tích tam giác $A B C$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [5],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ đứng tam giác $A B C . A' B' C'$ có diện tích đáy bằng $54$ $"cm"^2$. Gọi $G, G'$ lần lượt là trọng tâm của hai đáy $A B C$ và $A' B' C'$. Mặt phẳng $(alpha)$ đi qua trung điểm $I$ của $G G'$ và song song với đáy $(A B C)$ cắt các cạnh bên $A A', B B', C C'$ lần lượt tại $A_1, B_1, C_1$. Tính diện tích thiết diện $A_1 B_1 C_1$ (tính bằng xăng-ti-mét vuông).],
    [54],
    fig: canvas(length: 1.3cm, {
      import draw: *
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $A D$. Mặt phẳng $(A' M N)$ cắt các cạnh bên $B B'$ và $D D'$ lần lượt tại $P$ và $Q$. Biết độ dài cạnh bên $A A' = 12$ cm. Tính độ dài đoạn thẳng $B P$ (tính bằng xăng-ti-mét).],
    [6],
    fig: canvas(length: 1.3cm, {
      import draw: *
      let A = (-1.5, 0.5)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 03)!]      #v(0.6em)
