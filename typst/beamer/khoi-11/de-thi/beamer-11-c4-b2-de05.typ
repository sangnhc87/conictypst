// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 05)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 05)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Qua một điểm nằm ngoài một mặt phẳng cho trước, có bao nhiêu đường thẳng song song với mặt phẳng đó?],
    (
        [Có duy nhất một.],
        [Có hai.],
        [Không có.],
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Trong không gian, cho hai đường thẳng chéo nhau $a$ và $b$. Nếu đường thẳng $c$ song song với $a$ thì vị trí tương đối giữa $c$ và $b$ là gì?],
    (
        [Chắc chắn chéo nhau.],
        [Chắc chắn song song.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Để gia cố hệ thống khung giàn giáo đứng hình hộp, người ta lắp các thanh chéo chịu lực $A D'$ và $B C'$. Khẳng định nào sau đây đúng về vị trí tương đối của hai thanh chống chéo này?],
    (
        [Song song với nhau.],
        [Cắt nhau.],
        True([Chéo nhau.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M, N, P, Q$ lần lượt là trung điểm của các cạnh $S A, S B, S C, S D$. Mặt phẳng $(M N P Q)$ song song với mặt phẳng nào sau đây?],
    (
        [$(S A B)$.],
        [$(S B C)$.],
        True([$(A B C D)$]),
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Thông qua phép chiếu song song theo phương chiếu $l$ lên mặt phẳng $(P)$, hình chiếu của một đoạn thẳng $A B$ song song với phương chiếu $l$ là gì?],
    (
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho ba mặt phẳng song song $(P), (Q), (R)$. Hai đường thẳng $d_1$ và $d_2$ cắt ba mặt phẳng này lần lượt tại $A, B, C$ và $A', B', C'$. Biết $A B = 4$ cm, $B C = 6$ cm, $B' C' = 9$ cm. Tính độ dài đoạn thẳng $A' B'$ (tính bằng xăng-ti-mét).],
    (
        [$5$ cm.],
        True([$6$ cm.]),
        [$7$ cm.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một cấu kiện chịu lực của cầu vượt gồm các dầm ngang $A B, C D, E F$ song song với nhau và song song với mặt sông phẳng nằm ngang. Các dầm dọc chịu lực $M N, P Q$ gác lên các dầm ngang đó. Khẳng định nào sau đây đúng về vị trí của các dầm dọc đối với mặt sông phẳng?],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M$ là trung điểm của cạnh $B B'$. Thiết diện của hình lăng trụ cắt bởi mặt phẳng $(A M C)$ là hình gì?],
    (
        [Hình bình hành.],
        True([Hình tam giác.]),
        [Hình thang.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Hình biểu diễn của một hình vuông qua phép chiếu song song lên một mặt phẳng chéo góc với mặt phẳng chứa hình vuông luôn là hình gì?],
    (
        [Hình vuông.],
        [Hình chữ nhật.],
        True([Hình bình hành.]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Dưới ánh nắng mặt trời chiếu chéo góc, bóng của hai cột đèn đứng song song với nhau trên mặt sân phẳng nằm ngang có mối quan hệ như thế nào?],
    (
        [Cắt nhau.],
        [Chéo nhau.],
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Giao tuyến của hai mặt phẳng $(A B C D)$ và $(A' B' C' D')$ là gì?],
    (
        [Đường thẳng $A B$.],
        [Đường thẳng $A' B'$.],
        [Một điểm chung.],
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Mặt phẳng $(alpha)$ đi qua trọng tâm tam giác $S A B$ và song song với mặt đáy $(A B C D)$. Thiết diện cắt bởi mặt phẳng $(alpha)$ là hình gì?],
    (
        [Hình tam giác.],
        True([Hình bình hành.]),
        [Hình thang.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Gọi $M, N$ lần lượt là trung điểm của các cạnh $S A, S C$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $I, J, K$ lần lượt là trung điểm của các cạnh bên $A A', B B', C C'$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một hệ khung giàn chịu lực của nhà xưởng dạng hình chóp cụt tứ giác $A B C D . A' B' C' D'$ có đáy $A B C D$ và $A' B' C' D'$ là các hình bình hành song song với nhau. Gọi $M, N, P, Q$ lần lượt là trung điểm của các thanh xiên chịu lực $A A', B B', C C', D D'$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện $A B C D$. Gọi $G$ là trọng tâm của tam giác $B C D$. Phép chiếu song song theo phương $A B$ lên mặt phẳng $(A C D)$ biến các điểm của tứ diện. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành tâm $O$. Gọi $M$ là trung điểm của cạnh $S C$. Mặt phẳng $(alpha)$ đi qua $A M$ và song song với đường thẳng $B D$ cắt cạnh $S B$ tại điểm $P$. Tính tỉ số $(S P) / (S B)$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [5],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $A C$. Một mặt phẳng $(alpha)$ đi qua $M$ và song song với cả $B N$ và $A A'$. Mặt phẳng $(alpha)$ cắt đường thẳng $B C$ tại $K$. Tính tỉ số $(K B) / (K C)$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [4],
...
// TL 4
#lt-tln(num: 20, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A' B'$ và $B' C'$. Mặt phẳng $(D M N)$ cắt cạnh $B B'$ tại điểm $P$. Tính tỉ số $(B' P) / (B B')$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [5],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Bóng của một cột cờ đứng thẳng trên mặt đất phẳng dài $6$ m. Cùng lúc đó, một thanh chống chịu lực mái hiên dài gác nghiêng có bóng trên đất dài $3$ m. Biết cột cờ cao $8$ m. Tính độ cao của đầu thanh chống trên tường đứng (tính bằng mét).],
    [4],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Mặt phẳng $(alpha)$ đi qua trung điểm $M$ của cạnh $S A$ và song song với mặt phẳng $(S C D)$. Mặt phẳng $(alpha)$ cắt cạnh $A B$ tại điểm $N$. Tính tỉ số $(A N) / (A B)$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [3],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 05)!]      #v(0.6em)
