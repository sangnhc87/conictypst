// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 06)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 06)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Trong không gian, khẳng định nào sau đây là đúng về vị trí tương đối của hai đường thẳng chéo nhau?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho đường thẳng $a$ song song với mặt phẳng $(P)$. Khẳng định nào sau đây đúng?],
    (
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy là hình bình hành. Gọi $M, N, P$ lần lượt là trung điểm của $S A, S B, S D$. Mặt phẳng $(M N P)$ song song với mặt phẳng nào dưới đây?],
    (
        [$(S C D)$],
        [$(S B C)$],
        True([$(A B C D)$]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Trong các mệnh đề sau, mệnh đề nào sai?],
    (
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của $A' B'$ và $A' C'$. Đường thẳng $M N$ song song với mặt phẳng nào sau đây?],
    (
        True([$(B C C' B')$]),
        [$(A B B' A')$],
        [$(A C C' A')$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho ba mặt phẳng đôi một song song. Đường thẳng $d_1$ cắt ba mặt phẳng này lần lượt tại $A, B, C$ sao cho $A B = 3$ cm, $B C = 6$ cm. Đường thẳng $d_2$ cắt ba mặt phẳng trên lần lượt tại $D, E, F$ sao cho $D E = 4$ cm. Độ dài đoạn thẳng $E F$ là:],
    (
        [$2$ cm.],
        True([$8$ cm.]),
        [$6$ cm.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy là hình bình hành $A B C D$. Thiết diện của hình chóp cắt bởi mặt phẳng đi qua trung điểm của $S A, S D$ và song song với $A B$ là:],
    (
        [Hình thang cân.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Mặt phẳng chứa đường thẳng $A B'$ và song song với $C D'$ là mặt phẳng nào sau đây?],
    (
        True([$(A B B' A')$]),
        [$(A B C' D')$],
        [$(A D D' A')$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Khẳng định nào sau đây là sai khi nói về phép chiếu song song?],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C$. Gọi $G_1, G_2$ lần lượt là trọng tâm của các tam giác $S A B, S A C$. Khẳng định nào sau đây đúng?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy là hình bình hành $A B C D$. Một mặt phẳng $(alpha)$ song song với đáy và cắt các cạnh bên $S A, S B, S C, S D$ lần lượt tại $A', B', C', D'$. Khẳng định nào dưới đây đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Mặt phẳng $(B A' D)$ song song với mặt phẳng nào sau đây?],
    (
        [$(C' B' D)$],
        True([$(C B' D')$]),
        [$(C D D' C')$],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành tâm $O$. Gọi $M$ là trung điểm của cạnh $S D$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $B C$ và $B' C'$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $M, N$ lần lượt là trung điểm của $A' D'$ và $C' D'$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một mô hình kiến trúc chịu lực có kết cấu dạng hình chóp $S.A B C D$ với đáy $A B C D$ là hình thang ($A B parallel C D, A B = 2 C D$). Người ta lắp đặt các khung giằng thép nằm trong các mặt phẳng song song với đáy. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Mặt phẳng $(alpha)$ đi qua trung điểm $M$ của $S A$ và song song với $A B$ và $S C$. Mặt phẳng $(alpha)$ cắt cạnh bên $S B$ tại $N$. Tính tỉ số $(S B) / (S N)$.],
    [2],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $A D$. Mặt phẳng $(A' M N)$ cắt cạnh bên $C C'$ tại điểm $P$. Tính tỉ số $(C' P) / (C C')$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [5],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M, N$ lần lượt là trung điểm của các cạnh $S A, S B$. Mặt phẳng $(alpha)$ đi qua $M, N$ cắt các cạnh $S D, S C$ lần lượt tại $P, Q$. Biết độ dài cạnh đáy $C D = 16$ cm. Tính độ dài đoạn thẳng $P Q$ (tính bằng xăng-ti-mét).],
    [8],
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M, N$ lần lượt là trung điểm của các cạnh $S A$ và $S C$. Mặt phẳng $(B M N)$ cắt cạnh bên $S D$ tại $P$. Tính tỉ số $(S D) / (S P)$.],
    [3],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $B C, A' C'$. Gọi $d$ là giao tuyến của hai mặt phẳng $(A M N)$ và $(A' B' C')$. Biết $A' B' = 12$ cm. Tính độ dài đoạn thẳng thiết diện của giao tuyến $d$ nằm bên trong tam giác đáy $A' B' C'$ (tính bằng xăng-ti-mét).],
    [6],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 06)!]      #v(0.6em)
