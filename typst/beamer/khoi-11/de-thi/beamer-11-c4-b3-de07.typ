// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 07)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 07)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho đường thẳng $a$ song song với mặt phẳng $(P)$ và đường thẳng $b$ song song với $(P)$. Vị trí tương đối của $a$ và $b$ có thể là:],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hai mặt phẳng song song $(P)$ và $(Q)$. Nếu đường thẳng $a$ nằm trong $(P)$ và đường thẳng $b$ nằm trong $(Q)$ thì:],
    (
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M, N$ lần lượt là trung điểm của $S A, S C$. Khẳng định nào sau đây đúng?],
    (
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hai đường thẳng chéo nhau $a$ và $b$. Có bao nhiêu mặt phẳng chứa $a$ và song song với $b$?],
    (
        [Vô số.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $G$ là trọng tâm tam giác $S A B$. Qua $G$ kẻ đường thẳng song song với $A B$ cắt $S B$ tại $M$. Tỉ số $(S M) / (S B)$ bằng:],
    (
        [$1/2$],
        True([$2/3$]),
        [$1/3$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho ba mặt phẳng song song $(P), (Q), (R)$. Hai cát tuyến bất kỳ $d_1, d_2$ cắt ba mặt phẳng này lần lượt tại $A, B, C$ và $A', B', C'$. Khẳng định nào sau đây đúng?],
    (
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Thiết diện cắt bởi mặt phẳng $(A B' C')$ và mặt phẳng $(A' B C)$ song song với đường thẳng nào?],
    (
        [$A A'$],
        True([$B C$]),
        [$A B$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho phép chiếu song song lên mặt phẳng $(P)$ theo phương $l$. Hình chiếu của một tam giác $A B C$ (không có cạnh nào song song hoặc trùng với phương chiếu) là:],
    (
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy là hình bình hành $A B C D$ tâm $O$. Gọi $M$ là trung điểm của $S C$. Giao điểm của đường thẳng $A M$ và mặt phẳng $(S B D)$ là:],
    (
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Đường thẳng nào sau đây song song với mặt phẳng $(A A' C' C)$?],
    (
        [ $B D$ ],
        [ $B' D'$ ],
        True([ $B B'$ ]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M, N$ lần lượt là trung điểm của $S A, S B$. Khẳng định nào sau đây đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Khẳng định nào sau đây là đúng về các cặp mặt phẳng đối diện?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy là hình bình hành $A B C D$ tâm $O$. Gọi $M$ là trung điểm của $S A$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $G_1, G_2$ lần lượt là trọng tâm của các tam giác $A B C$ và $A' B' C'$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $I$ là giao điểm của hai đường chéo của mặt bên $A D D' A'$, $J$ là giao điểm của hai đường chéo của mặt bên $B C C' B'$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một tòa tháp kết cấu khung thép chịu lực dạng hình chóp $S.A B C D$ có đáy $A B C D$ là hình bình hành. Các kỹ sư lắp đặt các giằng chịu lực nối trung điểm các cạnh. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M, N$ lần lượt là trung điểm của $S A, S B$. Mặt phẳng $(alpha)$ đi qua $M, N$ cắt các cạnh $S D, S C$ lần lượt tại $P, Q$. Biết độ dài đoạn thẳng thiết diện $P Q = 5$ cm. Tính độ dài cạnh đáy $C D$ (tính bằng xăng-ti-mét).],
    [10],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $M$ là trung điểm của cạnh $A B$. Mặt phẳng $(A' M D)$ cắt cạnh bên $C C'$ tại điểm $P$. Tính tỉ số $(C' P) / (C C')$ (viết kết quả dưới dạng phân số tối giản $a/b$, nhập đáp án là $a+b$).],
    [3],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành $A B C D$. Gọi $M$ là trung điểm của cạnh $S A$. Mặt phẳng $(alpha)$ đi qua $M$ và song song với mặt phẳng $(S B C)$ cắt cạnh đáy $A B$ tại $N$. Tính tỉ số $(A B) / (A N)$.],
    [2],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $B C$ và $B' C'$. Mặt phẳng $(alpha)$ đi qua trung điểm $I$ của $M N$ và song song với mặt phẳng đáy $(A B C)$ cắt cạnh bên $A A'$ tại điểm $P$. Biết độ dài cạnh bên $A A' = 18$ cm. Tính độ dài đoạn thẳng $A P$ (tính bằng xăng-ti-mét).],
    [9],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $G_1, G_2$ lần lượt là trọng tâm của các tam giác $B D A'$ và $B D C'$. Biết độ dài đường chéo đáy $A' C' = 18$ cm. Tính độ dài đoạn thẳng $G_1 G_2$ (tính bằng xăng-ti-mét).],
    [6],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M$ là trung điểm của $S A$. Mặt phẳng $(alpha)$ đi qua $M$ và song song với cả $A B$ và $S D$. Mặt phẳng $(alpha)$ cắt cạnh bên $S C$ tại $P$. Biết độ dài cạnh $S C = 10$ cm. Tính độ dài đoạn thẳng $S P$ (tính bằng xăng-ti-mét).],
    [5],
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 07)!]      #v(0.6em)
