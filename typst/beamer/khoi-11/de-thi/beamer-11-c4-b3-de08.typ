// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 08)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 08)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lập phương $A B C D . A' B' C' D'$. Đường thẳng $A C'$ chéo với đường thẳng nào dưới đây?],
    (
        [$A A'$],
        [$A C$],
        [$A' C'$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hai mặt phẳng song song $(P)$ và $(Q)$. Nếu đường thẳng $a$ song song với mặt phẳng $(P)$ thì vị trí của $a$ đối với $(Q)$ là gì?],
    (
        [Chắc chắn song song.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $G_1, G_2$ lần lượt là trọng tâm của tam giác $S A B$ và $S C D$. Khẳng định nào sau đây đúng?],
    (
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho phép chiếu song song theo phương $l$ lên mặt phẳng $(P)$. Khẳng định nào sau đây đúng?],
    (
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Mặt phẳng đi qua cạnh $A B$ và song song với cạnh bên $C C'$ sẽ cắt mặt bên $A C C' A'$ của lăng trụ theo giao tuyến song song với đường thẳng nào?],
    (
        [$B C$],
        True([$A A'$]),
        [$A C$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Trong các mệnh đề sau, mệnh đề nào đúng?],
    (
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $O$ là giao điểm của $A C$ và $B D$. Đường thẳng $A' O$ song song với mặt phẳng nào sau đây?],
    (
        [$(A B D)$],
        True([$(C B' D')$]),
        [$(A B B' A')$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho ba mặt phẳng song song $(P), (Q), (R)$. Hai đường thẳng $d_1$ và $d_2$ cắt ba mặt phẳng này lần lượt tại các điểm $A, B, C$ và $D, E, F$. Biết $A B = 2$ cm, $A C = 6$ cm, $D F = 9$ cm. Độ dài đoạn thẳng $D E$ là:],
    (
        [$2$ cm.],
        True([$3$ cm.]),
        [$4$ cm.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy là hình bình hành. Thiết diện của hình chóp cắt bởi mặt phẳng song song với mặt bên $(S A B)$ là hình gì?],
    (
        [Tam giác.],
        True([Hình thang.]),
        [Hình bình hành.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện $A B C D$. Gọi $G_1, G_2, G_3$ lần lượt là trọng tâm của tam giác $A B C, A C D, A B D$. Khẳng định nào sau đây đúng?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hai đường thẳng chéo nhau $a$ và $b$. Đường thẳng $c$ song song với $a$. Khẳng định nào sau đây đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Hình hộp $A B C D . A' B' C' D'$ có tất cả bao nhiêu mặt chéo (mặt phẳng đi qua 4 đỉnh của hình hộp nhưng không phải là mặt bên)?],
    (
        [$4$],
        True([$6$]),
        [$8$],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho tứ diện $A B C D$. Gọi $M, N$ lần lượt là trung điểm của các cạnh $A B$ và $C D$. Mặt phẳng $(alpha)$ chứa đường thẳng $M N$ và song song với $B C$. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $O_1, O_2$ lần lượt là tâm của hai đáy $A B C D$ và $A' B' C' D'$. Gọi $M$ là trung điểm của cạnh bên $A A'$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ tam giác $A B C . A' B' C'$. Gọi $I, J, K$ lần lượt là trọng tâm của các tam giác $A' B C, B' C A, C' A B$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một hệ khung thép giàn chịu lực hình hộp chữ nhật $A B C D . A' B' C' D'$ được lắp đặt các thanh chống xiên cố định. Gọi $M$ là trung điểm của cạnh bên $A A'$. Các kỹ sư kiểm tra hệ giằng chéo. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M, N$ là các điểm trên các cạnh $S A, S B$ sao cho $(S M) / (S A) = 1/3, (S N) / (S B) = 1/3$. Một mặt phẳng song song với đáy và đi qua $M, N$ cắt cạnh bên $S C$ tại $P$. Biết độ dài cạnh bên $S C = 15$ cm. Tính độ dài đoạn thẳng $S P$ (tính bằng xăng-ti-mét).],
    [5],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lập phương $A B C D . A' B' C' D'$ cạnh $6$ cm. Gọi $M$ là trung điểm của cạnh đáy $A D$. Mặt phẳng $(A' M B)$ cắt cạnh bên $C C'$ tại điểm $P$. Tính độ dài đoạn thẳng $C' P$ (tính bằng xăng-ti-mét).],
    [3],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình chóp $S.A B C D$ đáy hình bình hành. Gọi $M$ là trung điểm của cạnh bên $S A$. Mặt phẳng $(alpha)$ đi qua $M$ và song song với cả $A B$ và $S C$. Mặt phẳng $(alpha)$ cắt cạnh đáy $B C$ tại $Q$. Biết độ dài cạnh $B C = 12$ cm. Tính độ dài đoạn thẳng $C Q$ (tính bằng xăng-ti-mét).],
    [6],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình lăng trụ đứng tam giác $A B C . A' B' C'$. Gọi $M, N$ lần lượt là trung điểm của các cạnh đáy $A B$ và $A C$. Mặt phẳng $(A' M N)$ cắt các cạnh bên $B B'$ và $C C'$ lần lượt tại $P$ và $Q$. Biết độ dài cạnh bên $A A' = 18$ cm. Tính độ dài đoạn thẳng $B P$ (tính bằng xăng-ti-mét).],
    [9],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình hộp $A B C D . A' B' C' D'$. Gọi $G_1, G_2$ lần lượt là trọng tâm của các tam giác $B D A'$ và $B D C'$. Biết độ dài đường chéo của đáy dưới $A' C' = 24$ cm. Tính độ dài đoạn thẳng $G_1 G_2$ (tính bằng xăng-ti-mét).],
    [8],
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 4. QUAN HỆ SONG SONG (ĐỀ SỐ 08)!]      #v(0.6em)
