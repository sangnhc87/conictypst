// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 03)
...
#show: lecture-theme.with(
  title: "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 03)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ thỏa mãn giới hạn $limits(lim)_(n -> +oo) (u_n - 2)/(3u_n + 1) = 2$. Tính giới hạn $L = limits(lim)_(n -> +oo) u_n$.],
    (
        [$L = 2$],
        [$L = 0$],
        True([$L = -0.8$]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho giới hạn $limits(lim)_(x -> 1) (x^2 + a x + b)/(x - 1) = 3$ với $a, b in RR$. Tính giá trị của biểu thức $P = a^2 + b^2$.],
    (
        [$P = 2$],
        True([$P = 5$]),
        [$P = 10$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một thấu kính hội tụ có tiêu cự $f = 10$ cm. Khoảng cách từ vật đến thấu kính là $d$ (cm), khoảng cách từ ảnh đến thấu kính là $d'$ (cm) được tính bởi công thức $d' = (10d)/(d - 10)$ với $d > 10$. Tính giới hạn của khoảng cách ảnh $d'$ khi vật dời ra xa vô cực ($d -> +oo$).],
    (
        [$0$ cm.],
        [$5$ cm.],
        True([$10$ cm.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = f(x)$ xác định trên $RR$ thỏa mãn giới hạn $limits(lim)_(x -> 2) (f(x) - 5)/(x - 2) = 4$. Tính giới hạn $I = limits(lim)_(x -> 2) (f^2(x) - 25)/(x^2 - 4)$.],
    (
        [$I = 4$],
        [$I = 5$],
        [$I = 8$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Chi phí để loại bỏ $p\%$ chất gây ô nhiễm trong nước thải của một nhà máy được tính bởi công thức $C(p) = (80p)/(100 - p)$ (triệu đồng), với $0 <= p < 100$. Nhận xét nào sau đây đúng về sự thay đổi của chi phí khi ta muốn lọc sạch hoàn toàn chất ô nhiễm ($p -> 100^-$)?],
    (
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Doanh số bán hàng tích lũy $S(t)$ (nghìn sản phẩm) của một sản phẩm công nghệ mới sau $t$ tháng ra mắt được mô tả bởi công thức $S(t) = 100 - (80)/(t + 1)$. Tính giới hạn doanh số tối đa mà sản phẩm này đạt được khi thời gian kéo dài vô hạn ($t -> +oo$).],
    (
        [$80$ nghìn sản phẩm.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Tìm giá trị của tham số $m$ để hàm số $f(x) = cases((x^2 - m^2)/(x - m) "khi" x != m, 4 "khi" x = m)$ liên tục tại điểm $x = m$.],
    (
        [$m = 4$],
        True([$m = 2$]),
        [$m = 1$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một hệ thống sưởi thông minh tự động đóng/ngắt điện theo nhiệt độ môi trường $T$ ($""^o C$). Cường độ dòng điện tiêu thụ $I(T)$ (ampe) là hàm số theo nhiệt độ: $I(T) = cases(10 "khi" T <= 18, 0 "khi" T > 18)$. Phát biểu nào sau đây đúng về tính liên tục của hàm số cường độ dòng điện tại mốc $T = 18 ""^o C$?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một máy bay cất cánh từ mặt đất ($h = 0$ m) và đạt độ cao tuần hành ổn định $10000$ m sau $15$ phút. Giả sử độ cao của máy bay $h(t)$ là một hàm số liên tục theo thời gian $t$. Khẳng định nào sau đây chắc chắn đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Trong thiết kế linh kiện điện tử, điện áp đầu ra $V(t)$ (vôn) theo thời gian $t$ (giây) được mô tả bởi hàm số: $V(t) = cases(t^2 + 1 "khi" 0 <= t < 1, k t^2 - 2t + 3 "khi" t >= 1)$. Tìm giá trị của $k$ để điện áp đầu ra biến thiên liên tục trên khoảng $[0; +oo)$.],
    (
        [$k = 0$],
        True([$k = 1$]),
        [$k = 2$],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho dãy số $(u_n)$ có giới hạn hữu hạn $L = limits(lim)_(n -> +oo) u_n$. Biết rằng với mọi $n >= 1$, ta có $u_n$ thỏa mãn phương trình: $(2n^2 + 1) u_n = n^2 a + b n$ (với $a, b$ là các tham số thực). Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một bể chứa nước có thể tích ban đầu là $1000$ lít nước sạch. Vào mỗi buổi sáng, người ta rút ra $50\%$ lượng nước có trong bể để tưới cây, đến buổi chiều lại bơm thêm vào bể $200$ lít nước sạch mới. Gọi $V_n$ (lít) là thể tích nước trong bể vào cuối ngày thứ $n$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho giới hạn $L = limits(lim)_(x -> 2) (x^2 + a x + b)/(x^2 - 4)$ với $a, b in RR$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc cầu trượt trẻ em ở công viên được thiết kế có mặt đường dốc với độ cao so với mặt đất được mô tả bởi hàm số $f(x)$ (mét) theo chiều ngang $x$ (mét, $0 <= x <= 4$). Hàm số độ cao có công thức:
...
// TL 2
#lt-tln(num: 18, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Biết giới hạn $limits(lim)_(x -> 2) (a sqrt(x + 2) + b)/(x - 2) = 1$ với $a, b in RR$. Tính giá trị của biểu thức $P = a^2 + b^2$.],
    [80],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = f(x)$ liên tục tại mọi điểm và thỏa mãn giới hạn $limits(lim)_(x -> 1) (f(x) - 4)/(x - 1) = 3$. Tính giá trị của biểu thức $2K$ biết $K = limits(lim)_(x -> 1) (f^2(x) + f(x) - 20)/(x^2 - 1)$.],
    [27],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Áp suất khí quyển $p(h)$ (đơn vị: mmHg) ở độ cao $h$ (km) so với mặt nước biển được xác định bởi công thức $p(h) = 760 dot (0.88)^h$. Tìm giới hạn của áp suất khí quyển khi độ cao $h -> +oo$ (tức là đi dần ra ngoài không gian vũ trụ).],
    [0],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Tìm giá trị dương của tham số $m$ để hàm số $f(x) = cases((x^2 - 5x + 6)/(x - 3) "khi" x < 3, m^2 x - 11 "khi" x >= 3)$ liên tục tại điểm $x = 3$.],
    [2],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Thể tích nước trong một bể chứa có vòi tự động xả được mô tả bởi hàm số liên tục:
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 03)!]      #v(0.6em)
