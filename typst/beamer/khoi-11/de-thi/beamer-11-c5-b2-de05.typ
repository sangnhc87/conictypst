// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 05)
...
#show: lecture-theme.with(
  title: "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 05)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một lượng chất hữu cơ độc hại thẩm thấu vào mạch nước ngầm của một khu dân cư. Mỗi tháng, do quá trình tự lọc tự nhiên và lưu chuyển nước, lượng chất độc giảm đi $40\%$ so với tháng trước, đồng thời có thêm $1.2$ kg chất độc mới thẩm thấu vào từ bề mặt đất. Gọi $u_n$ là lượng chất độc còn lại trong nước sau $n$ tháng. Tính lượng chất độc ổn định lâu dài trong mạch nước ngầm này khi thời gian kéo dài vô hạn ($n -> +oo$).],
    (
        [$1.2$ kg.],
        [$2.0$ kg.],
        True([$3.0$ kg.]),
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng cao su được thả rơi tự do từ độ cao $20$ m. Mỗi lần chạm đất, quả bóng nảy ngược lên độ cao bằng $(1)/(2)$ độ cao của lần rơi ngay trước đó. Tính tổng quãng đường quả bóng di chuyển (bao gồm cả quãng đường rơi xuống và nảy lên) cho đến khi nó hoàn toàn dừng lại (tính bằng mét).],
    (
        [$40$ m.],
        True([$60$ m.]),
        [$80$ m.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho giới hạn $limits(lim)_(x -> 2) (x^2 + a x + b)/(x - 2) = 5$ với $a, b in RR$. Tính giá trị của biểu thức $K = a + 2b$.],
    (
        [$K = 5$],
        [$K = -5$],
        [$K = 11$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Tổng chi phí để sản xuất $x$ sản phẩm của một xí nghiệp được cho bởi công thức $C(x) = 3x^2 + 20x + 300$ (nghìn đồng). Hàm chi phí trung bình trên mỗi sản phẩm là $A(x) = (C(x))/(x)$. Khảo sát giới hạn của chi phí trung bình khi sản lượng sản xuất $x -> +oo$.],
    (
        [$3$ nghìn đồng.],
        [$20$ nghìn đồng.],
        [$300$ nghìn đồng.],
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cường độ ánh sáng của một nguồn sáng truyền đi trong sương mù dày đặc giảm dần theo khoảng cách $d$ (mét) bởi công thức $I(d) = I_0 dot (d^2 - 9)/(d^2 - 3d)$ khi $d > 3$ mét. Tính giới hạn tỉ số cường độ ánh sáng $(I(d))/(I_0)$ khi khoảng cách $d$ tiến dần về sát ngày bắt đầu $3$ mét ($d -> 3^+$).],
    (
        [$1$],
        True([$2$]),
        [$3$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một tụ điện thông minh tự xả năng lượng theo thời gian $t$ (giây). Hiệu điện thế của tụ điện được xác định bởi công thức $V(t) = 12 dot e^(-0.05 t)$ (vôn). Tính giới hạn hiệu điện thế của tụ điện này khi thời gian xả kéo dài vô hạn ($t -> +oo$).],
    (
        [$12$ vôn.],
        [$6$ vôn.],
        True([$0$ vôn.]),
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x)$ thỏa mãn giới hạn $limits(lim)_(x -> 3) (f(x) - 4)/(x - 3) = 6$. Tính giới hạn $L = limits(lim)_(x -> 3) (f^2(x) - 16)/(x^2 - 9)$.],
    (
        [$L = 6$],
        True([$L = 8$]),
        [$L = 12$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Hiệu điện thế đầu ra của một bộ ổn áp biến thiên theo thời gian $t$ (giây) bởi hàm số $U(t) = cases(t^2 - t + 3 "khi" 0 <= t < 3, m t - 6 "khi" t >= 3)$ (vôn). Tìm giá trị của $m$ để hiệu điện thế biến thiên liên tục tại thời điểm giao mạch $t = 3$.],
    (
        [$m = 3$],
        [$m = 4$],
        True([$m = 5$]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Nhịp tim của một vận động viên điền kinh được theo dõi trong quá trình chạy bền. Khi vận động viên tăng tốc đột ngột tại phút thứ $10$, nhịp tim nhảy vọt tức thì từ $120$ nhịp/phút lên $160$ nhịp/phút. Biểu diễn nhịp tim theo thời gian là một hàm số mang tính chất nào sau đây?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Nhiệt độ của một lò nung công nghiệp là một hàm số liên tục theo thời gian $t$ (giờ). Biết nhiệt độ ban đầu là $30 ""^o C$ và sau $2$ giờ nung nhiệt độ đạt $1200 ""^o C$. Theo định lý giá trị trung gian, khẳng định nào dưới đây chắc chắn đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Hiện tượng nào sau đây được mô tả bằng một hàm số gián đoạn (có bước nhảy đột ngột) trong thực tế đời sống?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một doanh nghiệp đầu tư mua một hệ thống máy móc sản xuất trị giá $800$ triệu đồng. Mỗi năm, do hao mòn tự nhiên, máy móc bị khấu hao làm giảm giá trị đi $15\%$ so với năm trước đó. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Nồng độ của một loại kháng sinh $A(t)$ (mg/l) trong máu của một con bệnh sau $t$ giờ dùng thuốc được cho bởi công thức: $A(t) = (20t)/(t^2 + 9)$ với $t >= 0$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một đường trượt tuyết dốc nhân tạo được thiết kế gồm hai phần dốc và phẳng nối tiếp nhau. Độ cao của đường trượt $h(x)$ (mét) theo khoảng cách ngang $x$ (mét) được mô tả bởi hàm số:
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một ngân hàng trung ương bơm vào nền kinh tế một lượng tiền ban đầu là $100$ triệu USD. Giả sử tỷ lệ dự trữ bắt buộc của hệ thống ngân hàng là $10\%$, nghĩa là mỗi ngân hàng thương mại nhận được tiền gửi sẽ giữ lại $10\%$ làm dự trữ bắt buộc và đem cho vay ra nền kinh tế $90\%$ số tiền còn lại. Quá trình gửi và cho vay lặp lại vô hạn vòng. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng được thả rơi tự do từ độ cao $12$ m. Mỗi lần chạm đất, quả bóng nảy ngược lên độ cao bằng $(1)/(3)$ độ cao của lần rơi ngay trước đó. Tính tổng quãng đường quả bóng di chuyển được (bao gồm cả quãng đường rơi xuống và nảy lên) cho đến khi nó hoàn toàn dừng lại (tính bằng mét).],
    [24],
    loigiai: [
        Quãng đường di chuyển của quả bóng bao gồm:
...
// TL 2
#lt-tln(num: 18, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Biết giới hạn $limits(lim)_(x -> 4) (a sqrt(x) + b)/(x - 4) = 1$ với $a, b in RR$. Tính giá trị của biểu thức $P = a^2 + b^2$.],
    [80],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = f(x)$ liên tục tại mọi điểm và thỏa mãn giới hạn $limits(lim)_(x -> 3) (f(x) - 8)/(x - 3) = 7$. Tính giá trị của biểu thức $3I$ biết $I = limits(lim)_(x -> 3) (f^2(x) - 64)/(x^2 - 9)$.],
    [56],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một chiến dịch truyền thông tiếp thị trực tuyến đo lường số lượt khách hàng tiếp cận được (tính bằng triệu lượt) sau $t$ tuần triển khai bởi công thức $A(t) = (24t^2 - t + 3)/(t^2 + 1)$. Tính giới hạn số lượt khách hàng tiếp cận tối đa mà chiến dịch đạt được khi kéo dài thời gian vô hạn ($t -> +oo$).],
    [24],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Tìm giá trị dương của tham số $m$ để hàm số $f(x) = cases((x^2 - 4x + 3)/(x - 3) "khi" x < 3, m^2 x - 10 "khi" x >= 3)$ liên tục tại điểm $x = 3$.],
    [2],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 2 (de05) — Mã 101], back-to: "sec-exercise-hub",[Một ống dẫn dầu bằng sắt trong nhà máy được ghép nối bởi hai đoạn dốc và đoạn ngang. Độ cao của ống dẫn $h(t)$ (mét) theo chiều dài ống $t$ (mét) được mô tả bởi hàm số liên tục:
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 05)!]      #v(0.6em)
