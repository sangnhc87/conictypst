// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 06)
...
#show: lecture-theme.with(
  title: "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 06)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Trong một ao nuôi cá, người nuôi bổ sung thức ăn định kỳ mỗi ngày. Mỗi ngày lượng thức ăn cá tiêu thụ làm giảm $50\%$ lượng thức ăn cũ có trong ao, đồng thời người nuôi bổ sung thêm $20$ kg thức ăn mới. Gọi $u_n$ là lượng thức ăn còn dư trong ao sau $n$ ngày. Tính lượng thức ăn dư ổn định lâu dài trong ao khi thời gian kéo dài vô hạn ($n -> +oo$).],
    (
        [$20$ kg.],
        [$30$ kg.],
        True([$40$ kg.]),
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng được thả rơi tự do từ độ cao $15$ m. Mỗi lần chạm đất, quả bóng nảy ngược lên đạt độ cao bằng $(2)/(3)$ độ cao của lần rơi ngay trước đó. Tính tổng quãng đường quả bóng di chuyển (bao gồm cả quãng đường rơi xuống và nảy lên) cho đến khi nó hoàn toàn dừng lại (tính bằng mét).],
    (
        [$45$ m.],
        [$60$ m.],
        True([$75$ m.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho giới hạn $limits(lim)_(x -> 3) (x^2 + a x + b)/(x - 3) = 7$ với $a, b in RR$. Tính giá trị của biểu thức $P = a^2 + b$.],
    (
        [$P = 13$],
        [$P = -13$],
        [$P = 11$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Chi phí trung bình để sản xuất $x$ chiếc tủ lạnh của một công ty điện lạnh được cho bởi công thức $C(x) = (30x + 1500)/(x)$ (triệu đồng/chiếc). Khi số lượng sản xuất tủ lạnh cực kỳ lớn ($x -> +oo$), chi phí trung bình trên mỗi chiếc tiến sát về mức tối ưu nào?],
    (
        [$1500$ triệu đồng.],
        [$1530$ triệu đồng.],
        True([$30$ triệu đồng.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Số lượng vi sinh vật phát triển trong một môi trường thí nghiệm được xác định bởi công thức $N(t) = (50t^2 - 100t)/(t - 2)$ (cá thể) khi thời gian nuôi cấy $t > 2$ ngày. Tính giới hạn của số lượng vi sinh vật khi thời gian tiến sát đến mốc khởi phát $2$ ngày từ bên phải ($t -> 2^+$).],
    (
        [$50$ cá thể.],
        True([$100$ cá thể.]),
        [$0$ cá thể.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Dung lượng thông tin $M(t)$ (megabyte) được tải xuống từ một máy chủ sau $t$ giây hoạt động ổn định được xác định bởi công thức $M(t) = 500 - (300)/(t + 1)$. Tính giới hạn dung lượng tải xuống tối đa của máy chủ này khi thời gian kéo dài vô hạn ($t -> +oo$).],
    (
        [$300$ MB.],
        True([$500$ MB.]),
        [$200$ MB.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x)$ thỏa mãn giới hạn $limits(lim)_(x -> 4) (f(x) - 5)/(x - 4) = 3$. Tính giá trị của biểu thức $4K$ biết $K = limits(lim)_(x -> 4) (f^2(x) - 25)/(x^2 - 16)$.],
    (
        [$4K = 5$],
        [$4K = 10$],
        True([$4K = 15$]),
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Độ cao của một nhịp cầu treo (mét) so với mặt sông được đo bởi hàm số $h(t) = cases(t^2 - 2t + 4 "khi" 0 <= t < 4, a t - 8 "khi" t >= 4)$ với $t$ là chiều dài cầu ngang tính bằng mét. Tìm giá trị của $a$ để mặt cầu trơn trượt liên tục không bị nứt gãy tại khớp nối $t = 4$.],
    (
        [$a = 3$],
        [$a = 4$],
        True([$a = 5$]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Gói cước internet di động 4G quy định: Nếu dung lượng sử dụng dưới $5$ GB thì tính cước trọn gói là $50$ nghìn đồng. Kể từ GB thứ 5 trở đi, mỗi GB phụ trội sẽ tính thêm $10$ nghìn đồng. Hàm số biểu diễn cước phí theo dung lượng sử dụng có tính chất nào sau đây tại điểm mốc kết nối $5$ GB?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Quãng đường di chuyển của một chiếc ô tô điện được mô tả bởi một hàm số liên tục theo thời gian $t$ (phút). Tại thời điểm xuất phát $t = 0$, xe ở vị trí tọa độ $0$ m. Sau $10$ phút xe chạy đến tọa độ $5000$ m. Khẳng định nào sau đây chắc chắn đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Đại lượng nào sau đây thay đổi gián đoạn (có bước nhảy đột ngột) trong đời sống tự nhiên và xã hội?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một nhà sinh học theo dõi sự phát triển vùng bao phủ của một loài nấm ký sinh trên thân cây gỗ. Ban đầu diện tích vùng nấm bao phủ là $10$ $"cm"^2$. Mỗi ngày diện tích nấm phát triển tăng $20\%$ so với ngày hôm trước, đồng thời chất kháng của cây gỗ làm tiêu hủy định kỳ $5$ $"cm"^2$ nấm khô héo. Gọi $u_n$ là diện tích nấm còn lại sau $n$ ngày. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Chi phí trung bình để sản xuất $x$ sản phẩm của một xưởng cơ khí được cho bởi công thức: $C(x) = (15x + 30)/(x + 1)$ (triệu đồng/sản phẩm) với sản lượng $x > 0$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một đoạn đê biển chắn sóng được kỹ sư thiết kế mặt cắt đứng là đường biên cao độ mô tả bởi hàm số:
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một con lắc lò xo đặt trên mặt phẳng nghiêng dao động tắt dần liên tục. Khoảng cách di chuyển của con lắc ở chu kỳ đầu là $60$ cm. Kể từ chu kỳ thứ hai, khoảng cách di chuyển giảm $20\%$ so với chu kỳ liền trước đó. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một người thả một quả bóng từ độ cao $16$ m. Mỗi lần chạm đất, quả bóng nảy ngược lên đạt độ cao bằng $(1)/(3)$ độ cao của lần rơi ngay trước đó. Tính tổng quãng đường quả bóng di chuyển được (bao gồm cả quãng đường rơi xuống và nảy lên) cho đến khi nó hoàn toàn dừng lại (tính bằng mét).],
    [32],
    loigiai: [
        Quãng đường di chuyển của quả bóng bao gồm:
...
// TL 2
#lt-tln(num: 18, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Biết giới hạn $limits(lim)_(x -> 5) (a sqrt(x - 1) + b)/(x - 5) = 1$ với $a, b in RR$. Tính giá trị của biểu thức $P = a^2 + b^2$.],
    [80],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = f(x)$ liên tục tại mọi điểm và thỏa mãn giới hạn $limits(lim)_(x -> 4) (f(x) - 10)/(x - 4) = 9$. Tính giá trị của biểu thức $8K$ biết $K = limits(lim)_(x -> 4) (f^2(x) - 100)/(x^2 - 16)$.],
    [180],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một nhà máy lọc dầu đo lường tổng sản lượng dầu tinh chế được (tính bằng triệu thùng) sau $t$ tháng vận hành ổn định là $V(t) = (50t^2 - 3t + 2)/(t^2 + 4)$. Tính giới hạn lượng dầu tinh chế tối đa của nhà máy khi thời gian vận hành kéo dài vô hạn ($t -> +oo$).],
    [50],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Tìm giá trị dương của tham số $m$ để hàm số $f(x) = cases((x^2 - 5x + 4)/(x - 4) "khi" x < 4, m^2 x - 13 "khi" x >= 4)$ liên tục tại điểm $x = 4$.],
    [2],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một ống xả khí của nhà máy hóa chất được đúc liền khớp từ hai đoạn nghiêng và thẳng. Chiều cao của tâm ống khí $y(t)$ (mét) theo chiều dài ngang $t$ (mét) được mô tả bởi hàm số liên tục:
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 06)!]      #v(0.6em)
