// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 07)
...
#show: lecture-theme.with(
  title: "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 07)",
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một con lắc lò xo thực hiện dao động tắt dần liên tục. Quãng đường con lắc đi được ở chu kỳ đầu tiên là $50$ cm. Kể từ chu kỳ thứ hai, quãng đường đi được trong mỗi chu kỳ đều giảm $20\%$ so với chu kỳ liền trước đó. Tính tổng quãng đường con lắc di chuyển được cho đến khi dừng lại hẳn (tính bằng xăng-ti-mét).],
    (
        [$150$ cm.],
        [$200$ cm.],
        True([$250$ cm.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho một tam giác đều có chu vi bằng $18$ cm. Người ta dựng tam giác đều thứ hai bằng cách nối trung điểm các cạnh của tam giác đều thứ nhất, tam giác đều thứ ba nối trung điểm các cạnh của tam giác đều thứ hai, và cứ tiếp tục như vậy vô hạn lần. Tính tổng chu vi của tất cả các tam giác trong dãy vô hạn đó (tính bằng xăng-ti-mét).],
    (
        [$24$ cm.],
        [$30$ cm.],
        True([$36$ cm.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho giới hạn $limits(lim)_(x -> 4) (x^2 + a x + b)/(x - 4) = 9$ với $a, b in RR$. Tính giá trị của biểu thức $P = a^2 + b$.],
    (
        [$P = -15$],
        [$P = 15$],
        [$P = 19$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Chi phí trung bình để sản xuất $x$ chiếc điện thoại thông minh của một hãng công nghệ được cho bởi công thức $C(x) = (40x + 3000)/(x)$ (triệu đồng/chiếc). Khi quy mô sản xuất tăng lên cực kỳ lớn ($x -> +oo$), chi phí sản xuất trung bình trên mỗi chiếc tiến sát về mức tối ưu nào?],
    (
        [$3000$ triệu đồng.],
        True([$40$ triệu đồng.]),
        [$3040$ triệu đồng.],
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Nồng độ clo tồn dư trong đường ống xả của một nhà máy hóa chất được đo bằng công thức $G(t) = (t^2 - 9)/(t - 3)$ (ppm) khi thời gian xả nước $t > 3$ giờ. Tính giới hạn nồng độ clo dư khi thời gian tiến sát đến mốc bắt đầu $3$ giờ từ bên phải ($t -> 3^+$).],
    (
        [$3$ ppm.],
        True([$6$ ppm.]),
        [$0$ ppm.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Lượng điện tích còn lại $Q(t)$ (coulomb) trên hai bản cực của một tụ điện đang phóng điện được xác định bởi công thức $Q(t) = 0.05 dot e^(-0.1 t)$ với $t$ tính bằng giây. Tính giới hạn điện tích của tụ điện khi thời gian phóng điện kéo dài vô hạn ($t -> +oo$).],
    (
        [$0.05$ coulomb.],
        [$0.1$ coulomb.],
        True([$0$ coulomb.]),
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x)$ thỏa mãn giới hạn $limits(lim)_(x -> 5) (f(x) - 6)/(x - 5) = 4$. Tính giá trị của biểu thức $5K$ biết $K = limits(lim)_(x -> 5) (f^2(x) - 36)/(x^2 - 25)$.],
    (
        [$5K = 12$],
        [$5K = 18$],
        True([$5K = 24$]),
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cường độ sáng của một đèn giao thông tự động điều chỉnh theo thời gian $t$ (giây) bởi hàm số $E(t) = cases(t^2 - 3t + 5 "khi" 0 <= t < 3, a t - 1 "khi" t >= 3)$. Tìm giá trị của $a$ để đèn thay đổi cường độ sáng liên tục tại thời điểm khớp chế độ $t = 3$.],
    (
        [$a = 1$],
        True([$a = 2$]),
        [$a = 3$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Nhịp tim của một bệnh nhân được theo dõi tự động bằng máy đo điện tim. Khi bệnh nhân uống thuốc hỗ trợ nhịp tim tăng đột ngột tức thời từ $70$ nhịp/phút lên $110$ nhịp/phút tại phút thứ $15$. Biểu diễn nhịp tim theo thời gian là một hàm số mang tính chất nào tại điểm mốc $t = 15$ phút?],
    (
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Nhiệt độ của một lò nung sành sứ là một hàm số liên tục theo thời gian $t$ (giờ). Biết nhiệt độ ban đầu là $25 ""^o C$ và sau $3$ giờ nung đạt $1500 ""^o C$. Theo định lý giá trị trung gian, khẳng định nào dưới đây chắc chắn đúng?],
    (
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Đại lượng nào dưới đây thay đổi biến thiên liên tục trong thế giới tự nhiên?],
    (
...
// DS 1
#lt-ds(num: 13, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một cơ sở sản xuất đầu tư mua một thiết bị công nghệ hiện đại trị giá $400$ triệu đồng. Mỗi năm, do hao mòn vô hình và hữu hình, giá trị còn lại của thiết bị bị khấu hao giảm đi $20\%$ so với năm trước đó. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Nồng độ của một loại dược chất $C(t)$ (mg/l) trong máu của một con bệnh sau $t$ giờ dùng thuốc được cho bởi công thức: $C(t) = (30t)/(t^2 + 16)$ với thời gian $t >= 0$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một đoạn đê thủy lợi mặt cắt đứng có biên cao độ được mô tả bởi hàm số:
...
// DS 4
#lt-ds(num: 16, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một lò xo đặt trên mặt phẳng nghiêng dao động tắt dần liên tục. Khoảng cách di chuyển của quả nặng ở chu kỳ đầu tiên là $80$ cm. Kể từ chu kỳ thứ hai, khoảng cách di chuyển giảm $25\%$ so với chu kỳ liền trước đó. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một quả bóng cao su được thả rơi tự do từ độ cao $10$ m. Mỗi lần chạm đất, quả bóng nảy ngược lên đạt độ cao bằng $(1)/(2)$ độ cao của lần rơi ngay trước đó. Tính tổng quãng đường quả bóng di chuyển được (bao gồm cả quãng đường rơi xuống và nảy lên) cho đến khi nó hoàn toàn dừng lại (tính bằng mét).],
    [30],
    loigiai: [
...
// TL 2
#lt-tln(num: 18, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Biết giới hạn $limits(lim)_(x -> 6) (a sqrt(x - 2) + b)/(x - 6) = 1$ với $a, b in RR$. Tính giá trị của biểu thức $P = a^2 + b^2$.],
    [80],
    loigiai: [
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = f(x)$ liên tục tại mọi điểm và thỏa mãn giới hạn $limits(lim)_(x -> 5) (f(x) - 12)/(x - 5) = 11$. Tính giá trị của biểu thức $10K$ biết $K = limits(lim)_(x -> 5) (f^2(x) - 144)/(x^2 - 25)$.],
    [264],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Một nhà máy cấp nước đo lường nồng độ clo tích lũy (đơn vị: ppm) trong bể chứa sau $t$ giờ sục khí hoạt động ổn định là $C(t) = (36t^2 - t + 5)/(t^2 + 2)$. Tính giới hạn nồng độ clo tích lũy tối đa khi thời gian sục khí kéo dài vô hạn ($t -> +oo$).],
    [36],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Tìm giá trị dương của tham số $m$ để hàm số $f(x) = cases((x^2 - 6x + 5)/(x - 5) "khi" x < 5, m^2 x - 16 "khi" x >= 5)$ liên tục tại điểm $x = 5$.],
    [2],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 1 (de07) — Mã 101], back-to: "sec-exercise-hub",[Lòng của một máng xả rác tại tòa nhà chung cư được đúc liền khớp nối hai đoạn nghiêng và thẳng dốc. Chiều cao của máng nước $y(t)$ (mét) theo chiều ngang $t$ (mét) là hàm số liên tục:
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 07)!]      #v(0.6em)
