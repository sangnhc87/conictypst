// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 08)
...
#show: lecture-theme.with(
  title: "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 08)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vuông $C_1$ có diện tích bằng $36$. Người ta nối trung điểm các cạnh của hình vuông $C_1$ để tạo thành hình vuông $C_2$, nối trung điểm các cạnh của $C_2$ để tạo thành $C_3$, và cứ tiếp tục như vậy vô hạn lần (như hình vẽ minh họa bên dưới). Tính tổng diện tích của tất cả các hình vuông trong dãy vô hạn $C_1, C_2, C_3, ...$],
    (
        [$54$],
        True([$72$]),
        [$108$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vuông $C_1$ có cạnh bằng $4$ cm. Nối trung điểm các cạnh của $C_1$ để được hình vuông $C_2$, nối trung điểm các cạnh của $C_2$ để được hình vuông $C_3$, và cứ tiếp tục như vậy vô hạn lần (như hình vẽ minh họa bên dưới). Tính tổng chu vi của tất cả các hình vuông trong dãy vô hạn này (tính bằng xăng-ti-mét).],
    (
        [$16(2 - sqrt(2))$ cm.],
        True([$16(2 + sqrt(2))$ cm.]),
        [$32(2 + sqrt(2))$ cm.],
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác đều $T_1$ có cạnh bằng $8$ cm. Nối trung điểm các cạnh của $T_1$ để được tam giác đều $T_2$, nối trung điểm các cạnh của $T_2$ để được tam giác đều $T_3$, và cứ tiếp tục như vậy vô hạn lần (như hình vẽ minh họa). Tính tổng diện tích của tất cả các tam giác trong dãy vô hạn đó (tính bằng xăng-ti-mét vuông).],
    (
        [$16 sqrt(3)$],
        [$32 sqrt(3)$],
        True([$(64 sqrt(3))/(3)$]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vuông $C_1$ cạnh bằng $2$. Dựng đường tròn $D_1$ nội tiếp $C_1$. Dựng hình vuông $C_2$ nội tiếp $D_1$. Dựng đường tròn $D_2$ nội tiếp $C_2$, và cứ tiếp tục như vậy vô hạn lần (như hình vẽ minh họa). Tính tổng diện tích của tất cả các hình tròn $D_1, D_2, D_3, ...$],
    (
        [$pi$],
        [$1.5 pi$],
        True([$2 pi$]),
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho một lục giác đều $H_1$ có diện tích bằng $24$. Người ta nối trung điểm các cạnh liên tiếp của lục giác đều $H_1$ để tạo thành lục giác đều $H_2$, nối trung điểm các cạnh liên tiếp của $H_2$ để tạo thành lục giác đều $H_3$, và cứ tiếp tục như vậy vô hạn lần (như hình vẽ minh họa). Tính tổng diện tích của tất cả các lục giác đều trong dãy vô hạn đó.],
    (
        [$48$],
        [$72$],
        True([$96$]),
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vuông $C_1$ có cạnh bằng $8$ cm. Dựng dãy các hình vuông $C_2, C_3, ...$ bằng cách nối các trung điểm của các cạnh hình vuông ngay trước nó. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho góc $x O y = 60^o$. Điểm $M_1$ nằm trên cạnh $O x$ sao cho $O M_1 = 2$. Hạ hình chiếu vuông góc $M_2$ của $M_1$ trên cạnh $O y$. Hạ hình chiếu vuông góc $M_3$ của $M_2$ trên cạnh $O x$, và cứ tiếp tục quá trình này vô hạn lần tạo thành đường gấp khúc $M_1 M_2 M_3 M_4 ...$ (như hình vẽ bên dưới). Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một đường xoắn ốc gồm các cung tròn nối tiếp nhau trong mặt phẳng (như hình vẽ minh họa câu 6). Cung tròn thứ nhất là nửa đường tròn bán kính $R_1 = 12$ cm. Mỗi cung tròn tiếp theo là nửa đường tròn có bán kính bằng $(2)/(3)$ bán kính cung tròn ngay trước đó. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho hình vuông có cạnh dài $10$ cm. Dựng dãy vô hạn các hình vuông lồng nhau bằng cách nối các trung điểm của các cạnh hình vuông trước đó (hình vẽ bên dưới). Tính tổng diện tích của tất cả các hình vuông trong dãy vô hạn đó (tính bằng xăng-ti-mét vuông).],
    [200],
    fig: fig-nested-squares,
    fig-pos: "center",
    fig-width: 30%,
...
// TL 2
#lt-tln(num: 18, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một đường xoắn ốc gồm các nửa đường tròn có bán kính giảm dần theo cấp số nhân lùi vô hạn (hình vẽ bên dưới). Nửa đường tròn đầu tiên có bán kính $R_1 = 6$ cm. Các nửa đường tròn tiếp theo có bán kính bằng $(1)/(2)$ bán kính của cung ngay trước đó. Tính tổng độ dài đường xoắn ốc này dưới dạng $a pi$ cm. Tìm giá trị của tham số $a$.],
    [12],
    fig: fig-semicircle-spiral,
    fig-pos: "center",
    fig-width: 50%,
...
// TL 3
#lt-tln(num: 19, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cho một tam giác đều có diện tích bằng $12$ $"cm"^2$. Người ta nối trung điểm các cạnh để tạo thành tam giác đều thứ hai, rồi lại tiếp tục nối trung điểm để tạo thành tam giác đều thứ ba, cứ thế tiếp tục quá trình này vô hạn lần (như hình vẽ bên dưới). Tính tổng diện tích của tất cả các tam giác trong dãy vô hạn đó (tính bằng xăng-ti-mét vuông).],
    [16],
    fig: fig-nested-triangles,
    fig-pos: "center",
    fig-width: 30%,
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một mô hình cây nghệ thuật có thân thẳng đứng dài $20$ cm. Từ ngọn thân mọc ra 2 nhánh nghiêu đối xứng dài bằng $40\%$ thân trước. Từ ngọn mỗi nhánh phụ lại mọc ra 2 nhánh nhỏ hơn dài bằng $40\%$ nhánh trước đó, cứ thế vô hạn lần (mô hình bên dưới). Tính tổng chiều dài của thân và tất cả các nhánh trong mô hình này (tính bằng xăng-ti-mét).],
    [100],
    fig: fig-tree-fractal,
    fig-pos: "center",
    fig-width: 30%,
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 08)!]      #v(0.6em)
