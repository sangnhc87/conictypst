// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 11)
...
#show: lecture-theme.with(
  title: "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 11)",
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Dựng một đường xoắn ốc tam giác vuông vô hạn bằng cách xếp liên tiếp các tam giác vuông chung đỉnh $O$ (như hình vẽ minh họa). Tam giác đầu tiên $O A_1 A_2$ vuông tại $A_2$ có góc $A_1 O A_2 = 30^o$ và cạnh huyền $O A_1 = 8$. Tam giác tiếp theo $O A_2 A_3$ vuông tại $A_3$ có góc $A_2 O A_3 = 30^o$ và cạnh huyền là cạnh bên $O A_2$ của tam giác trước. Cứ tiếp tục như vậy vô hạn lần. Tính tổng độ dài đường gấp khúc vô hạn $A_1 A_2 + A_2 A_3 + A_3 A_4 + ...$],
    (
        [$4(2 + sqrt(3))$],
        [$4(2 - sqrt(3))$],
        True([$8(2 + sqrt(3))$]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác đều $T_1$ có cạnh bằng $6" cm"$. Dựng đường tròn $C_1$ nội tiếp $T_1$. Tiếp tục dựng tam giác đều $T_2$ nội tiếp đường tròn $C_1$. Dựng đường tròn $C_2$ nội tiếp $T_2$, và cứ tiếp tục quá trình này vô hạn lần (như hình vẽ). Tính tổng diện tích của tất cả các đường tròn $C_1, C_2, C_3, ...$ (tính bằng xăng-ti-mét vuông).],
    (
        [$3 pi" cm"^2$.],
        True([$4 pi" cm"^2$.]),
        [$6 pi" cm"^2$.],
...
// TN 7
#lt-tn(num: 7, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác đều có diện tích bằng $12" cm"^2$. Người ta thực hiện thuật toán dựng tam giác Sierpinski (như hình vẽ): chia tam giác thành 4 tam giác đều nhỏ bằng nhau và bỏ đi tam giác ở chính giữa. Sau đó tiếp tục bỏ đi tam giác ở chính giữa của các tam giác nhỏ còn lại, và cứ thế tiếp tục quá trình này vô hạn lần. Tính giới hạn tổng diện tích của tất cả các tam giác đã bị bỏ đi.],
    (
        [$8" cm"^2$.],
        [$9" cm"^2$.],
        True([$12" cm"^2$.]),
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Cho một bát giác đều $O_1$ có diện tích bằng $30" cm"^2$. Dựng bát giác đều $O_2$ bằng cách nối các trung điểm của các cạnh bát giác $O_1$, và cứ thế tiếp tục dựng các bát giác đều $O_3, O_4, ...$ vô hạn lần (như hình vẽ bát giác lồng nhau bên dưới). Quy ước tỉ số diện tích giữa bát giác đều sau và bát giác đều ngay trước nó là không đổi và bằng $q = (1)/(4)$. Tính tổng diện tích của tất cả các bát giác đều trong dãy vô hạn này.],
    (
        [$36" cm"^2$.],
        True([$40" cm"^2$.]),
        [$45" cm"^2$.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác vuông cân $T_1$ có độ dài hai cạnh góc vuông bằng $8" cm"$. Dựng dãy các tam giác vuông cân $T_2, T_3, ...$ bằng cách nối các trung điểm của các cạnh tam giác ngay trước nó (hình vẽ tương tự). Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Cứ sau đúng 24 giờ, một bệnh nhân được chỉ định tiêm $120$ mg một loại kháng sinh đặc trị. Cơ thể đào thải dần thuốc: sau mỗi chu kỳ 24 giờ, lượng thuốc còn lưu lại trong cơ thể giảm đi một nửa ($50\%$) so với lượng thuốc hiện có (như hình vẽ tương tự). Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Một cây cấu trúc hình tròn Fractal được tạo thành bởi các hình tròn xếp chồng lên nhau vô hạn (như mô tả hình vẽ). Hình tròn gốc ở thế hệ 0 có diện tích $S_0 = 8 pi" cm"^2 $. Thế thế hệ tiếp theo mọc thêm 2 hình tròn nhỏ hơn, tổng diện tích các thế hệ sau giảm dần theo cấp số nhân lùi vô hạn với công bội tổng quát là $q = 0.5$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Một đường gấp khúc nghệ thuật được vẽ bên trong một hình vuông cạnh $20$ cm (hình vẽ tương tự). Đoạn thẳng thứ nhất $A_1 A_2$ trùng với một cạnh hình vuông dài $20" cm"$. Mỗi đoạn thẳng tiếp theo vuông góc với đoạn liền trước và có chiều dài giảm đi một nửa. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Cho tam giác vuông cân có độ dài hai cạnh góc vuông bằng $12$ cm. Dựng dãy vô hạn các tam giác vuông cân lồng nhau bằng cách nối các trung điểm của các cạnh tam giác trước đó (hình vẽ tương tự). Tính tổng diện tích của tất cả các tam giác vuông cân trong dãy vô hạn đó (tính bằng xăng-ti-mét vuông).],
    [96],
    fig: fig-right-triangles,
    fig-pos: "center",
    fig-width: 30%,
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de11) — Mã 101], back-to: "sec-exercise-hub",[Một đường gấp khúc nghệ thuật được vẽ bên trong một hình vuông (hình vẽ tương tự). Đoạn thẳng thứ nhất $A_1 A_2$ dài $30" cm"$. Mỗi đoạn tiếp theo vuông góc với đoạn trước và giảm đi một nửa chiều dài. Tính tổng độ dài đường gấp khúc vô hạn đó (tính bằng xăng-ti-mét).],
    [60],
    fig: fig-spiral-path,
    fig-pos: "center",
    fig-width: 30%,
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 11)!]      #v(0.6em)
