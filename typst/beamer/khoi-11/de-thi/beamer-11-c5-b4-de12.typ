// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 12)
...
#show: lecture-theme.with(
  title: "CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 12)",
...
#lt-tn(num: 2, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một đường xoắn ốc được tạo bởi các cung tròn góc $90°$ liên tiếp (xoắn ốc tỷ lệ vàng như hình vẽ bên dưới). Cung tròn đầu tiên có bán kính $R_1 = 3$ cm. Bán kính của mỗi cung tròn tiếp theo bằng $60\%$ bán kính của cung tròn liền trước nó. Tính tổng độ dài đường xoắn ốc vô hạn này (tính bằng xăng-ti-mét).],
    (
        [$3 pi$],
        [$3.5 pi$],
        True([$3.75 pi$]),
...
#lt-tn(num: 4, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Cho góc nhọn $x O y = 30°$ và điểm $M_0$ trên cạnh $O x$ sao cho $O M_0 = 6$ cm. Một đường gấp khúc vô hạn $M_0 M_1 M_2 M_3 ...$ được dựng bằng cách hạ các đường vuông góc liên tiếp từ cạnh này sang cạnh kia của góc (như hình vẽ bên dưới). Tính tổng độ dài đường gấp khúc vô hạn đó (tính bằng xăng-ti-mét).],
    (
        True([$12 + 6 sqrt(3)$]),
        [$6 + 3 sqrt(3)$],
        [$18$],
...
#lt-tn(num: 10, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một mô hình nghệ thuật gồm các hình elip đồng tâm lồng nhau đệ quy (như hình vẽ bên dưới). Hình elip ngoài cùng $E_1$ có các bán trục $a_1 = 5$ cm và $b_1 = 4$ cm. Các hình elip bên trong lần lượt có kích thước bán trục giảm đi một nửa so với hình elip liền kề chứa nó. Tính tổng diện tích của tất cả các hình elip trong mô hình vô hạn này (tính bằng xăng-ti-mét vuông).],
    (
        [$25 pi$],
        [$30 pi$],
        True([$(80 pi)/(3)$]),
...
#lt-ds(num: 13, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Cho một lục giác đều $H_1$ có độ dài cạnh bằng $12$ cm. Dựng lục giác đều $H_2$ bằng cách nối các trung điểm của các cạnh lục giác $H_1$. Tiếp tục quá trình dựng dãy các lục giác đều lồng nhau $H_3, H_4, ...$ vô hạn lần (như hình vẽ bên dưới). Các phát biểu sau đúng hay sai?],
    (
...
#lt-ds(num: 14, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Cho một góc nhọn góc $60°$ giới hạn bởi hai tia. Người ta xếp một dãy vô hạn các hình tròn tiếp xúc ngoài liên tiếp nhau và tiếp xúc với hai tia của góc nhọn (như hình vẽ bên dưới). Biết hình tròn lớn nhất ở ngoài cùng có bán kính $R_1 = 9$ cm. Các phát biểu sau đúng hay sai?],
    (
...
#lt-ds(num: 15, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một thập tự hình vuông Fractal được dựng bắt đầu từ một hình vuông gốc lớn ở trung tâm có cạnh bằng $6$ cm (như hình vẽ bên dưới). Ở mỗi bước tiếp theo, người ta gắn thêm các hình vuông mới vào các cạnh lộ ra ngoài với tỉ lệ cạnh giảm đi còn một phần ba. Các phát biểu sau đúng hay sai?],
    (
...
#lt-ds(num: 16, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một đường xoắn ốc được tạo bởi các cung tròn góc $90°$ liên tiếp (xoắn ốc tỷ lệ vàng như hình vẽ bên dưới). Cung tròn thứ nhất có bán kính $R_1 = 10$ cm. Bán kính của mỗi cung tròn tiếp theo giảm đi một nửa so với cung tròn ngay trước nó. Các phát biểu sau đúng hay sai?],
    (
...
#lt-tln(num: 17, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Dựng một đường xoắn ốc tam giác vuông vô hạn chung đỉnh $O$ bằng cách xếp liên tiếp các tam giác vuông cân (như hình vẽ bên dưới). Tam giác đầu tiên có cạnh bên bằng $8$ cm. Mỗi tam giác tiếp theo có các cạnh bên giảm đi theo tỉ số diện tích là $q = 1/2$. Tính tổng diện tích của tất cả các tam giác vuông trong mô hình xoắn ốc vô hạn này (tính bằng xăng-ti-mét vuông).],
    [64],
    fig: fig-right-triangles-spiral,
    fig-pos: "center",
    fig-width: 30%,
...
#lt-tln(num: 18, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Một mô hình nghệ thuật gồm các hình elip đồng tâm lồng nhau đệ quy (như hình vẽ bên dưới). Hình elip ngoài cùng $E_1$ có các bán trục $a_1 = 10$ cm và $b_1 = 6$ cm. Các hình elip bên trong lần lượt có kích thước bán trục giảm đi một nửa so với hình elip liền kề chứa nó. Tính tổng diện tích của tất cả các hình elip dưới dạng $b pi" cm"^2 $. Tìm giá trị của $b$.],
    [80],
    fig: fig-nested-ellipses,
    fig-pos: "center",
    fig-width: 30%,
...
#lt-tln(num: 21, de: [Đề 3 (de12) — Mã 101], back-to: "sec-exercise-hub",[Người ta xếp các khối lập phương chồng lên nhau liên tiếp dọc theo một trục thẳng đứng để tạo thành một ngọn tháp đệ quy (như hình vẽ bên dưới). Khối lập phương thứ nhất ở đáy có cạnh bằng $6$ cm. Mỗi khối lập phương tiếp theo xếp chồng lên trên có độ dài cạnh giảm đi một nửa so với khối lập phương ngay dưới nó. Tính tổng diện tích bề mặt lộ ra ngoài (diện tích toàn phần không tính mặt đáy tiếp xúc đất) của ngọn tháp lập phương vô hạn này (tính bằng xăng-ti-mét vuông).],
    [228],
    fig: fig-stacked-cubes,
    fig-pos: "center",
    fig-width: 25%,
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG V. GIỚI HẠN. HÀM SỐ LIÊN TỤC (ĐỀ SỐ 12)!]      #v(0.6em)
