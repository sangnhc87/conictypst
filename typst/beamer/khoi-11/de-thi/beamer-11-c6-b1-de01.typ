// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 01)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 01)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Với $a > 0, a eq 1$ và $x, y > 0$, khẳng định nào sau đây là sai?],
    (
...
// TN 2
#lt-tn(num: 2, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Tập xác định của hàm số $y = (x - 2)^(-3)$ là],
    (
        [$(2; +oo)$],
        True([$RR \\ {2}$]),
        [$RR$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Một vi khuẩn E.coli có thời gian phân đôi là 20 phút. Giả sử ban đầu có $10^3$ vi khuẩn. Sau 2 giờ, số lượng vi khuẩn trong quần thể xấp xỉ bao nhiêu? (Giả sử các vi khuẩn phát triển bình thường).],
    (
        [$1.2 dot 10^4$],
        True([$6.4 dot 10^4$]),
        [$3.2 dot 10^4$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Độ pH của một dung dịch được tính bằng công thức $"pH" = -log[H^+]$, trong đó $[H^+]$ là nồng độ ion hydrogen (mol/L). Một loại nước ép táo có nồng độ $[H^+] = 3.16 dot 10^(-4)$ mol/L. Độ pH của nước ép táo này xấp xỉ bằng bao nhiêu?],
    (
        [$4.0$],
        [$3.0$],
        True([$3.5$]),
...
// TN 5
#lt-tn(num: 5, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Hàm số nào sau đây nghịch biến trên toàn bộ tập xác định của nó?],
    (
        [$y = 2^x$],
        [$y = e^x$],
        True([$y = (1/3)^x$]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Phương trình $3^(2x-1) = 27$ có nghiệm là],
    (
        [$x = 1$],
        True([$x = 2$]),
        [$x = 3$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Trong ngành địa chấn học, độ lớn $M$ (độ Richter) của một trận động đất được xác định bằng công thức $M = log(A / A_0)$, trong đó $A$ là biên độ tối đa của sóng địa chấn và $A_0$ là một biên độ chuẩn. Một trận động đất $6$ độ Richter có biên độ tối đa gấp bao nhiêu lần trận động đất $4$ độ Richter?],
    (
        [$1.5$ lần],
        [$20$ lần],
        True([$100$ lần]),
...
// TN 8
#lt-tn(num: 8, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Anh Minh gửi tiết kiệm ngân hàng $100$ triệu đồng theo thể thức lãi kép với kỳ hạn một năm, lãi suất $6%$/năm. Hỏi sau ít nhất bao nhiêu năm thì anh Minh nhận được số tiền (cả vốn lẫn lãi) lớn hơn $150$ triệu đồng?],
    (
        [$6$ năm],
        True([$7$ năm]),
        [$8$ năm],
...
// TN 9
#lt-tn(num: 9, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Tập nghiệm của bất phương trình $log_2 (x - 1) < 3$ là],
    (
        [$(1; 8)$],
        True([$(1; 9)$]),
        [$(-oo; 9)$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Định luật làm nguội của Newton mô tả nhiệt độ $T$ của một vật sau thời gian $t$ (phút) được làm mát trong môi trường có nhiệt độ $T_s$ bằng công thức $T = T_s + (T_0 - T_s) e^(-k t)$, với $T_0$ là nhiệt độ ban đầu, $k$ là hằng số làm mát. Nếu một cốc cafe từ $90^circ C$ giảm xuống $70^circ C$ trong 10 phút ở phòng có nhiệt độ $20^circ C$, hằng số $k$ xấp xỉ bằng bao nhiêu?],
    (
        [$0.012$],
        True([$0.034$]),
        [$0.052$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Cho biểu thức $P = x^(1/3) dot root(6, x)$ với $x > 0$. Viết biểu thức $P$ dưới dạng lũy thừa của $x$ với số mũ hữu tỉ, ta được],
    (
        True([$P = x^(1/2)$]),
        [$P = x^(2/9)$],
        [$P = x^(1/18)$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",[Mức cường độ âm $L$ (đơn vị dB) được tính bởi công thức $L = 10 log(I / I_0)$, trong đó $I$ là cường độ âm và $I_0 = 10^(-12) "W/m"^2$ là cường độ âm chuẩn. Tiếng ồn của luồng giao thông mạnh có mức cường độ âm khoảng $85$ dB. Cường độ âm $I$ của luồng giao thông đó là],
    (
        [$3.16 dot 10^(-5) " W/m"^2$],
...
// TL 1
#lt-tln(num: 17, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 2
#lt-tln(num: 18, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 3
#lt-tln(num: 19, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 4
#lt-tln(num: 20, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 5
#lt-tln(num: 21, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",
...
// TL 6
#lt-tln(num: 22, de: [Đề 1 (de01) — Mã 101], back-to: "sec-exercise-hub",
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 01)!]      #v(0.6em)
