// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 06 - MÔ HÌNH TOÁN HỌC)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 06 - MÔ HÌNH TOÁN HỌC)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Chu kì bán rã của nguyên tố Radium-226 là $1600$ năm. Hàm lượng Radium-226 còn lại $m(t)$ (gam) sau $t$ năm được tính theo công thức $m(t) = m_0 (1/2)^(t/1600)$, với $m_0$ là khối lượng ban đầu. Từ một mẫu ban đầu chứa $20$ gam Radium-226, sau bao lâu thì khối lượng Radium-226 trong mẫu chỉ còn lại $5$ gam?],
    (
        [$2400$ năm.],
        True([$3200$ năm.]),
        [$4000$ năm.],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một học viên đang học đánh máy vi tính. Tốc độ đánh máy $N$ (từ/phút) mà học viên đó đạt được sau $t$ tuần luyện tập được một chuyên gia ước lượng bởi hàm số $N(t) = 100(1 - e^(-0.1 t))$. Theo mô hình này, nếu học viên tiếp tục luyện tập vô hạn thời gian, tốc độ đánh máy tối đa người đó có thể tiến tới xấp xỉ là bao nhiêu từ/phút?],
    (
        [$80$ từ/phút.],
        [$90$ từ/phút.],
        True([$100$ từ/phút.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Số lượng một loài bọ cánh cứng trong một khu rừng tăng trưởng theo mô hình hàm số mũ. Biết rằng năm 2020 khu rừng có $20 000$ con bọ và đến năm 2024 số lượng bọ đã tăng lên $30 000$ con. Giả sử tốc độ tăng trưởng là không đổi, ước tính vào năm nào số lượng bọ trong khu rừng sẽ đạt ngưỡng $45 000$ con?],
    (
        [$2026$.],
        [$2027$.],
        True([$2028$.]),
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cường độ âm chuẩn là $I_0 = 10^(-12) "W/m"^2$. Một xe cứu thương hụ còi phát ra âm thanh với mức cường độ âm đo được là $110$ dB. Cường độ âm $I$ của tiếng còi xe cứu thương đó tính theo $"W/m"^2$ là],
    (
        [$10^(-2)$.],
        True([$10^(-1)$.]),
        [$1$.],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Độ lớn của một trận động đất được đo theo thang Richter bằng công thức $M = log(A / A_0)$, trong đó $A$ là biên độ chấn động lớn nhất và $A_0$ là biên độ chuẩn. Nếu một trận động đất đo được $8.2$ độ Richter, thì biên độ $A$ của nó gấp bao nhiêu lần biên độ $A$ của một trận động đất đo được $6.2$ độ Richter?],
    (
        [$2$ lần.],
        [$20$ lần.],
        True([$100$ lần.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Áp suất không khí $P$ giảm khi độ cao $h$ tăng theo công thức $P = P_0 e^(-0.12 h)$, trong đó $P_0$ là áp suất ở mực nước biển. Để áp suất không khí chỉ còn $25\%$ so với áp suất ở mực nước biển, ta phải lên đến độ cao $h$ (tính bằng km) xấp xỉ bằng bao nhiêu?],
    (
        [$8.5$ km.],
        [$10.2$ km.],
        True([$11.6$ km.]),
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một doanh nghiệp đang cân nhắc đầu tư vào một dây chuyền sản xuất tự động. Giá trị thu hồi $V(t)$ của dây chuyền sau $t$ năm giảm dần theo mô hình $V(t) = 1.2 dot 2^(-0.3 t)$ (tỉ đồng). Sau $5$ năm, giá trị thu hồi của dây chuyền còn khoảng bao nhiêu triệu đồng?],
    (
        [$350$ triệu đồng.],
        [$376$ triệu đồng.],
        [$415$ triệu đồng.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cô giáo Hạnh dự định mua một căn hộ chung cư. Cô đang có $800$ triệu đồng và quyết định gửi vào ngân hàng với lãi suất $7.5\%$/năm, tính lãi kép liên tục. Hỏi sau đúng $4$ năm gửi, cô Hạnh sẽ có khoảng bao nhiêu tiền?],
    (
        [$1000$ triệu đồng.],
        [$1050$ triệu đồng.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Chỉ số HDI (Chỉ số phát triển con người) của một tỉnh qua các năm được tính xấp xỉ bằng hàm logarit $H(t) = 0.5 + 0.1 ln(t + 1)$, trong đó $t$ là số năm tính từ mốc 2010. Ước tính chỉ số HDI của tỉnh này vào năm 2030 (tương ứng $t = 20$) là khoảng bao nhiêu?],
    (
        [$0.65$.],
        [$0.75$.],
        True([$0.80$.]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Trong ngành y tế, mô hình Gompertz thường dùng để dự đoán tỉ lệ mắc một căn bệnh. Giả sử số lượng người mắc bệnh trong cộng đồng có dạng $N(t) = 1000 e^(-4 e^(-0.5 t))$, với $t$ là số tháng. Sau bao lâu thì số người mắc bệnh đạt $500$ người?],
    (
        [$2.4$ tháng.],
        [$3.0$ tháng.],
        True([$3.5$ tháng.]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Vận tốc $v$ (m/s) của một chiếc dù nhảy sau $t$ giây kể từ khi bung dù rơi tự do có thể được lập mô hình bằng $v(t) = 40(1 - e^(-0.2 t))$. Khi $t$ đủ lớn, chiếc dù sẽ đạt đến một vận tốc rơi ổn định (vận tốc cuối). Vận tốc cuối đó là bao nhiêu m/s?],
    (
        [$10$ m/s.],
        [$20$ m/s.],
        True([$40$ m/s.]),
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Nồng độ một loại thuốc trừ sâu trong đất sau khi phun tản ra theo thời gian được đánh giá bằng hàm $C(t) = 15 t e^(-0.1 t)$ (ppm), trong đó $t$ là số ngày. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Kỹ sư thiết kế một con chip máy tính nhận thấy phần trăm số lượng chip bị hỏng $F(t)$ sau $t$ năm vận hành liên tục tuân theo phân bố Weibull $F(t) = 1 - e^(-0.05 t^2)$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Áp suất thẩm thấu $Pi$ (atm) của một dung dịch theo nồng độ mol $C$ (mol/L) được một sinh viên hóa học mô tả bởi $Pi = 24.5 e^(0.1 C)$. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Tỉ lệ phần trăm học sinh nhớ bài giảng sau $t$ tuần được một nhà tâm lý học lập mô hình là $R(t) = 85 - 20 ln(t + 1)$ ($\%$). Sau bao nhiêu tuần thì tỉ lệ học sinh nhớ bài giảng giảm xuống còn $45\%$? (Làm tròn kết quả đến hàng đơn vị).],
    [6],
    loigiai: [
        Giải phương trình:
        $
...
// TL 2
#lt-tln(num: 18, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Doanh thu của một bộ phim chiếu rạp trong tuần thứ $x$ kể từ lúc công chiếu được tính bằng $D(x) = 15 dot (0.6)^x$ (tỉ đồng). Tính tổng doanh thu của bộ phim trong 2 tuần đầu tiên ($x=1$ và $x=2$).],
    [14.4],
    loigiai: [
...
// TL 4
#lt-tln(num: 20, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Lực căng $T$ của một sợi dây cáp thép bị ăn mòn do thời tiết giảm theo hàm số $T(x) = 5000 - 150 ln(2x + 1)$ (Newton), trong đó $x$ là số năm sử dụng. Lực căng tối thiểu để đảm bảo an toàn là $4000$ Newton. Dây cáp sẽ không còn đảm bảo an toàn sau tối đa bao nhiêu năm sử dụng? (Làm tròn đến hàng đơn vị).],
    [392],
    loigiai: [
        Cần giải:
        $
...
// TL 5
#lt-tln(num: 21, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Chỉ số IQ trung bình của một cộng đồng sau chương trình giáo dục đặc biệt tăng theo quy luật $I(t) = 90 + 10 ln(0.5 t + 1)$, trong đó $t$ là số năm thực hiện chương trình. Sau bao nhiêu năm thì chỉ số IQ trung bình của cộng đồng đạt mốc $105$? (Làm tròn đến một chữ số thập phân).],
    [7.0],
    loigiai: [
        Giải phương trình:
        $
...
// TL 6
#lt-tln(num: 22, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Doanh số bán ra (chiếc) của một hãng công nghệ đối với một sản phẩm mới ra mắt được mô hình hóa bởi $S(t) = 5000 (1 - e^(-0.4 t))$, với $t$ là số tháng kể từ lúc ra mắt. Tổng doanh số bán ra trong $3$ tháng đầu tiên (tại $t=3$) là bao nhiêu chiếc? (Làm tròn đến hàng đơn vị).],
    [3494],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 06 - MÔ HÌNH TOÁN HỌC)!]      #v(0.6em)
