// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 08 - TỔNG HỢP TOÁN THỰC TẾ)
...
#show: lecture-theme.with(
  title: "CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 08 - TỔNG HỢP TOÁN THỰC TẾ)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Phương trình Tsiolkovsky dùng để tính toán vận tốc của một tên lửa trong không gian: $Delta v = v_e ln(m_0 / m_f)$, trong đó $Delta v$ là sự gia tăng vận tốc, $v_e$ là vận tốc phụt của khí thải, $m_0$ là khối lượng tên lửa lúc bắt đầu (bao gồm nhiên liệu) và $m_f$ là khối lượng tên lửa sau khi dùng hết nhiên liệu. Nếu $v_e = 3.0$ km/s và tên lửa cần đạt $Delta v = 6.9$ km/s, thì tỉ số khối lượng nhiên liệu trên tổng khối lượng ban đầu xấp xỉ bằng bao nhiêu?],
    (
        [$70\%$.],
        [$80\%$.],
        True([$90\%$.]),
...
// TN 2
#lt-tn(num: 2, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Theo độ sâu dưới mặt nước đại dương, lượng ánh sáng xuyên qua giảm dần theo mô hình $I(d) = I_0 e^(-k d)$, trong đó $d$ là độ sâu (mét), $I_0$ là cường độ sáng trên mặt nước và $k$ là hệ số hấp thụ. Giả sử tại vùng biển A có $k = 0.05$. Độ sâu mà tại đó lượng ánh sáng chỉ còn $1\%$ so với bề mặt xấp xỉ bằng],
    (
        [$46$ mét.],
        [$72$ mét.],
        True([$92$ mét.]),
...
// TN 3
#lt-tn(num: 3, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Dân số của một quốc gia có tốc độ tăng dân số hàng năm không đổi. Năm 2010 dân số là $80$ triệu người. Năm 2020 dân số đạt $92$ triệu người. Ước tính dân số năm 2030 (với cùng tốc độ tăng) sẽ là bao nhiêu?],
    (
        [$100$ triệu người.],
        [$104$ triệu người.],
...
// TN 4
#lt-tn(num: 4, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Cường độ một trận động đất đo theo thang Richter được tính bởi $M = log(E) - 4.4$, trong đó $E$ là năng lượng giải phóng đo bằng Jun (J). Nếu một trận động đất giải phóng năng lượng $10^12$ J thì độ Richter của trận động đất đó là],
    (
        [$6.6$ độ.],
        [$7.2$ độ.],
        True([$7.6$ độ.]),
...
// TN 5
#lt-tn(num: 5, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một học sinh nướng bánh trong lò ở nhiệt độ $200^circ "C"$. Khi lấy bánh ra, bánh nguội đi trong không khí ở nhiệt độ $25^circ "C"$. Hàm nhiệt độ của bánh sau $t$ phút là $T(t) = 25 + 175 e^(-0.04 t)$ ($""^circ "C"$). Sau khoảng bao nhiêu phút thì chiếc bánh đạt nhiệt độ $40^circ "C"$ để ăn không bị bỏng?],
    (
        [$30$ phút.],
        [$45$ phút.],
        True([$61$ phút.]),
...
// TN 6
#lt-tn(num: 6, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một giọt nước mắt có độ pH khoảng $7.4$. Một loại nước giải khát có tính axit với độ pH bằng $3.4$. Tỉ lệ nồng độ ion Hydrogen $[H^+]$ trong nước giải khát đó cao gấp bao nhiêu lần so với trong nước mắt?],
    (
        [$4$ lần.],
        [$40$ lần.],
        [$4000$ lần.],
...
// TN 8
#lt-tn(num: 8, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một máy kéo nông nghiệp mua mới có giá $800$ triệu đồng. Do hao mòn, mỗi năm máy kéo giảm giá trị $15\%$. Để giá trị thanh lý của máy còn $200$ triệu đồng, người nông dân cần sử dụng máy đó trong bao lâu?],
    (
        [$6.5$ năm.],
        True([$8.5$ năm.]),
        [$10.2$ năm.],
...
// TN 9
#lt-tn(num: 9, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Khảo sát đo tuổi của một mẫu than gỗ cổ bằng phương pháp đồng vị Carbon-14 ($C_14$). Chu kì bán rã của $C_14$ là $5730$ năm. Hàm lượng $C_14$ đo được trong mẫu than chỉ còn bằng $30\%$ lượng $C_14$ ở thực vật đang sống. Tuổi của mẫu than cổ xấp xỉ bằng bao nhiêu năm?],
    (
        [$7800$ năm.],
        True([$9950$ năm.]),
        [$11000$ năm.],
...
// TN 10
#lt-tn(num: 10, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Áp suất không khí $P(h)$ (mmHg) ở độ cao $h$ (km) so với mực nước biển được tính bằng công thức $P(h) = 760 e^(-0.13 h)$. Khi một máy bay bay ở độ cao $10$ km, áp suất không khí bên ngoài máy bay là bao nhiêu mmHg?],
    (
        [$100$ mmHg.],
        [$150$ mmHg.],
        True([$207$ mmHg.]),
...
// TN 11
#lt-tn(num: 11, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Mô hình Logistic của sự lan truyền tin đồn trong một trường học có $2000$ học sinh được cho bởi $N(t) = 2000 / (1 + 19 e^(-0.5 t))$, trong đó $t$ là số ngày. Vào thời điểm nào thì tốc độ lan truyền tin đồn lớn nhất (biết tốc độ lớn nhất xảy ra khi một nửa số học sinh đã biết tin)?],
    (
        [$3.5$ ngày.],
        [$4.8$ ngày.],
        True([$5.9$ ngày.]),
...
// TN 12
#lt-tn(num: 12, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một doanh nghiệp tính toán rằng nếu bỏ ra chi phí quảng cáo $x$ triệu đồng/tháng thì lợi nhuận thu được là $P(x) = 50 + 10 ln x$ (triệu đồng), với $x > 0$. Nếu doanh nghiệp muốn lợi nhuận tăng thêm $10$ triệu đồng từ mức lợi nhuận khi $x=10$, họ cần chi bao nhiêu tiền quảng cáo một tháng?],
    (
        [$20.5$ triệu đồng.],
...
// DS 1
#lt-ds(num: 13, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một loài sinh vật phù du sống trong môi trường nước bị ô nhiễm có mật độ $D(t) = 1000 e^(-0.15 t)$ (con/lít), trong đó $t$ là số giờ. Các phát biểu sau đúng hay sai?], (
...
// DS 2
#lt-ds(num: 14, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Độ lớn cảm giác âm (Sone) có liên hệ với mức cường độ âm $L$ (Phon hoặc dB ở 1kHz) bằng công thức kinh nghiệm: $S = 2^((L - 40)/10)$. Các phát biểu sau đúng hay sai?], (
...
// DS 3
#lt-ds(num: 15, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Chất phóng xạ Polonium-210 có chu kì bán rã là $138$ ngày. Ban đầu có $10$ gam Polonium-210. Phương trình khối lượng còn lại là $m(t) = 10 dot 2^(-t/138)$. Các phát biểu sau đúng hay sai?], (
...
// DS 4
#lt-ds(num: 16, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Để đánh giá chất lượng học trực tuyến, người ta xây dựng hàm thời gian tập trung $F(t) = 45 / (1 + 0.2 e^(0.1 t))$ (phút), trong đó $t$ là số phút học sinh đã ngồi trước màn hình không nghỉ. Các phát biểu sau đúng hay sai?], (
...
// TL 1
#lt-tln(num: 17, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Tốc độ sinh trưởng của một loài vi khuẩn tuân theo công thức $N(t) = N_0 3^(t/2)$, trong đó $t$ đo bằng giờ. Nếu ban đầu có $500$ con vi khuẩn, sau bao nhiêu giờ thì số lượng vi khuẩn đạt $13500$ con?],
    [6],
    loigiai: [
        Ta có phương trình:
        $
...
// TL 2
#lt-tln(num: 18, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một khoản vay mua ô tô $600$ triệu đồng, lãi suất $0.8\%$/tháng, trả góp đều đặn hàng tháng trong $5$ năm ($60$ tháng). Tính số tiền lãi (triệu đồng) sinh ra ngay trong tháng trả góp đầu tiên.],
    [4.8],
    loigiai: [
...
// TL 5
#lt-tln(num: 21, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Một chất làm lạnh được sử dụng trong công nghiệp bay hơi theo mô hình $V(t) = 500(0.9)^t$ (lít), với $t$ là số tuần. Tính tốc độ bay hơi của chất đó (đạo hàm $V'(t)$) ở tuần thứ $10$. (Lấy trị tuyệt đối, làm tròn đến một chữ số thập phân).],
    [18.4],
    loigiai: [
...
// TL 6
#lt-tln(num: 22, de: [Đề 2 (de08) — Mã 101], back-to: "sec-exercise-hub",[Mức năng suất làm việc của một nhân viên mới theo số tháng kinh nghiệm $x$ được mô hình hóa bởi hàm số $W(x) = 100 - A e^(-k x)$ ($\%$). Khi vừa vào làm ($x=0$), năng suất đạt $40\%$. Sau $3$ tháng, năng suất đạt $70\%$. Dự đoán sau $6$ tháng, năng suất của nhân viên đó sẽ đạt bao nhiêu phần trăm?],
    [85],
    loigiai: [
        Từ điều kiện $W(0) = 40$:
        $
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG 2. MŨ VÀ LOGARIT (ĐỀ SỐ 08 - TỔNG HỢP TOÁN THỰC TẾ)!]      #v(0.6em)
