// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG ĐẠO HÀM VÀ TIẾP TUYẾN (ĐỀ SỐ 03)
...
#show: lecture-theme.with(
  title: "CHƯƠNG ĐẠO HÀM VÀ TIẾP TUYẾN (ĐỀ SỐ 03)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Tính đạo hàm của hàm số đa thức $y = x^4 - 4x^2 + 3$.],
    (
        [$y' = 4x^3 - 8$],
        True([$y' = 4x^3 - 8x$]),
        [$y' = x^3 - 8x$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Phương trình tiếp tuyến của đồ thị hàm số $y = x^3 - 3x$ tại điểm $M(2; 2)$ là:],
    (
        [$y = 9x - 18$],
        True([$y = 9x - 16$]),
        [$y = 9x + 16$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Thể tích nước còn lại trong một bình chứa hình nón (như hình vẽ minh họa bên dưới) đang xả nước được cho bởi $V(t) = 100 - 4t - t^2$ (lít), với $t$ tính bằng phút ($0 <= t <= 8$). Tốc độ xả nước tức thời tại thời điểm $t = 3$ phút là bao nhiêu lít/phút?],
    (
        [$6" lít/phút"$],
        True([$10" lít/phút"$]),
        [$12" lít/phút"$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Doanh thu $R(x)$ và chi phí $C(x)$ (đơn vị: triệu đồng) khi sản xuất và bán $x$ sản phẩm được mô hình hóa bởi $R(x) = 120x - 0.5x^2$ và $C(x) = 20x + 300$ (như hình vẽ bên dưới). Lợi nhuận biên $P'(x) = 0$ tại mức sản lượng $x$ bằng bao nhiêu sản phẩm?],
    (
        [$x = 50$],
        True([$x = 100$]),
        [$x = 120$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Tính đạo hàm của hàm số lượng giác $y = tan(2x)$ (với $x neq pi/4 + k pi/2$).],
    (
        [$y' = (1)/(cos^2(2x))$],
        True([$y' = (2)/(cos^2(2x))$]),
        [$y' = (-2)/(cos^2(2x))$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một vật chuyển động theo phương trình $s(t) = t^3 - 6t^2 + 9t$ (m), $t >= 0$ (giây). Gia tốc tức thời của vật tại thời điểm $t = 4$ giây bằng bao nhiêu $m/s^2$?],
    (
        [$6" m/s"^2$],
        True([$12" m/s"^2$]),
        [$18" m/s"^2$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Tiếp tuyến của đồ thị hàm số $y = (x - 1)/(x + 1)$ vuông góc với đường thẳng $d: y = -2x + 3$ có hệ số góc $k$ bằng:],
    (
        [$k = 2$],
        True([$k = 1/2$]),
        [$k = -1/2$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Độ nâng $y$ (mm) của một con lăn trong cơ cấu cam cơ khí xoay đệ quy (như hình vẽ bên dưới) theo thời gian $t$ (giây) là $y(t) = 5 + 3 sin(10t)$. Tốc độ nâng cực đại của con lăn bằng bao nhiêu mm/s?],
    (
        [$15" mm/s"$],
        True([$30" mm/s"$]),
        [$50" mm/s"$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x) = (2x + 1)/(x - 1)$. Giá trị đạo hàm $f'(0)$ bằng bao nhiêu?],
    (
        [$3$],
        True([$-3$]),
        [$1$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho đồ thị hàm số $y = x^3 - 3x^2 + 1$. Đồ thị có hai tiếp tuyến cùng song song với đường thẳng $y = 9x + 2$. Tung độ của hai tiếp điểm tương ứng lần lượt là bao nhiêu?],
    (
        [$-1$ và $3$],
        True([$-3$ và $1$]),
        [$1$ và $9$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Trong một thiết bị quang học, mặt phản xạ gương có dạng một parabol $y = 0.25 x^2$ (như hình vẽ bên dưới). Tiếp tuyến của mặt gương tại điểm có hoành độ $x_0 = 2$ tạo với trục hoành một góc bằng bao nhiêu độ?],
    (
        [$30^°$],
        True([$45^°$]),
        [$60^°$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x) = x^4 - 6x^2 + 5$. Tập nghiệm của bất phương trình $f''(x) > 0$ là:],
    (
        [$(-1; 1)$],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một bình chứa nước hình nón đang xả nước ra ngoài qua một lỗ hở ở đáy (như hình vẽ minh họa bên dưới). Thể tích nước còn lại trong bình sau $t$ phút được mô hình hóa bởi $V(t) = (10 - 0.5t)^2 = 100 - 10t + 0.25t^2$ (lít), với $0 <= t <= 20$. Các phát biểu sau đúng hay sai?],
    (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một doanh nghiệp sản xuất độc quyền một loại thiết bị công nghệ. Tổng doanh thu và tổng chi phí (đơn vị: triệu đồng) khi sản xuất và bán $x$ sản phẩm ($x > 0$) được mô hình hóa lần lượt bởi $R(x) = 200x - x^2$ và $C(x) = x^2 + 40x + 500$ (như đồ thị bên dưới). Các phát biểu sau đúng hay sai?],
    (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Trong một cỗ máy cơ khí, độ nâng $y$ (cm) của con lăn trong cơ cấu cam đĩa (như hình vẽ bên dưới) phụ thuộc vào thời gian $t$ (giây) theo công thức $y(t) = 4 + 2 cos(5t)$. Các phát biểu sau đúng hay sai?],
    (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một gương phản xạ trong đèn pha ô tô có mặt cắt là một parabol $(P): y = 0.1 x^2$ (như hình vẽ bên dưới). Các phát biểu sau đúng hay sai?],
    (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x) = (2x - 1)/(x + 2)$. Tính giá trị của đạo hàm $f'(1)$ (làm tròn kết quả đến hai chữ số thập phân).],
    [0.56],
    loigiai: [
...
// TLN 2
#lt-tln(num: 18, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Vận tốc của một vật rơi tự do có sức cản không khí biến thiên theo thời gian $t$ (giây) theo công thức $v(t) = 50(1 - e^(-0.2t))$ (m/s). Tính gia tốc của vật tại thời điểm $t = 5$ giây (tính bằng $m/s^2$, làm tròn đến hai chữ số thập phân).],
    [3.68],
    loigiai: [
...
// TLN 3
#lt-tln(num: 19, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho đồ thị hàm số $y = x^3 - 3x^2 + 2$. Biết rằng có hai tiếp tuyến của đồ thị đi qua điểm $K(0; 2)$. Tính tổng hệ số góc $k_1 + k_2$ của hai tiếp tuyến đó.],
    [-2.25],
    loigiai: [
...
// TLN 4
#lt-tln(num: 20, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = x^4 - 2x^2 + 3$. Tiếp tuyến của đồ thị hàm số tại các điểm cực tiểu cắt trục tung $O y$ tại điểm có tung độ bằng bao nhiêu?],
    [2],
    loigiai: [
...
// TLN 5
#lt-tln(num: 21, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Một quần thể vi khuẩn nhân đôi phát triển theo công thức $P(t) = 100 dot 2^(0.5t)$, trong đó $t$ tính bằng giờ. Tính tốc độ sinh trưởng tức thời của quần thể vi khuẩn tại thời điểm $t = 4$ giờ (tính bằng con/giờ, làm tròn đến hai chữ số thập phân).],
    [138.63],
    loigiai: [
...
// TLN 6
#lt-tln(num: 22, de: [Đề 3 (de03) — Mã 101], back-to: "sec-exercise-hub",[Cho parabol $(P): y = x^2$. Tiếp tuyến của $(P)$ tại điểm có hoành độ $x_0 > 0$ cắt hai trục tọa độ $O x, O y$ lần lượt tại hai điểm $A, B$ sao cho diện tích tam giác vuông $O A B$ bằng $16$. Tìm giá trị của $x_0$.],
    [4],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG ĐẠO HÀM VÀ TIẾP TUYẾN (ĐỀ SỐ 03)!]      #v(0.6em)
