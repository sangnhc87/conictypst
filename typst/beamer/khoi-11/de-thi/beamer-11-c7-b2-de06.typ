// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHƯƠNG ĐẠO HÀM VÀ TIẾP TUYẾN (ĐỀ SỐ 06)
...
#show: lecture-theme.with(
  title: "CHƯƠNG ĐẠO HÀM VÀ TIẾP TUYẾN (ĐỀ SỐ 06)",
...
// TN 1
#lt-tn(num: 1, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Tính đạo hàm của hàm số đa thức $y = x^5 - 5x^3 + 4x$.],
    (
        [$y' = 5x^4 - 15x^2$],
        True([$y' = 5x^4 - 15x^2 + 4$]),
        [$y' = 5x^4 - 5x^2 + 4$],
...
// TN 2
#lt-tn(num: 2, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Lưu lượng nước chảy qua cửa xả của một đập thủy điện (như hình vẽ bên dưới) phụ thuộc vào chiều cao cột nước $h$ (mét) theo công thức $Q(h) = 5 h sqrt(h) = 5 h sqrt(h)$ ($"m"^3"/s"$). Tốc độ thay đổi lưu lượng nước $Q'(h)$ khi cột nước đạt chiều cao $h = 4$ m bằng bao nhiêu $"m"^2"/s"$?],
    (
        [$10$],
        True([$15$]),
        [$20$],
...
// TN 3
#lt-tn(num: 3, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = e^(2x) - x$. Phương trình tiếp tuyến của đồ thị hàm số tại điểm có hoành độ $x_0 = 0$ là:],
    (
        [$y = x$],
        True([$y = x + 1$]),
        [$y = 2x + 1$],
...
// TN 4
#lt-tn(num: 4, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Suất điện động tự cảm xuất hiện trong một cuộn cảm $L = 0.02$ H khi cường độ dòng điện $I(t) = 5 sin(100 pi t)$ (A) biến thiên theo thời gian $t$ (giây) được cho bởi $e(t) = -L I'(t)$. Độ lớn suất điện động tức thời tại thời điểm $t = 0$ bằng bao nhiêu Volt (lấy $pi approx 3.14$)?],
    (
        [$10.0$],
        True([$31.4$]),
        [$50.0$],
...
// TN 5
#lt-tn(num: 5, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Hệ số góc của tiếp tuyến của đồ thị hàm số $y = tan x + x$ tại điểm có hoành độ $x_0 = pi/4$ bằng bao nhiêu?],
    (
        [$2$],
        True([$3$]),
        [$4$],
...
// TN 6
#lt-tn(num: 6, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Theo mô hình động học enzym Michaelis-Menten (như hình vẽ bên dưới), tốc độ phản ứng sinh hóa $v$ ($mu$mol/s) phụ thuộc nồng độ cơ chất $S$ (mM) theo công thức $v(S) = (10 S)/(S + 2)$. Tốc độ gia tăng phản ứng $v'(S)$ tại nồng độ $S = 3$ mM bằng bao nhiêu $mu$mol/(s.mM)?],
    (
        [$0.40$],
        True([$0.80$]),
        [$1.20$],
...
// TN 7
#lt-tn(num: 7, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x) = x^4 - 12x^2 + 5x$. Tập nghiệm của bất phương trình đạo hàm cấp hai $f''(x) < 0$ là:],
    (
        [$(-2; 2)$],
        True([$(-sqrt(2); sqrt(2))$]),
        [$(-oo; -sqrt(2))$],
...
// TN 8
#lt-tn(num: 8, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một chiếc xe đua đang thực hiện kỹ thuật trượt bánh (drift) theo đường cong $y = x - x^3/27$ (mét) (như hình vẽ bên dưới). Tiếp tuyến với quỹ đạo chuyển động của xe nằm ngang (hệ số góc $k = 0$) tại điểm có hoành độ dương $x$ bằng bao nhiêu?],
    (
        [$x = 1$],
        True([$x = 3$]),
        [$x = 9$],
...
// TN 9
#lt-tn(num: 9, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho chuyển động của một chất điểm có phương trình quãng đường $s(t) = cos(2t) + t^2$ (m), với $t >= 0$ (giây). Gia tốc tức thời của chất điểm tại thời điểm $t = pi/6$ giây bằng bao nhiêu $"m/s"^2$?],
    (
        [$1.0$],
        True([$0.0$]),
        [$2.0$],
...
// TN 10
#lt-tn(num: 10, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = (x + 2)/(x + 1)$. Có hai tiếp tuyến của đồ thị hàm số đi qua gốc tọa độ $O(0; 0)$. Tích hoành độ $x_1 dot x_2$ của hai tiếp điểm đó bằng bao nhiêu?],
    (
        [$1$],
        True([$2$]),
        [$-2$],
...
// TN 11
#lt-tn(num: 11, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Nhiệt độ động cơ của một máy nén khí sau khi tắt máy giảm theo thời gian $t$ (giây) theo công thức $T(t) = 100 e^(-0.05 t)$ (°C). Tốc độ giảm nhiệt độ tức thời tại thời điểm $t = 20$ giây bằng bao nhiêu °C/s (lấy $e approx 2.718$)?],
    (
        [$3.68$],
        True([$1.84$]),
        [$5.00$],
...
// TN 12
#lt-tn(num: 12, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = sqrt((x)/(x + 1))$ với $x > 0$. Giá trị đạo hàm $y'(1)$ bằng bao nhiêu?],
    (
        [$(1)/(4)$],
        True([$(sqrt(2))/(8)$]),
        [$(sqrt(2))/(4)$],
...
// DS 1
#lt-ds(num: 13, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Lưu lượng nước xả qua cửa đáy của một đập thủy điện (như hình vẽ bên dưới) phụ thuộc vào chiều cao cột nước $h$ (mét, $h >= 0$) theo công thức $Q(h) = 4 h sqrt(h) = 4 h sqrt(h)$ ($"m"^3"/s"$). Các phát biểu sau đúng hay sai?],
    (
...
// DS 2
#lt-ds(num: 14, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Trong sinh hóa học, tốc độ phản ứng xúc tác bởi enzym theo mô hình Michaelis-Menten (như đồ thị bên dưới) được cho bởi $v(S) = (12 S)/(S + 4)$ ($mu$mol/s), trong đó $S >= 0$ là nồng độ cơ chất (mM). Các phát biểu sau đúng hay sai?],
    (
...
// DS 3
#lt-ds(num: 15, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Quỹ đạo trượt của một chiếc xe đua trong tình huống drift (như hình vẽ bên dưới) được mô tả trong hệ trục tọa độ bởi đường cong $y = 3x - x^3/9$ (mét) với $-3 <= x <= 3$. Các phát biểu sau đúng hay sai?],
    (
...
// DS 4
#lt-ds(num: 16, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cường độ dòng điện chạy qua một cuộn cảm $L = 0.1$ H biến thiên theo thời gian $t$ (giây) theo phương trình $I(t) = 4 sin(50 pi t)$ (A). Suất điện động tự cảm xuất hiện trong cuộn cảm là $e(t) = -L I'(t)$. Các phát biểu sau đúng hay sai?],
    (
...
// TLN 1
#lt-tln(num: 17, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $f(x) = x^2 e^x$. Tính giá trị đạo hàm $f'(1)$ (lấy $e approx 2.718$, làm tròn đến hai chữ số thập phân).],
    [8.15],
    loigiai: [
...
// TLN 2
#lt-tln(num: 18, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Một khối chóp đều có đáy là hình vuông cạnh $a$ tăng đều với tốc độ $0.3" cm/s"$ và chiều cao luôn gấp đôi cạnh đáy ($h = 2a$). Tính tốc độ tăng thể tích của khối chóp tại thời điểm $a = 3$ cm (tính bằng c$"m"^3"/s"$).],
    [5.4],
    loigiai: [
...
// TLN 3
#lt-tln(num: 19, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho đồ thị hàm số $y = x^4 - 4x^2 + 1$. Đồ thị hàm số có bao nhiêu đường tiếp tuyến nằm ngang (hệ số góc $k = 0$)?],
    [2],
    loigiai: [
...
// TLN 4
#lt-tln(num: 20, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Gia tốc tức thời của chuyển động $s(t) = A sin(omega t)$ tại thời điểm ban đầu $t = 0$ bằng bao nhiêu?],
    [0],
    loigiai: [
...
// TLN 5
#lt-tln(num: 21, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho parabol $(P): y = x^2 - 4x + 5$. Tìm hoành độ $x_0 > 2$ của tiếp điểm sao cho tiếp tuyến tại $x_0$ tạo với hai trục tọa độ $O x, O y$ một tam giác vuông cân.],
    [2.5],
    loigiai: [
...
// TLN 6
#lt-tln(num: 22, de: [Đề 3 (de06) — Mã 101], back-to: "sec-exercise-hub",[Cho hàm số $y = (x^2 + x + 2)/(x + 1) = x + (2)/(x + 1)$. Tiếp tuyến của đồ thị hàm số tại điểm có hoành độ $x_0 = 1$ cắt đường thẳng $d: y = 2x - 3$ tại điểm $M(x_M; y_M)$. Tính giá trị của tổng $x_M + y_M$.],
    [6],
    loigiai: [
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHƯƠNG ĐẠO HÀM VÀ TIẾP TUYẾN (ĐỀ SỐ 06)!]      #v(0.6em)
