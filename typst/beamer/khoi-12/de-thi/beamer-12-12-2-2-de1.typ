...
#show: lecture-theme.with(
  title: "BÀI 8: HỆ TRỤC TỌA ĐỘ TRONG KHÔNG GIAN",
  subtitle: "ĐỀ 1 — TỌA ĐỘ CỦA ĐIỂM VÀ TỌA ĐỘ VECTƠ — MÃ ĐỀ: 522",
  author: "Tổ Toán — THPT",
  institution: "TOÁN 12",
  base-size: 20pt,
)
...
#resetcau()
#exam-part([PHẦN III. Câu trắc nghiệm trả lời ngắn (9 câu)], count: 9)
