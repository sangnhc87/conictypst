// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHỦ ĐỀ 2B: GIÁ TRỊ HIỆN TẠI, GIÁ TRỊ TƯƠNG LAI & CHIẾT KHẤU DÒNG TIỀN (VD - VDC)
// Lớp: Khối 12  ·  Mã đề: 512  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHỦ ĐỀ 2B: GIÁ TRỊ HIỆN TẠI, GIÁ TRỊ TƯƠNG LAI & CHIẾT KHẤU DÒNG TIỀN (VD - VDC)",
  subtitle: "CHUYÊN ĐỀ 2: ỨNG DỤNG TOÁN HỌC TRONG TÀI CHÍNH — MÃ ĐỀ: 512",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 512]],
...
// TN 1
#lt-tn(num: 1, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một hợp đồng kinh tế cam kết chi trả cho nhà đầu tư số tiền $500$ triệu đồng sau đúng $4$ năm nữa. Biết lãi suất chiết khấu phi rủi ro trên thị trường tài chính là $6","5\%$/năm theo hình thức ghép lãi hàng năm. Giá trị hiện tại ($"PV"$) của khoản tiền này ở thời điểm ký kết hợp đồng hôm nay xấp xỉ bằng bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 3
#lt-tn(num: 3, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một doanh nghiệp xem xét đầu tư một dây chuyền đóng gói tự động với chi phí mua ban đầu là $800$ triệu đồng. Dự kiến dây chuyền này sẽ mang lại dòng tiền thuần hàng năm là $320$ triệu đồng vào cuối mỗi năm trong vòng $3$ năm liên tiếp. Với chi phí vốn (suất chiết khấu) của doanh nghiệp là $10\%$/năm, giá trị hiện tại ròng ($"NPV"$) của dự án này là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một học bổng tài năng cam kết trao thưởng vĩnh viễn hàng năm số tiền $60$ triệu đồng cho sinh viên thủ khoa của một trường đại học, bắt đầu trao khoản đầu tiên sau đúng một năm nữa. Nếu quỹ đầu tư của trường đạt tỷ suất sinh lời an toàn và ổn định là $7","5\%$/năm, số tiền tối thiểu mà nhà hảo tâm cần đóng góp vào quỹ ngay hôm nay để duy trì học bổng này là:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một người trúng giải thưởng xổ số đặc biệt được quyền lựa chọn một trong hai phương án nhận thưởng:
...
// TN 7
#lt-tn(num: 7, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một doanh nghiệp xem xét mua một hệ thống phần mềm quản trị với chi phí ban đầu là $150$ triệu đồng. Sau $1$ năm vận hành, doanh nghiệp thu về khoản lợi ích ròng là $180$ triệu đồng và kết thúc vòng đời của phần mềm. Suất hoàn vốn nội bộ (IRR - Internal Rate of Return) của dự án đầu tư công nghệ này là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một doanh nghiệp có hai phương án đầu tư loại trừ nhau với vốn đầu tư ban đầu như nhau ($C_0 = 500$ triệu đồng).
...
// DS 1
#lt-ds(num: 13, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một dự án mở rộng nhà xưởng may xuất khẩu có các thông số tài chính như sau:
...
// DS 2
#lt-ds(num: 14, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một doanh nghiệp sản xuất đang cân nhắc hai giải pháp thay thế hệ thống làm mát phân xưởng:
...
// DS 4
#lt-ds(num: 16, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một nhà đầu tư thiên thần rót vốn $500$ triệu đồng vào một công ty khởi nghiệp. Hợp đồng quy định sau $3$ năm, nhà đầu tư được quyền chọn một trong hai phương án thoái vốn:
...
// TLN 1
#lt-tln(num: 17, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một khoản tiền $400$ triệu đồng được chi trả sau $3$ năm nữa. Với lãi suất chiết khấu $7\%$/năm theo hình thức ghép lãi hàng năm, giá trị hiện tại ($"PV"$) của khoản tiền này bằng bao nhiêu triệu đồng? (làm tròn kết quả đến hàng đơn vị)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2
#lt-tln(num: 18, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một dự án kinh doanh đòi hỏi vốn đầu tư ban đầu là $600$ triệu đồng và mang lại dòng tiền thuần $280$ triệu đồng ở cuối năm thứ nhất, $450$ triệu đồng ở cuối năm thứ hai. Với lãi suất chiết khấu $8\%$/năm, giá trị hiện tại ròng ($"NPV"$) của dự án này là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng đơn vị)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một quỹ bảo trợ xã hội nhận được một khoản hiến tặng vĩnh viễn với dòng tiền tài trợ đều đặn hàng năm là $45$ triệu đồng. Nếu lãi suất chiết khấu thị trường là $6\%$/năm, giá trị hiện tại của dòng tiền hiến tặng vĩnh viễn này bằng bao nhiêu triệu đồng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4
#lt-tln(num: 20, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một thương vụ đầu tư bất động sản yêu cầu bỏ vốn $1$ tỷ đồng ($1000$ triệu đồng) tại thời điểm $t = 0$. Sau đúng $2$ năm, nhà đầu tư bán lại bất động sản và thu về trọn gói $1322","5$ triệu đồng. Suất hoàn vốn nội bộ (IRR) hàng năm của thương vụ này bằng bao nhiêu phần trăm? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 5
#lt-tln(num: 21, de: [Đề cd02B — Mã 512], back-to: "sec-exercise-hub",[Một khoản tiền gửi định kỳ gồm $3$ khoản thu nhận được ở cuối mỗi năm, mỗi khoản là $100$ triệu đồng. Với lãi suất tiền gửi ngân hàng là $6\%$/năm, tổng giá trị tương lai ($"FV"$) tích lũy được ở cuối năm thứ ba là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHỦ ĐỀ 2B: GIÁ TRỊ HIỆN TẠI, GIÁ TRỊ TƯƠNG LAI & CHIẾT KHẤU DÒNG TIỀN (VD - VDC)!]      #v(0.6em)
