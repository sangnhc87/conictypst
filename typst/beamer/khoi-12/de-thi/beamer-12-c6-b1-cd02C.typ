// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHỦ ĐỀ 2C: NIÊN KIM ĐỊNH KỲ & TÍCH LŨY TIẾT KIỆM (VD - VDC)
// Lớp: Khối 12  ·  Mã đề: 513  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHỦ ĐỀ 2C: NIÊN KIM ĐỊNH KỲ & TÍCH LŨY TIẾT KIỆM (VD - VDC)",
  subtitle: "CHUYÊN ĐỀ 2: ỨNG DỤNG TOÁN HỌC TRONG TÀI CHÍNH — MÃ ĐỀ: 513",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 513]],
...
// TN 1
#lt-tn(num: 1, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một người đều đặn gửi tiết kiệm vào ngân hàng số tiền $10$ triệu đồng vào cuối mỗi tháng, liên tục trong vòng $3$ năm ($36$ tháng). Biết lãi suất tiền gửi ổn định là $0","5\%$/tháng theo thể thức lãi kép hàng tháng và toàn bộ tiền lãi được tự động nhập gốc. Sau đúng $3$ năm, ngay sau lần gửi cuối cùng, tổng số tiền cả gốc và lãi người đó tích lũy được là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 4
#lt-tn(num: 4, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một cặp vợ chồng trẻ mua một chiếc xe ô tô theo hình thức trả góp. Sau khi trả trước một phần, số nợ gốc còn lại là $400$ triệu đồng. Ngân hàng đồng ý cho trả dần trong $4$ năm ($48$ tháng) bằng các khoản thanh toán đều nhau vào cuối mỗi tháng. Biết lãi suất cho vay cố định là $9\%$/năm ($0","75\%$/tháng) tính trên dư nợ thực tế. Số tiền vợ chồng phải trả đều đặn cho ngân hàng mỗi tháng xấp xỉ bằng bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một tập đoàn phát hành trái phiếu doanh nghiệp thời hạn $5$ năm với tổng mệnh giá nợ phải thanh toán khi đáo hạn là $100$ tỷ đồng. Để bảo đảm khả năng thanh toán nợ gốc khi đến hạn, điều lệ yêu cầu tập đoàn phải lập một quỹ chìm hoàn nợ (Sinking Fund), bằng cách gửi đều đặn một khoản tiền cố định vào cuối mỗi năm vào tài khoản phong tỏa tại ngân hàng với lãi suất $7\%$/năm theo hình thức lãi kép. Số tiền hàng năm mà tập đoàn phải trích lập gửi vào quỹ chìm xấp xỉ bằng bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một người dự kiến thuê một căn hộ chung cư trong $3$ năm. Chủ nhà đưa ra hai hình thức thanh toán tiền thuê nhà:
...
// TN 9
#lt-tn(num: 9, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một doanh nhân có dự định mua một khu đất sinh thái với giá $3$ tỷ đồng sau $6$ năm nữa. Ông dự định mở tài khoản tiết kiệm và gửi tiền vào cuối mỗi năm với lãi suất $8\%$/năm. Hỏi mỗi năm ông cần gửi tiết kiệm số tiền là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một hợp đồng bảo hiểm nhân thọ quy định: Khách hàng đóng phí bảo hiểm đều đặn $25$ triệu đồng vào ĐẦU mỗi năm trong suốt $10$ năm. Công ty bảo hiểm cam kết lãi suất tích lũy bình quân là $6\%$/năm. Ngay tại thời điểm tròn $10$ năm kể từ ngày ký hợp đồng, giá trị hoàn lại tích lũy trong tài khoản của khách hàng là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 11
#lt-tn(num: 11, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một doanh nghiệp vay ngân hàng $1$ tỷ đồng để mở rộng sản xuất với lãi suất ưu đãi $8\%$/năm theo hình thức trả nợ gốc và lãi đều nhau vào cuối mỗi năm trong vòng $5$ năm. Sau lần thanh toán thứ nhất ở cuối năm thứ nhất, số tiền nợ gốc còn lại mà doanh nghiệp chưa trả là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 1
#lt-ds(num: 13, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một kỹ sư trẻ bắt đầu đi làm từ năm $25$ tuổi, dự định nghỉ hưu năm $55$ tuổi (thời gian làm việc tích lũy là $30$ năm). Anh lập kế hoạch tài chính cá nhân như sau:
...
// DS 2
#lt-ds(num: 14, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một hộ kinh doanh vay ngân hàng số tiền $600$ triệu đồng để sửa chữa cửa hàng theo hình thức vay trả góp. Thời hạn vay là $5$ năm ($60$ tháng), lãi suất cho vay cố định là $10\%$/năm ($r = (10\%) / 12 approx 0","8333\%$/tháng). Các khoản thanh toán gốc và lãi được chia đều trả vào cuối mỗi tháng.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 3
#lt-ds(num: 15, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một cặp vợ chồng dự định tích lũy để mua nhà. Hiện tại hai vợ chồng chưa có đồng vốn nào. Họ lên kế hoạch mỗi tháng gửi tiết kiệm $15$ triệu đồng vào cuối mỗi tháng với lãi suất $0","6\%$/tháng. Căn nhà mục tiêu hiện tại có giá $1","5$ tỷ đồng.
...
// DS 4
#lt-ds(num: 16, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một doanh nghiệp đầu tư một tài sản cố định có giá trị $2$ tỷ đồng. Doanh nghiệp lập quỹ khấu hao hàng năm theo phương pháp niên kim đều (Sinking Fund Depreciation) với lãi suất tiền gửi khấu hao là $8\%$/năm trong $10$ năm để khi tài sản hết khấu hao sẽ có đủ $2$ tỷ đồng mua sắm máy móc mới.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1
#lt-tln(num: 17, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một sinh viên mới tốt nghiệp gửi tiết kiệm đều đặn $3$ triệu đồng vào cuối mỗi tháng với lãi suất $0","6\%$/tháng theo thể thức lãi kép. Sau đúng $5$ năm ($60$ tháng), tổng số tiền cả gốc lẫn lãi bạn sinh viên này tích lũy được là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng đơn vị)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2
#lt-tln(num: 18, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một khoản vay ngân hàng trị giá $300$ triệu đồng được trả góp đều đặn hàng năm trong $5$ năm với lãi suất $9\%$/năm (mỗi năm trả một lần vào cuối năm). Số tiền mà người vay phải trả đều đặn mỗi năm là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một người muốn sau $4$ năm nữa có sẵn khoản tiền $800$ triệu đồng để kinh doanh. Người đó gửi tiền định kỳ vào ĐẦU mỗi năm trong $4$ năm liên tiếp vào tài khoản tiết kiệm với lãi suất $7\%$/năm. Hỏi số tiền người đó cần nộp vào đầu mỗi năm là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng đơn vị)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 5
#lt-tln(num: 21, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một cặp vợ chồng gửi tiết kiệm $8$ triệu đồng vào cuối mỗi tháng liên tục trong $4$ năm ($48$ tháng) với lãi suất $0","5\%$/tháng. Sau $4$ năm, tổng số tiền lãi mà cặp vợ chồng này thu được từ ngân hàng là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng đơn vị)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 6
#lt-tln(num: 22, de: [Đề cd02C — Mã 513], back-to: "sec-exercise-hub",[Một quỹ học bổng sinh viên cần có sẵn số tiền ban đầu là bao nhiêu tỷ đồng để kể từ năm sau có thể chi trả học bổng đều đặn $180$ triệu đồng vào cuối mỗi năm vĩnh viễn, biết quỹ đạt tỷ suất sinh lời $7","2\%$/năm? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHỦ ĐỀ 2C: NIÊN KIM ĐỊNH KỲ & TÍCH LŨY TIẾT KIỆM (VD - VDC)!]      #v(0.6em)
