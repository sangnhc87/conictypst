// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHỦ ĐỀ 2D: VAY NỢ TRẢ GÓP & PHÂN BỔ NỢ (AMORTIZATION) (VD - VDC)
// Lớp: Khối 12  ·  Mã đề: 514  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHỦ ĐỀ 2D: VAY NỢ TRẢ GÓP & PHÂN BỔ NỢ (AMORTIZATION) (VD - VDC)",
  subtitle: "CHUYÊN ĐỀ 2: ỨNG DỤNG TOÁN HỌC TRONG TÀI CHÍNH — MÃ ĐỀ: 514",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 514]],
...
// TN 1
#lt-tn(num: 1, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một người vay ngân hàng số tiền $300$ triệu đồng để mua ô tô trả góp trong thời hạn $3$ năm ($36$ tháng). Ngân hàng áp dụng mức lãi suất cố định là $0","8\%$/tháng theo thể thức lãi kép trên dư nợ giảm dần, số tiền trả nợ mỗi tháng là như nhau (phương thức niên kim trả góp đều). Số tiền mà người đó phải thanh toán đều đặn cho ngân hàng vào cuối mỗi tháng xấp xỉ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 3
#lt-tn(num: 3, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một doanh nghiệp vay $800$ triệu đồng thời hạn $5$ năm ($60$ tháng) với lãi suất $0","7\%$/tháng theo phương thức trả góp đều hàng tháng. Biết số tiền thanh toán định kỳ mỗi tháng là $16","37$ triệu đồng. Sau đúng $2$ năm ($24$ tháng) thực hiện nghĩa vụ thanh toán đầy đủ, số dư nợ gốc còn lại của doanh nghiệp là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một khách hàng vay ngân hàng $600$ triệu đồng trong $5$ năm ($60$ tháng) với lãi suất $0","9\%$/tháng. Ngân hàng cho phép lựa chọn một trong hai phương thức trả nợ:
...
// TN 5
#lt-tn(num: 5, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Trong một hợp đồng vay vốn trả góp đều hàng tháng, người vay nhận thấy rằng số tiền nợ gốc trả được ở tháng thứ hai là $P_2 = 10","00$ triệu đồng và ở tháng thứ năm là $P_5 = 10","303$ triệu đồng. Lãi suất vay hàng tháng của hợp đồng này là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một hộ kinh doanh vay $500$ triệu đồng với thời hạn $5$ năm ($60$ tháng), lãi suất $0","8\%$/tháng theo phương thức trả góp đều hàng tháng (mỗi tháng trả $10","62$ triệu đồng). Sau khi đã trả được đúng $24$ tháng, hộ kinh doanh có nguồn thu đột xuất nên quyết định làm thủ tục tất toán toàn bộ khoản vay trước hạn. Biết ngân hàng áp dụng mức phí phạt tất toán trước hạn là $1","5\%$ trên số dư nợ gốc còn lại tại thời điểm tất toán. Tổng số tiền (gồm cả nợ gốc còn lại và phí phạt) mà hộ kinh doanh phải nộp cho ngân hàng là khoảng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một gia đình vay ngân hàng $1","2$ tỷ đồng ($1200$ triệu đồng) thời hạn $10$ năm ($120$ tháng) theo phương thức trả góp đều hàng tháng. Trong năm đầu tiên ($12$ tháng đầu), ngân hàng áp dụng lãi suất ưu đãi cố định là $0","6\%$/tháng ($7","2\%$/năm), khiến khoản trả góp hàng tháng là $14","06$ triệu đồng. Từ tháng thứ 13 trở đi, lãi suất thả nổi điều chỉnh tăng lên mức $0","9\%$/tháng ($10","8\%$/năm) trên dư nợ còn lại trong $108$ tháng tiếp theo. Khoản tiền mà gia đình phải trả mỗi tháng ở giai đoạn mới này là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một cá nhân vay ngân hàng $200$ triệu đồng với lãi suất $1\%$/tháng theo phương thức trả góp đều hàng tháng. Khả năng tài chính của cá nhân này cho phép trả tối đa $5$ triệu đồng vào cuối mỗi tháng. Hỏi sau ít nhất bao nhiêu tháng thì cá nhân đó có thể trả hết toàn bộ nợ gốc và lãi cho ngân hàng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 1
#lt-ds(num: 13, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một gia đình trẻ vay ngân hàng $1","5$ tỷ đồng ($1500$ triệu đồng) để mua một căn hộ chung cư với thời hạn vay là $10$ năm ($120$ tháng). Hợp đồng áp dụng mức lãi suất cố định $0","75\%$/tháng theo phương thức trả góp đều hàng tháng (dư nợ giảm dần, số tiền trả mỗi tháng cố định).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 2
#lt-ds(num: 14, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một công ty dịch vụ vận tải dự định mua một đội xe thương mại trị giá $600$ triệu đồng thời hạn $5$ năm ($60$ tháng). Công ty cân nhắc giữa hai gói tín dụng của ngân hàng:
...
// DS 3
#lt-ds(num: 15, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một doanh nghiệp đang có khoản vay tại Ngân hàng X với dư nợ gốc hiện tại là $2$ tỷ đồng ($2000$ triệu đồng), thời gian vay còn lại đúng $3$ năm ($36$ tháng) với lãi suất vay cũ khá cao là $12\%$/năm ($1\%$/tháng), số tiền trả góp cố định mỗi tháng là $66","43$ triệu đồng.
...
// DS 4
#lt-ds(num: 16, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một khách hàng cá nhân vay mua nhà gói tín dụng trị giá $1$ tỷ đồng ($1000$ triệu đồng) thời hạn $8$ năm ($96$ tháng) theo hình thức trả góp đều. Hợp đồng có điều khoản lãi suất hỗn hợp (Hybrid ARM):
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một khoản vay mua sắm $300$ triệu đồng được thanh toán theo phương thức trả góp đều hàng tháng trong thời hạn $36$ tháng với lãi suất $0","9\%$/tháng. Sau đúng $12$ tháng trả nợ đúng hạn, số dư nợ gốc còn lại của khoản vay là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4
#lt-tln(num: 20, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một khoản vay kinh doanh $1$ tỷ đồng ($1000$ triệu đồng) thời hạn $10$ năm ($120$ tháng) theo hình thức trả góp đều hàng tháng với lãi suất $0","7\%$/tháng. Ở tháng thứ mấy của hợp đồng thì số tiền trả nợ gốc trong tháng lần đầu tiên vượt qua số tiền trả nợ lãi?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 6
#lt-tln(num: 22, de: [Đề cd02D — Mã 514], back-to: "sec-exercise-hub",[Một người vay ngân hàng $800$ triệu đồng với lãi suất $0","8\%$/tháng theo thể thức lãi kép trên dư nợ giảm dần. Nếu mỗi tháng người đó có khả năng thanh toán tối đa $15$ triệu đồng vào cuối mỗi tháng, hỏi sau ít nhất bao nhiêu tháng thì người đó có thể trả dứt điểm khoản nợ?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHỦ ĐỀ 2D: VAY NỢ TRẢ GÓP & PHÂN BỔ NỢ (AMORTIZATION) (VD - VDC)!]      #v(0.6em)
