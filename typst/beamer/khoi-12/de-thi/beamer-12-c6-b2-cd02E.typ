// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHỦ ĐỀ 2E: LẬP KẾ HOẠCH TÀI CHÍNH CÁ NHÂN & QUỸ HƯU TRÍ (VD - VDC)
// Lớp: Khối 12  ·  Mã đề: 515  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHỦ ĐỀ 2E: LẬP KẾ HOẠCH TÀI CHÍNH CÁ NHÂN & QUỸ HƯU TRÍ (VD - VDC)",
  subtitle: "CHUYÊN ĐỀ 2: ỨNG DỤNG TOÁN HỌC TRONG TÀI CHÍNH — MÃ ĐỀ: 515",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 515]],
...
// TN 3
#lt-tn(num: 3, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Khi vừa bước sang tuổi $60$, một người chính thức nghỉ hưu với tài sản tích lũy trong quỹ hưu trí cá nhân là $3$ tỷ đồng ($3000$ triệu đồng). Quỹ này được gửi tại ngân hàng với mức lãi suất ổn định $6\%$/"năm" ($0","5\%$/"tháng"). Người đó lên kế hoạch rút đều đặn một khoản tiền cố định vào cuối mỗi tháng trong suốt $25$ năm ($300$ tháng) cho đến khi số dư quỹ hưu trí về đúng bằng $0$. Khoản tiền mà người đó có thể rút ra chi tiêu mỗi tháng là khoảng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một cán bộ hưu trí nhận lương hưu cố định là $12$ triệu đồng mỗi tháng. Giả định tỷ lệ lạm phát bình quân của nền kinh tế duy trì ở mức $3","5\%$/"năm" trong suốt thời gian dài. Sau $15$ năm, sức mua thực tế của số tiền lương hưu $12$ triệu đồng đó chỉ còn tương đương với bao nhiêu tiền tại thời điểm hiện tại?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Khi kết thúc hợp đồng lao động trước hạn, một chuyên gia tài chính được công ty đề xuất hai phương án trợ cấp thôi việc:
...
// TN 7
#lt-tn(num: 7, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Hai người bạn cùng tuổi quyết định đầu tư tích lũy vào cùng một quỹ cổ phiếu với tỷ suất sinh lời bình quân $10\%$/"năm" trong suốt $30$ năm. Tuy nhiên, hai người chọn hai quỹ đầu tư khác nhau:
...
// TN 8
#lt-tn(num: 8, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một người đang nợ $3$ khoản nợ tiêu dùng cá nhân:
...
// TN 10
#lt-tn(num: 10, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một người nhận thừa kế số tiền $2$ tỷ đồng vào năm $40$ tuổi. Người đó quyết định đem toàn bộ số tiền này đầu tư vào quỹ cổ phiếu đạt tỷ suất sinh lời $11\%$/"năm" trong $20$ năm cho đến khi $60$ tuổi mà không cần nộp thêm đồng nào. Trong khi đó, một người bạn cùng tuổi không có vốn ban đầu, bắt đầu gửi đều đặn mỗi năm một khoản tiền $C$ vào cuối mỗi năm với cùng tỷ suất sinh lời $11\%$/"năm" trong $20$ năm. Để tích lũy được khối tài sản bằng đúng người nhận thừa kế ở tuổi $60$, người bạn đó phải gửi đều đặn mỗi năm bao nhiêu tiền?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 1
#lt-ds(num: 13, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một kỹ sư công nghệ $30$ tuổi xây dựng kế hoạch hưu trí cho bản thân với hai giai đoạn cuộc đời:
...
// DS 2
#lt-ds(num: 14, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một hộ gia đình có tổng thu nhập ròng ổn định là $50$ triệu đồng mỗi tháng. Họ áp dụng nguyên tắc quản lý tài chính cá nhân $50/30/20$:
...
// DS 3
#lt-ds(num: 15, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Bài toán so sánh sức mạnh thời gian của lãi kép:
...
// DS 4
#lt-ds(num: 16, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một cá nhân về hưu với quỹ tài sản $5$ tỷ đồng ($5000$ triệu đồng). Danh mục đầu tư hưu trí đem lại tỷ suất sinh lời danh nghĩa $6\%$/"năm". Năm đầu tiên người này rút $250$ triệu đồng để chi tiêu ($5\%$ danh mục ban đầu). Để duy trì mức sống không đổi, từ năm thứ hai trở đi người đó tăng số tiền rút mỗi năm thêm $4\%$ tương ứng với tỷ lệ lạm phát $4\%$/"năm".
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1
#lt-tln(num: 17, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một người muốn đạt mục tiêu tự do tài chính và nghỉ hưu sớm. Ước tính chi phí sinh hoạt hàng tháng cần thiết là $20$ triệu đồng. Áp dụng quy tắc $4\%$ (The 4% Rule), số tiền tối thiểu (tính theo đơn vị tỷ đồng) mà người đó cần tích lũy trong quỹ đầu tư hưu trí là bao nhiêu tỷ đồng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2
#lt-tln(num: 18, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một gia đình có mức chi tiêu thiết yếu cố định mỗi tháng là $18$ triệu đồng. Gia đình muốn xây dựng một quỹ dự phòng khẩn cấp tương đương đúng $6$ tháng chi phí thiết yếu. Số tiền cần có trong quỹ dự phòng khẩn cấp này là bao nhiêu triệu đồng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một người gửi tiết kiệm định kỳ $6$ triệu đồng vào cuối mỗi tháng liên tục trong $15$ năm ($180$ tháng) với lãi suất tiền gửi ổn định là $0","7\%$/"tháng" theo thể thức lãi kép. Tổng số tiền cả gốc lẫn lãi tích lũy được sau $15$ năm là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng đơn vị)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 5
#lt-tln(num: 21, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một gia đình muốn sau $15$ năm nữa ($180$ tháng) có sẵn một quỹ giáo dục $500$ triệu đồng cho con học đại học. Quỹ tích lũy đạt tỷ suất sinh lời $0","6\%$/"tháng". Hỏi vào cuối mỗi tháng gia đình cần gửi vào quỹ số tiền là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng phần trăm)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 6
#lt-tln(num: 22, de: [Đề cd02E — Mã 515], back-to: "sec-exercise-hub",[Một người nhận lương hưu cố định là $10$ triệu đồng mỗi tháng. Tỷ lệ lạm phát bình quân của nền kinh tế là $4\%$/"năm". Sau $18$ năm, sức mua thực tế của số tiền $10$ triệu đồng lương hưu tương đương với bao nhiêu triệu đồng tại thời điểm hiện tại? (làm tròn kết quả đến hàng phần trăm)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHỦ ĐỀ 2E: LẬP KẾ HOẠCH TÀI CHÍNH CÁ NHÂN & QUỸ HƯU TRÍ (VD - VDC)!]      #v(0.6em)
