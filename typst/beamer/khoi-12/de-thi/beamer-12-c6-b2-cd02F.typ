// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHỦ ĐỀ 2F: ĐỊNH GIÁ TRÁI PHIẾU & ĐỘ NHẠY LÃI SUẤT (VD - VDC)
// Lớp: Khối 12  ·  Mã đề: 516  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHỦ ĐỀ 2F: ĐỊNH GIÁ TRÁI PHIẾU & ĐỘ NHẠY LÃI SUẤT (VD - VDC)",
  subtitle: "CHUYÊN ĐỀ 2: ỨNG DỤNG TOÁN HỌC TRONG TÀI CHÍNH — MÃ ĐỀ: 516",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 516]],
...
// TN 1
#lt-tn(num: 1, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu Chính phủ có mệnh giá $F = 100$ triệu đồng, thời hạn $5$ năm, lãi suất coupon cố định là $8\%$/năm trả lãi vào cuối mỗi năm. Hiện tại, mức lợi suất đáo hạn (YTM) yêu cầu của thị trường đối với các trái phiếu có mức rủi ro tương đương là $7\%$/năm. Thị giá lý thuyết hợp lý của trái phiếu này trên thị trường là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#lt-tn(num: 2, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một doanh nghiệp phát hành trái phiếu có mệnh giá $F = 1$ tỷ đồng ($1000$ triệu đồng), kỳ hạn $3$ năm, lãi suất coupon cố định $6\%$/năm trả lãi mỗi năm một lần ($C = 60$ triệu đồng/năm). Trên thị trường tài chính, các nhà đầu tư đòi hỏi mức lợi suất đáo hạn (YTM) đối với trái phiếu doanh nghiệp này là $9\%$/năm. Giá trị hợp lý mà nhà đầu tư sẵn sàng trả để mua trái phiếu này là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu không trả lãi định kỳ (Zero-Coupon Bond) có mệnh giá $F = 100$ triệu đồng, thời hạn $5$ năm. Hiện tại trên thị trường thứ cấp, trái phiếu này đang được giao dịch với mức giá $P = 68","06$ triệu đồng. Lợi suất đáo hạn (YTM) hàng năm của trái phiếu này xấp xỉ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Xét đường cong biểu diễn mối quan hệ giữa giá trái phiếu $P$ và lợi suất đáo hạn $y$ trên đồ thị tọa độ $(y, P)$. Đặc điểm hình học cơ bản của đường cong giá trái phiếu (Bond Price-Yield Curve) là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#lt-tn(num: 5, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu Chính phủ có mệnh giá $F = 100$ triệu đồng, thời hạn $4$ năm, lãi suất coupon $8\%$/năm nhưng được thanh toán định kỳ nửa năm một lần ($6$ tháng/lần). Mức lợi suất đáo hạn tương đương trên thị trường hiện tại là $10\%$/năm (tương ứng lợi suất $5\%$ cho mỗi kỳ $6$ tháng). Giá trị hiện tại của trái phiếu này là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Xét một trái phiếu zero-coupon có thời hạn đến lúc đáo hạn là đúng $7$ năm. Thời lượng Macaulay (Macaulay Duration) của trái phiếu này bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu có mệnh giá $F = 100$ triệu đồng, lãi suất coupon $10\%$/năm trả lãi hàng năm, thời hạn $3$ năm. Hiện tại trên thị trường, lợi suất đáo hạn của trái phiếu đúng bằng $10\%$/năm (trái phiếu đang được giao dịch ngang mệnh giá $P = 100$ triệu đồng). Thời lượng Macaulay của trái phiếu này là khoảng bao nhiêu năm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một danh mục đầu tư trái phiếu có Thời lượng Macaulay là $D = 4","5$ năm. Lợi suất đáo hạn bình quân hiện tại của danh mục là $y = 8\%$/năm. Theo công thức Thời lượng điều chỉnh (Modified Duration), nếu lợi suất thị trường tăng thêm $0","5\%$ ($Delta y = +0","5\%$), thì giá trị danh mục trái phiếu sẽ biến động xấp xỉ bao nhiêu phần trăm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Trong kinh tế học tài chính, hiện tượng "Đường cong lợi suất đảo ngược" (Inverted Yield Curve) xảy ra khi lợi suất trái phiếu ngắn hạn cao hơn lợi suất trái phiếu dài hạn. Hiện tượng này thường được các chuyên gia phân tích coi là dấu hiệu báo trước đáng tin cậy cho sự kiện kinh tế nào sau đây?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu vĩnh cửu (Consol Bond) quy định mỗi năm chi trả một khoản coupon cố định là $12$ triệu đồng vào cuối mỗi năm cho người sở hữu mãi mãi mà không bao giờ hoàn trả nợ gốc. Nếu mức lợi suất yêu cầu của thị trường đối với trái phiếu này là $8\%$/năm, thị giá hiện tại của trái phiếu vĩnh cửu là bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 11
#lt-tn(num: 11, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Khi một nhà đầu tư mua một trái phiếu coupon kỳ hạn $10$ năm với mục tiêu hưởng lợi suất đáo hạn danh nghĩa $9\%$/năm, rủi ro nào sau đây có thể làm cho tỷ suất sinh lời thực tế của nhà đầu tư sau $10$ năm bị thấp hơn mức $9\%$/năm mặc dù tổ chức phát hành không hề vỡ nợ?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 1
#lt-ds(num: 13, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu Chính phủ có mệnh giá $F = 1$ tỷ đồng ($1000$ triệu đồng), kỳ hạn $10$ năm, lãi suất coupon cố định $8\%$/năm trả lãi hàng năm ($C = 80$ triệu đồng/năm). Xét sự biến động giá thị trường của trái phiếu này theo ba kịch bản lãi suất:
...
// DS 2
#lt-ds(num: 14, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một công ty quản lý quỹ đang so sánh hai trái phiếu trên thị trường:
...
// DS 3
#lt-ds(num: 15, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một quỹ hưu trí cam kết phải chi trả một khoản trợ cấp hưu trí duy nhất trị giá $2$ tỷ đồng ($2000$ triệu đồng) sau đúng $5$ năm nữa ($t = 5$). Mức lợi suất phi rủi ro trên thị trường hiện là $8\%$/năm. Quỹ dự định dùng kỹ thuật miễn dịch hóa dòng tiền (Cash flow Immunization) bằng cách đầu tư vào hai loại trái phiếu zero-coupon:
...
// DS 4
#lt-ds(num: 16, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một công ty niêm yết phát hành Trái phiếu chuyển đổi (Convertible Bond) với mệnh giá $F = 100$ triệu đồng, kỳ hạn $5$ năm, lãi suất coupon $5\%$/năm. Hợp đồng cho phép người sở hữu được quyền chuyển đổi mỗi trái phiếu thành $2000$ cổ phiếu phổ thông của công ty tại bất kỳ thời điểm nào trước khi đáo hạn.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1
#lt-tln(num: 17, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu zero-coupon có mệnh giá $F = 100$ triệu đồng, thời hạn $3$ năm. Nếu mức lợi suất đáo hạn yêu cầu trên thị trường là $7\%$/năm, thị giá hiện tại của trái phiếu này là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu có mệnh giá $F = 100$ triệu đồng, kỳ hạn $2$ năm, lãi suất coupon $10\%$/năm trả lãi hàng năm. Biết lợi suất đáo hạn yêu cầu trên thị trường là $9\%$/năm. Giá trị thị trường hợp lý của trái phiếu này là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4
#lt-tln(num: 20, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một danh mục trái phiếu có Thời lượng điều chỉnh là $D^* = 5$ năm. Nếu lợi suất thị trường giảm bớt $0","6\%$ ($Delta y = -0","6\%$), giá trị của danh mục trái phiếu này sẽ tăng thêm bao nhiêu phần trăm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 5
#lt-tln(num: 21, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu vĩnh cửu cam kết chi trả coupon cố định $15$ triệu đồng vào cuối mỗi năm cho người sở hữu mãi mãi. Nếu lợi suất yêu cầu của thị trường đối với trái phiếu này là $7","5\%$/năm, thị giá hiện tại của trái phiếu vĩnh cửu là bao nhiêu triệu đồng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 6
#lt-tln(num: 22, de: [Đề cd02F — Mã 516], back-to: "sec-exercise-hub",[Một trái phiếu zero-coupon có mệnh giá $F = 100$ triệu đồng, thời hạn đáo hạn là đúng $2$ năm. Hiện tại trên thị trường, trái phiếu này đang được bán với giá $84$ triệu đồng. Lợi suất đáo hạn (YTM) hàng năm của trái phiếu là bao nhiêu phần trăm? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHỦ ĐỀ 2F: ĐỊNH GIÁ TRÁI PHIẾU & ĐỘ NHẠY LÃI SUẤT (VD - VDC)!]      #v(0.6em)
