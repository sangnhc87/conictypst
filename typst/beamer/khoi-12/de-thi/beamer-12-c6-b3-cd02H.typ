// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHỦ ĐỀ 2H: THUÊ TÀI CHÍNH VS MUA ĐỨT & ĐIỂM HÒA VỐN (VD - VDC)
// Lớp: Khối 12  ·  Mã đề: 518  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHỦ ĐỀ 2H: THUÊ TÀI CHÍNH VS MUA ĐỨT & ĐIỂM HÒA VỐN (VD - VDC)",
  subtitle: "CHUYÊN ĐỀ 2: ỨNG DỤNG TOÁN HỌC TRONG TÀI CHÍNH — MÃ ĐỀ: 518",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 518]],
...
// TN 3
#lt-tn(num: 3, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Khi phân tích quyết định tài chính "Thuê hay Mua" (Lease-versus-Buy Decision), dòng tiền phát sinh từ hợp đồng thuê tài sản có mức độ rủi ro tương đương với dòng tiền trả nợ vay ngân hàng (do cam kết trả tiền thuê có tính chất pháp lý bắt buộc như nghĩa vụ trả nợ). Nếu lãi suất vay vốn ngân hàng trước thuế của doanh nghiệp là $r_d = 10\%$/năm và thuế suất thuế TNDN là $T_c = 20\%$, thì mức lãi suất chiết khấu sau thuế thích hợp để chiết khấu dòng tiền trong bài toán Thuê hay Mua là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#lt-tn(num: 4, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một doanh nghiệp cần một máy móc công nghiệp trị giá $500$ triệu đồng phục vụ dự án trong $3$ năm. Doanh nghiệp đang cân nhắc giữa hai phương án:
...
// TN 5
#lt-tn(num: 5, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một doanh nghiệp sản xuất bánh ngọt có các số liệu tài chính sau:
...
// TN 6
#lt-tn(num: 6, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Tại mức sản lượng tiêu thụ hiện tại là $Q = 25000$ sản phẩm/năm, doanh nghiệp đạt doanh thu $1250$ triệu đồng, tổng chi phí biến đổi là $750$ triệu đồng (số dư đảm phí là $500$ triệu đồng), chi phí cố định là $400$ triệu đồng và lợi nhuận trước lãi vay và thuế là $"EBIT" = 100$ triệu đồng. Độ bẩy hoạt động (Degree of Operating Leverage - DOL) tại mức sản lượng này bằng bao nhiêu và có ý nghĩa kinh tế gì?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#lt-tn(num: 7, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[So sánh giữa Điểm hòa vốn kế toán (Accounting Break-even) và Điểm hòa vốn tài chính (Financial Break-even) của một dự án đầu tư vốn, nhận định nào sau đây là chính xác?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 9
#lt-tn(num: 9, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Khi so sánh giữa Phương pháp Khấu hao nhanh (Accelerated Depreciation) và Phương pháp Khấu hao đường thẳng (Straight-line Depreciation) cho cùng một tài sản cố định có cùng nguyên giá và thời gian sử dụng, nhận định nào sau đây là đúng về mặt giá trị thời gian của tiền?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một dự án đầu tư có vốn đầu tư ban đầu là $300$ triệu đồng. Dự án mang lại dòng tiền ròng đều đặn là $120$ triệu đồng vào cuối mỗi năm liên tục trong $4$ năm. Biết chi phí sử dụng vốn của dự án là $10\%$/năm. Dòng tiền chiết khấu từng năm lần lượt là: Năm 1: $109","09$ triệu; Năm 2: $99","17$ triệu; Năm 3: $90","16$ triệu; Năm 4: $81","96$ triệu. Thời gian hoàn vốn có chiết khấu (Discounted Payback Period - DPP) của dự án xấp xỉ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 11
#lt-tn(num: 11, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Theo chuẩn mực kế toán và các quy tắc tài chính doanh nghiệp, một hợp đồng thuê tài sản được xếp vào loại "Thuê tài chính" (Finance Lease / Capital Lease) thay vì "Thuê hoạt động" (Operating Lease) khi thỏa mãn điều kiện nào sau đây?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 1
#lt-ds(num: 13, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một doanh nghiệp sản xuất linh kiện điện tử cần đầu tư một dây chuyền tự động hóa trị giá $1$ tỷ đồng ($1000$ triệu đồng), thời gian sử dụng $4$ năm, giá trị thanh lý ước tính sau 4 năm bằng $0$. Doanh nghiệp đang cân nhắc giữa hai phương án tài trợ:
...
// DS 2
#lt-ds(num: 14, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một doanh nghiệp xem xét dự án mở rộng xưởng sản xuất:
...
// DS 3
#lt-ds(num: 15, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một công ty đầu tư thiết bị công nghệ nguyên giá $1","2$ tỷ đồng ($1200$ triệu đồng) thời hạn sử dụng $3$ năm, giá trị thanh lý bằng $0$, thuế suất thuế TNDN là $20\%$, chi phí vốn là $10\%$/năm. Công ty so sánh hai phương pháp khấu hao:
...
// DS 4
#lt-ds(num: 16, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một dự án đầu tư nhà máy chế biến nông sản có vốn đầu tư ban đầu là $800$ triệu đồng. Dòng tiền ròng tự do dự kiến thu về trong $4$ năm hoạt động lần lượt là: Năm 1: $300$ triệu; Năm 2: $350$ triệu; Năm 3: $300$ triệu; Năm 4: $200$ triệu đồng. Chi phí sử dụng vốn của dự án là $12\%$/năm.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1
#lt-tln(num: 17, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một xưởng may áo sơ mi có chi phí cố định hàng năm là $300$ triệu đồng. Giá bán mỗi chiếc áo là $40$ nghìn đồng và chi phí biến đổi để may mỗi chiếc áo là $25$ nghìn đồng. Sản lượng hòa vốn của xưởng may là bao nhiêu nghìn sản phẩm mỗi năm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2
#lt-tln(num: 18, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một doanh nghiệp mua một máy in công nghiệp trị giá $600$ triệu đồng và thực hiện trích khấu hao đường thẳng trong thời gian $5$ năm, giá trị thanh lý ước tính bằng $0$. Biết thuế suất thuế TNDN là $20\%$. Khoản tiền tiết kiệm thuế (Lá chắn thuế từ khấu hao) mà máy in này mang lại cho doanh nghiệp trong mỗi năm là bao nhiêu triệu đồng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một công ty thuê văn phòng làm việc với chi phí tiền thuê là $200$ triệu đồng mỗi năm. Tiền thuê văn phòng được trừ toàn bộ vào thu nhập chịu thuế khi tính thuế TNDN với thuế suất $20\%$. Dòng tiền chi trả thực tế sau thuế của công ty cho khoản tiền thuê này mỗi năm là bao nhiêu triệu đồng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4
#lt-tln(num: 20, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một doanh nghiệp vay nợ ngân hàng với mức lãi suất vay trước thuế là $12\%$/năm. Biết chi phí lãi vay được tính vào chi phí hợp lý khi tính thuế TNDN và thuế suất thuế TNDN là $20\%$. Chi phí sử dụng nợ sau thuế của doanh nghiệp là bao nhiêu phần trăm mỗi năm? (làm tròn kết quả đến hàng phần mười)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 5
#lt-tln(num: 21, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Tại mức sản lượng tiêu thụ hiện tại, một công ty có tổng số dư đảm phí là $400$ triệu đồng, tổng chi phí cố định là $300$ triệu đồng (lợi nhuận trước lãi và thuế $"EBIT" = 400 - 300 = 100$ triệu đồng). Hệ số độ bẩy hoạt động (DOL) của công ty tại mức sản lượng này bằng bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 6
#lt-tln(num: 22, de: [Đề cd02H — Mã 518], back-to: "sec-exercise-hub",[Một thiết bị cơ khí đã trích khấu hao hết về giá trị sổ sách bằng $0$. Doanh nghiệp bán thanh lý thiết bị này được số tiền $80$ triệu đồng. Biết thuế suất thuế TNDN là $20\%$. Số tiền ròng sau thuế thực tế mà doanh nghiệp thu về từ việc bán thanh lý thiết bị là bao nhiêu triệu đồng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHỦ ĐỀ 2H: THUÊ TÀI CHÍNH VS MUA ĐỨT & ĐIỂM HÒA VỐN (VD - VDC)!]      #v(0.6em)
