// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: CHỦ ĐỀ 2I: TỐI ƯU HÓA DANH MỤC ĐẦU TƯ & QUẢN TRỊ RỦI RO (VD - VDC)
// Lớp: Khối 12  ·  Mã đề: 519  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "CHỦ ĐỀ 2I: TỐI ƯU HÓA DANH MỤC ĐẦU TƯ & QUẢN TRỊ RỦI RO (VD - VDC)",
  subtitle: "CHUYÊN ĐỀ 2: ỨNG DỤNG TOÁN HỌC TRONG TÀI CHÍNH — MÃ ĐỀ: 519",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 519]],
...
// TN 1
#lt-tn(num: 1, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một nhà đầu tư phân bổ vốn vào danh mục gồm hai cổ phiếu:
...
// TN 2
#lt-tn(num: 2, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một danh mục đầu tư gồm hai cổ phiếu X và Y có độ lệch chuẩn rủi ro lần lượt là $sigma_X = 15\%$ và $sigma_Y = 10\%$. Giả sử hai cổ phiếu này có hệ số tương quan nghịch đảo hoàn hảo ($rho_(X Y) = -1$). Tỷ trọng đầu tư vào cổ phiếu X ($w_X$) để rủi ro của danh mục hoàn toàn bị triệt tiêu ($sigma_p = 0$) là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#lt-tn(num: 3, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một nhà quản lý quỹ so sánh hai danh mục đầu tư trên thị trường:
...
// TN 5
#lt-tn(num: 5, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một quỹ đầu tư mạo hiểm phân tích một cổ phiếu có hệ số rủi ro hệ thống $beta = 1","2$. Lợi suất phi rủi ro là $R_f = 4\%$ và lợi suất thị trường là $E(R_m) = 11\%$ (lợi suất kỳ vọng theo CAPM là $12","4\%$/năm). Trên thực tế, qua phân tích cơ bản, quỹ dự phóng cổ phiếu này sẽ đạt tỷ suất sinh lời thực tế lên tới $15\%$/năm. Chỉ số Alpha của Jensen (Jensen's Alpha) của cổ phiếu này bằng bao nhiêu và thể hiện điều gì?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#lt-tn(num: 6, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một danh mục đầu tư gồm 3 cổ phiếu với cơ cấu phân bổ như sau:
...
// TN 7
#lt-tn(num: 7, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Khi số lượng cổ phiếu ngẫu nhiên không có tương quan hoàn hảo trong một danh mục đầu tư tăng từ $1$ lên $30$ cổ phiếu, rủi ro của danh mục sẽ biến đổi như thế nào?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#lt-tn(num: 8, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một danh mục đầu tư gồm hai cổ phiếu hoàn toàn độc lập với nhau (hệ số tương quan $rho_(A B) = 0$). Độ lệch chuẩn của cổ phiếu A là $sigma_A = 20\%$ và của cổ phiếu B là $sigma_B = 10\%$. Tỷ trọng đầu tư vào cổ phiếu A để danh mục có phương sai tối thiểu (Minimum Variance Portfolio - MVP) là
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#lt-tn(num: 10, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Khi đánh giá hiệu quả của các dự án đầu tư có dòng tiền biến động phức tạp, chỉ số Tỷ lệ hoàn vốn nội bộ điều chỉnh (MIRR - Modified Internal Rate of Return) được ưa chuộng hơn chỉ số IRR truyền thống vì
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 11
#lt-tn(num: 11, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một nhà đầu tư xây dựng danh mục mục tiêu phân bổ theo tỷ lệ $60\%$ Cổ phiếu và $40\%$ Trái phiếu. Sau một năm thị trường chứng khoán tăng trưởng mạnh, giá trị cổ phiếu tăng vọt làm cơ cấu danh mục thực tế bị lệch thành $75\%$ Cổ phiếu và $25\%$ Trái phiếu. Thao tác "Tái cân bằng danh mục" (Portfolio Rebalancing) đòi hỏi nhà đầu tư phải thực hiện hành động nào sau đây?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// DS 1
#lt-ds(num: 13, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một nhà đầu tư xây dựng danh mục đầu tư gồm hai cổ phiếu A và B với các tham số thống kê lịch sử:
...
// DS 2
#lt-ds(num: 14, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một công ty chứng khoán áp dụng Mô hình định giá tài sản vốn (CAPM) để đánh giá hai cổ phiếu X và Y trên thị trường:
...
// DS 3
#lt-ds(num: 15, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một quỹ tương hỗ quản lý danh mục cổ phiếu có tổng giá trị thị trường là $2$ tỷ đồng ($2000$ triệu đồng). Lợi suất hàng ngày của danh mục tuân theo phân phối chuẩn với độ lệch chuẩn $sigma = 1","8\%$/ngày (giả định lợi suất kỳ vọng hàng ngày $mu = 0$). Quỹ thực hiện quản trị rủi ro bằng mô hình Giá trị chịu rủi ro (Value at Risk - VaR).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1
#lt-tln(num: 17, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một cổ phiếu có hệ số rủi ro hệ thống là $beta = 1","5$. Biết mức lãi suất phi rủi ro trên thị trường là $R_f = 5\%$/năm và phần bù rủi ro thị trường là $E(R_m) - R_f = 6\%$/năm. Theo Mô hình định giá tài sản vốn (CAPM), tỷ suất sinh lời kỳ vọng của cổ phiếu này là bao nhiêu phần trăm mỗi năm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2
#lt-tln(num: 18, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một danh mục đầu tư gồm hai cổ phiếu có tỷ trọng bằng nhau ($w_A = 0","5$ và $w_B = 0","5$). Độ lệch chuẩn của hai cổ phiếu lần lượt là $sigma_A = 20\%$ và $sigma_B = 10\%$. Biết hệ số tương quan giữa hai cổ phiếu là nghịch đảo hoàn hảo ($rho = -1$). Độ lệch chuẩn rủi ro của toàn bộ danh mục đầu tư là bao nhiêu phần trăm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một danh mục đầu tư trị giá $1$ tỷ đồng ($1000$ triệu đồng) có độ lệch chuẩn lợi suất hàng ngày là $sigma = 2\%$/ngày (giả định lợi suất trung bình bằng $0$). Với mức độ tin cậy $95\%$ ($Z = 1","65$), Giá trị chịu rủi ro (Value at Risk - VaR) trong $1$ ngày của danh mục là bao nhiêu triệu đồng? (làm tròn kết quả đến hàng đơn vị)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4
#lt-tln(num: 20, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Một danh mục đầu tư có tỷ suất sinh lời kỳ vọng là $14\%$/năm và độ lệch chuẩn rủi ro là $8\%$/năm. Biết lãi suất phi rủi ro trên thị trường là $4\%$/năm. Tỷ số Sharpe (Sharpe Ratio) của danh mục đầu tư này bằng bao nhiêu? (làm tròn kết quả đến hàng phần trăm)
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 5
#lt-tln(num: 21, de: [Đề cd02I — Mã 519], back-to: "sec-exercise-hub",[Hai cổ phiếu độc lập không tương quan ($rho = 0$) có phương sai lần lượt là $sigma_1^2 = 0","09$ và $sigma_2^2 = 0","01$. Tỷ trọng tối ưu của cổ phiếu 1 trong danh mục có phương sai tối thiểu (Minimum Variance Portfolio) là bao nhiêu phần trăm?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH CHỦ ĐỀ 2I: TỐI ƯU HÓA DANH MỤC ĐẦU TƯ & QUẢN TRỊ RỦI RO (VD - VDC)!]      #v(0.6em)
