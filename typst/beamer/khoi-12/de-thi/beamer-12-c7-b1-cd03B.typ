// ═══════════════════════════════════════════════════════════════════════════
// BEAMER ĐỀ THI: ĐỀ ÔN TẬP CHUYÊN ĐỀ 3B: KỲ VỌNG TOÁN HỌC E(X) & ỨNG DỤNG RA QUYẾT ĐỊNH THỰC TIỄN
// Lớp: Khối 12  ·  Mã đề: 522  ·  GV: Nguyễn Văn Sang
...
#show: lecture-theme.with(
  title: "ĐỀ ÔN TẬP CHUYÊN ĐỀ 3B: KỲ VỌNG TOÁN HỌC E(X) & ỨNG DỤNG RA QUYẾT ĐỊNH THỰC TIỄN",
  subtitle: "CHUYÊN ĐỀ 3: BIẾN NGẪU NHIÊN RỜI RẠC & CÁC SỐ ĐẶC TRƯNG — MÃ ĐỀ: 522",
...
#slide(title: none)[
  ...
  #context {
    ...
    grid(
      ...
      pad(left: 8pt)[#text(size: 9pt, fill: s.muted, weight: "bold")[MÃ ĐỀ: 522]],
...
// TN 1
#lt-tn(num: 1, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một biến ngẫu nhiên rời rạc $X$ có bảng phân bố xác suất như sau:
#align(center)[
  #table(
    columns: 5,
    align: center,
...
// TN 2
#lt-tn(num: 2, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Cho biến ngẫu nhiên rời rạc $X$ có kỳ vọng $E(X) = 2","5$. Xét biến ngẫu nhiên mới $Y = 4 X - 3$. Kỳ vọng toán học $E(Y)$ có giá trị bằng:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 3
#lt-tn(num: 3, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một người tham gia một trò chơi may rủi bằng cách tung một đồng xu cân đối và đồng chất:
...
// TN 4
#lt-tn(num: 4, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một đợt phát hành vé số gồm $10000$ vé với giá bán $10$ nghìn đồng mỗi vé. Cơ cấu giải thưởng gồm:
...
// TN 5
#lt-tn(num: 5, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Trong lý thuyết trò chơi và toán bảo hiểm, một trò chơi may rủi được gọi là "công bằng" (Fair Game) nếu lợi nhuận ròng kỳ vọng của người chơi sau khi trừ đi chi phí mua vé tham gia bằng đúng $0$. Một trò chơi quay số có tiền thưởng kỳ vọng là $35$ nghìn đồng. Để trò chơi trở thành công bằng thì mức phí tham gia $C$ của người chơi phải bằng:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 6
#lt-tn(num: 6, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Gieo một con xúc xắc cân đối và đồng chất $6$ mặt. Gọi $X$ là số chấm xuất hiện ở mặt trên. Kỳ vọng toán học của biến ngẫu nhiên $X$ bằng:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 7
#lt-tn(num: 7, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một công ty bảo hiểm bán hợp đồng bảo hiểm tài sản thời hạn $1$ năm cho một chủ nhà với mức phí bảo hiểm là $2$ triệu đồng. Nếu trong năm xảy ra hỏa hoạn, công ty sẽ bồi thường toàn bộ thiệt hại cam kết là $400$ triệu đồng. Giả sử xác suất xảy ra hỏa hoạn đối với ngôi nhà trong năm đó là $0","002$. Lợi nhuận kỳ vọng của công ty bảo hiểm trên mỗi hợp đồng này là:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    rect((-2.5, -0.8), (2.5, 0.8), stroke: 1pt + accent, fill: rgb("f8fafc"))
...
// TN 8
#lt-tn(num: 8, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một nhân viên kinh doanh bất động sản mỗi tháng tiếp cận được $4$ khách hàng tiềm năng độc lập. Xác suất để mỗi khách hàng đồng ý ký hợp đồng mua căn hộ là $0","25$. Với mỗi hợp đồng ký thành công, nhân viên được thưởng $30$ triệu đồng hoa hồng. Số tiền hoa hồng kỳ vọng mỗi tháng của nhân viên đó bằng:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    for i in range(4) {
...
// TN 9
#lt-tn(num: 9, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Cho biến ngẫu nhiên $X$ tuân theo phân bố nhị thức $B(20; 0","35)$. Kỳ vọng toán học $E(X)$ bằng:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 10
#lt-tn(num: 10, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một biến ngẫu nhiên rời rạc $X$ có bảng phân bố xác suất chứa tham số $m$:
#align(center)[
  #table(
    columns: 4,
    align: center,
...
// TN 11
#lt-tn(num: 11, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một doanh nghiệp đang xem xét đầu tư vào một dự án kinh doanh mới trong thời hạn $1$ năm. Đội ngũ phân tích tài chính dự báo ba kịch bản thị trường có thể xảy ra:
...
// TN 12
#lt-tn(num: 12, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một máy móc có hai bộ phận $A$ và $B$ hoạt động độc lập với nhau. Trong một ca sản xuất, xác suất bị hỏng của bộ phận $A$ là $0","1$ và của bộ phận $B$ là $0","15$. Chi phí sửa chữa khi bộ phận $A$ bị hỏng là $400$ nghìn đồng, và khi bộ phận $B$ bị hỏng là $600$ nghìn đồng. Chi phí sửa chữa kỳ vọng của máy móc trong một ca sản xuất bằng:
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// DS 1
#lt-ds(num: 13, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một cửa hàng kinh doanh đồ điện tử thống kê số lượng máy tính bảng bán được trong một ngày (ký hiệu là biến ngẫu nhiên $X$) trong suốt một năm qua và thu được bảng phân bố xác suất như sau:
#align(center)[
  #table(
    columns: 6,
    align: center,
...
// DS 2
#lt-ds(num: 14, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một công ty xây dựng nộp hồ sơ tham gia đấu thầu hai gói thầu dự án độc lập $A$ và $B$.
...
// DS 4
#lt-ds(num: 16, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Cho hai biến ngẫu nhiên rời rạc $X$ và $Y$ độc lập với nhau. Biết bảng phân bố xác suất của $X$ và $Y$ lần lượt là:
#align(center)[
  #grid(
    columns: 2,
    gutter: 20pt,
...
// TLN 1
#lt-tln(num: 17, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một biến ngẫu nhiên rời rạc $X$ có bảng phân bố xác suất như sau:
#align(center)[
  #table(
    columns: 6,
    align: center,
...
// TLN 3
#lt-tln(num: 19, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Cho biến ngẫu nhiên $X$ có kỳ vọng $E(X) = 3","6$. Xét biến ngẫu nhiên $Y = 5 X - 8$. Tính kỳ vọng $E(Y)$ (kết quả viết dưới dạng số thập phân).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TLN 4
#lt-tln(num: 20, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một công ty khai khoáng tiến hành khảo sát $3$ mỏ quặng độc lập. Trữ lượng quặng ước tính nếu có của mỗi mỏ lần lượt là $100$ nghìn tấn, $150$ nghìn tấn và $200$ nghìn tấn. Xác suất tìm thấy quặng ở ba mỏ đó lần lượt là $0","3$; $0","4$ và $0","2$. Tính tổng trữ lượng quặng kỳ vọng mà công ty có thể khai thác được từ cả ba mỏ (đơn vị: nghìn tấn).
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    for i in range(3) {
...
// TLN 5
#lt-tln(num: 21, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Ban tổ chức một hội chợ triển lãm thiết kế trò chơi ném phi tiêu trúng thưởng. Cơ cấu giải thưởng cho mỗi lượt chơi gồm:
...
// TLN 6
#lt-tln(num: 22, de: [Đề cd03B — Mã 522], back-to: "sec-exercise-hub",[Một kiện hàng gồm $20$ sản phẩm máy tính xách tay, trong đó có $4$ sản phẩm có lỗi nhẹ ở vỏ ngoài. Nhân viên kiểm tra chất lượng chọn ngẫu nhiên đồng thời $5$ sản phẩm từ kiện hàng đó. Gọi $X$ là số sản phẩm bị lỗi vỏ tìm thấy trong mẫu kiểm tra. Tính kỳ vọng toán học $E(X)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
#slide(title: none)[
  #align(center + horizon)[
    #block(
      ...
      #text(weight: "bold", fill: rgb("#a5b4fc"), size: 22pt)[🎉 CHÚC MỪNG HOÀN THÀNH ĐỀ ÔN TẬP CHUYÊN ĐỀ 3B: KỲ VỌNG TOÁN HỌC E(X) & ỨNG DỤNG RA QUYẾT ĐỊNH THỰC TIỄN!]      #v(0.6em)
