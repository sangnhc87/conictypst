...
#casio-exam-render(
  ...
  exam-name: "KỲ THI CHỌN HỌC SINH GIỎI TP HỒ CHÍ MINH",
  subject: "Môn thi: TOÁN 12 THPT (SỬ DỤNG MTCT)",
  time: "120 phút",
  year: "2025 - 2026",
  show-solution: true,
  casio-question(
    ...
    solution: [
      ...
      #align(center)[
        #cetz.canvas(length: 2cm, {
          import cetz.draw: *
          circle((0,0), radius: 1, stroke: luma(200))
          line((-1.5, 0), (1.5, 0), mark: (end: ">"), stroke: gray)
          line((0, -1.5), (0, 1.5), mark: (end: ">"), stroke: gray)
          content((1.4, -0.2), text(fill: gray, $x$))
          content((-0.2, 1.4), text(fill: gray, $y$))
          
          let p1 = (calc.cos(22.5deg), calc.sin(22.5deg))
          let p2 = (calc.cos(112.5deg), calc.sin(112.5deg))
          let p3 = (calc.cos(135deg), calc.sin(135deg))
          let p4 = (calc.cos(202.5deg), calc.sin(202.5deg))
          let p5 = (calc.cos(292.5deg), calc.sin(292.5deg))
          let p6 = (calc.cos(315deg), calc.sin(315deg))
          
          line(p1, p2, p3, p4, p5, p6, close: true, stroke: 1pt + rgb("#c62828"), fill: rgb("#c62828").lighten(80%))
          
          circle(p1, radius: 0.04, fill: rgb("#c62828"))
          content((p1.at(0) + 0.2, p1.at(1) + 0.1), text(8pt, $pi/8$))
          circle(p2, radius: 0.04, fill: rgb("#c62828"))
          content((p2.at(0) + 0.0, p2.at(1) + 0.2), text(8pt, $5pi/8$))
          circle(p3, radius: 0.04, fill: rgb("#c62828"))
          content((p3.at(0) - 0.2, p3.at(1) + 0.15), text(8pt, $3pi/4$))
          circle(p4, radius: 0.04, fill: rgb("#c62828"))
          content((p4.at(0) - 0.2, p4.at(1) - 0.15), text(8pt, $9pi/8$))
          circle(p5, radius: 0.04, fill: rgb("#c62828"))
          content((p5.at(0) + 0.0, p5.at(1) - 0.2), text(8pt, $13pi/8$))
          circle(p6, radius: 0.04, fill: rgb("#c62828"))
          content((p6.at(0) + 0.25, p6.at(1) - 0.1), text(8pt, $7pi/4$))
        })
      ]
    ]
  )[
