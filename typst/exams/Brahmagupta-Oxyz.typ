...
#tln(
  ...
  fig: align(center)[
    #cetz.canvas(length: 0.9cm, {
      ...
      content((cx + 0.2, htop + 1.1), text(weight: "bold")[$z$])
...
#tln(
  ...
  fig: align(center)[
    #cetz.canvas(length: 0.9cm, {
      ...
      content((cx + 0.3, htop + 1.2), text(weight: "bold")[${z}$])
