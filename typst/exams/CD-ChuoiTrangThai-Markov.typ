...
#set page(
  header: context {
    set text(size: 8.5pt, fill: rgb("0a3629"))
    grid(
      columns: (1fr, auto),
      [Chuyên Đề Toán 12 — Chuỗi Trạng Thái & Chuỗi Markov],
      [GV Nguyễn Văn Sang · 0389.821.115],
    )
    v(-4pt)
    line(length: 100%, stroke: 0.6pt + rgb("1A936F"))
  },
  footer: context {
    set text(size: 9pt, fill: rgb("0a3629"))
    grid(
      columns: (1fr, auto),
      [],
