...
#set page(
  header: context {
    set text(size: 8.5pt, fill: col-navy)
    grid(
      columns: (1fr, auto),
      [Chuyên Đề Tọa Độ Hóa Chuyển Động & Cảm Biến Tiệm Cận], [GV Nguyễn Văn Sang · 0389.821.115],
    )
    v(-4pt)
    line(length: 100%, stroke: 0.6pt + rgb("90CAF9"))
  },
  footer: context {
    set text(size: 9pt, fill: col-navy)
    grid(
      columns: (1fr, auto),
