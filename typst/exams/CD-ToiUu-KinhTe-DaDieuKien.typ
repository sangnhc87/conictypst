...
#set page(
  header: context {
    set text(size: 8.5pt, fill: col-teal)
    grid(
      columns: (1fr, auto),
      [Chuyên Đề Tối Ưu Hóa & Mô Hình Hóa Kinh Tế Đa Điều Kiện], [GV Nguyễn Văn Sang · 0389.821.115],
    )
    v(-4pt)
    line(length: 100%, stroke: 0.6pt + col-teal.lighten(50%))
  },
  footer: context {
    set text(size: 9pt, fill: col-teal)
    grid(
      columns: (1fr, auto),
