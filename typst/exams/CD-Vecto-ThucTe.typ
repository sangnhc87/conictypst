...
#tln(
  ...
  fig: cetz.canvas(length: 1cm, {
    ...
    arc(O, radius: 0.8, start: 0deg, stop: 60deg)
    content((1, 0.4), [ $60^o$ ])
  }),
  loigiai: [
...
#tln(
  ...
  fig: cetz.canvas(length: 1cm, {
    ...
    arc(O, radius: 0.6, start: 18.4deg, stop: 111.8deg) 
...
#tln(
  [Một tàu ngầm xuất phát từ tọa độ $A(100, 200, 0)$ trên mặt nước biển (mặt phẳng $O x y$, trục $O z$ hướng thẳng đứng lên trời, cao độ dương). Thuyền trưởng xả nước vào các khoang để tàu lặn chìm dần, đồng thời kích hoạt chân vịt. Chân vịt sinh ra một vận tốc tự thân $arrow(v)_t = (10, 15, -5)$ (m/s). Đồng thời, tại vùng biển này có một dòng hải lưu tác động một lực đẩy làm tăng thêm vận tốc trôi dạt $arrow(v)_h = (-2, 5, 0)$. Hãy tính tọa độ của tàu ngầm $B$ sau $30$ giây lặn, giả sử hệ thống vận tốc tổng hợp không đổi trong suốt quá trình và quỹ đạo lặn là một đường thẳng.],
  [$B(340, 800, -150)$],
  fig: cetz.canvas(length: 1cm, {
    import cetz.draw: *
    let A = (0, 3)
