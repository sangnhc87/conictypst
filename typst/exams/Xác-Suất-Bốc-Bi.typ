  ...
  loigiai: [
    ...
    #align(center)[
      #cetz.canvas(length: 1cm, {
        import cetz.draw: *
        // Nút gốc
        content((0, 0), box(stroke: 1pt, inset: 6pt, radius: 3pt, fill: rgb("fff5f5"))[*Lượt 1* \ Lấy 2 bi từ Hộp I \ (Tổng 21 cách)], name: "root")
    ...
    #align(center)[
      #cetz.canvas(length: 1.1cm, {
        ...
        for i in range(5) {
          ...
          // Nhánh Lượt 1
          content((3, Y.at(i)), box(stroke: 1pt + l1-color, inset: 4pt, radius: 2pt, fill: rgb("f8fafc"))[*TH#(i+1):* #L1.at(i)], name: "T" + str(i))
          ...
          let fe-stroke = if i > 2 { (paint: red, dash: "dashed", thickness: 1.5pt) } else { (paint: fe-color, thickness: 1.2pt) }
          
          content((10, Y.at(i)), box(stroke: 1pt + fe-color, fill: white, inset: 4pt, radius: 2pt)[$#PFE.at(i)$], name: "F" + str(i))
          line("E" + str(i), "F" + str(i), mark: (end: ">"), stroke: fe-stroke, name: "f" + str(i))
          
          if i > 2 {
            content("f" + str(i) + ".mid", text(fill: red, weight: "bold", size: 14pt)[$times$], anchor: "south", padding: 2pt)
          }
        }
      })
    ]
    ...
    *Sơ đồ cây biểu diễn xác suất:*
    #align(center)[
      #cetz.canvas(length: 1.2cm, {
        ...
        // Nhánh Hộp
        content((3, 2), box(stroke: 1pt + rgb("0057b8"), fill: rgb("f0f6ff"), inset: 6pt, radius: 3pt)[*Hộp A* \ (3Đ, 4X)], name: "A")
        line("root", "A", mark: (end: ">"), stroke: rgb("0057b8"), name: "eA")
        content("eA.mid", text(fill: rgb("0057b8"))[$1/3$], anchor: "south-east", padding: 2pt)
        
        content((3, -2), box(stroke: 1pt + rgb("1a7a2e"), fill: rgb("f0fdf4"), inset: 6pt, radius: 3pt)[*Hộp B* \ (5Đ, 2X)], name: "B")
  ...
  loigiai: [
    ...
    #align(center)[
      #cetz.canvas(length: 1cm, {
        ...
        // Nhánh Hộp
        content((3, 2.5), box(stroke: 1pt + rgb("0057b8"), fill: rgb("f0f6ff"), inset: 6pt, radius: 3pt)[*Hộp I* \ $1/6$], name: "H1")
        line("root", "H1", mark: (end: ">"), stroke: rgb("0057b8"), name: "e1")

        content((3, 0), box(stroke: 1pt + rgb("1a7a2e"), fill: rgb("f0fdf4"), inset: 6pt, radius: 3pt)[*Hộp II* \ $1/3$], name: "H2")
        line("root", "H2", mark: (end: ">"), stroke: rgb("1a7a2e"), name: "e2")

        content((3, -2.5), box(stroke: 1.5pt + rgb("d81b60"), fill: rgb("fdf2f8"), inset: 6pt, radius: 3pt)[*Hộp III* \ $1/2$], name: "H3")
        line("root", "H3", mark: (end: ">"), stroke: 1.5pt + rgb("d81b60"), name: "e3")

        // Hàm vẽ nhánh phụ
        let draw-sub(name, y-base, p-E, p-F, E-val, E-color, stroke-w: 1pt) = {
          content((6.5, y-base + 0.8), box(fill: rgb("f1f5f9"), inset: 4pt, radius: 2pt)[Cùng màu ($E$)], name: name + "E")
          ...
          content((6.5, y-base - 0.8), box(fill: rgb("fff1f2"), inset: 4pt, radius: 2pt)[Khác màu ($F$)], name: name + "F")
...
#ds(
  ...
  (
    ...
    True([Giả sử có hai người dân độc lập với nhau cùng đi xét nghiệm và đều nhận kết quả dương tính. Xác suất để cả hai người này đều thực sự mắc bệnh xấp xỉ bằng $0,15$ (làm tròn đến hai chữ số thập phân).])
  ),
    ...
    *Ta xây dựng Sơ đồ cây xác suất:*
    #align(center)[
      #cetz.canvas(length: 1.3cm, {
        ...
        // Nút gốc
        content((0, 0), box(stroke: 1.5pt + rgb("475569"), inset: 6pt, radius: 3pt, fill: rgb("f8fafc"))[*Người dân*], name: "root")
        ...
        // --- Nhánh 1: Bệnh ---
        content((2.5, Y.at(0)), box(stroke: 1pt + rgb("cc2200"), fill: rgb("fef2f2"), inset: 4pt, radius: 3pt)[#L1.at(0)], name: "B")
        ...
        content((7, Y.at(0) - 0.8), box(fill: rgb("f1f5f9"), inset: 4pt, radius: 2pt)[Âm tính ($overline(T)$)], name: "BT_bar")
        ...
        // --- Nhánh 2: Không Bệnh ---
        content((2.5, Y.at(1)), box(stroke: 1pt + rgb("1a7a2e"), fill: rgb("f0fdf4"), inset: 4pt, radius: 3pt)[#L1.at(1)], name: "B_bar") 
        line("root", "B_bar", mark: (end: ">"), stroke: rgb("1a7a2e"))
        content((1.2, -1.3), text(fill: rgb("1a7a2e"))[$#P1.at(1)$], angle: -30deg)
        
        // Test từ Không Bệnh
        content((7, Y.at(1) + 0.8), box(fill: rgb("fff1f2"), stroke: 1pt+rgb("f57c00"), inset: 4pt, radius: 2pt)[Dương tính ($T$)], name: "B_barT")
        ...
        content((7, Y.at(1) - 0.8), box(fill: rgb("f1f5f9"), inset: 4pt, radius: 2pt)[Âm tính ($overline(T)$)], name: "B_barT_bar")
  ...
  loigiai: [
    ...
    #align(center)[
      #cetz.canvas(length: 1cm, {
        ...
        // Nhánh Hộp
        content((3, 2), box(stroke: 1pt + rgb("0057b8"), fill: rgb("f0f6ff"), inset: 6pt, radius: 3pt)[*H1* ($1/3$)], name: "H1")
        line("root", "H1", mark: (end: ">"), stroke: rgb("0057b8"))

        content((3, 0), box(stroke: 1pt + rgb("1a7a2e"), fill: rgb("f0fdf4"), inset: 6pt, radius: 3pt)[*H2* ($1/3$)], name: "H2")
        line("root", "H2", mark: (end: ">"), stroke: rgb("1a7a2e"))

        content((3, -2), box(stroke: 1pt + rgb("d81b60"), fill: rgb("fdf2f8"), inset: 6pt, radius: 3pt)[*H3* ($1/3$)], name: "H3")
  ...
  loigiai: [
    ...
    #align(center)[
      #cetz.canvas(length: 1.1cm, {
        ...
        // Nhánh Hộp
        content((3, 2.5), box(stroke: 1pt + rgb("0057b8"), fill: rgb("f0f6ff"), inset: 6pt, radius: 3pt)[*Hộp I* \ $1/2$], name: "H1")
        line("root", "H1", mark: (end: ">"), stroke: rgb("0057b8"))

        content((3, 0), box(stroke: 1pt + rgb("1a7a2e"), fill: rgb("f0fdf4"), inset: 6pt, radius: 3pt)[*Hộp II* \ $1/3$], name: "H2")
        line("root", "H2", mark: (end: ">"), stroke: rgb("1a7a2e"))

        content((3, -2.5), box(stroke: 1pt + rgb("d81b60"), fill: rgb("fdf2f8"), inset: 6pt, radius: 3pt)[*Hộp III* \ $1/6$], name: "H3")
        line("root", "H3", mark: (end: ">"), stroke: rgb("d81b60"))
...
#tln(
  ...
  fig: cetz.canvas(length: 1cm, {
    ...
    // Mũi tên chuyển bi
    bezier((2.8, 1.5), (5.2, 1.5), (4, 2.2), mark: (end: ">"), stroke: (paint: rgb("0057b8"), thickness: 1.2pt, dash: "dashed"))
    content((4, 2.1), text(size: 9pt)[Mặt Chẵn (A $->$ B)], fill: rgb("0057b8"))
    
    bezier((5.2, 0.5), (2.8, 0.5), (4, -0.2), mark: (end: ">"), stroke: (paint: rgb("1a7a2e"), thickness: 1.2pt, dash: "dashed"))
    ...
    *Sơ đồ cây tổng quát (chỉ vẽ các nhánh dẫn tới bốc được bóng Đỏ):*
    #align(center)[
      #cetz.canvas(length: 1cm, {
        ...
        // Tầng 1
        content((3, 2.5), box(stroke: 1pt + rgb("0057b8"), fill: rgb("f0f6ff"), inset: 6pt, radius: 3pt)[*Mặt Chẵn* ($1/2$)], name: "C")
        line("root", "C", mark: (end: ">"), stroke: rgb("0057b8"))

        content((3, -2.5), box(stroke: 1pt + rgb("1a7a2e"), fill: rgb("f0fdf4"), inset: 6pt, radius: 3pt)[*Mặt Lẻ* ($1/2$)], name: "L")
...
#ds(
  ...
  (
    ...
    True([Giả sử MC mở mắt cho người chơi và thông báo: "Bạn đã bốc được $2$ quả bóng cùng màu". Xác suất để $2$ quả bóng đó được bốc ra từ Hộp I là $1/3$.])
  ),
  fig: cetz.canvas(length: 1.1cm, {
    import cetz.draw: *
    ...
    *Sơ đồ cây (tóm tắt các nhánh Cùng màu $C$ và Khác màu $K$, đồng thời tách riêng $2 "Đỏ"$ để trả lời câu hỏi b):*
    #align(center)[
      #cetz.canvas(length: 1.1cm, {
        ...
        content((3, -3), box(stroke: 1pt + rgb("d81b60"), fill: rgb("fdf2f8"), inset: 6pt)[*Hộp III* ($1/6$)], name: "H3")
        line("root", "H3", mark: (end: ">"), stroke: rgb("d81b60"))
...
#ds(
  ...
  (
    ...
    True([Giả sử một nhân viên mở thư mục Spam và đọc ngẫu nhiên một email, xác suất để email đó thực chất là thư công việc bình thường bị nhận diện nhầm xấp xỉ $7,3%$.]),
    ...
    *Sơ đồ cây xác suất:*
    #align(center)[
      #cetz.canvas(length: 1cm, {
        ...
        content((3, -2), box(stroke: 1pt + rgb("10b981"), fill: rgb("ecfdf5"), inset: 6pt)[*Bình thường* ($0,6$)], name: "B")
    ...
    *Sơ đồ cây rút gọn (nhánh dẫn đến biến cố K):*
    #align(center)[
      #cetz.canvas(length: 1.1cm, {
        ...
        content((3, 0), box(stroke: 1pt + rgb("ca8a04"), fill: rgb("fefce8"), inset: 6pt)[*Rương Vàng* ($2/8$)], name: "H2")
...
#tln(
  ...
  fig: cetz.canvas(length: 1cm, {
    ...
    content((0.9*calc.cos(180deg), 0.9*calc.sin(180deg)), text(weight: "bold", fill: rgb("9a3412"), size: 9pt)[ĐỒNG])
    ...
    line((r*calc.cos(54deg)+0.1, r*calc.sin(54deg)), (3.3, 2.1), mark: (end: ">"), stroke: (paint: rgb("a16207"), dash: "dashed"))
    line((r+0.1, 0), (3.3, 0), mark: (end: ">"), stroke: (paint: rgb("c2410c"), dash: "dashed"))
    line((r*calc.cos(324deg)+0.1, r*calc.sin(324deg)), (3.3, -1.9), mark: (end: ">"), stroke: (paint: rgb("64748b"), dash: "dashed"))
  }),
  fig-pos: "center",
  loigiai: [
    #ppgiai[
    ...
    *Sơ đồ cây rút gọn (Nhánh dẫn đến kết quả Cùng loại $K$):*
    #align(center)[
      #cetz.canvas(length: 1.1cm, {
        ...
        content((3, 2), box(stroke: 1pt + rgb("a16207"), fill: rgb("fefce8"), inset: 6pt)[*Rương Vàng* ($2/10$)], name: "V")
        line("root", "V", mark: (end: ">"), stroke: rgb("a16207"))

        content((3, 0), box(stroke: 1pt + rgb("c2410c"), fill: rgb("fff7ed"), inset: 6pt)[*Rương Đồng* ($5/10$)], name: "D")
        line("root", "D", mark: (end: ">"), stroke: rgb("c2410c"))

        content((3, -2), box(stroke: 1pt + rgb("64748b"), fill: rgb("f8fafc"), inset: 6pt)[*Rương Bạc* ($3/10$)], name: "B")
