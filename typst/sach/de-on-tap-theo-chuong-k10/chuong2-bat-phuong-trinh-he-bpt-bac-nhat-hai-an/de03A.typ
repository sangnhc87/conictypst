...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 3: BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 1)",
  subject: "TOÁN",
...
#tn([Sau khi rút gọn, bất phương trình nào sau đây trở thành bất phương trình bậc nhất hai ẩn?],
    (
        [$(x + y)^2 - x^2 <= 4$],
        True([$(x + 1)^2 - x^2 + 2y <= 5$]),
        [$(x + 1)(y - 1) > 2$],
...
#tn([Cặp số $(x; y) = (1/2; -1/3)$ là nghiệm của bất phương trình nào sau đây?],
    (
        [$2x + 3y > 1$],
        [$4x - 6y - 5 >= 0$],
        True([$6x + 9y + 1 >= 0$]),
...
#tn([Cho bất phương trình $2x - 3y > 0$. Miền nghiệm của bất phương trình chứa điểm nào sau đây?],
    (
        [$O(0; 0)$],
        [$M(1; 1)$],
        True([$N(3; 1)$]),
...
#tn([Miền nghiệm của bất phương trình $y >= -2$ trên mặt phẳng tọa độ $O x y$ là:],
    (
...
#tn([Bất phương trình $(x - y)/2 <= (2x + y - 1)/3$ tương đương với bất phương trình nào sau đây?],
    (
        [$x + 5y - 2 <= 0$],
        True([$x + 5y - 2 >= 0$]),
        [$-x + 5y - 2 >= 0$],
...
#tn([Khoảng cách từ gốc tọa độ $O(0;0)$ đến đường thẳng bờ của bất phương trình $3x + 4y - 10 <= 0$ bằng:],
    (
        [$1$],
        True([$2$]),
        [$5$],
...
#tn([Cho bất phương trình $x - 2y + 3 > 0$. Điểm $A(1; 3)$ có điểm đối xứng qua trục hoành $O x$ là $A'$. Khẳng định nào sau đây đúng?],
    (
...
#tn([Góc phần tư thứ II trên mặt phẳng $O x y$ ($x < 0, y > 0$) chứa điểm nào sau đây thuộc miền nghiệm của bất phương trình $2x + y + 5 > 0$?],
    (
        [$(-4; 1)$],
        [$(-3; 0)$],
        True([$(-1; 2)$]),
...
#tn([Một cơ sở chuẩn bị các giỏ quà Tết gồm hai loại bánh: bánh quy (giá 60 nghìn đồng/hộp) và bánh socola (giá 90 nghìn đồng/hộp). Mỗi giỏ quà có ngân sách tối đa 450 nghìn đồng cho bánh. Gọi $x, y$ lần lượt là số hộp bánh quy và bánh socola trong một giỏ ($x, y in NN$). Bất phương trình mô tả giới hạn ngân sách là:],
    (
        [$3x + 2y <= 15$],
        True([$2x + 3y <= 15$]),
        [$2x + 3y >= 15$],
...
// TN 11: Tham số m
#tn([Tìm tất cả các giá trị của tham số $m$ để cặp số $(m; m - 1)$ là nghiệm của bất phương trình $2x - y + 3 <= 0$.],
    (
        [$m >= -4$],
        True([$m <= -4$]),
        [$m <= 4$],
...
#tn([Tìm điều kiện của tham số $m$ để bất phương trình $(m^2 - 1)x^2 + 2x - 3y + 1 >= 0$ là bất phương trình bậc nhất hai ẩn.],
    (
        [$m != 1$],
        [$m != -1$],
        True([$m = 1$ hoặc $m = -1$]),
...
// DS 1
#ds([Cho bất phương trình bậc nhất hai ẩn $3x - 4y + 12 >= 0$ và hai điểm $A(0; 4), B(-2; 1)$. Xét tính đúng sai của các phát biểu sau:],
  (
...
// DS 2
#ds([Cho hình vẽ biểu diễn miền nghiệm của một bất phương trình trên mặt phẳng tọa độ $O x y$ (phần không bị gạch, kể cả bờ):
#draw_bpt(
  a: 1,
  b: -2,
  c: 2,
...
// DS 3
#ds([Một thuê bao di động sử dụng gói cước trả trước: cước gọi nội mạng là $1$ nghìn đồng/phút và cước dung lượng 4G là $5$ nghìn đồng/GB. Khách hàng nạp vào tài khoản $100$ nghìn đồng. Gọi $x$ là số phút gọi nội mạng và $y$ là số GB dung lượng 4G đã sử dụng trong tháng ($x, y in NN$).],
  (
...
// DS 4
#ds([Cho bất phương trình $(m + 2)x + (2m - 1)y - 5 <= 0$ (với $m$ là tham số). Xét tính đúng sai của các mệnh đề sau:],
  (
...
#tln([Cho bất phương trình $2x + 3y <= 12$. Có tất cả bao nhiêu cặp số nguyên không âm $(x; y)$ thỏa mãn bất phương trình trên?],
    [19],
    loigiai: [
...
#tln([Cho tam giác $A B C$ có tọa độ các đỉnh là $A(1; 2), B(3; 0), C(0; 4)$. Có bao nhiêu đỉnh của tam giác $A B C$ thuộc miền nghiệm của bất phương trình $x + 2y - 5 <= 0$?],
    [2],
    loigiai: [
...
#tln([Một xưởng bánh Trung thu sản xuất bánh nướng và bánh dẻo. Lượng bột đường dự trữ là $45$ kg. Mỗi chiếc bánh nướng cần $0.3$ kg bột, mỗi chiếc bánh dẻo cần $0.2$ kg bột. Nếu xưởng dự định làm ít nhất 50 chiếc bánh dẻo thì xưởng có thể làm tối đa bao nhiêu chiếc bánh nướng?],
    [116],
    loigiai: [
...
#tln([Tìm giá trị nguyên dương nhỏ nhất của tham số $m$ để cả hai điểm $A(1; 1)$ và $B(2; 3)$ đều thuộc miền nghiệm của bất phương trình $m x - y + 2 >= 0$.],
    [1],
    loigiai: [
...
#tln([Đường thẳng bờ $d: 4x + 3y = 24$ cùng với hai trục tọa độ $O x, O y$ tạo thành một tam giác vuông. Tính diện tích của tam giác vuông đó.],
    [24],
    loigiai: [
...
#tln([Có tất cả bao nhiêu cặp số nguyên $(x; y)$ thỏa mãn đồng thời bất phương trình $x + y <= 3$ với $x in [0; 3]$ và $y in [0; 3]$?],
    [10],
    loigiai: [
