...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 3: BẤT PHƯƠNG TRÌNH BẬC NHẤT HAI ẨN (ĐỀ SỐ 3)",
  subject: "TOÁN",
...
#tn([Cặp số $(a; b)$ nào sau đây làm cho bất phương trình $(a - 1)x + (b + 2)y + 5 <= 0$ KHÔNG PHẢI là bất phương trình bậc nhất hai ẩn?],
    (
        [$(1; 2)$],
        [$(-1; -2)$],
        True([$(1; -2)$]),
...
#tn([Bất phương trình đường phân giác của góc phần tư thứ nhất và thứ ba $x - y >= 0$ có miền nghiệm chứa điểm nào sau đây?],
    (
        [$A(1; 3)$],
        [$B(-2; 1)$],
        True([$C(2; 1)$]),
...
#tn([Miền nghiệm của bất phương trình $|x| <= 2$ trên mặt phẳng tọa độ $O x y$ là:],
    (
...
#tn([Có bao nhiêu điểm có tọa độ nguyên $(x; y)$ thỏa mãn $x^2 + y^2 <= 1$ thuộc miền nghiệm của bất phương trình $3x - 4y + 5 < 0$?],
    (
        True([$0$]),
        [$1$],
        [$2$],
...
#tn([Cho hai điểm $A(1; 2)$ và $B(m; 1)$. Tìm tất cả các giá trị của tham số $m$ để đoạn thẳng $A B$ KHÔNG CẮT đường thẳng $d: x + y - 4 = 0$.],
    (
        [$m > 3$],
        True([$m < 3$]),
        [$m <= 3$],
...
#tn([Đường thẳng bờ $d: a x + b y = 6$ đi qua hai điểm $M(2; 0)$ và $N(0; 3)$. Tổng $a + b$ bằng:],
    (
        [$3$],
        [$4$],
        True([$5$]),
...
#tn([Bất phương trình nào sau đây có miền nghiệm là nửa mặt phẳng KHÔNG CHỨA gốc tọa độ $O(0;0)$?],
    (
        [$2x - y + 3 >= 0$],
        [$x + 4y - 1 < 0$],
        True([$3x + 2y - 6 > 0$]),
...
#tn([Trong mặt phẳng $O x y$, hình vuông đơn vị có 4 đỉnh $O(0;0), A(1;0), B(1;1), C(0;1)$ nằm hoàn toàn trong miền nghiệm của bất phương trình nào sau đây?],
    (
        [$2x + y - 4 > 0$],
        True([$x + y - 3 <= 0$]),
        [$x - 2y + 1 < 0$],
...
#tn([Một hộ gia đình lắp đặt hệ thống năng lượng tái tạo gồm pin mặt trời (mỗi tấm công suất $0.5$ kW) và tuabin gió mini (mỗi tuabin công suất $1.5$ kW). Gia đình muốn tổng công suất đạt tối thiểu $15$ kW. Gọi $x, y$ lần lượt là số tấm pin và số tuabin gió ($x, y in NN$). Bất phương trình mô tả điều kiện công suất là:],
    (
        [$3x + y >= 30$],
        True([$x + 3y >= 30$]),
        [$x + 3y <= 30$],
...
#tn([Bất phương trình bậc nhất hai ẩn $a x + b y <= c$ có đường thẳng bờ đi qua gốc tọa độ $O(0;0)$ khi và chỉ khi:],
    (
        [$a = 0$],
        [$b = 0$],
        True([$c = 0$]),
...
#tn([Tìm tất cả các giá trị của tham số $m$ để miền nghiệm của bất phương trình $x + (m - 1)y <= 2$ chứa đồng thời cả hai điểm $O(0;0)$ và $A(1; 1)$.],
    (
        [$m >= 2$],
        True([$m <= 2$]),
        [$m <= 1$],
...
#ds([Cho bất phương trình bậc nhất hai ẩn $x - y + 2 >= 0$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#ds([Cho hình vẽ biểu diễn miền nghiệm của một bất phương trình trên mặt phẳng tọa độ $O x y$ (phần không bị gạch chéo, kể cả bờ):
#draw_bpt(
  a: 1,
  b: 2,
  c: -4,
...
#ds([Một dự án trồng rừng phủ xanh đồi trọc gồm hai loại cây: cây keo lai (chi phí $20$ nghìn đồng/cây, hấp thụ $15$ kg $"CO"_2$/năm) và cây bạch đàn (chi phí $30$ nghìn đồng/cây, hấp thụ $20$ kg $"CO"_2$/năm). Ban quản lý dự án có ngân sách tối đa $60$ triệu đồng ($60000$ nghìn đồng) cho cây giống. Gọi $x$ là số cây keo lai và $y$ là số cây bạch đàn ($x, y in NN$).],
  (
...
#ds([Cho họ đường thẳng bờ $(m + 1)x + (m - 2)y - 3m = 0$ (với $m$ là tham số). Xét tính đúng sai của các mệnh đề sau:],
  (
...
#tln([Cho tam giác $O A B$ có ba đỉnh là $O(0;0), A(6;0), B(0;4)$. Có tất cả bao nhiêu điểm có tọa độ nguyên $(x; y) in NN^*$ nằm nghiêm ngặt phía trong tam giác $O A B$?],
    [7],
    loigiai: [
...
#tln([Cho các số tự nhiên $x, y$ thỏa mãn bất phương trình $x + y <= 5$. Tìm giá trị lớn nhất của biểu thức $F(x, y) = 3x + 2y$.],
    [15],
    loigiai: [
...
#tln([Một xưởng chế biến cà phê phối trộn hai loại: Robusta (giá $80$ nghìn đồng/kg) và Arabica (giá $120$ nghìn đồng/kg). Một khách hàng có ngân sách tối đa $1.2$ triệu đồng ($1200$ nghìn đồng) và muốn mua đúng $5$ kg Arabica. Khách hàng đó có thể mua tối đa bao nhiêu kg Robusta (làm tròn lấy số nguyên kg)?],
    [7],
    loigiai: [
...
#tln([Cho bất phương trình $(m - 2)x + 3y - 6 <= 0$. Có tất cả bao nhiêu giá trị nguyên của tham số $m in [-5; 5]$ để miền nghiệm chứa cả hai điểm $C(1; 1)$ và $D(2; 0)$?],
    [11],
    loigiai: [
...
#tln([Trong góc phần tư thứ nhất, hai đường thẳng $d_1: x + y = 4$ và $d_2: x + y = 6$ cùng với hai trục tọa độ $O x, O y$ tạo thành một hình tứ giác. Tính diện tích của hình tứ giác đó.],
    [10],
    loigiai: [
...
#tln([Có tất cả bao nhiêu cặp số nguyên $(x; y)$ thỏa mãn bất phương trình $2x + 5y <= 20$ với điều kiện $x >= 0$ và $y >= 1$?],
    [18],
    loigiai: [
