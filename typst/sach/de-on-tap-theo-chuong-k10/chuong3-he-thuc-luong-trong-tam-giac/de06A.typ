...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 6: HỆ THỨC LƯỢNG TRONG TAM GIÁC (ĐỀ SỐ 1)",
  subject: "TOÁN",
...
// TN 2: Định lý sin
#tn([Cho tam giác $A B C$ có bán kính đường tròn ngoại tiếp bằng $R$. Khẳng định nào sau đây đúng?],
    (
        [$b / (sin B) = R$],
        [$b / (sin B) = 4R$],
        True([$b / (sin B) = 2R$]),
...
#tn([Cho tam giác $A B C$ có $b = 5, c = 8$ và góc $hat(A) = 60^circ$. Độ dài cạnh $a$ bằng:],
    (
        [$a = sqrt(129)$],
        [$a = 49$],
        True([$a = 7$]),
...
#tn([Cho tam giác $A B C$ có $a = 6$ và góc $hat(A) = 30^circ$. Bán kính đường tròn ngoại tiếp tam giác $A B C$ bằng:],
    (
        [$R = 3$],
        True([$R = 6$]),
        [$R = 12$],
...
#tn([Cho tam giác $A B C$ có $a = 4, b = 6$ và $hat(C) = 30^circ$. Diện tích của tam giác $A B C$ bằng:],
    (
        [$12$],
        [$12 sqrt(3)$],
        True([$6$]),
...
#tn([Cho tam giác $A B C$ có ba cạnh $a = 7, b = 8, c = 13$. Côsin của góc $hat(B)$ bằng:],
    (
        [$1/2$],
        [$7/13$],
        True([$11/13$]),
...
#tn([Cho tam giác $A B C$ vuông tại $A$ có $A B = 6$ và $A C = 8$. Độ dài đường trung tuyến $A M$ kẻ từ đỉnh $A$ bằng:],
    (
        [$10$],
        True([$5$]),
        [$2 sqrt(13)$],
...
#tn([Cho tam giác $A B C$ có độ dài ba cạnh là $a = 5, b = 6, c = 7$. Diện tích của tam giác $A B C$ bằng:],
    (
        True([$6 sqrt(6)$]),
        [$12 sqrt(6)$],
        [$24$],
...
#tn([Cho tam giác $A B C$ có độ dài ba cạnh là $a = 5, b = 12, c = 13$. Bán kính $r$ của đường tròn nội tiếp tam giác $A B C$ bằng:],
    (
        [$1$],
        True([$2$]),
        [$3$],
...
#tn([Cho tam giác đều $A B C$ có độ dài cạnh bằng $4$. Độ dài đường cao $A H$ của tam giác bằng:],
    (
        [$2$],
        [$4 sqrt(3)$],
        True([$2 sqrt(3)$]),
...
#tn([Cho tam giác $A B C$ thỏa mãn hệ thức $a^2 = b^2 + c^2 + b c$. Số đo góc $hat(A)$ bằng:],
    (
        [$60^circ$],
        [$30^circ$],
        [$150^circ$],
...
#tn([Hai tàu thủy cùng rời một cảng $O$ vào cùng một thời điểm. Tàu thứ nhất chạy theo hướng Đông với vận tốc $20" km/h"$, tàu thứ hai chạy theo hướng Đông Bắc (lệch $60^circ$ so với hướng Đông) với vận tốc $30" km/h"$. Sau $2$ giờ, khoảng cách giữa hai tàu xấp xỉ bằng:],
    (
        [$45.5" km"$],
        True([$52.9" km"$]),
        [$60.0" km"$],
...
#ds([Cho tam giác $A B C$ có độ dài ba cạnh $a = 7, b = 5, c = 6$. Xét tính đúng sai của các khẳng định sau:],
  (
...
#ds([Cho tam giác $A B C$ có $b = 7, c = 8$ và góc $hat(A) = 120^circ$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#ds([Để đo khoảng cách giữa hai vị trí $A$ và $B$ nằm ở hai bên bờ một hồ nước mà không thể đo trực tiếp, một kỹ sư đo đạc chọn một vị trí $C$ trên bờ sao cho từ $C$ có thể ngắm nhìn được cả $A$ và $B$. Kỹ sư đo được các số liệu: $C A = 150" m", C B = 200" m"$ và góc ngắm $hat(A C B) = 60^circ$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
#ds([Cho tam giác $A B C$ thỏa mãn hệ thức lượng $a = 2b cos C$. Xét tính đúng sai của các khẳng định sau:],
  (
...
#tln([Cho tam giác $A B C$ có $b = 6, c = 8$ và đường trung tuyến kẻ từ đỉnh $A$ có độ dài $m_a = 5$. Tính độ dài cạnh $a$ của tam giác $A B C$.],
    [10],
    loigiai: [
...
#tln([Cho tam giác $A B C$ có ba cạnh là $a = 13, b = 14, c = 15$. Tính bán kính đường tròn nội tiếp $r$ của tam giác $A B C$.],
    [4],
    loigiai: [
        #step([Tính nửa chu vi p])
...
#tln([Cho tam giác $A B C$ có ba cạnh $a = 13, b = 14, c = 15$. Tính độ dài đường cao $h_b$ kẻ từ đỉnh $B$ của tam giác.],
    [12],
    loigiai: [
        #step([Tính diện tích tam giác])
...
#tln([Từ một ngọn hải đăng $H$, người quan sát phát hiện hai chiếc thuyền $A$ và $B$ đang neo đậu trên biển. Khoảng cách từ hải đăng đến thuyền $A$ là $5" km"$, đến thuyền $B$ là $8" km"$, và góc nhìn giữa hai thuyền là $hat(A H B) = 60^circ$. Tính khoảng cách giữa hai chiếc thuyền (đơn vị: km).],
    [7],
    loigiai: [
