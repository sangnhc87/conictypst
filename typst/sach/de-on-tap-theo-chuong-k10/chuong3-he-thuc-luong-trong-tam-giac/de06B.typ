...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 6: HỆ THỨC LƯỢNG TRONG TAM GIÁC (ĐỀ SỐ 2)",
  subject: "TOÁN",
...
#tn([Cho tam giác $A B C$ có các cạnh $B C = a, C A = b, A B = c$. Khẳng định nào sau đây đúng?],
    (
...
#tn([Cho tam giác $A B C$ có bán kính đường tròn ngoại tiếp bằng $R$. Độ dài cạnh $a = B C$ được tính bởi công thức nào sau đây?],
    (
        [$a = R sin A$],
        [$a = (sin A) / (2R)$],
        True([$a = 2R sin A$]),
...
#tn([Cho tam giác $A B C$ có $a = 8, b = 10$ và góc $hat(C) = 60^circ$. Độ dài cạnh $c$ bằng:],
    (
        [$c = 2 sqrt(41)$],
        [$c = 14$],
        True([$c = 2 sqrt(21)$]),
...
#tn([Cho tam giác $A B C$ có $a = 10$ và góc $hat(A) = 45^circ$. Bán kính $R$ của đường tròn ngoại tiếp tam giác $A B C$ bằng:],
    (
        [$R = 10$],
        [$R = 10 sqrt(2)$],
        True([$R = 5 sqrt(2)$]),
...
#tn([Cho tam giác $A B C$ có $b = 3, c = 4$ và góc $hat(A) = 150^circ$. Diện tích của tam giác $A B C$ bằng:],
    (
        [$6$],
        [$6 sqrt(3)$],
        True([$3$]),
...
#tn([Cho tam giác $A B C$ có độ dài ba cạnh là $a = 3, b = 5, c = 7$. Số đo của góc $hat(C)$ bằng:],
    (
        [$60^circ$],
        [$90^circ$],
        [$150^circ$],
...
#tn([Cho tam giác đều $A B C$ có độ dài cạnh bằng $6$. Độ dài đường trung tuyến kẻ từ đỉnh $A$ bằng:],
    (
        [$3$],
        [$6 sqrt(3)$],
        True([$3 sqrt(3)$]),
...
#tn([Cho tam giác $A B C$ có ba cạnh là $a = 4, b = 5, c = 7$. Diện tích của tam giác $A B C$ bằng:],
    (
        [$8 sqrt(6)$],
        True([$4 sqrt(6)$]),
        [$12 sqrt(3)$],
...
#tn([Cho tam giác đều $A B C$ có độ dài cạnh bằng $6$. Bán kính $r$ của đường tròn nội tiếp tam giác bằng:],
    (
        [$1$],
        [$2$],
        True([$sqrt(3)$]),
...
#tn([Cho tam giác $A B C$ vuông tại $A$ có $A B = 6$ và $A C = 8$. Độ dài đường cao $A H$ kẻ từ đỉnh $A$ bằng:],
    (
        [$5$],
        True([$4.8$]),
        [$3.6$],
...
#tn([Cho tam giác có độ dài ba cạnh là $5, 7, 9$. Khẳng định nào sau đây là đúng về tính chất của tam giác này?],
    (
...
#tn([Từ vị trí $A$ và $B$ cách nhau $500" m"$, hai người quan sát cùng ngắm nhìn một trạm hải đăng $C$. Người tại $A$ đo được $hat(C A B) = 70^circ$, người tại $B$ đo được $hat(C B A) = 60^circ$. Góc nhìn $hat(A C B)$ từ hải đăng đến hai người bằng:],
    (
        [$40^circ$],
        True([$50^circ$]),
        [$60^circ$],
...
#ds([Cho tam giác $A B C$ có độ dài ba cạnh $a = 8, b = 10, c = 6$. Xét tính đúng sai của các khẳng định sau:],
  (
...
#ds([Cho tam giác $A B C$ có $b = 6, c = 4$ và góc $hat(A) = 60^circ$. Xét tính đúng sai của các mệnh đề sau:],
  (
...
#ds([Một chiếc trực thăng cứu hộ xuất phát từ trạm $A$, bay theo hướng thẳng về phía Bắc một quãng đường $A B = 300" km"$ đến vị trí $B$. Tại $B$, do thời tiết xấu, trực thăng đổi hướng bay lệch về phía Đông Bắc một góc $45^circ$ so với hướng Bắc và bay thêm một đoạn $B C = 400" km"$ để đến đích $C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
#ds([Cho tam giác $A B C$ có độ dài ba cạnh $a, b, c$ thỏa mãn hệ thức $b + c = 2a$. Xét tính đúng sai của các khẳng định sau:],
  (
...
#tln([Cho tam giác $A B C$ có độ dài ba cạnh $a = 7, b = 8, c = 9$. Tính độ dài đường trung tuyến $m_b$ kẻ từ đỉnh $B$ của tam giác $A B C$.],
    [7],
    loigiai: [
...
#tln([Cho tam giác $A B C$ có độ dài ba cạnh là $a = 15, b = 13, c = 14$. Tính diện tích của tam giác $A B C$.],
    [84],
    loigiai: [
...
#tln([Cho tam giác $A B C$ có $b = 10, c = 16$ và góc $hat(A) = 60^circ$. Tính độ dài cạnh $a$ của tam giác $A B C$.],
    [14],
    loigiai: [
        #step([Áp dụng định lý côsin])
...
#tln([Để đo khoảng cách giữa hai vị trí $A$ và $B$ qua một đầm lầy, người đo đạc chọn vị trí $C$ cách $A$ một đoạn $200" m"$, cách $B$ một đoạn $300" m"$ và góc ngắm $hat(A C B) = 60^circ$. Tính khoảng cách giữa hai vị trí $A$ và $B$ (làm tròn đến hàng đơn vị theo mét).],
    [265],
    loigiai: [
        #step([Áp dụng định lý côsin])
...
#tln([Một ngọn hải đăng có dàn đèn tín hiệu kéo dài theo phương thẳng đứng từ độ cao $12" m"$ (điểm $B$) đến độ cao $27" m"$ (điểm $A$) so với mặt nước biển. Một cano cứu nạn di chuyển trên mặt nước.
#align(center)[
    #cetz.canvas({
        import cetz.draw: *
        set-style(stroke: 0.8pt)
