...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 6: HỆ THỨC LƯỢNG TRONG TAM GIÁC (ĐỀ SỐ 3)",
  subject: "TOÁN",
...
#tn([Cho tam giác $A B C$ có diện tích $S$, nửa chu vi $p$ và độ dài ba cạnh là $a, b, c$. Bán kính đường tròn ngoại tiếp $R$ của tam giác được tính bằng công thức nào?],
    (
        [$R = (a b c) / S$],
        [$R = (a b c) / (2S)$],
        True([$R = (a b c) / (4S)$]),
...
#tn([Cho tam giác $A B C$ có $a = sqrt(3), b = 2, c = 1$. Số đo của góc $hat(B)$ bằng:],
    (
        [$30^circ$],
        [$45^circ$],
        [$60^circ$],
...
#tn([Cho tam giác $A B C$ có $b = 4$ và góc $hat(B) = 60^circ$. Độ dài đường kính của đường tròn ngoại tiếp tam giác $A B C$ bằng:],
    (
        [$4$],
        [$4 sqrt(3)$],
        True([$(8 sqrt(3)) / 3$]),
...
#tn([Cho tam giác $A B C$ có độ dài ba cạnh là $a = 6, b = 8, c = 10$. Diện tích của tam giác $A B C$ bằng:],
    (
        [$48$],
        [$30$],
        True([$24$]),
...
#tn([Cho tam giác $A B C$ có $a = 2 sqrt(3), b = 2$ và góc $hat(C) = 30^circ$. Độ dài cạnh $c$ bằng:],
    (
        [$c = 4$],
        True([$c = 2$]),
        [$c = 2 sqrt(2)$],
...
#tn([Cho tam giác $A B C$ có $a = 5, b = 6, c = 7$. Độ dài đường trung tuyến $m_c$ kẻ từ đỉnh $C$ bằng:],
    (
        [$sqrt(73)$],
        True([$sqrt(73) / 2$]),
        [$7/2$],
...
#tn([Cho tam giác $A B C$ có $a = 10, b = 10, c = 12$. Diện tích của tam giác $A B C$ bằng:],
    (
        [$60$],
        True([$48$]),
        [$96$],
...
#tn([Cho tam giác $A B C$ có diện tích $S = 48$ và nửa chu vi $p = 16$. Bán kính $r$ của đường tròn nội tiếp tam giác $A B C$ bằng:],
    (
        [$2$],
        True([$3$]),
        [$4$],
...
#tn([Cho tam giác $A B C$ có diện tích $S = 24$ và độ dài cạnh $a = 6$. Độ dài đường cao $h_a$ tương ứng bằng:],
    (
        [$4$],
        True([$8$]),
        [$6$],
...
#tn([Cho tam giác $A B C$ thỏa mãn hệ thức $sin^2 A = sin^2 B + sin^2 C$. Khẳng định nào sau đây là đúng?],
    (
...
#tn([Một xà lan di chuyển dọc theo một bờ kênh thẳng từ điểm $A$ đến điểm $B$ dài $100" m"$. Người quan sát đứng ở vị trí $C$ bên bờ đối diện đo được $hat(C A B) = 45^circ$ và $hat(C B A) = 60^circ$. Số đo góc $hat(A C B)$ bằng:],
    (
        [$65^circ$],
        [$70^circ$],
        True([$75^circ$]),
...
#ds([Cho tam giác $A B C$ có độ dài ba cạnh là $a = 13, b = 14, c = 15$. Xét tính đúng sai của các khẳng định sau:],
  (
...
#ds([Cho tam giác $A B C$ có cạnh $a = 8$ và hai góc $hat(B) = 45^circ, hat(C) = 75^circ$. Xét tính đúng sai của các khẳng định sau:],
  (
...
#ds([Cho tam giác $A B C$ thỏa mãn đẳng thức $sin A = (sin B + sin C) / (cos B + cos C)$. Xét tính đúng sai của các khẳng định sau:],
  (
...
#tln([Cho tam giác $A B C$ có $b = 7, c = 8$ và $cos A = 11/14$. Tính độ dài cạnh $a$ của tam giác $A B C$.],
    [5],
    loigiai: [
...
#tln([Cho tam giác $A B C$ có ba cạnh $a = 6, b = 8, c = 10$. Tính bán kính đường tròn ngoại tiếp $R$ của tam giác $A B C$.],
    [5],
    loigiai: [
...
#tln([Cho tam giác $A B C$ cân tại $C$ có $C A = C B = 10$ và $A B = 12$. Tính độ dài đường cao $h_c$ hạ từ đỉnh $C$ xuống cạnh $A B$.],
    [8],
    loigiai: [
...
#tln([Từ hai vị trí $A$ và $B$ trên bờ biển cách nhau $A B = 1000" m"$, người ta quan sát một hòn đảo nhỏ $C$ ngoài khơi. Các góc ngắm đo được gồm $hat(C A B) = 80^circ$ và $hat(C B A) = 70^circ$. Tính khoảng cách $A C$ từ trạm $A$ đến hòn đảo $C$ (làm tròn đến hàng đơn vị theo mét).],
    [1879],
    loigiai: [
...
#tln([Một bức tượng nghệ thuật có chiều cao $A B = 1.6" m"$ được đặt thẳng đứng trên một bệ đỡ. Mép dưới của tượng (điểm $B$) cách mặt đất $2.5" m"$, mép trên (điểm $A$) cách mặt đất $4.1" m"$. Một người quan sát có tầm mắt cách mặt đất $1.6" m"$.
#align(center)[
    #cetz.canvas({
        import cetz.draw: *
        set-style(stroke: 0.8pt)
