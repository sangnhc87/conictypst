...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 9: TÍCH CỦA MỘT VECTƠ VỚI MỘT SỐ (ĐỀ SỐ 1)",
  subject: "TOÁN",
...
// TN 1
#tn([Cho số thực $k > 0$ và vectơ $vec(a) != vec(0)$. Khẳng định nào sau đây là đúng về vectơ $k vec(a)$?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
...
// TN 2
#tn([Cho số thực $k < 0$ và vectơ $vec(a) != vec(0)$. Vectơ $k vec(a)$ có hướng và độ dài như thế nào so với vectơ $vec(a)$?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 3
#tn([Cho đoạn thẳng $A B$ có trung điểm là $I$. Đẳng thức vectơ nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 4
#tn([Cho tam giác $A B C$. Gọi $M$ là trung điểm của cạnh $B C$. Với điểm $O$ tùy ý, khẳng định nào sau đây luôn đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 5
#tn([Cho tam giác $A B C$ có trọng tâm là $G$ và $A M$ là đường trung tuyến. Khẳng định nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 6
#tn([Cho vectơ $vec(u)$ có độ dài $|vec(u)| = 4$. Độ dài của vectơ $- 3 vec(u)$ bằng bao nhiêu?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 7
#tn([Cho điểm $M$ nằm trên đoạn thẳng $A B$ sao cho $A M = 3 M B$. Đẳng thức vectơ nào sau đây là đúng?
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 8
#tn([Với hai vectơ tùy ý $vec(a), vec(b)$ và số thực $k$, khẳng định nào sau đây là SAI (tính chất phân phối)?],
    (
...
// TN 9
#tn([Cho tam giác đều $A B C$ có cạnh bằng $a$. Gọi $M$ là trung điểm của $B C$. Độ dài của vectơ $2 vec(A M)$ bằng
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 10
#tn([Cho hình bình hành $A B C D$ có tâm $O$. Phân tích vectơ $vec(A O)$ theo hai vectơ cạnh $vec(A B)$ và $vec(A D)$ ta được
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TN 11
#tn([Điều kiện cần và đủ để hai vectơ $vec(a)$ và $vec(b)$ ($vec(b) != vec(0)$) cùng phương là],
    (
...
// TN 12
#tn([Cho số thực $k$ và vectơ $vec(a)$. Đẳng thức $k vec(a) = vec(0)$ xảy ra khi và chỉ khi],
    (
...
#ds([Cho tam giác $A B C$. Gọi $M$ là trung điểm của cạnh $B C$, $N$ là trung điểm của cạnh $A C$ và $P$ là trung điểm của cạnh $A B$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#ds([Cho hình bình hành $A B C D$. Lấy điểm $M$ trên cạnh $A B$ sao cho $A M = 1/3 A B$, điểm $N$ trên đường chéo $A C$ sao cho $A N = 1/4 A C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#ds([Một khối hàng có khối lượng $m = 4" kg"$ đang nằm yên trên mặt sàn nằm ngang nhẵn bóng (bỏ qua mọi lực cản và ma sát). Tại thời điểm ban đầu, người ta tác dụng vào vật một lực kéo không đổi $vec(F)$ có phương nằm ngang hướng từ Tây sang Đông với độ lớn $F = 12" N"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 1 (Câu 17)
#tln([Cho đoạn thẳng $A B$ có độ dài bằng $12" cm"$. Điểm $M$ nằm giữa hai điểm $A$ và $B$ sao cho thỏa mãn hệ thức vectơ $vec(M A) = - 3 vec(M B)$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 2 (Câu 18)
#tln([Cho tam giác $A B C$ có trọng tâm là $G$. Gọi $M$ là trung điểm của cạnh $B C$. Biết độ dài đoạn thẳng trung tuyến $A M = 15" cm"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 3 (Câu 19)
#tln([Cho tam giác đều $A B C$ có cạnh bằng $8" cm"$. Gọi $M$ là trung điểm của cạnh $B C$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
// TLN 4 (Câu 20)
#tln([Cho hình vuông $A B C D$ có cạnh bằng $6" cm"$. Gọi $O$ là tâm của hình vuông.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
...
#tln([Một thanh đòn bẩy đồng chất nhẹ có chiều dài $A B = 200" cm"$ tựa thăng bằng nằm ngang trên điểm tựa $O$ nằm giữa hai đầu $A$ và $B$. Tại đầu $A$ treo một vật có khối lượng $m_1 = 30" kg"$, tại đầu $B$ treo một vật có khối lượng $m_2 = 50" kg"$.
#align(center)[
  #cetz.canvas({
    import cetz.draw: *
    set-style(stroke: 0.8pt)
