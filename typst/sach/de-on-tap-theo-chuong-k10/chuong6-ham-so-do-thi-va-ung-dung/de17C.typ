...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 16: HÀM SỐ BẬC HAI (ĐỀ SỐ 17C - NÂNG CAO & VDC)",
  subject: "TOÁN",
...
// TN 1
#tn([Khi tham số $m$ thay đổi, đỉnh của parabol $(P_m): y = x^2 - 2(m + 1)x + m^2 + 2m - 3$ luôn nằm trên đường thẳng cố định nào?],
    (
        True([$y = -4$]),
        [$y = 4$],
        [$y = 2x - 1$],
...
// TN 2
#tn([Đồ thị của hàm số bậc hai $y = a x^2 + b x + c$ đi qua hai điểm phân biệt có cùng tung độ là $A(1; 5)$ và $B(5; 5)$. Trục đối xứng của parabol là đường thẳng],
    (
        True([$x = 3$]),
        [$x = 2$],
        [$x = 4$],
...
// TN 3
#tn([Tìm tất cả các giá trị của tham số $m$ để parabol $y = x^2 - 4x + m$ cắt trục hoành tại hai điểm phân biệt $x_1, x_2$ thỏa mãn $x_1^2 + x_2^2 = 10$.],
    (
        True([$m = 3$]),
        [$m = -3$],
        [$m = 6$],
...
// TN 4
#tn([Xác định parabol $y = a x^2 + b x + c$ biết đồ thị có đỉnh $I(-1; -4)$ và cắt trục tung tại điểm $C(0; -3)$.],
    (
        True([$y = x^2 + 2x - 3$]),
        [$y = x^2 - 2x - 3$],
        [$y = 2x^2 + 4x - 3$],
...
// TN 5
#tn([Cho hàm số $f(x) = x^2 - 2x + 3$. Số nghiệm thực của phương trình $f(f(x)) = 3$ là],
    (
        True([$1$]),
        [$2$],
        [$3$],
...
// TN 6
#tn([Giá trị nhỏ nhất của hàm số $y = x^4 - 2x^2 + 5$ trên toàn trục số thực $RR$ bằng],
    (
        True([$4$]),
        [$5$],
        [$3$],
...
// TN 7
#tn([Giá trị lớn nhất của hàm số $y = (x - 1)(5 - x)$ trên đoạn $[1; 5]$ bằng],
    (
        True([$4$]),
        [$5$],
        [$3$],
...
// TN 8
#tn([Biết parabol $y = a x^2 + b x + c$ nhận trục tung $O y$ làm trục đối xứng và đi qua hai điểm $A(1; 2)$, $B(2; 5)$. Khi đó giá trị của biểu thức $T = a + b + c$ bằng],
    (
        True([$2$]),
        [$3$],
        [$5$],
...
// TN 9
#tn([Tìm giá trị của tham số $m$ để giá trị nhỏ nhất của hàm số $y = x^2 - 2x + m$ trên đoạn $[2; 4]$ bằng $5$.],
    (
        True([$m = 5$]),
        [$m = 4$],
        [$m = 6$],
...
// TN 10
#tn([Số giao điểm của hai parabol $(P_1): y = x^2 - 3x + 1$ và $(P_2): y = -x^2 + x + 7$ trên mặt phẳng tọa độ $O x y$ là],
    (
        True([$2$]),
        [$1$],
        [$0$],
...
// TN 11
#tn([Dây cáp chính của một cây cầu treo có dạng một parabol $y = a x^2$. Khoảng cách giữa hai tháp cầu là $120 text(" m")$, đỉnh của mỗi tháp cao $30 text(" m")$ so với điểm thấp nhất của dây cáp (gốc tọa độ $O$). Chiều cao của dây cáp tại điểm cách tháp cầu một khoảng $30 text(" m")$ bằng],
    (
        True([$7.5 text(" m")$]),
        [$15 text(" m")$],
        [$10 text(" m")$],
...
// TN 12
#tn([Cho hàm số $y = a x^2 + b x + c$ có đồ thị với bề lõm quay lên trên, đỉnh nằm ở góc phần tư thứ nhất và cắt trục tung tại điểm có tung độ dương. Dấu của các hệ số $a, b, c$ là],
    (
        True([$a > 0, b < 0, c > 0$]),
        [$a > 0, b > 0, c > 0$],
        [$a < 0, b > 0, c > 0$],
...
#ds([Cho hàm số $y = f(x) = |x^2 - 4x + 3|$ có đồ thị trên mặt phẳng tọa độ $O x y$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#ds([Cho hàm số $y = f(x) = x^2 - 2m x + m^2 - 2m + 3$ (với $m$ là tham số thực) xác định trên đoạn $[0; 2]$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#ds([Một chảo thu sóng truyền hình vệ tinh dạng gương cầu parabol có đường kính miệng chảo là $D = 120 text(" cm")$ và chiều sâu của chảo là $h = 30 text(" cm")$.
...
#ds([Cho parabol $(P): y = x^2 - (m + 1)x + m$ và đường thẳng $d: y = x - 1$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#tln([Tìm giá trị của tham số $m$ để parabol $y = x^2 - 2(m - 1)x + m^2 - 3$ có trục đối xứng là đường thẳng $x = 3$.],
    [4],
    loigiai: [
...
#tln([Cho hàm số $y = -x^2 + 2x + 3$ xác định trên đoạn $[-1; 4]$.
...
#tln([Tìm số giá trị nguyên của tham số $m in [-5; 5]$ để parabol $y = x^2 - 2x + m$ không có điểm chung với đường thẳng $y = 2x - 3$.],
    [4],
    loigiai: [
        #step([Phương trình hoành độ giao điểm])
...
#tln([Một chiếc cổng vòm hình parabol có chiều cao $12 text(" m")$ và khoảng cách giữa hai chân cổng trên mặt đất là $12 text(" m")$.
...
#tln([Cho hai số thực $x, y$ thỏa mãn điều kiện $x + y = 6$.
...
#tln([Một doanh nghiệp sản xuất bóng đèn LED. Nếu sản xuất $x$ nghìn bóng đèn thì tổng chi phí sản xuất là $C(x) = x^2 - 20x + 400$ (triệu đồng).
