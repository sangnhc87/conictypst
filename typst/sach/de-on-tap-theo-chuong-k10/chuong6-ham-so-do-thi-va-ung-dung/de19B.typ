...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 18: PHƯƠNG TRÌNH QUY VỀ PHƯƠNG TRÌNH BẬC HAI (ĐỀ SỐ 19B - VẬN DỤNG & THỰC TIỄN)",
  subject: "TOÁN",
...
// TN 1
#tn([Tập nghiệm của phương trình $sqrt(3x^2 - 4x - 1) = sqrt(2x^2 - 2x + 2)$ là],
    (
        True([$\{-1; 3\}$]),
        [$\{3\}$],
        [$\{-1\}$],
...
// TN 2
#tn([Số nghiệm thực của phương trình $sqrt(x^2 - 2x - 3) = 2x - 5$ là],
    (
        True([$0$]),
        [$1$],
        [$2$],
...
// TN 3
#tn([Tập nghiệm của phương trình $sqrt(5x^2 + 10x + 1) = x + 1$ là],
    (
        True([$\{0\}$]),
        [$\{-2; 0\}$],
        [$\{-2\}$],
...
// TN 4
#tn([Số nghiệm thực của phương trình $x^2 - 3x + sqrt(x^2 - 3x + 11) = 9$ là],
    (
        True([$2$]),
        [$1$],
        [$4$],
...
// TN 5
#tn([Tổng các bình phương các nghiệm thực của phương trình trùng phương $x^4 - 6x^2 + 8 = 0$ bằng],
    (
        True([$12$]),
        [$6$],
        [$8$],
...
// TN 6
#tn([Tập nghiệm của phương trình $sqrt(2x^2 - 7x + 6) = 2 - x$ là],
    (
        True([$\{1; 2\}$]),
        [$\{1\}$],
        [$\{2\}$],
...
// TN 7
#tn([Số nghiệm của phương trình $sqrt(x^2 - 5) = sqrt(x - 3)$ là],
    (
        True([$0$]),
        [$1$],
        [$2$],
...
// TN 8
#tn([Nghiệm của phương trình $sqrt(2x^2 + 5x - 2) = x + 2$ là],
    (
        True([$x = 2$]),
        [$x = -3$],
        [$x = 1$],
...
// TN 9
#tn([Tìm tất cả các giá trị của tham số $m$ để phương trình $sqrt(x^2 - 4x + m) = x - 1$ VÔ NGHIỆM.],
    (
        True([$m < 3$]),
        [$m > 3$],
        [$m >= 3$],
...
// TN 10
#tn([Tích các nghiệm thực của phương trình trùng phương $x^4 - 7x^2 + 12 = 0$ bằng],
    (
        True([$12$]),
        [$-12$],
        [$7$],
...
// TN 11
#tn([Hai con tàu $A$ và $B$ xuất phát từ hai bến cảng. Tàu $A$ chạy thẳng theo hướng Bắc với vận tốc $30 text(" km/h")$. Tàu $B$ chạy thẳng theo hướng Đông với vận tốc $40 text(" km/h")$.
...
// TN 12
#tn([Số giao điểm của đồ thị hàm số $y = sqrt(x^2 - 6x + 5)$ và đường thẳng $y = 2$ là],
    (
        True([$2$]),
        [$1$],
        [$0$],
...
#ds([Cho phương trình: $sqrt(x^2 - 2x + 4) = x + 1$.
...
#ds([Cho phương trình: $x^2 - 4x + sqrt(x^2 - 4x + 9) = 11$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#ds([Tại một ngã tư giao nhau vuông góc giữa hai tuyến đường lớn Đông - Tây và Nam - Bắc:
...
#ds([Cho phương trình: $sqrt(x^2 - 2x + m) = 2x - 1$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#tln([Tìm tổng các nghiệm thực của phương trình:
...
#tln([Một chiếc thang dài $5 text(" m")$ tựa vào một bức tường thẳng đứng. Ban đầu chân thang cách chân tường một khoảng $x text(" (m)")$ ($0 < x < 5$).
...
#tln([Tìm số nghiệm nguyên của phương trình:
...
#tln([Tìm giá trị nguyên lớn nhất của tham số $m$ để phương trình $sqrt(x^2 - 4x + m) = x - 3$ có nghiệm thực.],
    [3],
    loigiai: [
        #step([Điều kiện có nghiệm])
        $x - 3 >= 0 <=> x >= 3$.
