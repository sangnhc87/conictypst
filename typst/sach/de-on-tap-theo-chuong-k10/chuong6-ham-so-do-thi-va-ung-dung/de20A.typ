...
#show: thpt-school-exam.with(
  ...
  exam-title: "ÔN TẬP CHƯƠNG VI (ĐỀ SỐ 20A - CƠ BẢN ĐẾN VẬN DỤNG)",
  subject: "TOÁN",
...
// TN 1
#tn([Tập xác định của hàm số $y = sqrt(2x - 4) + 1 / (x - 3)$ là],
    (
...
// TN 2
#tn([Tọa độ đỉnh $I$ của parabol $(P): y = x^2 - 4x + 1$ là],
    (
        True([$I(2; -3)$]),
        [$I(-2; 13)$],
        [$I(2; 3)$],
...
// TN 3
#tn([Trục đối xứng của parabol $(P): y = -2x^2 + 8x - 5$ là đường thẳng],
    (
        True([$x = 2$]),
        [$x = -2$],
        [$x = 4$],
...
// TN 4
#tn([Hàm số bậc hai $y = -x^2 + 6x - 2$ đồng biến trên khoảng nào dưới đây?],
    (
        True([$(-infinity; 3)$]),
        [$(3; +infinity)$],
        [$(-infinity; 6)$],
...
// TN 5
#tn([Tập nghiệm của bất phương trình bậc hai $x^2 - 7x + 10 <= 0$ là],
    (
        True([$[2; 5]$]),
        [$(2; 5)$],
...
// TN 6
#tn([Tam thức bậc hai nào sau đây luôn nhận giá trị DƯƠNG với mọi số thực $x in RR$?],
    (
        True([$f(x) = x^2 - 2x + 5$]),
        [$g(x) = x^2 - 4x + 4$],
        [$h(x) = -x^2 + 2x - 3$],
...
// TN 7
#tn([Nghiệm của phương trình $sqrt(2x^2 - 3x + 1) = x - 1$ là],
    (
        True([$x = 1$]),
        [$x = 0$],
        [$x = 2$],
...
// TN 8
#tn([Số giao điểm của parabol $(P): y = x^2 - 3x + 2$ với trục hoành $O x$ là],
    (
        True([$2$]),
        [$1$],
        [$0$],
...
// TN 9
#tn([Biết đồ thị hàm số bậc hai $y = x^2 - 2x + m$ đi qua điểm $A(1; 3)$. Giá trị của tham số $m$ là],
    (
        True([$m = 4$]),
        [$m = 2$],
        [$m = -2$],
...
// TN 10
#tn([Tập nghiệm của bất phương trình $(x - 3) / (x^2 - 4) <= 0$ là],
    (
...
// TN 11
#tn([Một cây cầu treo có nhịp cầu dạng parabol với khoảng cách giữa hai chân cầu là $120 text(" m")$ và chiều cao vòm cầu tại điểm cao nhất là $20 text(" m")$.
...
// TN 12
#tn([Tổng các nghiệm thực của phương trình $sqrt(3x^2 - 5x + 1) = sqrt(x^2 - 2x + 4)$ bằng],
    (
        True([$3/2$]),
        [$-3/2$],
        [$1$],
...
#ds([Cho hàm số $y = f(x) = x^2 - 2x - 3$ có đồ thị parabol $(P)$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#ds([Cho phương trình: $sqrt(2x^2 - 5x + 2) = x - 1$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#ds([Một công ty điện tử sản xuất chuột không dây công thái học.
...
#ds([Cho tam thức bậc hai: $f(x) = x^2 - 2(m + 1)x + 4m$ (với $m$ là tham số thực).
Xét tính đúng sai của các nhận định sau:],
  (
...
#tln([Tìm giá trị nhỏ nhất của hàm số $y = x^2 - 6x + 13$ trên đoạn $[0; 5]$.],
    [4],
    loigiai: [
...
#tln([Tìm số nghiệm nguyên của bất phương trình bậc hai $x^2 - 9x + 14 <= 0$.],
    [6],
    loigiai: [
...
#tln([Một cổng chào hình parabol có chiều rộng ở chân cổng là $8 text(" m")$ và chiều cao tính từ mặt đất đến đỉnh cổng là $6 text(" m")$.
...
#tln([Tìm số giá trị nguyên của tham số $m in [-10; 10]$ để tam thức bậc hai $f(x) = x^2 - 2m x + 3m + 4$ luôn nhận giá trị dương với mọi số thực $x$.],
    [4],
    loigiai: [
...
#tln([Tìm tổng các nghiệm thực của phương trình trùng phương $x^4 - 8x^2 + 15 = 0$.],
    [0],
    loigiai: [
