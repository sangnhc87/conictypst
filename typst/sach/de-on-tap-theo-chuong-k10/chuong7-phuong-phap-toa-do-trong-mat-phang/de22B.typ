...
#show: thpt-school-exam.with(
  ...
  exam-title: "BÀI 20: VỊ TRÍ TƯƠNG ĐỐI GIỮA HAI ĐƯỜNG THẲNG. GÓC VÀ KHOẢNG CÁCH (ĐỀ SỐ 22B - VẬN DỤNG & THỰC TIỄN)",
  subject: "TOÁN",
...
// TN 1
#tn([Cho hai đường thẳng $d_1: 2x + y - 1 = 0$ và $d_2: x - 2y + 3 = 0$. Khẳng định nào sau đây là đúng?],
    (
...
// TN 2
#tn([Khoảng cách từ điểm $M(3; -1)$ đến đường thẳng $Delta: 4x - 3y + 5 = 0$ bằng],
    (
        True([$4$]),
        [$20$],
        [$5$],
...
// TN 3
#tn([Khoảng cách giữa hai đường thẳng song song $d_1: 3x - 4y + 2 = 0$ và $d_2: 3x - 4y + 12 = 0$ bằng],
    (
        True([$2$]),
        [$10$],
        [$2.5$],
...
// TN 4
#tn([Cosin của góc giữa hai đường thẳng $d_1: 3x + y - 2 = 0$ và $d_2: 2x - y + 5 = 0$ bằng],
    (
        True([$sqrt(2) / 2$]),
        [$1 / 2$],
        [$sqrt(3) / 2$],
...
// TN 5
#tn([Góc tạo bởi đường thẳng $d: x + y - 5 = 0$ và trục hoành $O x$ bằng],
    (
        True([$45^circ$]),
        [$30^circ$],
        [$60^circ$],
...
// TN 6
#tn([Tìm giá trị của tham số $m$ để hai đường thẳng $d_1: m x + 2y - 1 = 0$ và $d_2: 2x - 4y + 3 = 0$ vuông góc với nhau.],
    (
        True([$m = 4$]),
        [$m = -4$],
        [$m = 2$],
...
// TN 7
#tn([Điểm $A(1; 2)$ cách đường thẳng $Delta: 3x + 4y + c = 0$ một khoảng bằng $3$. Giá trị dương của tham số $c$ bằng],
    (
        True([$c = 4$]),
        [$c = 26$],
        [$c = 15$],
...
// TN 8
#tn([Một đường thẳng $d'$ song song với đường thẳng $d: 3x - 4y + 1 = 0$ và cách điểm $M(1; 2)$ một khoảng bằng $2$ có phương trình là],
    (
        True([$3x - 4y + 15 = 0$]),
        [$3x - 4y - 15 = 0$],
        [$4x + 3y + 5 = 0$],
...
// TN 9
#tn([Trong tam giác $A B C$, hai đường cao kẻ từ $B$ và $C$ lần lượt nằm trên các đường thẳng $d_1: x - y + 1 = 0$ và $d_2: 2x + y - 4 = 0$. Tọa độ trực tâm $H$ của tam giác $A B C$ là],
    (
        True([$H(1; 2)$]),
        [$H(2; 3)$],
        [$H(0; 1)$],
...
// TN 10
#tn([Góc tạo bởi hai đường thẳng $d_1: x - y = 0$ và $d_2: x + y - 2 = 0$ bằng],
    (
        True([$90^circ$]),
        [$45^circ$],
        [$60^circ$],
...
// TN 11
#tn([Một đường ray xe lửa chạy thẳng được mô phỏng bởi đường thẳng $Delta: 3x + 4y - 12 = 0$ (đơn vị: kilômét).
...
// TN 12
#tn([Trên hải đồ vùng biển ven bờ, luồng hàng hải cho tàu tải trọng lớn ra vào cảng được quy hoạch theo đường thẳng $d: 12x - 5y + 39 = 0$.
...
#ds([Cho hai đường thẳng song song $Delta_1: 3x + 4y - 7 = 0$ và $Delta_2: 3x + 4y + 13 = 0$ như hình vẽ:
#align(center)[
#cetz.canvas({
  import cetz.draw: *
...
#ds([Cho hai đường thẳng cắt nhau $d_1: 3x - 4y + 1 = 0$ và $d_2: 4x + 3y - 2 = 0$.
Xét tính đúng sai của các nhận định sau:],
  (
...
#ds([Một dải đá ngầm ven biển trải dài trên đường thẳng $d: 5x - 12y + 26 = 0$ (đơn vị: hải lý).
...
#ds([Trong mặt phẳng $O x y$, cho điểm $A(1; 2)$ và đường thẳng $d_m: 3x - 4y + m = 0$ (với $m$ là tham số).
Xét tính đúng sai của các nhận định sau:],
  (
...
#tln([Tính khoảng cách từ điểm $M(3; -1)$ đến đường thẳng $4x - 3y + 5 = 0$.],
    [4],
    loigiai: [
...
#tln([Tính khoảng cách giữa hai đường thẳng song song $3x + 4y - 7 = 0$ và $3x + 4y + 13 = 0$.],
    [4],
    loigiai: [
...
#tln([Tìm giá trị dương của tham số $m$ để khoảng cách từ gốc tọa độ $O(0; 0)$ đến đường thẳng $d: 5x - 12y + m = 0$ bằng $3$.],
    [39],
    loigiai: [
...
#tln([Trong bài toán xây dựng đường dây cáp điện ngầm từ trạm $S(6; 6)$ đến đường ray xe lửa $3x + 4y - 12 = 0$, khoảng cách ngắn nhất cần thi công bằng bao nhiêu kilômét?],
    [6],
    loigiai: [
...
#tln([Tìm giá trị của tham số $m$ để hai đường thẳng $d_1: m x + 2y - 1 = 0$ và $d_2: 2x - 4y + 3 = 0$ vuông góc với nhau.],
    [4],
    loigiai: [
...
#tln([Hai đường thẳng $d_1: 3x - y + 1 = 0$ và $d_2: x + 3y - 5 = 0$ cắt nhau tạo thành một góc bằng bao nhiêu độ?],
    [90],
    loigiai: [
