// Cấu hình chung cho Lượng Giác — Chương 1 (Toán 11)
...
// ─── Màu chủ đạo của chương: INDIGO ────────────────────────────
#let c-book  = rgb("#4338CA")   // Indigo — màu chính
#let c-p1    = rgb("#4338CA")   // Alias
