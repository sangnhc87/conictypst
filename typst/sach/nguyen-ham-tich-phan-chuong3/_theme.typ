#let C-DARK = rgb("#0F2742")
#let C-NAVY = rgb("#1D4E89")
#let C-FOREST = rgb("#0F766E")
#let C-EMERALD = rgb("#0F766E")
#let C-GOLD = rgb("#C9A227")
#let C-AMBER = rgb("#B45309")
#let C-WINE = rgb("#7C2D12")
...
#let cover-box(title, subtitle) = block(
  ...
  #align(center)[
    ...
    #v(0.5em)
    #text(fill: rgb("#D7F5F1"), size: 13pt, style: "italic")[#subtitle]
    #v(1em)
    #line(length: 42%, stroke: 1.1pt + C-GOLD)
    #v(0.8em)
    #text(fill: rgb("#D4F4E8"), size: 10pt)[
...
#let eye-box(body) = block(
  ...
  #set par(first-line-indent: 0em)
  #text(fill: C-TEAL, weight: "bold", size: 10.5pt)[👁 TRỰC GIÁC — Bức Tranh Ẩn Sau Các Công Thức Tích Phân]
  #v(0.5em)
  #body
]
